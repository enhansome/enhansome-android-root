...
> For privacy-friendly installs, use the F-Droid ecosystem: install [Droid-ify](https://github.com/Droid-ify/client/releases) ⭐ 7,272 | 🐛 198 | 🌐 Kotlin | 📅 2026-08-17 (modern F-Droid client) and enable the [IzzyOnDroid](https://apt.izzysoft.de/fdroid/) repo for many additional packages.
...
| :----------------------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------- |
|       **[Magisk](https://github.com/topjohnwu/Magisk) ⭐ 62,275 \| 🐛 61 \| 🌐 Kotlin \| 📅 2026-08-13** <br><small> `Root & Module Management` </small>      | If you chose Magisk, this is your manager.               |
| **[App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 8,749 \| 🐛 216 \| 🌐 Java \| 📅 2026-06-29** <br><small> `App & Package Management` </small> | Inspect and manage apps with root privileges.            |
...
* **[⭐ Magisk](https://github.com/topjohnwu/Magisk) ⭐ 62,275 | 🐛 61 | 🌐 Kotlin | 📅 2026-08-13** - Manage Magisk modules and root permissions. `FOSS`
* **[⭐ KernelSU](https://github.com/tiann/KernelSU) ⭐ 17,858 | 🐛 61 | 🌐 Kotlin | 📅 2026-08-17** - A Kernel based root solution for Android. `FOSS`
* **[APatch](https://github.com/bmax121/APatch) ⭐ 7,807 | 🐛 94 | 🌐 Kotlin | 📅 2026-08-16** - The patching of Android kernel and Android system. `FOSS` | [🌱](https://f-droid.org/packages/me.bmax.apatch/)
* **[SukiSU-Ultra](https://github.com/SukiSU-Ultra/SukiSU-Ultra) ⭐ 6,110 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-15** - A kernel-based root solution for Android devices, forked from `KernelSU` with some useful changes. `FOSS`
* **[KernelSU-next](https://github.com/KernelSU-Next/KernelSU-Next) ⭐ 4,106 | 🐛 19 | 🌐 Kotlin | 📅 2026-08-17** - An advanced Kernel based root solution for Android. `FOSS`
* **[ReSukiSU](https://github.com/ReSukiSU/ReSukiSU) ⭐ 1,221 | 🐛 16 | 🌐 Kotlin | 📅 2026-08-17** - Fork of SukiSU-Ultra with additional features. `FOSS`
* **[FolkPatch](https://github.com/LyraVoid/FolkPatch) ⭐ 1,049 | 🐛 25 | 🌐 Kotlin | 📅 2026-08-17** - A Root management tool focused on interface optimization and feature extension, based on APatch. `FOSS`

### Module Managers

* **[⭐ MMRL](https://github.com/DerGoogler/MMRL) ⭐ 2,130 | 🐛 8 | 🌐 Kotlin | 📅 2026-07-10** - An Android app that helps manage your own modules repository. `FOSS` `[M]` `[K]` `[A]` | [🌱](https://f-droid.org/en/packages/com.dergoogler.mmrl/) | [▶️](https://play.google.com/store/apps/details?id=com.dergoogler.mmrl)
* **[KPatch Next Module](https://github.com/KernelSU-Next/KPatch-Next-Module) ⭐ 468 | 🐛 7 | 🌐 JavaScript | 📅 2026-03-05** - Standalone implementation of KPM (KernelSU Patch Module) support for Magisk/KernelSU with WebUI. `FOSS` `[M]` `[K]`
...
* **[Meta-hybrid\_mount](https://github.com/YuzakiKokuban/meta-hybrid_mount) ⭐ 1,437 | 🐛 4 | 🌐 Rust | 📅 2026-08-17** - Three-engine mount orchestration (OverlayFS + Magic Mount + Kasumi LKM) with conflict monitor, SolidJS WebUI, auto-fallback, and EROFS storage backend support. `FOSS` `[K]` `[A]`
* **[⭐ Mountify](https://github.com/backslashxx/mountify) ⭐ 1,296 | 🐛 22 | 🌐 Shell | 📅 2026-08-16** - OverlayFS with tmpfs/ext4 sparse support for reduced detection, works on APatch/Magisk too. `FOSS` `[M]` `[K]` `[A]`
...
* **[⭐ Vector](https://github.com/JingMatrix/Vector) ⭐ 12,135 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-17** - Open Source *Fork* of original LSPosed with dynamic module loading, and other improvements. `FOSS` `[M]`
...
* **[⭐ Zygisk Next](https://github.com/Dr-TSNG/ZygiskNext) ⭐ 10,329 | 🐛 1 | 📅 2026-08-05** The "Gold Standard" for detection evasion. It is a standalone Zygisk implementation that offers the most advanced stealth features, including a dedicated **Zygote Monitor** and dashboard. `Proprietary` `[M]` `[K]` `[A]`
* **[ReZygisk](https://github.com/PerformanC/ReZygisk) ⭐ 3,836 | 🐛 11 | 🌐 C | 📅 2026-08-04** A high-performance implementation **entirely rewritten in C**. It introduces **custom linkers** to bypass modern linker-based detections, offering a WebUI for status monitoring and compatibility with Android 15 and 16. `FOSS` `[M]` `[K]` `[A]`
...
* **[⭐ Shamiko](https://github.com/LSPosed/LSPosed.github.io/releases) ⭐ 6,311 | 🐛 0 | 🌐 HTML | 📅 2026-07-29** - Hides Magisk root from detection. `Proprietary` `[M]`
* **[TrickyStore](https://github.com/5ec1cff/TrickyStore) ⭐ 6,290 | 🐛 4 | 📅 2025-11-30** - Modifies the certificate chain for Android key attestation (keybox-based). The original/reference module. `Proprietary` `[M]` `[K]`
* **[Hide My Applist](https://github.com/Dr-TSNG/Hide-My-Applist) ⭐ 5,516 | 🐛 9 | 🌐 Kotlin | 📅 2026-08-01** - Intercepts app-list detection. `Proprietary` `[LSP]`
...
* **[Play Integrity Fix (inject)](https://github.com/KOWX712/PlayIntegrityFix) ⭐ 3,745 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-11** - Actively maintained fork using injected GMS/Play Store spoofing with a WebUI. `FOSS` `[M]`
* **[Tricky Addon – Update Target List](https://github.com/KOWX712/Tricky-Addon-Update-Target-List) ⭐ 3,382 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-16** - KSU WebUI to configure TrickyStore's `target.txt`. `FOSS` `[K]`
* **[⭐ HMA-OSS](https://github.com/frknkrc44/HMA-OSS) ⭐ 2,868 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-16** - FOSS rewrite of Hide My Applist; hides your app list, settings, and package installers. `FOSS` `[LSP]`
* **[Zygisk Assistant](https://github.com/snake-4/Zygisk-Assistant) ⭐ 2,567 | 🐛 17 | 🌐 C++ | 📅 2026-05-04** - Zygisk module to hide root on KernelSU, Magisk, and APatch. `FOSS` `[M]`
* **[⭐ SUSFS for KernelSU](https://github.com/sidex15/susfs4ksu-module) ⭐ 2,504 | 🐛 2 | 🌐 HTML | 📅 2026-08-08** - Add-on root-hiding service for SUSFS-patched kernels (KernelSU/Next). The core of modern KSU hiding setups. `FOSS` `[M]` `[K]`
* **[⭐ TEESimulator](https://github.com/JingMatrix/TEESimulator) ⭐ 2,211 | 🐛 9 | 🌐 C++ | 📅 2026-08-17** - Create a complete, software-based simulation of a hardware-backed Trusted Execution Environment (TEE) for Key Attestation. `FOSS` `[M]` `[K]`
* **[YuriKey](https://github.com/dpejoh/yurikey) ⭐ 1,848 | 🐛 9 | 🌐 Shell | 📅 2026-08-01** - Systemless module to obtain strong integrity easily. `FOSS` `[M]` `[K]`
* **[TEESimulator-RS](https://github.com/Enginex0/TEESimulator-RS) ⭐ 1,603 | 🐛 20 | 🌐 Kotlin | 📅 2026-07-11** - Fork of TEESimulator with native Rust certificate generation, key persistence, and AOSP-compliant attestation behavior. `FOSS` `[M]` `[K]`
* **[NoHello](https://github.com/MhmRdd/NoHello) ⭐ 1,342 | 🐛 21 | 🌐 C++ | 📅 2025-06-28** - Lightweight Zygisk module to hide root. `FOSS` `[M]`
* **[TrickyStore OSS](https://github.com/beakthoven/TrickyStoreOSS) ⭐ 1,287 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-15** - Open-source alternative to TrickyStore. `FOSS` `[M]` `[K]`
...
* **[Specter](https://github.com/dpejoh/specter) ⭐ 516 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-17** - Unified Play Integrity and root hiding stack for Android. Successor of Yurikey. `FOSS` `[M]` `[K]`
...
* **[⭐ BRENE](https://github.com/rrr333nnn333/BRENE) ⭐ 323 | 🐛 9 | 🌐 Shell | 📅 2026-08-17** - SUSFS/KernelSU module for patched kernels with enhanced root hiding & spoofing. `FOSS` `[M]` `[K]`
* **[Always Strong](https://github.com/evoker0/AlwaysStrong) ⭐ 295 | 🐛 4 | 🌐 Shell | 📅 2026-08-16** - Bundles TEESimulator-RS and PlayIntegrityFork into a single module for strong integrity on rooted devices. `FOSS` `[M]` `[K]`
* **[OhMyKeymint](https://github.com/qwq233/OhMyKeymint) ⭐ 248 | 🐛 2 | 🌐 Rust | 📅 2026-08-12** - Custom keystore implementation for Android Keystore Spoofer. `FOSS` `[M]` `[K]`
* **[ReZygisk's Treat Wheel](https://github.com/PerformanC/Treat-Wheel-Zygisk) ⭐ 242 | 🐛 7 | 🌐 C | 📅 2026-07-22** - Hides Magisk/root traces exclusively for ReZygisk, acting as the best userspace root hiding tool. `FOSS` `[M]` `[K]`
...
* **[YetAnotherBootloopProtector](https://github.com/Magisk-Modules-Alt-Repo/YetAnotherBootloopProtector) ⭐ 173 | 🐛 5 | 🌐 Shell | 📅 2026-04-14** - Monitor and fix potential Bootloops and SystemUI failures. `FOSS` `[M]`
...
* **[Duck Detector](https://github.com/eltavine/Duck-Detector-Refactoring) ⭐ 856 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-17** - Android environment integrity inspection tool for root, hook, bootloader, SELinux, virtualization, and attestation signals. `FOSS`
* **[Play Integrity API Checker](https://github.com/1nikolas/play-integrity-checker-app) ⭐ 806 | 🐛 7 | 🌐 Java | 📅 2025-08-19** - This app shows info about your device integrity as reported by Google Play Services. If any of this fails could mean your device is rooted or tampered in a way. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=gr.nikolasspyr.integritycheck)
...
* **[⭐ Duck Detector Fork](https://github.com/rrr333nnn333/Duck-Detector-Refactoring) ⭐ 41 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-14** - Duck Detector fork with additional features and improvements. `FOSS`
...
* **[HyperOS Security Center](https://github.com/Mods-Center/HyperOS-Security-Center) ⭐ 120 | 🐛 5 | 📅 2026-08-14** - Advanced app info tools, system app Wi-Fi management, removal of root/account restrictions etc. `Proprietary` `[M]` `[K]`
...
* **[LuckyTool](https://github.com/Xposed-Modules-Repo/com.luckyzyx.luckytool/blob/main/README_EN.md) ⭐ 1,869 | 🐛 8 | 📅 2026-04-26** - Extended functionality and optimization module for ColorOS. `Proprietary` `[LSP]`
* **[OShin](https://github.com/suqi8/OShin/blob/master/README_EN.md) ⭐ 1,156 | 🐛 99 | 🌐 Kotlin | 📅 2026-07-28** - Auxiliary module deeply integrated with ColorOS, designed to enhance and optimize your operating system experience. `FOSS` `[LSP]`
...
* **[⭐ HyperCeiler](https://github.com/ReChronoRain/HyperCeiler/blob/main/README_en-US.md) ⭐ 5,218 | 🐛 230 | 🌐 Java | 📅 2026-08-04** - Extensive customizations for HyperOS. `FOSS` `[LSP]`
...
* **[One UI X](https://github.com/SoClear/OneUIX) ⭐ 168 | 🐛 16 | 🌐 Kotlin | 📅 2026-08-15** - Remove annoying restrictions, and inject powerful enhancements into the Status Bar, Quick Settings, and native apps etc on Samsung's One UI. `FOSS` `[LSP]`
...
* **[Oxygen-Customizer](https://github.com/DHD2280/Oxygen-Customizer/) ⭐ 453 | 🐛 37 | 🌐 Java | 📅 2026-08-16** - Open-source Oxygen OS customizer application. `FOSS` `[LSP]`
...
* **[⭐ Canta](https://github.com/samolego/Canta) ⭐ 5,569 | 🐛 29 | 🌐 Kotlin | 📅 2026-08-16** - Uninstall any app without root using [Shizuku](#developer-tools). `FOSS` | [🌱](https://f-droid.org/en/packages/io.github.samolego.canta/) | [▶️](https://play.google.com/store/apps/details?id=io.github.samolego.canta)
...
* **[System App Nuker](https://github.com/ChiseWaguri/systemapp_nuker) ⭐ 243 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-17** - A module to debloat system apps with WebUI Interface. `FOSS` `[M]`
...
* **[⭐ App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 8,749 | 🐛 216 | 🌐 Java | 📅 2026-06-29** - A full-featured package manager and viewer for Android. `FOSS` | [🌱](https://f-droid.org/packages/io.github.muntashirakon.AppManager/)
* **[⭐ Droid-ify](https://github.com/Droid-ify/client) ⭐ 7,272 | 🐛 198 | 🌐 Kotlin | 📅 2026-08-17** - F-Droid client with Material UI and auto updating apps using root. `FOSS` | [🌱](https://f-droid.org/packages/com.looker.droidify)
* **[⭐ Hail](https://github.com/aistra0528/Hail) ⭐ 6,469 | 🐛 168 | 🌐 Kotlin | 📅 2026-08-12** - Disable / Hide / Suspend / Uninstall Android apps. `FOSS` | [🌱](https://f-droid.org/packages/com.aistra.hail/)
* **[InstallerX-Revived](https://github.com/wxxsfxyzm/InstallerX-Revived) ⭐ 6,187 | 🐛 14 | 🌐 Kotlin | 📅 2026-08-17** - A modern and functional Android app installer. `FOSS` `[LSP]`
* **[Neo Store](https://github.com/NeoApplications/Neo-Store) ⭐ 4,910 | 🐛 130 | 🌐 Kotlin | 📅 2026-04-25** - An F-Droid client with modern UI and an arsenal of extra features. `FOSS` | [🌱](https://f-droid.org/packages/com.machiav3lli.fdroid)
* **[Aurora Store](https://github.com/whyorean/AuroraStore) ⭐ 2,820 | 🐛 26 | 🌐 Kotlin | 📅 2026-08-11** - A Google Play Store client to search, view app details, and download APKs directly to your device. `FOSS` | [🌱](https://f-droid.org/packages/com.aurora.store/)
* **[⭐ Zygisk Detach](https://github.com/j-hc/zygisk-detach) ⭐ 2,106 | 🐛 0 | 🌐 Rust | 📅 2026-07-09** - Zygisk module to detach installed apps from Play Store, hooking binder. `FOSS` `[M]` `[K]`
* **[Inure](https://github.com/Hamza417/Inure) ⭐ 1,878 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-16** - An elegant and beautiful premium Android app manager for rooted and non-rooted devices. `FOSS` | [🌱](https://f-droid.org/en/packages/app.simple.inure/) | [▶️](https://play.google.com/store/apps/details?id=app.simple.inure.play)
* **[Universal Installer](https://github.com/pass-with-high-score/universal-installer) ⭐ 1,265 | 🐛 18 | 🌐 Kotlin | 📅 2026-08-09** - Install and manage APK packages with split APK support. `FOSS` `[LSP]`
* **[InxLocker](https://github.com/Chimioo/InxLocker) ⭐ 850 | 🐛 2 | 🌐 Kotlin | 📅 2026-06-11** - Intercepts/forwards Android system application installation and uninstallation requests, redirecting them to your specified installer app. `FOSS` `[LSP]`
...
* **[Thor](https://github.com/trinadhthatakula/Thor) ⭐ 514 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-17** - Android App Manager and App Installer utility. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/com.valhalla.thor) | [▶️](https://play.google.com/store/apps/details?id=com.valhalla.thor)
...
* **[AZenith](https://github.com/Liliya2727/AZenith) ⭐ 110 | 🐛 6 | 🌐 HTML | 📅 2026-07-05** - All-In-One (AIO) system optimization module designed to enhance Android performance. `FOSS` `[M]` `[K]`
...
* **[COPG-VD](https://github.com/VD171/COPG-VD) ⭐ 80 | 🐛 4 | 🌐 C++ | 📅 2026-08-10** - Fork of COPG with additional features and optimizations. `FOSS` `[M]` `[K]`
...
* **[KonaBess](https://github.com/libxzr/KonaBess) ⭐ 1,772 | 🐛 12 | 🌐 Java | 📅 2025-10-03** - A straightforward application designed to customize GPU frequency and voltage tables without the need for kernel recompilation. `FOSS`
* **[Kernel Flasher](https://github.com/fatalcoder524/KernelFlasher) ⭐ 485 | 🐛 7 | 🌐 Kotlin | 📅 2026-07-01** - An Android app to flash (AK3 files), backup, and restore kernels. `FOSS`
...
* **[KonaBess Next](https://github.com/KonaBess-Next/KonaBess-Next) ⭐ 205 | 🐛 18 | 🌐 Kotlin | 📅 2026-08-06** - Fork of KonaBess, Custom GPU overclocking and undervolting tool with granulated voltage for rooted Snapdragon Android devices. `FOSS`
...
* **[⭐ FROSTY](https://github.com/Drsexo/Frosty) ⭐ 203 | 🐛 3 | 🌐 Shell | 📅 2026-07-04** - Optimizes battery life by selectively freezing Google Mobile Services (GMS) components and applying system-wide doze enhancements. `FOSS` `[M]` `[K]`
* **[BatStats](https://github.com/mlm-games/BatStats) ⭐ 172 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-17** - Battery monitor with stats via Shizuku/root. `FOSS`
...
* **[Universal GMS Doze Fork](https://github.com/MarsPatrick/universal-gms-doze) ⭐ 61 | 🐛 3 | 🌐 HTML | 📅 2026-08-17** - Patches Google Play services app and certain processes/services to be able to use battery optimization. `FOSS` `[M]`
...
* **[AccA](https://github.com/VR-25/acc) ⭐ 2,371 | 🐛 19 | 🌐 Shell | 📅 2025-06-06** - Advanced Charging Controller app. `FOSS`
...
* **[TaskManager](https://github.com/RohitKushvaha01/TaskManager) ⭐ 608 | 🐛 4 | 🌐 C++ | 📅 2026-08-07** - Task Manager inspired from gnome system monitor for android.Must read [F-Droid inclusion](https://github.com/RohitKushvaha01/TaskManager/issues/24) ⭐ 608 | 🐛 4 | 🌐 C++ | 📅 2026-08-07 `FOSS` | [▶️](https://play.google.com/store/apps/details?id=com.rk.taskmanager)
* **[Shappky](https://github.com/YasserNull/shappky) ⭐ 534 | 🐛 19 | 🌐 Kotlin | 📅 2026-08-17** - A simple app to boost performance by stopping background apps, relying on Root/Shizuku permissions. `FOSS` `[M]`
* **[No More Background](https://github.com/adil192/no_more_background) ⭐ 299 | 🐛 8 | 🌐 Dart | 📅 2026-08-06** - A fire-and-forget program to stop Android apps from running in the background. `FOSS` | [🌱](https://f-droid.org/en/packages/com.adilhanney.no_more_background/)
...
* **[BlockAds](https://github.com/pass-with-high-score/blockads-android) ⭐ 1,741 | 🐛 64 | 🌐 Kotlin | 📅 2026-07-30** - System‑wide ad, tracker, & malware filtering, custom blocklists, per‑app controls etc. `FOSS` | [🌱](https://f-droid.org/packages/app.pwhs.blockads)
* **[⭐ Bindhosts](https://github.com/bindhosts/bindhosts) ⭐ 1,371 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-16** - Systemless hosts for APatch, KernelSU and Magisk that is fully standalone and self-updating. `FOSS` `[M]` `[K]`
...
* **[Magisk Ad Blocking Module](https://github.com/pantsufan/Magisk-Ad-Blocking-Module) ⭐ 567 | 🐛 19 | 📅 2026-08-17** - Block ads on android. `FOSS` `[M]`
...
* **[Re-Malwack](https://github.com/ZG089/Re-Malwack) ⭐ 443 | 🐛 3 | 🌐 C | 📅 2026-08-16** - A fully-fledged ad-block module. Contains all your needs. `FOSS` `[M]`
...
* **[PCAPdroid](https://github.com/emanuele-f/PCAPdroid#pcapdroid) ⭐ 4,448 | 🐛 45 | 🌐 Java | 📅 2026-08-16** - Lets you track, analyze and block the connections made by the other apps in your device. `FOSS` | [🌱](https://f-droid.org/packages/com.emanuelef.remote_capture) | [▶️](https://play.google.com/store/apps/details?id=com.emanuelef.remote_capture)
* **[NetGuard](https://github.com/M66B/NetGuard) ⭐ 3,828 | 🐛 1 | 🌐 Java | 📅 2026-08-01** - Block access to the internet. Apps and addresses can individually be allowed or denied access to your Wi-Fi and/or mobile connection. `FOSS`
* **[AFWall+](https://github.com/ukanth/afwall) ⭐ 3,444 | 🐛 217 | 🌐 Java | 📅 2026-08-06** - Iptables-based firewall. `FOSS` | [🌱](https://f-droid.org/packages/dev.ukanth.ufirewall/) | [▶️](https://play.google.com/store/apps/details?id=dev.ukanth.ufirewall)
* **[ShizuWall](https://github.com/AhmetCanArslan/ShizuWall) ⭐ 2,135 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-13** - Android firewall without VPN powered by Shizuku / local ADB daemon / Root. `FOSS` | [🌱](https://f-droid.org/packages/com.arslan.shizuwall/) | [▶️](https://play.google.com/store/apps/details?id=com.arslan.shizuwall)
* **[Athena](https://github.com/Kin69/Athena) ⭐ 686 | 🐛 43 | 🌐 Kotlin | 📅 2026-01-26** - Material You (Material 3) firewall and ad blocker that works seamlessly on both rooted and non-rooted devices. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=com.kin.athena)
...
* **[⭐ Amarok](https://github.com/deltazefiro/Amarok-Hider) ⭐ 3,195 | 🐛 61 | 🌐 Java | 📅 2026-08-11** - Android application which enables you to hide your private files and apps with a single click. `FOSS` | [🌱](https://f-droid.org/zh_Hans/packages/deltazero.amarok.foss/)
...
* **[⭐ Move Certificate](https://github.com/ys1231/MoveCertificate) ⭐ 1,939 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-17** - Move user certificates to system certificates. Supports Android 7-16. `FOSS` `[M]` `[K]`
* **[⭐ Enable Screenshot](https://github.com/LSPosed/DisableFlagSecure) ⭐ 1,284 | 🐛 3 | 🌐 Java | 📅 2026-08-13** - Enabling screenshots in apps that normally wouldn't allow it, and disabling screenshot(Android 14+) and screen record(Android 15+) detection. `FOSS` `[LSP]`
...
* **[ih8SecureLock](https://github.com/j-hc/ih8SecureLock) ⭐ 166 | 🐛 2 | 🌐 C++ | 📅 2026-08-15** - Prevent apps from blocking and listening to your screenshots with Zygisk. `FOSS` `[M]` `[K]`
...
* **[Biometric App Lock](https://github.com/hxreborn/biometric-app-lock) ⭐ 42 | 🐛 8 | 🌐 Kotlin | 📅 2026-08-17** - Locks apps you choose behind fingerprint or face unlock. `FOSS` `[LSP]`
...
* **[Device Faker](https://github.com/Seyud/device_faker/) ⭐ 691 | 🐛 0 | 🌐 Vue | 📅 2026-08-12** - A device model spoofing module based on Zygisk that can configure different device models for different applications. `FOSS` `[M]` `[K]`
* **[DeviceID/SSAID Changer](https://github.com/sidex15/deviceidchanger) ⭐ 257 | 🐛 4 | 🌐 HTML | 📅 2025-12-19** - A simple WebUI Module to change SSAID/DeviceID on Rooted Android Devices with Apatch, KSU (And its forks), or Magisk. `FOSS` `[M]` `[K]`
...
* **[Island](https://github.com/oasisfeng/island/tree/dev) ⭐ 3,874 | 🐛 663 | 🌐 Java | 📅 2025-04-24** - App isolation and cloning. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=com.oasisfeng.island)
...
* **[FingerprintPay](https://github.com/eritpchy/FingerprintPay) ⭐ 4,485 | 🐛 35 | 🌐 Java | 📅 2026-03-06** - Enables fingerprint payment via WeChat, Alipay, Taobao, Tencent QQ, and UnionPay on phones that support fingerprint recognition. `FOSS` `[M]` `[LSP]`
...
* **[⭐ GPhotosUnlimited](https://github.com/Rev4N1/GPhotosUnlimited) ⭐ 327 | 🐛 1 | 🌐 C++ | 📅 2026-08-11** - A Zygisk module which gives unlimited Google Photos storage. `FOSS` `[M]` `[K]`
...
* **[Deekseep](https://github.com/lllucccian/Deekseep) ⭐ 139 | 🐛 0 | 🌐 Java | 📅 2026-08-17** - Adds account, chat, image, interface, and local API tools to the official DeepSeek Android app. `FOSS` `[LSP]`
...
* **[Nexus](https://github.com/niki914/agentic-nexus) ⭐ 120 | 🐛 40 | 🌐 Kotlin | 📅 2026-08-17** - Plug your own model into your phone's voice assistant. `Proprietary` `[LSP]`
...
* **[AmznKiller](https://github.com/hxreborn/amznkiller) ⭐ 80 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-17** - Hides sponsored content and ads in the Amazon Shopping app. `FOSS` `[LSP]`
* **[Play Store Adblock](https://github.com/hxreborn/playstore-adblock) ⭐ 71 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-16** - Xposed module to remove sponsored listings and ads from the Google Play Store. `FOSS` `[LSP]`
...
* **[BBZQ](https://github.com/HSSkyBoy/BBZQ) ⭐ 374 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-17** - Removes unnecessary content, optimizes the core experience, and provide various practical functions. `FOSS` `[LSP]`

#### Discord

* **[Revenge](https://github.com/revenge-mod/revenge-bundle-next) ⭐ 163 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-17** - Revenge is a client modification for Discord Android. `FOSS`
...
* **[Facebook App Ads Remover](https://github.com/Xposed-Modules-Repo/tn.loukious.facebookappadsremover) ⭐ 47 | 🐛 5 | 🌐 Kotlin | 📅 2026-07-23** - Removes ads from Facebook app. `FOSS` `[LSP]`

#### Instagram

* **[InstaEclipse](https://github.com/ReSo7200/InstaEclipse/) ⭐ 1,399 | 🐛 16 | 🌐 Java | 📅 2026-07-24** - Adds Features like Developer Options, Ghost Mode, Ad-Free browsing, and Distraction-Free Mode to Instagram. `FOSS` `[LSP]`

#### Line

* **[Knot](https://github.com/2b-zipper/Knot) ⭐ 105 | 🐛 3 | 🌐 Java | 📅 2026-08-16** - Message privacy, notification tweaks & Screen display & UI mods for Line. `FOSS` `[LSP]`

#### QQ

* **[QAuxiliary](https://github.com/cinit/QAuxiliary) ⭐ 5,705 | 🐛 265 | 🌐 Java | 📅 2026-08-17** - Xposed module based on QNotified. `FOSS` `[LSP]`
* **[XAutoDaily](https://github.com/LuckyPray/XAutoDaily) ⭐ 1,574 | 🐛 37 | 🌐 Kotlin | 📅 2026-07-22** - Various tweaks for QQ. `FOSS` `[LSP]`
* **[QFun](https://github.com/oneQAQone/QFun) ⭐ 227 | 🐛 2 | 🌐 Java | 📅 2026-08-11** - Functionality enhancement module developed based on the Xposed framework. `FOSS` `[LSP]`
* **[TCQT Module](https://github.com/callng/TCQT) ⭐ 217 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-17** - An Xposed module designed for Android QQ/TIM clients, which is used to intercept and retain messages that would otherwise be "retracted". `FOSS` `[LSP]`
...
* **[Morphe Reddit Patches](https://github.com/MorpheApp/morphe-patches#-patches-list) ⭐ 3,258 | 🐛 420 | 🌐 Java | 📅 2026-08-17** - Various patches for reddit. `FOSS`
* **[Patcheddit](https://github.com/wchill/patcheddit) ⭐ 760 | 🐛 48 | 🌐 Kotlin | 📅 2026-05-03** - Custom patches with features like view: deleted Reddit posts & comments,Banned subreddits etc. `FOSS`
* **[Adobo Patches](https://github.com/jkennethcarino/adobo/) ⭐ 227 | 🐛 11 | 🌐 Kotlin | 📅 2026-08-09** - Various patches for reddit app. `FOSS`
...
* **[Douyin Enhancer](https://github.com/twyora/DouyinEnhancer) ⭐ 81 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-15** - Adds minor quality-of-life features to Douyin (Chinese TikTok). `FOSS` `[LSP]`
...
* **[WeChat Auxiliary](https://github.com/HdShare/WAuxiliary_Public) ⭐ 3,957 | 🐛 12 | 🌐 Kotlin | 📅 2026-05-31** - Various tweaks for WeChat. `Proprietary` `[LSP]`
...
* **[⭐ WA Enhancer](https://github.com/Dev4Mod/WaEnhancer) ⭐ 1,649 | 🐛 283 | 🌐 Kotlin | 📅 2026-08-17** - Enhances your WhatsApp experience. `FOSS` `[LSP]`
* **[WA Enhancer X](https://github.com/mubashardev/WaEnhancerX) ⭐ 371 | 🐛 47 | 🌐 Java | 📅 2026-08-12** - Fork of WA Enhancer with additional features. `FOSS` `[LSP]`
* **[WAPlus](https://github.com/RevealedSoulEven/WAPlusXposed) ⭐ 33 | 🐛 0 | 🌐 Kotlin | 📅 2026-06-29** - Unlock WhatsApp Plus Features. `FOSS` `[LSP]`

#### X/Twitter

* **[⭐ Piko Patches](https://github.com/crimera/piko) ⭐ 4,736 | 🐛 484 | 🌐 Java | 📅 2026-08-17** - Morphe patches for twitter with features like hide promoted tweets, hide promoted accounts, hide promoted trends, hide "who to follow" etc. `FOSS`
* **[Re:X](https://github.com/Xposed-Modules-Repo/one.dot.rex) ⭐ 107 | 🐛 0 | 📅 2026-08-15** -  Tweaks for the new X / Twitter app. `Proprietary` `[LSP]`
...
* **[BetterVia](https://github.com/JiGuroLGC/BetterVia) ⭐ 1,214 | 🐛 3 | 🌐 JavaScript | 📅 2026-07-11** - Bypass whitelist restrictions, Screenshot protection, Block components, One-tap theme switching etc. `FOSS` `[LSP]`
...
* **[Fxxk-MiBrowser](https://github.com/DuhMatt/Fxxk-MiBrowser) ⭐ 27 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-17** - Redirects forced Xiaomi Browser links to the system default browser. `FOSS` `[LSP]`

### YouTube & Media Mods

* **[NexAlloy](https://github.com/NexAlloy/NexAlloy) ⭐ 2,865 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-03** - YouTube, YT Music block ads, background playback, sponsorblock and much more. Also unlocks premium features of Strava and Photomath. Unlimited Google Photos backup. `FOSS` `[LSP]`
* **[GlassMic](https://github.com/lm060719/io.mo.glassmic) ⭐ 50 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-14** - Lets you route an imported audio file into target recording apps through AudioRecord/AAudio hooks. `FOSS` `[LSP]`
...
* **[xCam](https://github.com/hazbu/xCam) ⭐ 16 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-14** - Replace live camera feeds and actual photo captures with virtual media sources. `FOSS` `[LSP]`

### Signature & Verification

* **[⭐ Core Patch N](https://github.com/LSPosed/CorePatch) ⭐ 3,258 | 🐛 9 | 🌐 Kotlin | 📅 2026-07-26** - Disable signature verification For Android. `FOSS` `[LSP]`
* **[⭐ Pairipfix](https://github.com/ahmedmani/pairipfix) ⭐ 646 | 🐛 20 | 🌐 Java | 📅 2026-04-20** - Bypasses the "Get this app from Play" screen that appears when installing Android apps as an APK instead of from the Google Play Store. `FOSS` `[LSP]`
...
* **[F\*\*k Google License](https://github.com/JiGuroLGC/FuckGoogleLicense) ⭐ 187 | 🐛 0 | 🌐 Java | 📅 2026-08-16** - Bypass Google Service License Verification. `FOSS` `[LSP]`
...
* **[Material Files](https://github.com/zhanghai/MaterialFiles) ⭐ 8,758 | 🐛 624 | 🌐 Kotlin | 📅 2026-04-06** - Modern file manager with root capabilities. `FOSS` | [🌱](https://f-droid.org/packages/me.zhanghai.android.files)| [▶️](https://play.google.com/store/apps/details?id=me.zhanghai.android.files)
...
* **[Fossify File Manager](https://github.com/FossifyOrg/File-Manager) ⭐ 1,701 | 🐛 95 | 🌐 Kotlin | 📅 2026-08-17** - Easy app for managing your files without ads, respecting your privacy and security. `FOSS` | [🌱](https://f-droid.org/packages/org.fossify.filemanager/) | [▶️](https://play.google.com/store/apps/details?id=org.fossify.filemanager)
...
* **[DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,217 | 🐛 186 | 🌐 Kotlin | 📅 2026-08-17** - DataBackup for Android 7.0+. `FOSS` | [🌱](https://f-droid.org/zh_Hans/packages/com.xayah.databackup.foss/)
* **[Neo Backup](https://github.com/NeoApplications/Neo-Backup) ⭐ 3,763 | 🐛 240 | 🌐 Kotlin | 📅 2026-05-03** - Powerful open-source backup solution. `FOSS` | [🌱](https://f-droid.org/packages/com.machiav3lli.backup/)
...
* **[⭐ SD Maid 2/SE](https://github.com/d4rken-org/sdmaid-se) ⭐ 7,299 | 🐛 29 | 🌐 Kotlin | 📅 2026-08-17** - A file management tool for Android that specializes in maintenance. Its core purpose is freeing up space and removing unwanted data. `FOSS` | [🌱](https://f-droid.org/en/packages/eu.darken.sdmse/) | [▶️](https://play.google.com/store/apps/details?id=eu.darken.sdmse)
...
* **[ClearBox](https://github.com/FLYCOM-E/ClearBox) ⭐ 34 | 🐛 1 | 🌐 C | 📅 2026-08-17** - Can delete all software caches, installation packages, compressed packages, garbage, empty folders etc. `Proprietary` `[M]` `[K]`
...
* **[Iconify](https://github.com/Mahmud0808/Iconify) ⭐ 3,131 | 🐛 99 | 🌐 Kotlin | 📅 2026-08-16** - Customize your Android 12+ device easily. `FOSS` `[M]`
* **[ColorBlendr](https://github.com/Mahmud0808/ColorBlendr) ⭐ 2,377 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-17** - Customize Material You colors of your device. `FOSS` | [🌱](https://f-droid.org/en/packages/com.drdisagree.colorblendr/)
* **[HyperLight](https://github.com/KiminonawaResa/HyperLight#english) ⭐ 657 | 🐛 35 | 📅 2026-08-17** - Completes the highlight blur effects for HyperOS 3, bringing a unified visual experience to the desktop, notification shade, and control center. `FOSS` `[LSP]`
...
* **[Lyricon](https://github.com/tomakino/lyricon) ⭐ 709 | 🐛 34 | 🌐 Kotlin | 📅 2026-05-30** - An Android status bar lyric enhancement tool based on the Xposed framework. `FOSS` `[LSP]`
...
* **[Recents](https://github.com/tymwitko/Recents) ⭐ 65 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-15** - Launcher-agnostic "Recents" menu for Android. `FOSS` `[LSP]`
...
* **[Magisk Fonts](https://github.com/JingMatrix/MagiskFonts) ⭐ 75 | 🐛 0 | 🌐 Shell | 📅 2025-01-20** - Add custom fonts to Android for system-wide usage. `FOSS` `[M]`
...
* **[KernelSU-iOS-Emoji](https://github.com/n4bi10p/Ios-emoji) ⭐ 30 | 🐛 5 | 🌐 Shell | 📅 2026-07-13** - Systemlessly replaces emoji font with iOS Emoji. `FOSS` `[K]`
...
* **[HyperIsland](https://github.com/1812z/HyperIsland/blob/main/README_EN.md) ⭐ 444 | 🐛 6 | 🌐 Dart | 📅 2026-08-17** - Dynamic Island-style notifications for HyperOS 3, powered by LSPosed. `FOSS` `[LSP]`
...
* **[ColorOS Live Lyrics Bridge](https://github.com/Andrea-lyz/ColorOS-Live-Lyrics-Bridge) ⭐ 144 | 🐛 6 | 🌐 Java | 📅 2026-08-14** - Bridges timed lyrics from supported players into the ColorOS/OPlus lock-screen lyric pipeline. `FOSS` `[LSP]`
...
* **[Adaptive Theme: Auto Dark Mode by Ambient Light](https://github.com/xLexip/Adaptive-Theme) ⭐ 190 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-17** - Automatically switches between Light and Dark mode using the ambient light sensor. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=dev.lexip.hecate)
...
* **[JamesDSP](https://github.com/james34602/JamesDSPManager) ⭐ 929 | 🐛 35 | 🌐 C | 📅 2025-06-18** - Audio DSP effects built on the Android system framework layer. This repository contains a pack of high-quality DSP algorithms specialized for audio processing. `FOSS` `[M]`
...
* **[⭐ ViPERFX\_RE](https://github.com/likelikeslike/ViPERFX_RE) ⭐ 267 | 🐛 2 | 🌐 C | 📅 2026-08-11** - A fork of ViPER4Android FX with a redesigned UI and additional features. `FOSS` `[M]` `[K]`

### Audio Control

* **[LibrePods](https://github.com/kavishdevar/librepods) ⭐ 29,457 | 🐛 265 | 🌐 Kotlin | 📅 2026-07-13** - Unlocks Apple's exclusive premium AirPods features on non-Apple devices. `FOSS` `[LSP]` `[M]` `[K]`
...
* **[SonyPods](https://github.com/Mercury000/SonyPods) ⭐ 18 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-16** - System-level Sony headphone control for HyperOS devices. `FOSS` `[LSP]`
...
* **[Box for Root](https://github.com/taamarin/box_for_magisk) ⭐ 2,503 | 🐛 85 | 🌐 Shell | 📅 2025-10-21** - Box for Root (BFR) is a Magisk, KernelSU, APatch, module that provides a suite of proxy tools, including clash, sing-box, v2ray, hysteria and xray. It allows you to configure a transparent proxy on Android devices with root access. `FOSS` `[M]` `[K]`
* **[Surfing](https://github.com/GitMetaio/Surfing) ⭐ 2,339 | 🐛 77 | 🌐 Shell | 📅 2026-08-17** - Magisk and KernelSU modules for Clash/mihomo, sing-box, v2ray, xray, hysteria services. `FOSS` `[M]` `[K]`
* **[Box4Magisk / KernelSU / APatch](https://github.com/CHIZI-0618/box4magisk) ⭐ 1,890 | 🐛 3 | 🌐 Shell | 📅 2026-04-10** - Deploy multiple proxy cores on Android devices, including clash, mihomo, sing-box, v2ray, xray, and hysteria. `FOSS` `[M]` `[K]`
* **[NetProxy-Magisk](https://github.com/Fanju6/NetProxy-Magisk) ⭐ 1,081 | 🐛 24 | 🌐 Kotlin | 📅 2026-08-17** - Magisk proxy module based on Xray kernel, supports one-click start/stop transparent proxy. `FOSS` `[M]`
* **[VPN Hide](https://github.com/okhsunrog/vpnhide) ⭐ 508 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-16** - Hide active VPN from selected Android apps (kernel module + LSPosed + Zygisk) `FOSS` `[M]` `[K]`
* **[ZDT-D Root Module](https://github.com/GAME-OVER-op/ZDT-D) ⭐ 266 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-17** - Module for traffic routing, DPI bypass, proxy chaining, DNS control, and per-app network management. `FOSS` `[M]` `[K]`
...
* **[MagicNet](https://github.com/LIghtJUNction/MagicNet#english-summary) ⭐ 156 | 🐛 0 | 🌐 Shell | 📅 2026-08-17** - Module for device-side traffic governance that enforce network rules below the app layer instead of relying on every app to respect a proxy setting. `FOSS` `[M]` `[K]`
...
* **[NFCGate](https://github.com/nfcgate/nfcgate) ⭐ 2,315 | 🐛 11 | 🌐 Java | 📅 2026-07-20** - Android application meant to capture, analyze, or modify NFC traffic. `FOSS` `[LSP]` | [🌱](https://f-droid.org/packages/de.tu_darmstadt.seemoo.nfcgate/)
...
* **[XposedFakeLocation](https://github.com/noobexon1/XposedFakeLocation) ⭐ 647 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-02** - Allows you to spoof your device's location globally or for specific apps without using "mock location" from the developer options. `FOSS` `[LSP]`
* **[AnyWhere](https://github.com/cxOrz/AnyWhere) ⭐ 547 | 🐛 9 | 🌐 Java | 📅 2026-08-04** - Location simulation tool for debugging LBS applications and for users to test geolocation functionality. `FOSS` `[LSP]`
...
* **[HLocation](https://github.com/sparr-sherrya/hlocation-release) ⭐ 35 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-17** - Location spoofing framework that synchronizes fake GPS and related environment signals across system and app processes for more consistent location virtualization. `FOSS` `[LSP]`
...
* **[Encore Tweaks](https://github.com/Rem01Gaming/encore) ⭐ 499 | 🐛 3 | 🌐 C++ | 📅 2026-08-16** - Enhance device performance during gaming sessions, while keeping battery life optimized for normal use. `Proprietary` `[M]`
...
* **[⭐ Termux](https://github.com/termux/termux-app) ⭐ 59,349 | 🐛 589 | 🌐 Java | 📅 2026-07-14** - A terminal emulator application for Android OS extendible by variety of packages. `FOSS` | [🌱](https://f-droid.org/en/packages/com.termux)
* **[aShell You](https://github.com/DP-Hridayan/aShellYou) ⭐ 2,191 | 🐛 36 | 🌐 Kotlin | 📅 2026-08-17** - Android shell utility app with Material Design 3 UI, letting you run ADB, root and shell commands. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/in.hridayan.ashell)
* **[Termux-Root-Recovery-Tool](https://github.com/Ishu43642/Termux-Root-Recovery-Tool) ⭐ 257 | 🐛 5 | 🌐 Shell | 📅 2026-03-17** - Install GSi Rom , Flashing Fastboot Rom, install Twrp Recovery, Boot.img & vbmeta.img files. `FOSS`
...
* **[LADB](https://github.com/tytydraco/LADB) ⭐ 2,384 | 🐛 53 | 🌐 Kotlin | 📅 2026-07-26** - Local ADB shell. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=com.draco.ladb)
...
* **[Shizuku](https://github.com/RikkaApps/Shizuku) ⭐ 28,972 | 🐛 533 | 🌐 Kotlin | 📅 2025-06-18** - Use system APIs directly with ADB/root privileges. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/moe.shizuku.privileged.api) | [▶️](https://play.google.com/store/search?q=shizuku\&c=apps)
* **[⭐ Shizuku Fork](https://github.com/thedjchi/Shizuku) ⭐ 5,108 | 🐛 64 | 🌐 Kotlin | 📅 2026-07-15** - Shizuku for with automatic Shizuku startup, automation, and recovery features. `FOSS`
* **[Shevery](https://github.com/HmnDev-Tech/shevery) ⭐ 774 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-17** - Based on shizuku with Jetpack Compose, Material 3, and compatibility enhancements. `FOSS`
...
* **[Zygisk-Loader](https://github.com/HanSoBored/Zygisk-Loader) ⭐ 99 | 🐛 0 | 🌐 C | 📅 2026-08-16** - Module for hot-swapping native libraries into Android applications without rebooting. `FOSS` `[K]`
...
* **[Bluetooth Hook](https://github.com/jingyu233/bluetoothhook#english) ⭐ 59 | 🐛 6 | 🌐 Kotlin | 📅 2025-12-22** - Inject virtual BLE devices into Android system Bluetooth scan results, facilitating Bluetooth application debugging for developers. `FOSS` `[LSP]`
...
* **[⭐ Droidspaces](https://github.com/ravindu644/Droidspaces-OSS) ⭐ 1,699 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-17** - Run full Linux environments on top of Android, with complete init system support. `FOSS`
...
* **[USB HID Client](https://github.com/Arian04/android-hid-client) ⭐ 420 | 🐛 17 | 🌐 Kotlin | 📅 2026-08-16** - Use your phone as a keyboard and mouse without any software on the other end. `FOSS` | [🌱](https://apt.izzysoft.de/packages/me.arianb.usb_hid_client)
...
* **[RebootNya](https://github.com/daisukiKaffuChino/RebootNya) ⭐ 238 | 🐛 2 | 🌐 Kotlin | 📅 2026-04-29** - A simple yet advanced reboot utility for Android devices. `FOSS`
...
* **[UotanToolbox NT](https://github.com/Uotan-Dev/UotanToolboxNT) ⭐ 2,661 | 🐛 7 | 🌐 C# | 📅 2026-08-02** - A modern toolbox for Android power users and geeks. `FOSS`
* **[⭐ Essentials](https://github.com/sameerasw/essentials) ⭐ 2,631 | 🐛 90 | 🌐 Kotlin | 📅 2026-08-17** - Multi-purpose tweaks for display, notifications and alerts, security and privacy, sound and haptics, and app freezing. `FOSS`
* **[SwitchAI - Switch AI Digital Assistant](https://github.com/WSTxda/SwitchAI) ⭐ 1,420 | 🐛 4 | 🌐 Kotlin | 📅 2026-07-12** - Easily select, start, and manage your preferred AI digital assistants. `FOSS`
* **[Zygisk Sui](https://github.com/XiaoTong6666/Sui) ⭐ 621 | 🐛 3 | 🌐 Java | 📅 2026-08-17** - Modern superuser interface (SUI) implementation for Android. `FOSS` `[M]` `[K]`
...
| 📂 **GitHub**    | Source, discussions & issues  | [GitHub Repo](https://github.com/awesome-android-root/awesome-android-root) ⭐ 4,347 \| 🐛 1 \| 🌐 Python \| 📅 2026-08-17 |
...
* 🐛 Report [issues](https://github.com/awesome-android-root/awesome-android-root/issues) ⭐ 4,347 | 🐛 1 | 🌐 Python | 📅 2026-08-17
...
**⚡ Built with ❤️ by [Awesome Android Root](https://github.com/awesome-android-root/awesome-android-root) ⭐ 4,347 | 🐛 1 | 🌐 Python | 📅 2026-08-17**
