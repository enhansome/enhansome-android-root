...
> For privacy-friendly installs, use the F-Droid ecosystem: install [Droid-ify](https://github.com/Droid-ify/client/releases) ⭐ 7,292 | 🐛 198 | 🌐 Kotlin | 📅 2026-08-22 (modern F-Droid client) and enable the [IzzyOnDroid](https://apt.izzysoft.de/fdroid/) repo for many additional packages.
...
| :----------------------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------- |
|       **[Magisk](https://github.com/topjohnwu/Magisk) ⭐ 62,364 \| 🐛 46 \| 🌐 Kotlin \| 📅 2026-08-20** <br><small> `Root & Module Management` </small>      | If you chose Magisk, this is your manager.               |
| **[App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 8,790 \| 🐛 218 \| 🌐 Java \| 📅 2026-06-29** <br><small> `App & Package Management` </small> | Inspect and manage apps with root privileges.            |
...
* **[⭐ Magisk](https://github.com/topjohnwu/Magisk) ⭐ 62,364 | 🐛 46 | 🌐 Kotlin | 📅 2026-08-20** - Manage Magisk modules and root permissions. `FOSS`
* **[⭐ KernelSU](https://github.com/tiann/KernelSU) ⭐ 17,950 | 🐛 62 | 🌐 Kotlin | 📅 2026-08-22** - A Kernel based root solution for Android. `FOSS`
* **[APatch](https://github.com/bmax121/APatch) ⭐ 7,831 | 🐛 86 | 🌐 Kotlin | 📅 2026-08-22** - The patching of Android kernel and Android system. `FOSS` | [🌱](https://f-droid.org/packages/me.bmax.apatch/)
* **[SukiSU-Ultra](https://github.com/SukiSU-Ultra/SukiSU-Ultra) ⭐ 6,138 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-15** - A kernel-based root solution for Android devices, forked from `KernelSU` with some useful changes. `FOSS`
* **[KernelSU-next](https://github.com/KernelSU-Next/KernelSU-Next) ⭐ 4,142 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-22** - An advanced Kernel based root solution for Android. `FOSS`
* **[ReSukiSU](https://github.com/ReSukiSU/ReSukiSU) ⭐ 1,270 | 🐛 9 | 🌐 Kotlin | 📅 2026-08-22** - Fork of SukiSU-Ultra with additional features. `FOSS`
* **[FolkPatch](https://github.com/LyraVoid/FolkPatch) ⭐ 1,066 | 🐛 28 | 🌐 Kotlin | 📅 2026-08-21** - A Root management tool focused on interface optimization and feature extension, based on APatch. `FOSS`

### Module Managers

* **[⭐ MMRL](https://github.com/DerGoogler/MMRL) ⭐ 2,137 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-18** - An Android app that helps manage your own modules repository. `FOSS` `[M]` `[K]` `[A]` | [🌱](https://f-droid.org/en/packages/com.dergoogler.mmrl/) | [▶️](https://play.google.com/store/apps/details?id=com.dergoogler.mmrl)
...
* **[Meta-hybrid\_mount](https://github.com/YuzakiKokuban/meta-hybrid_mount) ⭐ 1,457 | 🐛 3 | 🌐 Rust | 📅 2026-08-17** - Three-engine mount orchestration (OverlayFS + Magic Mount + Kasumi LKM) with conflict monitor, SolidJS WebUI, auto-fallback, and EROFS storage backend support. `FOSS` `[K]` `[A]`
* **[⭐ Mountify](https://github.com/backslashxx/mountify) ⭐ 1,311 | 🐛 23 | 🌐 Shell | 📅 2026-08-22** - OverlayFS with tmpfs/ext4 sparse support for reduced detection, works on APatch/Magisk too. `FOSS` `[M]` `[K]` `[A]`
* **[⭐ Meta-overlayfs](https://github.com/KernelSU-Modules-Repo/meta-overlayfs) ⭐ 460 | 🐛 8 | 🌐 Rust | 📅 2025-12-02** - Official reference implementation using OverlayFS for most users and standard setup. `FOSS` `[K]`
...
* **[⭐ Vector](https://github.com/JingMatrix/Vector) ⭐ 12,198 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-22** - Open Source *Fork* of original LSPosed with dynamic module loading, and other improvements. `FOSS` `[M]`
...
* **[⭐ Zygisk Next](https://github.com/Dr-TSNG/ZygiskNext) ⭐ 10,382 | 🐛 2 | 📅 2026-08-05** The "Gold Standard" for detection evasion. It is a standalone Zygisk implementation that offers the most advanced stealth features, including a dedicated **Zygote Monitor** and dashboard. `Proprietary` `[M]` `[K]` `[A]`
* **[ReZygisk](https://github.com/PerformanC/ReZygisk) ⭐ 3,849 | 🐛 11 | 🌐 C | 📅 2026-08-04** A high-performance implementation **entirely rewritten in C**. It introduces **custom linkers** to bypass modern linker-based detections, offering a WebUI for status monitoring and compatibility with Android 15 and 16. `FOSS` `[M]` `[K]` `[A]`
* **[NeoZygisk](https://github.com/JingMatrix/NeoZygisk) ⭐ 2,211 | 🐛 7 | 🌐 C++ | 📅 2026-08-20** A minimalist, high-stealth implementation using **ptrace injection**. It focuses on "trace cleaning," aiming to remove all injection artifacts from memory once modules are loaded. `FOSS` `[M]` `[K]` `[A]`
...
* **[TrickyStore](https://github.com/5ec1cff/TrickyStore) ⭐ 6,304 | 🐛 4 | 📅 2025-11-30** - Modifies the certificate chain for Android key attestation (keybox-based). The original/reference module. `Proprietary` `[M]` `[K]`
* **[Hide My Applist](https://github.com/Dr-TSNG/Hide-My-Applist) ⭐ 5,530 | 🐛 11 | 🌐 Kotlin | 📅 2026-08-01** - Intercepts app-list detection. `Proprietary` `[LSP]`
* **[Play Integrity Fork (PIF)](https://github.com/osm0sis/PlayIntegrityFork) ⭐ 4,409 | 🐛 0 | 🌐 C++ | 📅 2026-08-22** - The most actively maintained PIF. Fixes `DEVICE_INTEGRITY` verdicts with custom fields/props. Recommended starting point after chiteroman's original was discontinued. `FOSS` `[M]`
* **[Play Integrity Fix (inject)](https://github.com/KOWX712/PlayIntegrityFix) ⭐ 3,765 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-18** - Actively maintained fork using injected GMS/Play Store spoofing with a WebUI. `FOSS` `[M]`
* **[Tricky Addon – Update Target List](https://github.com/KOWX712/Tricky-Addon-Update-Target-List) ⭐ 3,398 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-18** - KSU WebUI to configure TrickyStore's `target.txt`. `FOSS` `[K]`
* **[⭐ HMA-OSS](https://github.com/frknkrc44/HMA-OSS) ⭐ 2,932 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-20** - FOSS rewrite of Hide My Applist; hides your app list, settings, and package installers. `FOSS` `[LSP]`
* **[Zygisk Assistant](https://github.com/snake-4/Zygisk-Assistant) ⭐ 2,574 | 🐛 17 | 🌐 C++ | 📅 2026-05-04** - Zygisk module to hide root on KernelSU, Magisk, and APatch. `FOSS` `[M]`
* **[⭐ SUSFS for KernelSU](https://github.com/sidex15/susfs4ksu-module) ⭐ 2,518 | 🐛 2 | 🌐 HTML | 📅 2026-08-08** - Add-on root-hiding service for SUSFS-patched kernels (KernelSU/Next). The core of modern KSU hiding setups. `FOSS` `[M]` `[K]`
* **[⭐ TEESimulator](https://github.com/JingMatrix/TEESimulator) ⭐ 2,261 | 🐛 6 | 🌐 C++ | 📅 2026-08-21** - Create a complete, software-based simulation of a hardware-backed Trusted Execution Environment (TEE) for Key Attestation. `FOSS` `[M]` `[K]`
* **[YuriKey](https://github.com/dpejoh/yurikey) ⭐ 1,857 | 🐛 9 | 🌐 Shell | 📅 2026-08-01** - Systemless module to obtain strong integrity easily. `FOSS` `[M]` `[K]`
* **[TEESimulator-RS](https://github.com/Enginex0/TEESimulator-RS) ⭐ 1,637 | 🐛 22 | 🌐 Kotlin | 📅 2026-07-11** - Fork of TEESimulator with native Rust certificate generation, key persistence, and AOSP-compliant attestation behavior. `FOSS` `[M]` `[K]`
* **[NoHello](https://github.com/MhmRdd/NoHello) ⭐ 1,348 | 🐛 21 | 🌐 C++ | 📅 2025-06-28** - Lightweight Zygisk module to hide root. `FOSS` `[M]`
* **[TrickyStore OSS](https://github.com/beakthoven/TrickyStoreOSS) ⭐ 1,305 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-20** - Open-source alternative to TrickyStore. `FOSS` `[M]` `[K]`
...
* **[Specter](https://github.com/dpejoh/specter) ⭐ 541 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-22** - Unified Play Integrity and root hiding stack for Android. Successor of Yurikey. `FOSS` `[M]` `[K]`
...
* **[⭐ BRENE](https://github.com/rrr333nnn333/BRENE) ⭐ 326 | 🐛 11 | 🌐 Shell | 📅 2026-08-21** - SUSFS/KernelSU module for patched kernels with enhanced root hiding & spoofing. `FOSS` `[M]` `[K]`
* **[Always Strong](https://github.com/evoker0/AlwaysStrong) ⭐ 322 | 🐛 5 | 🌐 Shell | 📅 2026-08-16** - Bundles TEESimulator-RS and PlayIntegrityFork into a single module for strong integrity on rooted devices. `FOSS` `[M]` `[K]`
* **[OhMyKeymint](https://github.com/qwq233/OhMyKeymint) ⭐ 271 | 🐛 2 | 🌐 Rust | 📅 2026-08-12** - Custom keystore implementation for Android Keystore Spoofer. `FOSS` `[M]` `[K]`
...
* **[YetAnotherBootloopProtector](https://github.com/Magisk-Modules-Alt-Repo/YetAnotherBootloopProtector) ⭐ 175 | 🐛 5 | 🌐 Shell | 📅 2026-04-14** - Monitor and fix potential Bootloops and SystemUI failures. `FOSS` `[M]`

### Root Detection & Testing

* **[⭐ Android-Native-Root-Detector](https://github.com/reveny/Android-Native-Root-Detector) ⭐ 1,375 | 🐛 16 | 🌐 Kotlin | 📅 2026-04-11** - A tool for detecting root on android. `FOSS`
* **[MagiskDetection](https://github.com/apkunpacker/MagiskDetection) ⭐ 1,048 | 🐛 4 | 📅 2026-05-10** - Collection of Some publicly Available POC Apps to Detect Root/Magisk presence. `Proprietary`
* **[Duck Detector](https://github.com/eltavine/Duck-Detector-Refactoring) ⭐ 882 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-21** - Android environment integrity inspection tool for root, hook, bootloader, SELinux, virtualization, and attestation signals. `FOSS`
* **[Play Integrity API Checker](https://github.com/1nikolas/play-integrity-checker-app) ⭐ 808 | 🐛 7 | 🌐 Java | 📅 2025-08-19** - This app shows info about your device integrity as reported by Google Play Services. If any of this fails could mean your device is rooted or tampered in a way. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=gr.nikolasspyr.integritycheck)
...
* **[⭐ Duck Detector Fork](https://github.com/rrr333nnn333/Duck-Detector-Refactoring) ⭐ 42 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-21** - Duck Detector fork with additional features and improvements. `FOSS`
* **[Play Integrity Alert](https://github.com/Xiddoc/PlayIntegrityAlert) ⭐ 25 | 🐛 2 | 🌐 Kotlin | 📅 2026-07-02** - Get notified when an app calls the Play Integrity API. `FOSS` `[LSP]`
...
* **[TWRP A/B Retention Script](https://github.com/Magisk-Modules-Repo/twrp-keep) ⭐ 272 | 🐛 0 | 🌐 Shell | 📅 2026-08-08** - Keep TWRP installed after an A/B OTA. `FOSS` `[M]`
* **[Noogle Magisk](https://github.com/SelfRef/noogle-magisk) ⭐ 128 | 🐛 16 | 🌐 Shell | 📅 2025-04-23** - Magisk modules for removing/replacing Google applications on stock Android 11-15. `FOSS` `[M]`
* **[HyperOS Security Center](https://github.com/Mods-Center/HyperOS-Security-Center) ⭐ 124 | 🐛 5 | 📅 2026-08-14** - Advanced app info tools, system app Wi-Fi management, removal of root/account restrictions etc. `Proprietary` `[M]` `[K]`
...
* **[Cromite SystemWebView](https://github.com/hddq/magisk-cromite-webview) ⭐ 6 | 🐛 0 | 🌐 Shell | 📅 2026-06-12** - Replaces the Android System WebView with Cromite WebView. `FOSS` `[M]`
...
* **[PIXELIFY NEXT](https://github.com/BasGame1/Pixelify-Next) ⭐ 307 | 🐛 0 | 🌐 Shell | 📅 2026-08-21** - A Magisk Module which enables Pixel UI and some exclusive features. `FOSS` `[M]`
...
* **[LuckyTool](https://github.com/Xposed-Modules-Repo/com.luckyzyx.luckytool/blob/main/README_EN.md) ⭐ 1,876 | 🐛 8 | 📅 2026-04-26** - Extended functionality and optimization module for ColorOS. `Proprietary` `[LSP]`
* **[OShin](https://github.com/suqi8/OShin/blob/master/README_EN.md) ⭐ 1,168 | 🐛 101 | 🌐 Kotlin | 📅 2026-07-28** - Auxiliary module deeply integrated with ColorOS, designed to enhance and optimize your operating system experience. `FOSS` `[LSP]`
...
* **[⭐ HyperCeiler](https://github.com/ReChronoRain/HyperCeiler/blob/main/README_en-US.md) ⭐ 5,249 | 🐛 228 | 🌐 Java | 📅 2026-08-20** - Extensive customizations for HyperOS. `FOSS` `[LSP]`
* **[Pengeek](https://github.com/monwf/customiuizer) ⭐ 1,464 | 🐛 48 | 🌐 Java | 📅 2026-05-19** - Customize your HyperOS to your liking. For HyperOS based on Android 14. `FOSS` `[LSP]`
* **[Hyper Helper](https://github.com/HowieHChen/XiaomiHelper/blob/master/README_EN-US.md) ⭐ 344 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-22** - Lightweight customization module for HyperOS only. `FOSS` `[LSP]`
* **[Hyper Unlocked](https://github.com/ukriu/HyperUnlocked) ⭐ 224 | 🐛 16 | 🌐 Shell | 📅 2026-07-14** - Unlock all high-end features possible to be unlocked on low-end xiaomi devices. `FOSS` `[M]`
...
* **[NothingTweaks](https://github.com/RevealedSoulEven/NothingTweaks) ⭐ 6 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-21** - A customization module for Nothing OS based on Xposed framework. `FOSS` `[LSP]`

#### One UI (Samsung)

* **[⭐ KnoxPatch](https://github.com/salvogiangri/KnoxPatch) ⭐ 1,489 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-11** - Get Samsung apps/features working again in your rooted Galaxy device. For better experience, please also [read this ↗](https://github.com/salvogiangri/KnoxPatch?tab=readme-ov-file#knoxpatch-enhancer) ⭐ 1,489 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-11 . `FOSS` `[LSP]`
* **[One UI X](https://github.com/SoClear/OneUIX) ⭐ 175 | 🐛 15 | 🌐 Kotlin | 📅 2026-08-21** - Remove annoying restrictions, and inject powerful enhancements into the Status Bar, Quick Settings, and native apps etc on Samsung's One UI. `FOSS` `[LSP]`
...
* **[ZTool](https://github.com/qwqawa64/ZUX-ZTool) ⭐ 62 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-20** - Provides optimization and customization features for the ZUXOS system. `FOSS` `[LSP]`
...
* **[⭐ Canta](https://github.com/samolego/Canta) ⭐ 5,598 | 🐛 29 | 🌐 Kotlin | 📅 2026-08-16** - Uninstall any app without root using [Shizuku](#developer-tools). `FOSS` | [🌱](https://f-droid.org/en/packages/io.github.samolego.canta/) | [▶️](https://play.google.com/store/apps/details?id=io.github.samolego.canta)
* **[De-Bloater](https://github.com/sunilpaulmathew/De-Bloater) ⭐ 763 | 🐛 47 | 🌐 Java | 📅 2026-05-25** - An application using the power of Magisk to debloat unwanted system apps!. `FOSS` | [🌱](https://f-droid.org/packages/com.sunilpaulmathew.debloater) | [▶️](https://play.google.com/store/apps/details?id=com.sunilpaulmathew.debloater)
...
* **[⭐ App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 8,790 | 🐛 218 | 🌐 Java | 📅 2026-06-29** - A full-featured package manager and viewer for Android. `FOSS` | [🌱](https://f-droid.org/packages/io.github.muntashirakon.AppManager/)
* **[⭐ Droid-ify](https://github.com/Droid-ify/client) ⭐ 7,292 | 🐛 198 | 🌐 Kotlin | 📅 2026-08-22** - F-Droid client with Material UI and auto updating apps using root. `FOSS` | [🌱](https://f-droid.org/packages/com.looker.droidify)
* **[⭐ Hail](https://github.com/aistra0528/Hail) ⭐ 6,501 | 🐛 169 | 🌐 Kotlin | 📅 2026-08-12** - Disable / Hide / Suspend / Uninstall Android apps. `FOSS` | [🌱](https://f-droid.org/packages/com.aistra.hail/)
* **[InstallerX-Revived](https://github.com/wxxsfxyzm/InstallerX-Revived) ⭐ 6,242 | 🐛 16 | 🌐 Kotlin | 📅 2026-08-22** - A modern and functional Android app installer. `FOSS` `[LSP]`
* **[Neo Store](https://github.com/NeoApplications/Neo-Store) ⭐ 4,923 | 🐛 129 | 🌐 Kotlin | 📅 2026-04-25** - An F-Droid client with modern UI and an arsenal of extra features. `FOSS` | [🌱](https://f-droid.org/packages/com.machiav3lli.fdroid)
* **[Aurora Store](https://github.com/whyorean/AuroraStore) ⭐ 2,861 | 🐛 26 | 🌐 Kotlin | 📅 2026-08-21** - A Google Play Store client to search, view app details, and download APKs directly to your device. `FOSS` | [🌱](https://f-droid.org/packages/com.aurora.store/)
* **[⭐ Zygisk Detach](https://github.com/j-hc/zygisk-detach) ⭐ 2,112 | 🐛 0 | 🌐 Rust | 📅 2026-07-09** - Zygisk module to detach installed apps from Play Store, hooking binder. `FOSS` `[M]` `[K]`
* **[Inure](https://github.com/Hamza417/Inure) ⭐ 1,887 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-22** - An elegant and beautiful premium Android app manager for rooted and non-rooted devices. `FOSS` | [🌱](https://f-droid.org/en/packages/app.simple.inure/) | [▶️](https://play.google.com/store/apps/details?id=app.simple.inure.play)
* **[Universal Installer](https://github.com/pass-with-high-score/universal-installer) ⭐ 1,286 | 🐛 23 | 🌐 Kotlin | 📅 2026-08-22** - Install and manage APK packages with split APK support. `FOSS` `[LSP]`
* **[InxLocker](https://github.com/Chimioo/InxLocker) ⭐ 866 | 🐛 2 | 🌐 Kotlin | 📅 2026-06-11** - Intercepts/forwards Android system application installation and uninstallation requests, redirecting them to your specified installer app. `FOSS` `[LSP]`
* **[Package Manager](https://github.com/SmartPack/PackageManager) ⭐ 812 | 🐛 90 | 🌐 Java | 📅 2026-06-17** - A highly powerful app to manage both system and user apps installed on an Android device. `FOSS` | [🌱](https://f-droid.org/packages/com.smartpack.packagemanager) | [▶️](https://play.google.com/store/apps/details?id=com.smartpack.packagemanager)
* **[BetterKnownInstalled](https://github.com/Pixel-Props/BetterKnownInstalled) ⭐ 542 | 🐛 0 | 🌐 Shell | 📅 2026-08-13** - Patches packages to fix DroidGuard UNKNOWN\_INSTALLED issues. `FOSS` `[LSP]`
* **[Thor](https://github.com/trinadhthatakula/Thor) ⭐ 519 | 🐛 11 | 🌐 Kotlin | 📅 2026-08-22** - Android App Manager and App Installer utility. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/com.valhalla.thor) | [▶️](https://play.google.com/store/apps/details?id=com.valhalla.thor)
...
* **[Thanox](https://github.com/Tornaco/Thanox) ⭐ 3,236 | 🐛 467 | 🌐 Java | 📅 2026-08-14** - A system management tool that provide convenient functions like application startup management, background management, permission management etc. `FOSS` `[LSP]` | [▶️](https://play.google.com/store/apps/details?id=github.tornaco.android.thanos.pro\&hl=en\&gl=US)
* **[PermissionManagerX](https://github.com/mirfatif/PermissionManagerX) ⭐ 759 | 🐛 10 | 🌐 HTML | 📅 2026-07-11** - eXtended Permission Manager for Android to view and set Manifest Permissions and AppOps. `FOSS` | [🌱](https://f-droid.org/packages/com.mirfatif.permissionmanagerx) | [▶️](https://play.google.com/store/apps/details?id=com.mirfatif.permissionmanagerx)
...
* **[FDE.AI](https://github.com/feravolt/FDE.AI-docs) ⭐ 666 | 🐛 0 | 🌐 HTML | 📅 2026-08-19** - All-in-One ultimate optimizer for all devices running Android OS. `Proprietary` `[LSP]`
* **[COPG](https://github.com/AlirezaParsi/COPG) ⭐ 376 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-18** - Spoof your device to enjoy premium features, max performance, and exclusive benefits. `FOSS` `[M]`
...
* **[Kernel Flasher](https://github.com/fatalcoder524/KernelFlasher) ⭐ 488 | 🐛 7 | 🌐 Kotlin | 📅 2026-07-01** - An Android app to flash (AK3 files), backup, and restore kernels. `FOSS`
...
* **[KonaBess Next](https://github.com/KonaBess-Next/KonaBess-Next) ⭐ 206 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-06** - Fork of KonaBess, Custom GPU overclocking and undervolting tool with granulated voltage for rooted Snapdragon Android devices. `FOSS`
* **[Minimal Kernel Manager](https://github.com/abhay-byte/mkm) ⭐ 136 | 🐛 7 | 🌐 Kotlin | 📅 2026-07-07** - Android kernel management and system monitoring application. `FOSS` | [🌱](https://f-droid.org/packages/com.ivarna.fluxlinux/)
* **[iUnlocker GLTool](https://github.com/i-Taylo/iUnlockerGL) ⭐ 100 | 🐛 17 | 🌐 Shell | 📅 2025-12-29** - Designed to spoof GPU information, allowing users to modify GPU information for unlocking graphics in games and testing. `FOSS` `[M]`
...
* **[PerfMTK](https://github.com/JUANIMAN/PerfMTK) ⭐ 86 | 🐛 21 | 🌐 Shell | 📅 2026-06-28** - Designed to optimize performance and power efficiency on MediaTek devices with Mali GPUs. `FOSS` `[M]`
...
* **[Plus Plus Battery](https://github.com/dijia1124/plusplusbattery) ⭐ 463 | 🐛 16 | 🌐 Kotlin | 📅 2026-02-22** - Real-time battery stats & health estimator for OnePlus/Oppo/Realme phones. `FOSS` | [🌱](https://f-droid.org/en/packages/com.dijia1124.plusplusbattery/)
* **[EnforceDoze](https://github.com/farfromrefug/EnforceDoze) ⭐ 354 | 🐛 21 | 🌐 Java | 📅 2026-07-26** - Enable Doze mode immediately after screen off and turn off motion sensing to get best battery life. `FOSS` | [🌱](https://f-droid.org/packages/com.akylas.enforcedoze/)
...
* **[⭐ FROSTY](https://github.com/Drsexo/Frosty) ⭐ 206 | 🐛 3 | 🌐 Shell | 📅 2026-07-04** - Optimizes battery life by selectively freezing Google Mobile Services (GMS) components and applying system-wide doze enhancements. `FOSS` `[M]` `[K]`
...
* **[Xtreme-Battery-Saver](https://github.com/Magisk-Modules-Alt-Repo/Xtreme-Battery-Saver) ⭐ 125 | 🐛 1 | 🌐 Shell | 📅 2025-08-13** - An extreme battery saver Magisk Module for users who want to really stretch their battery life. `FOSS` `[M]`
...
* **[AccA](https://github.com/VR-25/acc) ⭐ 2,377 | 🐛 19 | 🌐 Shell | 📅 2025-06-06** - Advanced Charging Controller app. `FOSS`
...
* **[TaskManager](https://github.com/RohitKushvaha01/TaskManager) ⭐ 612 | 🐛 4 | 🌐 C++ | 📅 2026-08-18** - Task Manager inspired from gnome system monitor for android.Must read [F-Droid inclusion](https://github.com/RohitKushvaha01/TaskManager/issues/24) ⭐ 612 | 🐛 4 | 🌐 C++ | 📅 2026-08-18 `FOSS` | [▶️](https://play.google.com/store/apps/details?id=com.rk.taskmanager)
* **[Shappky](https://github.com/YasserNull/shappky) ⭐ 534 | 🐛 19 | 🌐 Kotlin | 📅 2026-08-22** - A simple app to boost performance by stopping background apps, relying on Root/Shizuku permissions. `FOSS` `[M]`
...
* **[⭐ AdAway](https://github.com/AdAway/AdAway) ⭐ 9,356 | 🐛 668 | 🌐 C | 📅 2026-02-10** - Open-source ad blocker using the hosts file. Blocks ads without permissions. `FOSS` | [🌱](https://f-droid.org/packages/org.adaway)
* **[BlockAds](https://github.com/pass-with-high-score/blockads-android) ⭐ 1,757 | 🐛 67 | 🌐 Kotlin | 📅 2026-07-30** - System‑wide ad, tracker, & malware filtering, custom blocklists, per‑app controls etc. `FOSS` | [🌱](https://f-droid.org/packages/app.pwhs.blockads)
* **[⭐ Bindhosts](https://github.com/bindhosts/bindhosts) ⭐ 1,377 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-22** - Systemless hosts for APatch, KernelSU and Magisk that is fully standalone and self-updating. `FOSS` `[M]` `[K]`
...
* **[Magisk Ad Blocking Module](https://github.com/pantsufan/Magisk-Ad-Blocking-Module) ⭐ 567 | 🐛 19 | 📅 2026-08-22** - Block ads on android. `FOSS` `[M]`
...
* **[F\*ck AD](https://github.com/hujiayucc/Fuck-AD) ⭐ 481 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-16** - Ad-blocking Xposed module. `FOSS` `[LSP]`
* **[Re-Malwack](https://github.com/ZG089/Re-Malwack) ⭐ 444 | 🐛 3 | 🌐 C | 📅 2026-08-16** - A fully-fledged ad-block module. Contains all your needs. `FOSS` `[M]`
...
* **[Discover Ads Filter](https://github.com/hxreborn/discover-ads-filter) ⭐ 43 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-17** - Hides sponsored cards and ads from the Google Discover feed in the Pixel Launcher -1 screen and inside the Google app itself. `FOSS` `[LSP]`
...
* **[PCAPdroid](https://github.com/emanuele-f/PCAPdroid#pcapdroid) ⭐ 4,576 | 🐛 44 | 🌐 Java | 📅 2026-08-22** - Lets you track, analyze and block the connections made by the other apps in your device. `FOSS` | [🌱](https://f-droid.org/packages/com.emanuelef.remote_capture) | [▶️](https://play.google.com/store/apps/details?id=com.emanuelef.remote_capture)
* **[NetGuard](https://github.com/M66B/NetGuard) ⭐ 3,834 | 🐛 1 | 🌐 Java | 📅 2026-08-01** - Block access to the internet. Apps and addresses can individually be allowed or denied access to your Wi-Fi and/or mobile connection. `FOSS`
* **[AFWall+](https://github.com/ukanth/afwall) ⭐ 3,446 | 🐛 218 | 🌐 Java | 📅 2026-08-06** - Iptables-based firewall. `FOSS` | [🌱](https://f-droid.org/packages/dev.ukanth.ufirewall/) | [▶️](https://play.google.com/store/apps/details?id=dev.ukanth.ufirewall)
* **[ShizuWall](https://github.com/AhmetCanArslan/ShizuWall) ⭐ 2,156 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-22** - Android firewall without VPN powered by Shizuku / local ADB daemon / Root. `FOSS` | [🌱](https://f-droid.org/packages/com.arslan.shizuwall/) | [▶️](https://play.google.com/store/apps/details?id=com.arslan.shizuwall)
...
* **[De1984 Firewall](https://github.com/dorumrr/de1984) ⭐ 369 | 🐛 29 | 🌐 Kotlin | 📅 2025-12-15** - A privacy-focused Firewall and Package Manager for Android devices. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/io.github.dorumrr.de1984)
...
* **[Fyrypt](https://github.com/mirfatif/Fyrypt) ⭐ 73 | 🐛 0 | 📅 2026-08-17** - Android firewall with UID + PID rules, dnscrypt-proxy management, and per-app live network monitoring. `Proprietary`

### Privacy Tools

* **[⭐ Amarok](https://github.com/deltazefiro/Amarok-Hider) ⭐ 3,206 | 🐛 61 | 🌐 Java | 📅 2026-08-11** - Android application which enables you to hide your private files and apps with a single click. `FOSS` | [🌱](https://f-droid.org/zh_Hans/packages/deltazero.amarok.foss/)
* **[Tarnhelm](https://github.com/lz233/Tarnhelm) ⭐ 783 | 🐛 9 | 🌐 Kotlin | 📅 2026-08-13** - The magic to clean sharing links up. `FOSS` `[LSP]`
* **[IAmNotADeveloper](https://github.com/xfqwdsj/IAmNotADeveloper) ⭐ 582 | 🐛 13 | 🌐 Kotlin | 📅 2025-10-23** - Hide Android developer-related switches status. `FOSS` `[LSP]`
...
* **[Do Not Try Accessibility](https://github.com/Nitsuya/DoNotTryAccessibility) ⭐ 199 | 🐛 7 | 🌐 Kotlin | 📅 2025-01-23** - Hook System Framework makes the app think that accessibility services are not enabled. `FOSS` `[LSP]`
...
* **[Always Trust User Certs](https://github.com/NVISOsecurity/AlwaysTrustUserCerts) ⭐ 2,545 | 🐛 10 | 🌐 Shell | 📅 2025-06-24** - A Magisk/KernelSU module that automatically adds user certificates to the system root CA store. `FOSS` `[M]` `[K]`
...
* **[⭐ Enable Screenshot](https://github.com/LSPosed/DisableFlagSecure) ⭐ 1,291 | 🐛 3 | 🌐 Java | 📅 2026-08-13** - Enabling screenshots in apps that normally wouldn't allow it, and disabling screenshot(Android 14+) and screen record(Android 15+) detection. `FOSS` `[LSP]`
...
* **[TapDucky](https://github.com/iodn/tap-ducky) ⭐ 156 | 🐛 8 | 🌐 Dart | 📅 2026-05-17** - Open-source DuckyScript runner for rooted Android with USB Gadget (ConfigFS) support. `FOSS`  | [🌱](https://f-droid.org/en/packages/org.kaijinlab.tap_ducky/)
* **[Just Trust Me Pro](https://github.com/hang666/JustTrustMePro) ⭐ 146 | 🐛 5 | 🌐 Kotlin | 📅 2026-03-31** - Disables SSL certificate checking for the purposes of auditing an app with cert pinning. `FOSS` `[M]`
...
* **[Biometric App Lock](https://github.com/hxreborn/biometric-app-lock) ⭐ 46 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-20** - Locks apps you choose behind fingerprint or face unlock. `FOSS` `[LSP]`
...
* **[Device Faker](https://github.com/Seyud/device_faker/) ⭐ 703 | 🐛 0 | 🌐 Vue | 📅 2026-08-21** - A device model spoofing module based on Zygisk that can configure different device models for different applications. `FOSS` `[M]` `[K]`
* **[DeviceID/SSAID Changer](https://github.com/sidex15/deviceidchanger) ⭐ 261 | 🐛 4 | 🌐 HTML | 📅 2025-12-19** - A simple WebUI Module to change SSAID/DeviceID on Rooted Android Devices with Apatch, KSU (And its forks), or Magisk. `FOSS` `[M]` `[K]`
...
* **[SpoofMyDevice](https://github.com/BuSung-dev/SpoofMyDevice) ⭐ 115 | 🐛 9 | 🌐 Java | 📅 2026-07-19** - Xposed module and companion app for building, saving, and applying spoofed Android device profiles to selected apps. `FOSS` `[LSP]`
* **[HideMyAndroid](https://github.com/Xposed-Modules-Repo/com.wowsoftware.hidemyandroid/) ⭐ 83 | 🐛 0 | 📅 2026-08-22** - Android anti-detect module with profile isolation and spoofing. `Proprietary` `[LSP]`
...
* **[Island](https://github.com/oasisfeng/island/tree/dev) ⭐ 3,880 | 🐛 667 | 🌐 Java | 📅 2025-04-24** - App isolation and cloning. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=com.oasisfeng.island)
...
* **[FingerprintPay](https://github.com/eritpchy/FingerprintPay) ⭐ 4,491 | 🐛 35 | 🌐 Java | 📅 2026-03-06** - Enables fingerprint payment via WeChat, Alipay, Taobao, Tencent QQ, and UnionPay on phones that support fingerprint recognition. `FOSS` `[M]` `[LSP]`
...
* **[⭐ GPhotosUnlimited](https://github.com/Rev4N1/GPhotosUnlimited) ⭐ 334 | 🐛 1 | 🌐 C++ | 📅 2026-08-19** - A Zygisk module which gives unlimited Google Photos storage. `FOSS` `[M]` `[K]`
* **[Spotify Plus](https://github.com/LeNerd46/SpotifyPlus) ⭐ 217 | 🐛 10 | 🌐 Java | 📅 2026-07-25** - Adds beautiful lyrics to Spotify. `FOSS` `[LSP]`
* **[Deekseep](https://github.com/lllucccian/Deekseep) ⭐ 212 | 🐛 3 | 🌐 Java | 📅 2026-08-17** - Adds account, chat, image, interface, and local API tools to the official DeepSeek Android app. `FOSS` `[LSP]`
* **[Xposed Translate Text](https://github.com/tianci-sh/XPTranslateText) ⭐ 186 | 🐛 13 | 🌐 Java | 📅 2025-12-16** - Translate text by MLKit / gemini2.0 / google api. `FOSS` `[LSP]`
...
* **[GboardHook](https://github.com/chenyue404/GboardHook) ⭐ 134 | 🐛 1 | 🌐 Kotlin | 📅 2026-06-14** - Modifies the number of clipboard items displayed and their expiration time. `FOSS` `[LSP]`
* **[Nexus](https://github.com/niki914/agentic-nexus) ⭐ 123 | 🐛 42 | 🌐 Kotlin | 📅 2026-08-22** - Plug your own model into your phone's voice assistant. `Proprietary` `[LSP]`
...
* **[AmznKiller](https://github.com/hxreborn/amznkiller) ⭐ 82 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-17** - Hides sponsored content and ads in the Amazon Shopping app. `FOSS` `[LSP]`
* **[Play Store Adblock](https://github.com/hxreborn/playstore-adblock) ⭐ 75 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-19** - Xposed module to remove sponsored listings and ads from the Google Play Store. `FOSS` `[LSP]`
...
* **[Yandex Maps Patcher](https://github.com/Xposed-Modules-Repo/ru.bluecat.yandexmapspatcher) ⭐ 63 | 🐛 0 | 📅 2026-07-26** - Hides ads and intrusive services in the Yandex Maps app. `Proprietary` `[LSP]`
* **[F\*\*k Solid Explorer](https://github.com/fzer0x/dev.fzer0x.fucksolidexplorer) ⭐ 40 | 🐛 0 | 🌐 Kotlin | 📅 2026-01-23** - Unlock premium features and remove advertisements from Solid Explorer. `FOSS` `[LSP]`
...
* **[Spicy EX](https://github.com/amarinne/spicy-ex) ⭐ 19 | 🐛 2 | 🌐 Java | 📅 2026-08-15** - Adds Spicy lyrics in Spotify along with translation and much more UI features. `FOSS` `[LSP]`
...
* **[KeyFlux](https://github.com/NawafCode/KeyFlux) ⭐ 17 | 🐛 3 | 🌐 Kotlin | 📅 2026-07-02** - Customize Google Gboard, exposing selected hidden features, and adding clipboard-related enhancements. `FOSS` `[LSP]`
...
* **[NSG Tweaks](https://github.com/h3nnes/nsg-tweaks) ⭐ 14 | 🐛 0 | 🌐 Java | 📅 2026-08-21** - Extends [NSG (QuickTest) ↗](https://play.google.com/store/apps/details?id=com.qtrun.QuickTest) with additional columns, rows, signaling tools, and log-replay improvements. `Proprietary` `[LSP]`
...
* **[BBZQ](https://github.com/HSSkyBoy/BBZQ) ⭐ 388 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-22** - Removes unnecessary content, optimizes the core experience, and provide various practical functions. `FOSS` `[LSP]`

#### Discord

* **[Revenge](https://github.com/revenge-mod/revenge-bundle-next) ⭐ 166 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-22** - Revenge is a client modification for Discord Android. `FOSS`
...
* **[Facebook App Ads Remover](https://github.com/Xposed-Modules-Repo/tn.loukious.facebookappadsremover) ⭐ 50 | 🐛 5 | 🌐 Kotlin | 📅 2026-07-23** - Removes ads from Facebook app. `FOSS` `[LSP]`

#### Instagram

* **[InstaEclipse](https://github.com/ReSo7200/InstaEclipse/) ⭐ 1,412 | 🐛 17 | 🌐 Java | 📅 2026-07-24** - Adds Features like Developer Options, Ghost Mode, Ad-Free browsing, and Distraction-Free Mode to Instagram. `FOSS` `[LSP]`

#### Line

* **[Knot](https://github.com/2b-zipper/Knot) ⭐ 113 | 🐛 3 | 🌐 Java | 📅 2026-08-22** - Message privacy, notification tweaks & Screen display & UI mods for Line. `FOSS` `[LSP]`

#### QQ

* **[QAuxiliary](https://github.com/cinit/QAuxiliary) ⭐ 5,709 | 🐛 265 | 🌐 Java | 📅 2026-08-21** - Xposed module based on QNotified. `FOSS` `[LSP]`
* **[XAutoDaily](https://github.com/LuckyPray/XAutoDaily) ⭐ 1,579 | 🐛 37 | 🌐 Kotlin | 📅 2026-07-22** - Various tweaks for QQ. `FOSS` `[LSP]`
* **[QFun](https://github.com/oneQAQone/QFun) ⭐ 232 | 🐛 2 | 🌐 Java | 📅 2026-08-20** - Functionality enhancement module developed based on the Xposed framework. `FOSS` `[LSP]`
* **[TCQT Module](https://github.com/callng/TCQT) ⭐ 218 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-21** - An Xposed module designed for Android QQ/TIM clients, which is used to intercept and retain messages that would otherwise be "retracted". `FOSS` `[LSP]`
...
* **[Morphe Reddit Patches](https://github.com/MorpheApp/morphe-patches#-patches-list) ⭐ 3,334 | 🐛 435 | 🌐 Java | 📅 2026-08-22** - Various patches for reddit. `FOSS`
* **[Patcheddit](https://github.com/wchill/patcheddit) ⭐ 771 | 🐛 48 | 🌐 Kotlin | 📅 2026-05-03** - Custom patches with features like view: deleted Reddit posts & comments,Banned subreddits etc. `FOSS`
* **[Adobo Patches](https://github.com/jkennethcarino/adobo/) ⭐ 235 | 🐛 11 | 🌐 Kotlin | 📅 2026-08-21** - Various patches for reddit app. `FOSS`

#### Telegram

* **[TMoe](https://github.com/cinit/TMoe) ⭐ 1,423 | 🐛 20 | 🌐 Java | 📅 2026-07-19** - Adds various tweaks to various Telegram clients. `FOSS` `[LSP]`
* **[Killergram](https://github.com/shatyuka/Killergram) ⭐ 584 | 🐛 1 | 🌐 Java | 📅 2026-07-22** - Remove sponsored messages of Telegram. `FOSS` `[LSP]`
...
* **[Telegami](https://github.com/aoya111/Telegami) ⭐ 224 | 🐛 27 | 🌐 Kotlin | 📅 2026-08-21** - Various tweaks for Telegram. `FOSS` `[LSP]`
...
* **[Douyin Enhancer](https://github.com/twyora/DouyinEnhancer) ⭐ 83 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-22** - Adds minor quality-of-life features to Douyin (Chinese TikTok). `FOSS` `[LSP]`
...
* **[WeChat Auxiliary](https://github.com/HdShare/WAuxiliary_Public) ⭐ 3,970 | 🐛 12 | 🌐 Kotlin | 📅 2026-05-31** - Various tweaks for WeChat. `Proprietary` `[LSP]`
...
* **[⭐ WA Enhancer](https://github.com/Dev4Mod/WaEnhancer) ⭐ 1,656 | 🐛 285 | 🌐 Kotlin | 📅 2026-08-20** - Enhances your WhatsApp experience. `FOSS` `[LSP]`
* **[WA Enhancer X](https://github.com/mubashardev/WaEnhancerX) ⭐ 375 | 🐛 49 | 🌐 Java | 📅 2026-08-12** - Fork of WA Enhancer with additional features. `FOSS` `[LSP]`
* **[WAPlus](https://github.com/RevealedSoulEven/WAPlusXposed) ⭐ 33 | 🐛 0 | 🌐 Kotlin | 📅 2026-06-29** - Unlock WhatsApp Plus Features. `FOSS` `[LSP]`

#### X/Twitter

* **[⭐ Piko Patches](https://github.com/crimera/piko) ⭐ 4,819 | 🐛 499 | 🌐 Java | 📅 2026-08-22** - Morphe patches for twitter with features like hide promoted tweets, hide promoted accounts, hide promoted trends, hide "who to follow" etc. `FOSS`
* **[Re:X](https://github.com/Xposed-Modules-Repo/one.dot.rex) ⭐ 137 | 🐛 0 | 📅 2026-08-15** -  Tweaks for the new X / Twitter app. `Proprietary` `[LSP]`
...
* **[BetterVia](https://github.com/JiGuroLGC/BetterVia) ⭐ 1,226 | 🐛 3 | 🌐 JavaScript | 📅 2026-07-11** - Bypass whitelist restrictions, Screenshot protection, Block components, One-tap theme switching etc. `FOSS` `[LSP]`
...
* **[Fxxk-MiBrowser](https://github.com/DuhMatt/Fxxk-MiBrowser) ⭐ 27 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-22** - Redirects forced Xiaomi Browser links to the system default browser. `FOSS` `[LSP]`

### YouTube & Media Mods

* **[NexAlloy](https://github.com/NexAlloy/NexAlloy) ⭐ 2,890 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-03** - YouTube, YT Music block ads, background playback, sponsorblock and much more. Also unlocks premium features of Strava and Photomath. Unlimited Google Photos backup. `FOSS` `[LSP]`
* **[GlassMic](https://github.com/lm060719/io.mo.glassmic) ⭐ 54 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-19** - Lets you route an imported audio file into target recording apps through AudioRecord/AAudio hooks. `FOSS` `[LSP]`
...
* **[xCam](https://github.com/hazbu/xCam) ⭐ 20 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-14** - Replace live camera feeds and actual photo captures with virtual media sources. `FOSS` `[LSP]`
...
* **[⭐ Core Patch N](https://github.com/LSPosed/CorePatch) ⭐ 3,270 | 🐛 9 | 🌐 Kotlin | 📅 2026-07-26** - Disable signature verification For Android. `FOSS` `[LSP]`
* **[⭐ Pairipfix](https://github.com/ahmedmani/pairipfix) ⭐ 651 | 🐛 20 | 🌐 Java | 📅 2026-04-20** - Bypasses the "Get this app from Play" screen that appears when installing Android apps as an APK instead of from the Google Play Store. `FOSS` `[LSP]`
...
* **[Material Files](https://github.com/zhanghai/MaterialFiles) ⭐ 8,790 | 🐛 627 | 🌐 Kotlin | 📅 2026-04-06** - Modern file manager with root capabilities. `FOSS` | [🌱](https://f-droid.org/packages/me.zhanghai.android.files)| [▶️](https://play.google.com/store/apps/details?id=me.zhanghai.android.files)
...
* **[Fossify File Manager](https://github.com/FossifyOrg/File-Manager) ⭐ 1,719 | 🐛 96 | 🌐 Kotlin | 📅 2026-08-17** - Easy app for managing your files without ads, respecting your privacy and security. `FOSS` | [🌱](https://f-droid.org/packages/org.fossify.filemanager/) | [▶️](https://play.google.com/store/apps/details?id=org.fossify.filemanager)
...
* **[DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,246 | 🐛 186 | 🌐 Kotlin | 📅 2026-08-21** - DataBackup for Android 7.0+. `FOSS` | [🌱](https://f-droid.org/zh_Hans/packages/com.xayah.databackup.foss/)
* **[Neo Backup](https://github.com/NeoApplications/Neo-Backup) ⭐ 3,772 | 🐛 240 | 🌐 Kotlin | 📅 2026-05-03** - Powerful open-source backup solution. `FOSS` | [🌱](https://f-droid.org/packages/com.machiav3lli.backup/)
...
* **[⭐ SD Maid 2/SE](https://github.com/d4rken-org/sdmaid-se) ⭐ 7,343 | 🐛 13 | 🌐 Kotlin | 📅 2026-08-22** - A file management tool for Android that specializes in maintenance. Its core purpose is freeing up space and removing unwanted data. `FOSS` | [🌱](https://f-droid.org/en/packages/eu.darken.sdmse/) | [▶️](https://play.google.com/store/apps/details?id=eu.darken.sdmse)
* **[Cleaner Royall](https://github.com/araafroyall/Cleaner-Royall) ⭐ 240 | 🐛 0 | 🌐 Shell | 📅 2026-08-21** - A lightweight but ultra-fast and powerful cleaner for Android. `Proprietary` `[LSP]`
...
* **[ClearBox](https://github.com/FLYCOM-E/ClearBox) ⭐ 36 | 🐛 1 | 🌐 C | 📅 2026-08-21** - Can delete all software caches, installation packages, compressed packages, garbage, empty folders etc. `Proprietary` `[M]` `[K]`
...
* **[USB Mass Storage](https://github.com/Enginex0/UsbMassStorage) ⭐ 66 | 🐛 1 | 🌐 Kotlin | 📅 2026-04-02** - Turn Your Phone into a USB Drive.
...
* **[Iconify](https://github.com/Mahmud0808/Iconify) ⭐ 3,141 | 🐛 99 | 🌐 Kotlin | 📅 2026-08-22** - Customize your Android 12+ device easily. `FOSS` `[M]`
* **[ColorBlendr](https://github.com/Mahmud0808/ColorBlendr) ⭐ 2,398 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-22** - Customize Material You colors of your device. `FOSS` | [🌱](https://f-droid.org/en/packages/com.drdisagree.colorblendr/)
* **[HyperLight](https://github.com/KiminonawaResa/HyperLight#english) ⭐ 688 | 🐛 36 | 📅 2026-08-20** - Completes the highlight blur effects for HyperOS 3, bringing a unified visual experience to the desktop, notification shade, and control center. `FOSS` `[LSP]`
* **[Global Icon Pack](https://github.com/RichardLuo0/global-icon-pack-android) ⭐ 406 | 🐛 5 | 🌐 Kotlin | 📅 2026-07-08** - Apply icon packs globally. `FOSS` `[LSP]`
...
* **[Activity Manager](https://github.com/sdex/ActivityManager) ⭐ 1,283 | 🐛 14 | 🌐 Kotlin | 📅 2026-07-25** - Discover the activities of installed applications, run them, and create shortcuts. `FOSS` | [🌱](https://f-droid.org/packages/com.activitymanager/)
...
* **[HyperOS Launcher](https://github.com/Mods-Center/HyperOS-Launcher#hyperos-launcher-v5) ⭐ 381 | 🐛 60 | 📅 2026-08-12** - Enhanced HyperOS Launcher with features from high-end devices, including customizable app drawer, icon packs, and more. `Proprietary` `[M]` `[K]`
...
* **[Launcher3 QuickLaunch](https://github.com/hddq/launcher3-quicklaunch) ⭐ 1 | 🐛 3 | 🌐 Java | 📅 2026-08-22** - Lets you press Enter in Launcher3's app drawer search to instantly launch the first search result. `FOSS` `[LSP]`
...
* **[NavTweaks](https://github.com/Magisk-Modules-Alt-Repo/HideNavBar) ⭐ 802 | 🐛 27 | 🌐 JavaScript | 📅 2026-06-23** - Fullscreen/Immersive Gesture Tweaks for Android 10-14. `FOSS` `[M]`
* **[Lyricon](https://github.com/tomakino/lyricon) ⭐ 719 | 🐛 36 | 🌐 Kotlin | 📅 2026-05-30** - An Android status bar lyric enhancement tool based on the Xposed framework. `FOSS` `[LSP]`
* **[LyricProvider](https://github.com/tomakino/LyricProvider/tree/master) ⭐ 360 | 🐛 52 | 🌐 Kotlin | 📅 2026-08-22** - A lyric provider for Lyricon. `FOSS` `[LSP]`
...
* **[Volume Key Track Control Module](https://github.com/Hepolise/VolumeKeyTrackControlModule) ⭐ 80 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-22** - Allows to skip and play/pause track with volume keys. `FOSS` `[LSP]`
...
* **[Recents](https://github.com/tymwitko/Recents) ⭐ 66 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-20** - Launcher-agnostic "Recents" menu for Android. `FOSS` `[LSP]`
...
* **[Ogesture](https://github.com/tanujnotes/ogesture) ⭐ 21 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-20** - Use gesture navigation with third-party launchers on any Android phone. `FOSS` `[LSP]`
...
* **[MakeFontsGreatAgain](https://github.com/Numbersf/MakeFontsGreatAgain) ⭐ 295 | 🐛 10 | 🌐 C | 📅 2026-08-01** - System-wide Font Overrider with Unique GMS Masking & Multi-Range Unicode Filter. `FOSS` `[M]` `[K]`
...
* **[KernelSU-iOS-Emoji](https://github.com/n4bi10p/Ios-emoji) ⭐ 30 | 🐛 8 | 🌐 Shell | 📅 2026-07-13** - Systemlessly replaces emoji font with iOS Emoji. `FOSS` `[K]`
...
* **[HyperIsland](https://github.com/1812z/HyperIsland/blob/main/README_EN.md) ⭐ 446 | 🐛 7 | 🌐 Dart | 📅 2026-08-19** - Dynamic Island-style notifications for HyperOS 3, powered by LSPosed. `FOSS` `[LSP]`
* **[Punch-hole Download Progress](https://github.com/hxreborn/punch-hole-download-progress) ⭐ 229 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-22** - Displays download progress as an animated ring around the camera cutout. `FOSS` `[LSP]` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/eu.hxreborn.phdp)
...
* **[Auto Expand Notifications](https://github.com/kvmy666/-AutoExpandNotifications) ⭐ 33 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-18** - Notification Tweaks for OxygenOS. `FOSS` `[LSP]`
...
* **[AlwaysOn](https://github.com/Domi04151309/AlwaysOn) ⭐ 230 | 🐛 23 | 🌐 Kotlin | 📅 2025-06-23** - Adds an always-on display with various customization options regarding watch face, behavior, and background. `FOSS` `[LSP]`
* **[ColorOS Live Lyrics Bridge](https://github.com/Andrea-lyz/ColorOS-Live-Lyrics-Bridge) ⭐ 148 | 🐛 6 | 🌐 Java | 📅 2026-08-22** - Bridges timed lyrics from supported players into the ColorOS/OPlus lock-screen lyric pipeline. `FOSS` `[LSP]`
...
* **[HyperGlow](https://github.com/amarinne/hyperglow) ⭐ 7 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-15** - Animated lock screen and always-on display lyrics for HyperOS 3. `FOSS` `[LSP]`
...
* **[Adaptive Theme: Auto Dark Mode by Ambient Light](https://github.com/xLexip/Adaptive-Theme) ⭐ 194 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-22** - Automatically switches between Light and Dark mode using the ambient light sensor. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=dev.lexip.hecate)
...
* **[DarQ Fork](https://github.com/Arora-Sir/DarQ) ⭐ 74 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-12** - Provides a per-app selectable force dark option for Android 10 and above. `FOSS`
* **[Pointer Replacer](https://github.com/thesandipv/pointer_replacer) ⭐ 27 | 🐛 9 | 🌐 Kotlin | 📅 2026-08-22** - Replaces a dot appears when user touch the screen \[Require Show Touches to be enabled in Developer Options]. `FOSS` `[LSP]`
...
* **[⭐ ViPERFX\_RE](https://github.com/likelikeslike/ViPERFX_RE) ⭐ 280 | 🐛 2 | 🌐 C | 📅 2026-08-11** - A fork of ViPER4Android FX with a redesigned UI and additional features. `FOSS` `[M]` `[K]`

### Audio Control

* **[LibrePods](https://github.com/kavishdevar/librepods) ⭐ 29,551 | 🐛 273 | 🌐 Kotlin | 📅 2026-07-13** - Unlocks Apple's exclusive premium AirPods features on non-Apple devices. `FOSS` `[LSP]` `[M]` `[K]`
...
* **[SonyPods](https://github.com/Mercury000/SonyPods) ⭐ 20 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-18** - System-level Sony headphone control for HyperOS devices. `FOSS` `[LSP]`
* **[HuaweiPods](https://github.com/Nshpiter/HuaweiPods) ⭐ 12 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-21** - Huawei audio device integration for Xiaomi HyperOS. `FOSS` `[LSP]`
...
* **[AdGuardHome for Root](https://github.com/twoone-3/AdGuardHomeForRoot/blob/main/README_en.md#adguardhome-for-root) ⭐ 1,365 | 🐛 15 | 🌐 Shell | 📅 2026-07-28** - A module to easily execute AdGuardHome on Android. `FOSS` `[M]`
...
* **[Pi-hole-for-Android](https://github.com/DesktopECHO/Pi-hole-for-Android) ⭐ 647 | 🐛 4 | 🌐 Shell | 📅 2025-12-26** - Pi-hole/Unbound Raspbian APK installer for Android 5.0+ devices. `FOSS`
* **[DNS Toggle](https://github.com/ELowry/DNSToggle) ⭐ 97 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-20** - A tiny Android app that allows you to easily toggle your phone's Private DNS through the Quick Settings panel. `FOSS`
...
* **[VPN Hotspot](https://github.com/Mygod/VPNHotspot) ⭐ 6,330 | 🐛 23 | 🌐 Kotlin | 📅 2026-08-16** - Share your VPN connection over hotspot or repeater. `FOSS`
...
* **[Surfing](https://github.com/GitMetaio/Surfing) ⭐ 2,345 | 🐛 79 | 🌐 Shell | 📅 2026-08-22** - Magisk and KernelSU modules for Clash/mihomo, sing-box, v2ray, xray, hysteria services. `FOSS` `[M]` `[K]`
* **[Box4Magisk / KernelSU / APatch](https://github.com/CHIZI-0618/box4magisk) ⭐ 1,892 | 🐛 3 | 🌐 Shell | 📅 2026-04-10** - Deploy multiple proxy cores on Android devices, including clash, mihomo, sing-box, v2ray, xray, and hysteria. `FOSS` `[M]` `[K]`
* **[NetProxy-Magisk](https://github.com/Fanju6/NetProxy-Magisk) ⭐ 1,111 | 🐛 23 | 🌐 Kotlin | 📅 2026-08-20** - Magisk proxy module based on Xray kernel, supports one-click start/stop transparent proxy. `FOSS` `[M]`
* **[VPN Hide](https://github.com/okhsunrog/vpnhide) ⭐ 518 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-22** - Hide active VPN from selected Android apps (kernel module + LSPosed + Zygisk) `FOSS` `[M]` `[K]`
* **[ZDT-D Root Module](https://github.com/GAME-OVER-op/ZDT-D) ⭐ 269 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-19** - Module for traffic routing, DPI bypass, proxy chaining, DNS control, and per-app network management. `FOSS` `[M]` `[K]`
...
* **[MagicNet](https://github.com/LIghtJUNction/MagicNet#english-summary) ⭐ 155 | 🐛 0 | 🌐 Shell | 📅 2026-08-22** - Module for device-side traffic governance that enforce network rules below the app layer instead of relying on every app to respect a proxy setting. `FOSS` `[M]` `[K]`
* **[TCP Optimiser Module](https://github.com/fatalcoder524/TCP_Optimiser_Module) ⭐ 147 | 🐛 4 | 🌐 JavaScript | 📅 2026-07-01** - Change tcp congestion algorithm based on current active internet type and some network enhancements. `FOSS` `[M]` `[K]`
...
* **[Network Switch](https://github.com/aunchagaonkar/NetworkSwitch#installation) ⭐ 429 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-20** - Modern Android app for 4G/5G network mode switching. `FOSS` | [🌱](https://apt.izzysoft.de/packages/com.supernova.networkswitch)
* **[WiFi Password Manager](https://github.com/Khh-vu/wifi-password-manager) ⭐ 281 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-21** - Simple app to manage WiFi passwords. `FOSS` | [🌱](https://apt.izzysoft.de/packages/io.github.wifi_password_manager)
* **[VirtualAP](https://github.com/ravindu644/VirtualAP) ⭐ 70 | 🐛 2 | 🌐 Kotlin | 📅 2026-07-16** - Turn a rooted Android phone into Wi-Fi access point with static gateway, selectable upstream (mobile data, Wi-Fi, Ethernet, or a VPN tunnel) etc. `FOSS` `[LSP]`
...
* **[NFCGate](https://github.com/nfcgate/nfcgate) ⭐ 2,319 | 🐛 13 | 🌐 Java | 📅 2026-07-20** - Android application meant to capture, analyze, or modify NFC traffic. `FOSS` `[LSP]` | [🌱](https://f-droid.org/packages/de.tu_darmstadt.seemoo.nfcgate/)
...
* **[XposedFakeLocation](https://github.com/noobexon1/XposedFakeLocation) ⭐ 655 | 🐛 8 | 🌐 Kotlin | 📅 2026-08-02** - Allows you to spoof your device's location globally or for specific apps without using "mock location" from the developer options. `FOSS` `[LSP]`
* **[AnyWhere](https://github.com/cxOrz/AnyWhere) ⭐ 553 | 🐛 9 | 🌐 Java | 📅 2026-08-04** - Location simulation tool for debugging LBS applications and for users to test geolocation functionality. `FOSS` `[LSP]`
...
* **[HLocation](https://github.com/sparr-sherrya/hlocation-release) ⭐ 43 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-21** - Location spoofing framework that synchronizes fake GPS and related environment signals across system and app processes for more consistent location virtualization. `FOSS` `[LSP]`
...
* **[AsoulOpt](https://github.com/nakixii/Magisk_AsoulOpt) ⭐ 2,651 | 🐛 5 | 🌐 Shell | 📅 2026-08-09** - Game threads tweaker for Android, suitable for mainstream games and some niche games. `FOSS` `[M]`
...
* **[Encore Tweaks](https://github.com/Rem01Gaming/encore) ⭐ 504 | 🐛 3 | 🌐 C++ | 📅 2026-08-16** - Enhance device performance during gaming sessions, while keeping battery life optimized for normal use. `Proprietary` `[M]`
...
* **[⭐ Termux](https://github.com/termux/termux-app) ⭐ 59,575 | 🐛 592 | 🌐 Java | 📅 2026-07-14** - A terminal emulator application for Android OS extendible by variety of packages. `FOSS` | [🌱](https://f-droid.org/en/packages/com.termux)
* **[aShell You](https://github.com/DP-Hridayan/aShellYou) ⭐ 2,212 | 🐛 36 | 🌐 Kotlin | 📅 2026-08-22** - Android shell utility app with Material Design 3 UI, letting you run ADB, root and shell commands. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/in.hridayan.ashell)
* **[Termux-Root-Recovery-Tool](https://github.com/Ishu43642/Termux-Root-Recovery-Tool) ⭐ 259 | 🐛 5 | 🌐 Shell | 📅 2026-03-17** - Install GSi Rom , Flashing Fastboot Rom, install Twrp Recovery, Boot.img & vbmeta.img files. `FOSS`
...
* **[Shizuku](https://github.com/RikkaApps/Shizuku) ⭐ 29,210 | 🐛 541 | 🌐 Kotlin | 📅 2025-06-18** - Use system APIs directly with ADB/root privileges. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/moe.shizuku.privileged.api) | [▶️](https://play.google.com/store/search?q=shizuku\&c=apps)
* **[⭐ Shizuku Fork](https://github.com/thedjchi/Shizuku) ⭐ 5,218 | 🐛 64 | 🌐 Kotlin | 📅 2026-07-15** - Shizuku for with automatic Shizuku startup, automation, and recovery features. `FOSS`
* **[Shevery](https://github.com/HmnDev-Tech/shevery) ⭐ 820 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-22** - Based on shizuku with Jetpack Compose, Material 3, and compatibility enhancements. `FOSS`
...
* **[KSU Toolkit](https://github.com/backslashxx/ksu_toolkit) ⭐ 103 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-18** - Small extensions on top of KernelSU for testing and debugging purposes. `FOSS` `[K]`
...
* **[⭐ Droidspaces](https://github.com/ravindu644/Droidspaces-OSS) ⭐ 1,734 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-22** - Run full Linux environments on top of Android, with complete init system support. `FOSS`
...
* **[USB HID Client](https://github.com/Arian04/android-hid-client) ⭐ 425 | 🐛 19 | 🌐 Kotlin | 📅 2026-08-22** - Use your phone as a keyboard and mouse without any software on the other end. `FOSS` | [🌱](https://apt.izzysoft.de/packages/me.arianb.usb_hid_client)
...
* **[RebootNya](https://github.com/daisukiKaffuChino/RebootNya) ⭐ 248 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-20** - A simple yet advanced reboot utility for Android devices. `FOSS`
...
* **[No Photo Picker API](https://github.com/yureitzk/NoPhotoPickerAPI) ⭐ 51 | 🐛 0 | 🌐 Kotlin | 📅 2026-02-19** - Bypasses the Android Photo Picker API and lets apps use the classic document/file picker. `FOSS` `[LSP]`
...
* **[Basic Call Recorder](https://github.com/chenxiaolong/BCR) ⭐ 2,878 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-20** - A Basic Call Recorder for rooted Android devices. Also check out [GUI for BCR ↗](https://github.com/nicorac/bcr-gui) ⭐ 350 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-10. `FOSS` `[M]` `[K]`
...
* **[⭐ Essentials](https://github.com/sameerasw/essentials) ⭐ 2,659 | 🐛 80 | 🌐 Kotlin | 📅 2026-08-22** - Multi-purpose tweaks for display, notifications and alerts, security and privacy, sound and haptics, and app freezing. `FOSS`
* **[SwitchAI - Switch AI Digital Assistant](https://github.com/WSTxda/SwitchAI) ⭐ 1,419 | 🐛 5 | 🌐 Kotlin | 📅 2026-07-12** - Easily select, start, and manage your preferred AI digital assistants. `FOSS`
* **[Zygisk Sui](https://github.com/XiaoTong6666/Sui) ⭐ 632 | 🐛 2 | 🌐 Java | 📅 2026-08-22** - Modern superuser interface (SUI) implementation for Android. `FOSS` `[M]` `[K]`
...
* **[KernelSU Grant Toast](https://github.com/NativeStar/KernelSUGrantToast) ⭐ 50 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-07** - Make KernelSU show a root granted toast like Magisk. `FOSS` `[K]`
...
| 📂 **GitHub**    | Source, discussions & issues  | [GitHub Repo](https://github.com/awesome-android-root/awesome-android-root) ⭐ 4,372 \| 🐛 1 \| 🌐 Python \| 📅 2026-08-20 |
...
* 🐛 Report [issues](https://github.com/awesome-android-root/awesome-android-root/issues) ⭐ 4,372 | 🐛 1 | 🌐 Python | 📅 2026-08-20
...
**⚡ Built with ❤️ by [Awesome Android Root](https://github.com/awesome-android-root/awesome-android-root) ⭐ 4,372 | 🐛 1 | 🌐 Python | 📅 2026-08-20**
