...
> For privacy-friendly installs, use the F-Droid ecosystem: install [Droid-ify](https://github.com/Droid-ify/client/releases) ⭐ 7,301 | 🐛 200 | 🌐 Kotlin | 📅 2026-08-23 (modern F-Droid client) and enable the [IzzyOnDroid](https://apt.izzysoft.de/fdroid/) repo for many additional packages.
...
| :----------------------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------- |
|       **[Magisk](https://github.com/topjohnwu/Magisk) ⭐ 62,384 \| 🐛 45 \| 🌐 Kotlin \| 📅 2026-08-23** <br><small> `Root & Module Management` </small>      | If you chose Magisk, this is your manager.               |
| **[App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 8,797 \| 🐛 207 \| 🌐 Java \| 📅 2026-08-22** <br><small> `App & Package Management` </small> | Inspect and manage apps with root privileges.            |
...
* **[⭐ Magisk](https://github.com/topjohnwu/Magisk) ⭐ 62,384 | 🐛 45 | 🌐 Kotlin | 📅 2026-08-23** - Manage Magisk modules and root permissions. `FOSS`
* **[⭐ KernelSU](https://github.com/tiann/KernelSU) ⭐ 17,970 | 🐛 60 | 🌐 Kotlin | 📅 2026-08-23** - A Kernel based root solution for Android. `FOSS`
* **[APatch](https://github.com/bmax121/APatch) ⭐ 7,837 | 🐛 89 | 🌐 Kotlin | 📅 2026-08-22** - The patching of Android kernel and Android system. `FOSS` | [🌱](https://f-droid.org/packages/me.bmax.apatch/)
* **[SukiSU-Ultra](https://github.com/SukiSU-Ultra/SukiSU-Ultra) ⭐ 6,142 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-15** - A kernel-based root solution for Android devices, forked from `KernelSU` with some useful changes. `FOSS`
* **[KernelSU-next](https://github.com/KernelSU-Next/KernelSU-Next) ⭐ 4,144 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-22** - An advanced Kernel based root solution for Android. `FOSS`
* **[ReSukiSU](https://github.com/ReSukiSU/ReSukiSU) ⭐ 1,282 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-23** - Fork of SukiSU-Ultra with additional features. `FOSS`
* **[FolkPatch](https://github.com/LyraVoid/FolkPatch) ⭐ 1,067 | 🐛 28 | 🌐 Kotlin | 📅 2026-08-21** - A Root management tool focused on interface optimization and feature extension, based on APatch. `FOSS`

### Module Managers

* **[⭐ MMRL](https://github.com/DerGoogler/MMRL) ⭐ 2,138 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-18** - An Android app that helps manage your own modules repository. `FOSS` `[M]` `[K]` `[A]` | [🌱](https://f-droid.org/en/packages/com.dergoogler.mmrl/) | [▶️](https://play.google.com/store/apps/details?id=com.dergoogler.mmrl)
...
* **[Meta-hybrid\_mount](https://github.com/YuzakiKokuban/meta-hybrid_mount) ⭐ 1,459 | 🐛 0 | 🌐 Rust | 📅 2026-08-23** - Three-engine mount orchestration (OverlayFS + Magic Mount + Kasumi LKM) with conflict monitor, SolidJS WebUI, auto-fallback, and EROFS storage backend support. `FOSS` `[K]` `[A]`
* **[⭐ Mountify](https://github.com/backslashxx/mountify) ⭐ 1,313 | 🐛 23 | 🌐 Shell | 📅 2026-08-23** - OverlayFS with tmpfs/ext4 sparse support for reduced detection, works on APatch/Magisk too. `FOSS` `[M]` `[K]` `[A]`
* **[⭐ Meta-overlayfs](https://github.com/KernelSU-Modules-Repo/meta-overlayfs) ⭐ 461 | 🐛 8 | 🌐 Rust | 📅 2025-12-02** - Official reference implementation using OverlayFS for most users and standard setup. `FOSS` `[K]`
...
* **[⭐ Vector](https://github.com/JingMatrix/Vector) ⭐ 12,203 | 🐛 9 | 🌐 Kotlin | 📅 2026-08-22** - Open Source *Fork* of original LSPosed with dynamic module loading, and other improvements. `FOSS` `[M]`
...
* **[⭐ Zygisk Next](https://github.com/Dr-TSNG/ZygiskNext) ⭐ 10,386 | 🐛 2 | 📅 2026-08-05** The "Gold Standard" for detection evasion. It is a standalone Zygisk implementation that offers the most advanced stealth features, including a dedicated **Zygote Monitor** and dashboard. `Proprietary` `[M]` `[K]` `[A]`
* **[ReZygisk](https://github.com/PerformanC/ReZygisk) ⭐ 3,850 | 🐛 10 | 🌐 C | 📅 2026-08-22** A high-performance implementation **entirely rewritten in C**. It introduces **custom linkers** to bypass modern linker-based detections, offering a WebUI for status monitoring and compatibility with Android 15 and 16. `FOSS` `[M]` `[K]` `[A]`
* **[NeoZygisk](https://github.com/JingMatrix/NeoZygisk) ⭐ 2,214 | 🐛 7 | 🌐 C++ | 📅 2026-08-20** A minimalist, high-stealth implementation using **ptrace injection**. It focuses on "trace cleaning," aiming to remove all injection artifacts from memory once modules are loaded. `FOSS` `[M]` `[K]` `[A]`
...
* **[TrickyStore](https://github.com/5ec1cff/TrickyStore) ⭐ 6,308 | 🐛 4 | 📅 2025-11-30** - Modifies the certificate chain for Android key attestation (keybox-based). The original/reference module. `Proprietary` `[M]` `[K]`
...
* **[Play Integrity Fork (PIF)](https://github.com/osm0sis/PlayIntegrityFork) ⭐ 4,409 | 🐛 0 | 🌐 C++ | 📅 2026-08-23** - The most actively maintained PIF. Fixes `DEVICE_INTEGRITY` verdicts with custom fields/props. Recommended starting point after chiteroman's original was discontinued. `FOSS` `[M]`
* **[Play Integrity Fix (inject)](https://github.com/KOWX712/PlayIntegrityFix) ⭐ 3,773 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-18** - Actively maintained fork using injected GMS/Play Store spoofing with a WebUI. `FOSS` `[M]`
* **[Tricky Addon – Update Target List](https://github.com/KOWX712/Tricky-Addon-Update-Target-List) ⭐ 3,399 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-23** - KSU WebUI to configure TrickyStore's `target.txt`. `FOSS` `[K]`
* **[⭐ HMA-OSS](https://github.com/frknkrc44/HMA-OSS) ⭐ 2,936 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-23** - FOSS rewrite of Hide My Applist; hides your app list, settings, and package installers. `FOSS` `[LSP]`
...
* **[⭐ TEESimulator](https://github.com/JingMatrix/TEESimulator) ⭐ 2,276 | 🐛 7 | 🌐 C++ | 📅 2026-08-21** - Create a complete, software-based simulation of a hardware-backed Trusted Execution Environment (TEE) for Key Attestation. `FOSS` `[M]` `[K]`
* **[YuriKey](https://github.com/dpejoh/yurikey) ⭐ 1,861 | 🐛 9 | 🌐 Shell | 📅 2026-08-01** - Systemless module to obtain strong integrity easily. `FOSS` `[M]` `[K]`
* **[TEESimulator-RS](https://github.com/Enginex0/TEESimulator-RS) ⭐ 1,641 | 🐛 22 | 🌐 Kotlin | 📅 2026-07-11** - Fork of TEESimulator with native Rust certificate generation, key persistence, and AOSP-compliant attestation behavior. `FOSS` `[M]` `[K]`
* **[NoHello](https://github.com/MhmRdd/NoHello) ⭐ 1,349 | 🐛 21 | 🌐 C++ | 📅 2025-06-28** - Lightweight Zygisk module to hide root. `FOSS` `[M]`
* **[TrickyStore OSS](https://github.com/beakthoven/TrickyStoreOSS) ⭐ 1,306 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-20** - Open-source alternative to TrickyStore. `FOSS` `[M]` `[K]`
...
* **[Specter](https://github.com/dpejoh/specter) ⭐ 543 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-22** - Unified Play Integrity and root hiding stack for Android. Successor of Yurikey. `FOSS` `[M]` `[K]`
...
* **[Always Strong](https://github.com/evoker0/AlwaysStrong) ⭐ 331 | 🐛 6 | 🌐 Shell | 📅 2026-08-16** - Bundles TEESimulator-RS and PlayIntegrityFork into a single module for strong integrity on rooted devices. `FOSS` `[M]` `[K]`
* **[⭐ BRENE](https://github.com/rrr333nnn333/BRENE) ⭐ 327 | 🐛 9 | 🌐 Shell | 📅 2026-08-23** - SUSFS/KernelSU module for patched kernels with enhanced root hiding & spoofing. `FOSS` `[M]` `[K]`
* **[OhMyKeymint](https://github.com/qwq233/OhMyKeymint) ⭐ 273 | 🐛 2 | 🌐 Rust | 📅 2026-08-12** - Custom keystore implementation for Android Keystore Spoofer. `FOSS` `[M]` `[K]`
...
* **[Duck Detector](https://github.com/eltavine/Duck-Detector-Refactoring) ⭐ 884 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-21** - Android environment integrity inspection tool for root, hook, bootloader, SELinux, virtualization, and attestation signals. `FOSS`
...
* **[Multi Userui Enabler](https://github.com/InsertX2k/multiuseruienabler) ⭐ 7 | 🐛 0 | 🌐 Shell | 📅 2025-12-19** - Magisk module that tries to enable Multi-User UI. `FOSS` `[M]`
...
* **[PIXELIFY NEXT](https://github.com/BasGame1/Pixelify-Next) ⭐ 308 | 🐛 1 | 🌐 Shell | 📅 2026-08-23** - A Magisk Module which enables Pixel UI and some exclusive features. `FOSS` `[M]`
...
* **[OShin](https://github.com/suqi8/OShin/blob/master/README_EN.md) ⭐ 1,170 | 🐛 102 | 🌐 Kotlin | 📅 2026-07-28** - Auxiliary module deeply integrated with ColorOS, designed to enhance and optimize your operating system experience. `FOSS` `[LSP]`
...
* **[⭐ HyperCeiler](https://github.com/ReChronoRain/HyperCeiler/blob/main/README_en-US.md) ⭐ 5,257 | 🐛 230 | 🌐 Java | 📅 2026-08-20** - Extensive customizations for HyperOS. `FOSS` `[LSP]`
...
* **[Hyper Helper](https://github.com/HowieHChen/XiaomiHelper/blob/master/README_EN-US.md) ⭐ 345 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-23** - Lightweight customization module for HyperOS only. `FOSS` `[LSP]`
...
* **[Fingerprint Catalog](https://github.com/custombeta/fingerprint-cataloge) ⭐ 20 | 🐛 0 | 🌐 Kotlin | 📅 2026-07-03** - Allows you to create, upload, import, and apply your own fingerprint icons and animations on HyperOS. `Proprietary` `[LSP]`
...
> \[!TIP]
> Check this resource for more [HyperOS Mods ↗](https://github.com/ImKKingshuk/Awesome-HyperOS) ⭐ 155 | 🐛 0 | 📅 2026-01-12

#### NothingOS

* **[NothingTweaks](https://github.com/RevealedSoulEven/NothingTweaks) ⭐ 7 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-21** - A customization module for Nothing OS based on Xposed framework. `FOSS` `[LSP]`

#### One UI (Samsung)

* **[⭐ KnoxPatch](https://github.com/salvogiangri/KnoxPatch) ⭐ 1,492 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-11** - Get Samsung apps/features working again in your rooted Galaxy device. For better experience, please also [read this ↗](https://github.com/salvogiangri/KnoxPatch?tab=readme-ov-file#knoxpatch-enhancer) ⭐ 1,492 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-11 . `FOSS` `[LSP]`
* **[One UI X](https://github.com/SoClear/OneUIX) ⭐ 175 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-21** - Remove annoying restrictions, and inject powerful enhancements into the Status Bar, Quick Settings, and native apps etc on Samsung's One UI. `FOSS` `[LSP]`
...
* **[Oxygen-Customizer](https://github.com/DHD2280/Oxygen-Customizer/) ⭐ 452 | 🐛 37 | 🌐 Java | 📅 2026-08-23** - Open-source Oxygen OS customizer application. `FOSS` `[LSP]`
...
* **[Samsung Boot Animation Module](https://github.com/John0n1/SMbootFX) ⭐ 82 | 🐛 8 | 🌐 Shell | 📅 2026-01-20** - Custom boot animations for Samsung devices via Magisk. `FOSS` `[M]`
...
* **[⭐ Canta](https://github.com/samolego/Canta) ⭐ 5,611 | 🐛 30 | 🌐 Kotlin | 📅 2026-08-16** - Uninstall any app without root using [Shizuku](#developer-tools). `FOSS` | [🌱](https://f-droid.org/en/packages/io.github.samolego.canta/) | [▶️](https://play.google.com/store/apps/details?id=io.github.samolego.canta)
...
* **[⭐ App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 8,797 | 🐛 207 | 🌐 Java | 📅 2026-08-22** - A full-featured package manager and viewer for Android. `FOSS` | [🌱](https://f-droid.org/packages/io.github.muntashirakon.AppManager/)
* **[⭐ Droid-ify](https://github.com/Droid-ify/client) ⭐ 7,301 | 🐛 200 | 🌐 Kotlin | 📅 2026-08-23** - F-Droid client with Material UI and auto updating apps using root. `FOSS` | [🌱](https://f-droid.org/packages/com.looker.droidify)
* **[⭐ Hail](https://github.com/aistra0528/Hail) ⭐ 6,512 | 🐛 169 | 🌐 Kotlin | 📅 2026-08-12** - Disable / Hide / Suspend / Uninstall Android apps. `FOSS` | [🌱](https://f-droid.org/packages/com.aistra.hail/)
* **[InstallerX-Revived](https://github.com/wxxsfxyzm/InstallerX-Revived) ⭐ 6,256 | 🐛 17 | 🌐 Kotlin | 📅 2026-08-22** - A modern and functional Android app installer. `FOSS` `[LSP]`
* **[Neo Store](https://github.com/NeoApplications/Neo-Store) ⭐ 4,927 | 🐛 129 | 🌐 Kotlin | 📅 2026-04-25** - An F-Droid client with modern UI and an arsenal of extra features. `FOSS` | [🌱](https://f-droid.org/packages/com.machiav3lli.fdroid)
* **[Aurora Store](https://github.com/whyorean/AuroraStore) ⭐ 2,866 | 🐛 26 | 🌐 Kotlin | 📅 2026-08-21** - A Google Play Store client to search, view app details, and download APKs directly to your device. `FOSS` | [🌱](https://f-droid.org/packages/com.aurora.store/)
* **[⭐ Zygisk Detach](https://github.com/j-hc/zygisk-detach) ⭐ 2,114 | 🐛 0 | 🌐 Rust | 📅 2026-07-09** - Zygisk module to detach installed apps from Play Store, hooking binder. `FOSS` `[M]` `[K]`
* **[Inure](https://github.com/Hamza417/Inure) ⭐ 1,889 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-22** - An elegant and beautiful premium Android app manager for rooted and non-rooted devices. `FOSS` | [🌱](https://f-droid.org/en/packages/app.simple.inure/) | [▶️](https://play.google.com/store/apps/details?id=app.simple.inure.play)
* **[Universal Installer](https://github.com/pass-with-high-score/universal-installer) ⭐ 1,288 | 🐛 22 | 🌐 Kotlin | 📅 2026-08-23** - Install and manage APK packages with split APK support. `FOSS` `[LSP]`
* **[InxLocker](https://github.com/Chimioo/InxLocker) ⭐ 871 | 🐛 2 | 🌐 Kotlin | 📅 2026-06-11** - Intercepts/forwards Android system application installation and uninstallation requests, redirecting them to your specified installer app. `FOSS` `[LSP]`
...
* **[BetterKnownInstalled](https://github.com/Pixel-Props/BetterKnownInstalled) ⭐ 548 | 🐛 0 | 🌐 Shell | 📅 2026-08-23** - Patches packages to fix DroidGuard UNKNOWN\_INSTALLED issues. `FOSS` `[LSP]`
* **[Thor](https://github.com/trinadhthatakula/Thor) ⭐ 520 | 🐛 11 | 🌐 Kotlin | 📅 2026-08-23** - Android App Manager and App Installer utility. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/com.valhalla.thor) | [▶️](https://play.google.com/store/apps/details?id=com.valhalla.thor)
...
* **[COPG](https://github.com/AlirezaParsi/COPG) ⭐ 376 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-18** - Spoof your device to enjoy premium features, max performance, and exclusive benefits. `FOSS` `[M]`
...
* **[KonaBess Next](https://github.com/KonaBess-Next/KonaBess-Next) ⭐ 208 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-06** - Fork of KonaBess, Custom GPU overclocking and undervolting tool with granulated voltage for rooted Snapdragon Android devices. `FOSS`
...
* **[Plus Plus Battery](https://github.com/dijia1124/plusplusbattery) ⭐ 464 | 🐛 16 | 🌐 Kotlin | 📅 2026-02-22** - Real-time battery stats & health estimator for OnePlus/Oppo/Realme phones. `FOSS` | [🌱](https://f-droid.org/en/packages/com.dijia1124.plusplusbattery/)
...
* **[Hyper Optimize](https://github.com/TatshSiow/HyperOptimize) ⭐ 68 | 🐛 0 | 🌐 Shell | 📅 2026-07-28** - Tune HyperOS System and Kernel parameters to reduce power consumption. `FOSS` `[M]`
...
* **[AccA](https://github.com/VR-25/acc) ⭐ 2,379 | 🐛 19 | 🌐 Shell | 📅 2025-06-06** - Advanced Charging Controller app. `FOSS`
...
* **[Shappky](https://github.com/YasserNull/shappky) ⭐ 535 | 🐛 19 | 🌐 Kotlin | 📅 2026-08-23** - A simple app to boost performance by stopping background apps, relying on Root/Shizuku permissions. `FOSS` `[M]`
...
* **[⭐ AdAway](https://github.com/AdAway/AdAway) ⭐ 9,361 | 🐛 668 | 🌐 C | 📅 2026-02-10** - Open-source ad blocker using the hosts file. Blocks ads without permissions. `FOSS` | [🌱](https://f-droid.org/packages/org.adaway)
* **[BlockAds](https://github.com/pass-with-high-score/blockads-android) ⭐ 1,762 | 🐛 61 | 🌐 Kotlin | 📅 2026-08-23** - System‑wide ad, tracker, & malware filtering, custom blocklists, per‑app controls etc. `FOSS` | [🌱](https://f-droid.org/packages/app.pwhs.blockads)
* **[⭐ Bindhosts](https://github.com/bindhosts/bindhosts) ⭐ 1,382 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-23** - Systemless hosts for APatch, KernelSU and Magisk that is fully standalone and self-updating. `FOSS` `[M]` `[K]`
...
* **[Magisk Ad Blocking Module](https://github.com/pantsufan/Magisk-Ad-Blocking-Module) ⭐ 569 | 🐛 19 | 📅 2026-08-23** - Block ads on android. `FOSS` `[M]`
...
* **[Cubic-AdBlock](https://github.com/Vaz15k/Cubic-AdBlock) ⭐ 76 | 🐛 1 | 🌐 Python | 📅 2026-08-17** - A simple AdBlock module based on the hosts file. `FOSS` `[M]`
* **[Magical Protection](https://github.com/programminghoch10/MagicalProtection) ⭐ 45 | 🐛 1 | 🌐 Shell | 📅 2026-08-19** - Magisk-only completely systemless adblocking. `FOSS` `[M]`
...
* **[PCAPdroid](https://github.com/emanuele-f/PCAPdroid#pcapdroid) ⭐ 4,584 | 🐛 44 | 🌐 Java | 📅 2026-08-22** - Lets you track, analyze and block the connections made by the other apps in your device. `FOSS` | [🌱](https://f-droid.org/packages/com.emanuelef.remote_capture) | [▶️](https://play.google.com/store/apps/details?id=com.emanuelef.remote_capture)
* **[NetGuard](https://github.com/M66B/NetGuard) ⭐ 3,838 | 🐛 1 | 🌐 Java | 📅 2026-08-01** - Block access to the internet. Apps and addresses can individually be allowed or denied access to your Wi-Fi and/or mobile connection. `FOSS`
* **[AFWall+](https://github.com/ukanth/afwall) ⭐ 3,447 | 🐛 218 | 🌐 Java | 📅 2026-08-06** - Iptables-based firewall. `FOSS` | [🌱](https://f-droid.org/packages/dev.ukanth.ufirewall/) | [▶️](https://play.google.com/store/apps/details?id=dev.ukanth.ufirewall)
* **[ShizuWall](https://github.com/AhmetCanArslan/ShizuWall) ⭐ 2,158 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-23** - Android firewall without VPN powered by Shizuku / local ADB daemon / Root. `FOSS` | [🌱](https://f-droid.org/packages/com.arslan.shizuwall/) | [▶️](https://play.google.com/store/apps/details?id=com.arslan.shizuwall)
* **[Athena](https://github.com/Kin69/Athena) ⭐ 692 | 🐛 43 | 🌐 Kotlin | 📅 2026-01-26** - Material You (Material 3) firewall and ad blocker that works seamlessly on both rooted and non-rooted devices. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=com.kin.athena)
* **[De1984 Firewall](https://github.com/dorumrr/de1984) ⭐ 370 | 🐛 29 | 🌐 Kotlin | 📅 2025-12-15** - A privacy-focused Firewall and Package Manager for Android devices. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/io.github.dorumrr.de1984)
...
* **[Fyrypt](https://github.com/mirfatif/Fyrypt) ⭐ 75 | 🐛 0 | 📅 2026-08-23** - Android firewall with UID + PID rules, dnscrypt-proxy management, and per-app live network monitoring. `Proprietary`
...
* **[⭐ Move Certificate](https://github.com/ys1231/MoveCertificate) ⭐ 1,945 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-18** - Move user certificates to system certificates. Supports Android 7-16. `FOSS` `[M]` `[K]`
* **[⭐ Enable Screenshot](https://github.com/LSPosed/DisableFlagSecure) ⭐ 1,292 | 🐛 3 | 🌐 Java | 📅 2026-08-13** - Enabling screenshots in apps that normally wouldn't allow it, and disabling screenshot(Android 14+) and screen record(Android 15+) detection. `FOSS` `[LSP]`
...
* **[ih8SecureLock](https://github.com/j-hc/ih8SecureLock) ⭐ 170 | 🐛 2 | 🌐 C++ | 📅 2026-08-15** - Prevent apps from blocking and listening to your screenshots with Zygisk. `FOSS` `[M]` `[K]`
...
* **[Just Trust Me Pro](https://github.com/hang666/JustTrustMePro) ⭐ 147 | 🐛 5 | 🌐 Kotlin | 📅 2026-03-31** - Disables SSL certificate checking for the purposes of auditing an app with cert pinning. `FOSS` `[M]`
...
* **[Custom Certificate Authorities](https://github.com/Magisk-Modules-Alt-Repo/custom-certificate-authorities) ⭐ 90 | 🐛 1 | 🌐 Shell | 📅 2026-06-15** - Moves user-installed certificate authorities into the system trust store, making them trusted by all apps. `FOSS` `[M]`
...
* **[Biometric App Lock](https://github.com/hxreborn/biometric-app-lock) ⭐ 46 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-20** - Locks apps you choose behind fingerprint or face unlock. `FOSS` `[LSP]`
...
* **[Device Faker](https://github.com/Seyud/device_faker/) ⭐ 706 | 🐛 0 | 🌐 Vue | 📅 2026-08-23** - A device model spoofing module based on Zygisk that can configure different device models for different applications. `FOSS` `[M]` `[K]`
* **[DeviceID/SSAID Changer](https://github.com/sidex15/deviceidchanger) ⭐ 262 | 🐛 4 | 🌐 HTML | 📅 2025-12-19** - A simple WebUI Module to change SSAID/DeviceID on Rooted Android Devices with Apatch, KSU (And its forks), or Magisk. `FOSS` `[M]` `[K]`
...
* **[Deekseep](https://github.com/lllucccian/Deekseep) ⭐ 219 | 🐛 3 | 🌐 Java | 📅 2026-08-17** - Adds account, chat, image, interface, and local API tools to the official DeepSeek Android app. `FOSS` `[LSP]`
...
* **[Nexus](https://github.com/niki914/agentic-nexus) ⭐ 124 | 🐛 47 | 🌐 Kotlin | 📅 2026-08-23** - Plug your own model into your phone's voice assistant. `Proprietary` `[LSP]`
...
* **[Play Store Adblock](https://github.com/hxreborn/playstore-adblock) ⭐ 75 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-23** - Xposed module to remove sponsored listings and ads from the Google Play Store. `FOSS` `[LSP]`
...
* **[Spicy EX](https://github.com/amarinne/spicy-ex) ⭐ 19 | 🐛 1 | 🌐 Java | 📅 2026-08-22** - Adds Spicy lyrics in Spotify along with translation and much more UI features. `FOSS` `[LSP]`
...
* **[BBZQ](https://github.com/HSSkyBoy/BBZQ) ⭐ 395 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-22** - Removes unnecessary content, optimizes the core experience, and provide various practical functions. `FOSS` `[LSP]`
...
* **[Knot](https://github.com/2b-zipper/Knot) ⭐ 113 | 🐛 3 | 🌐 Java | 📅 2026-08-23** - Message privacy, notification tweaks & Screen display & UI mods for Line. `FOSS` `[LSP]`

#### QQ

* **[QAuxiliary](https://github.com/cinit/QAuxiliary) ⭐ 5,710 | 🐛 265 | 🌐 Java | 📅 2026-08-21** - Xposed module based on QNotified. `FOSS` `[LSP]`
* **[XAutoDaily](https://github.com/LuckyPray/XAutoDaily) ⭐ 1,580 | 🐛 37 | 🌐 Kotlin | 📅 2026-07-22** - Various tweaks for QQ. `FOSS` `[LSP]`
...
* **[TCQT Module](https://github.com/callng/TCQT) ⭐ 219 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-23** - An Xposed module designed for Android QQ/TIM clients, which is used to intercept and retain messages that would otherwise be "retracted". `FOSS` `[LSP]`
...
* **[Morphe Reddit Patches](https://github.com/MorpheApp/morphe-patches#-patches-list) ⭐ 3,346 | 🐛 439 | 🌐 Java | 📅 2026-08-23** - Various patches for reddit. `FOSS`
* **[Patcheddit](https://github.com/wchill/patcheddit) ⭐ 774 | 🐛 48 | 🌐 Kotlin | 📅 2026-05-03** - Custom patches with features like view: deleted Reddit posts & comments,Banned subreddits etc. `FOSS`
* **[Adobo Patches](https://github.com/jkennethcarino/adobo/) ⭐ 235 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-21** - Various patches for reddit app. `FOSS`

#### Telegram

* **[TMoe](https://github.com/cinit/TMoe) ⭐ 1,423 | 🐛 20 | 🌐 Java | 📅 2026-07-19** - Adds various tweaks to various Telegram clients. `FOSS` `[LSP]`
* **[Killergram](https://github.com/shatyuka/Killergram) ⭐ 585 | 🐛 0 | 🌐 Java | 📅 2026-08-23** - Remove sponsored messages of Telegram. `FOSS` `[LSP]`
...
* **[Douyin Enhancer](https://github.com/twyora/DouyinEnhancer) ⭐ 86 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-23** - Adds minor quality-of-life features to Douyin (Chinese TikTok). `FOSS` `[LSP]`
...
* **[WeChat Auxiliary](https://github.com/HdShare/WAuxiliary_Public) ⭐ 3,971 | 🐛 12 | 🌐 Kotlin | 📅 2026-05-31** - Various tweaks for WeChat. `Proprietary` `[LSP]`
...
* **[⭐ WA Enhancer](https://github.com/Dev4Mod/WaEnhancer) ⭐ 1,659 | 🐛 282 | 🌐 Kotlin | 📅 2026-08-23** - Enhances your WhatsApp experience. `FOSS` `[LSP]`
* **[WA Enhancer X](https://github.com/mubashardev/WaEnhancerX) ⭐ 375 | 🐛 52 | 🌐 Java | 📅 2026-08-12** - Fork of WA Enhancer with additional features. `FOSS` `[LSP]`
* **[WAPlus](https://github.com/RevealedSoulEven/WAPlusXposed) ⭐ 33 | 🐛 0 | 🌐 Kotlin | 📅 2026-06-29** - Unlock WhatsApp Plus Features. `FOSS` `[LSP]`

#### X/Twitter

* **[⭐ Piko Patches](https://github.com/crimera/piko) ⭐ 4,838 | 🐛 499 | 🌐 Java | 📅 2026-08-23** - Morphe patches for twitter with features like hide promoted tweets, hide promoted accounts, hide promoted trends, hide "who to follow" etc. `FOSS`
* **[Re:X](https://github.com/Xposed-Modules-Repo/one.dot.rex) ⭐ 138 | 🐛 0 | 📅 2026-08-15** -  Tweaks for the new X / Twitter app. `Proprietary` `[LSP]`
...
* **[Fxxk-MiBrowser](https://github.com/DuhMatt/Fxxk-MiBrowser) ⭐ 27 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-23** - Redirects forced Xiaomi Browser links to the system default browser. `FOSS` `[LSP]`

### YouTube & Media Mods

* **[NexAlloy](https://github.com/NexAlloy/NexAlloy) ⭐ 2,893 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-03** - YouTube, YT Music block ads, background playback, sponsorblock and much more. Also unlocks premium features of Strava and Photomath. Unlimited Google Photos backup. `FOSS` `[LSP]`
* **[GlassMic](https://github.com/lm060719/io.mo.glassmic) ⭐ 54 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-19** - Lets you route an imported audio file into target recording apps through AudioRecord/AAudio hooks. `FOSS` `[LSP]`
...
* **[⭐ Core Patch N](https://github.com/LSPosed/CorePatch) ⭐ 3,271 | 🐛 9 | 🌐 Kotlin | 📅 2026-07-26** - Disable signature verification For Android. `FOSS` `[LSP]`
* **[⭐ Pairipfix](https://github.com/ahmedmani/pairipfix) ⭐ 652 | 🐛 20 | 🌐 Java | 📅 2026-04-20** - Bypasses the "Get this app from Play" screen that appears when installing Android apps as an APK instead of from the Google Play Store. `FOSS` `[LSP]`
...
* **[Material Files](https://github.com/zhanghai/MaterialFiles) ⭐ 8,796 | 🐛 627 | 🌐 Kotlin | 📅 2026-04-06** - Modern file manager with root capabilities. `FOSS` | [🌱](https://f-droid.org/packages/me.zhanghai.android.files)| [▶️](https://play.google.com/store/apps/details?id=me.zhanghai.android.files)
...
* **[Fossify File Manager](https://github.com/FossifyOrg/File-Manager) ⭐ 1,720 | 🐛 96 | 🌐 Kotlin | 📅 2026-08-23** - Easy app for managing your files without ads, respecting your privacy and security. `FOSS` | [🌱](https://f-droid.org/packages/org.fossify.filemanager/) | [▶️](https://play.google.com/store/apps/details?id=org.fossify.filemanager)
* **[NoStorageRestrict](https://github.com/Xposed-Modules-Repo/com.github.dan.nostoragerestrict) ⭐ 510 | 🐛 3 | 🌐 Java | 📅 2026-07-29** - Removes the restriction when selecting folders (Sdcard, Download, data and obb) through the file manager on Android 11 and higher. `FOSS`
...
* **[DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,254 | 🐛 186 | 🌐 Kotlin | 📅 2026-08-21** - DataBackup for Android 7.0+. `FOSS` | [🌱](https://f-droid.org/zh_Hans/packages/com.xayah.databackup.foss/)
...
* **[Restoid](https://github.com/hddq/restoid) ⭐ 164 | 🐛 15 | 🌐 Kotlin | 📅 2026-08-23** - modern, root-based Android app backup tool powered by restic. `FOSS`
...
* **[⭐ SD Maid 2/SE](https://github.com/d4rken-org/sdmaid-se) ⭐ 7,350 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-23** - A file management tool for Android that specializes in maintenance. Its core purpose is freeing up space and removing unwanted data. `FOSS` | [🌱](https://f-droid.org/en/packages/eu.darken.sdmse/) | [▶️](https://play.google.com/store/apps/details?id=eu.darken.sdmse)
...
* **[USB Mass Storage](https://github.com/Enginex0/UsbMassStorage) ⭐ 66 | 🐛 2 | 🌐 Kotlin | 📅 2026-04-02** - Turn Your Phone into a USB Drive.
...
* **[Iconify](https://github.com/Mahmud0808/Iconify) ⭐ 3,142 | 🐛 99 | 🌐 Kotlin | 📅 2026-08-22** - Customize your Android 12+ device easily. `FOSS` `[M]`
...
* **[HyperLight](https://github.com/KiminonawaResa/HyperLight#english) ⭐ 690 | 🐛 36 | 📅 2026-08-20** - Completes the highlight blur effects for HyperOS 3, bringing a unified visual experience to the desktop, notification shade, and control center. `FOSS` `[LSP]`
* **[Global Icon Pack](https://github.com/RichardLuo0/global-icon-pack-android) ⭐ 406 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-23** - Apply icon packs globally. `FOSS` `[LSP]`
...
* **[Lyricon](https://github.com/tomakino/lyricon) ⭐ 723 | 🐛 36 | 🌐 Kotlin | 📅 2026-08-23** - An Android status bar lyric enhancement tool based on the Xposed framework. `FOSS` `[LSP]`
...
* **[MiNavBarImmerse](https://github.com/Ianzb/MiNavBarImmerse) ⭐ 196 | 🐛 0 | 🌐 Python | 📅 2026-08-23** - Optimizes the Xiaomi NavBar immersion by replacing the NavBar configuration file of third-party applications built into Xiaomi HyperOS 2.2. `FOSS` `[LSP]`
...
* **[Volume Key Track Control Module](https://github.com/Hepolise/VolumeKeyTrackControlModule) ⭐ 82 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-22** - Allows to skip and play/pause track with volume keys. `FOSS` `[LSP]`
...
* **[Magisk-iOS-Emoji](https://github.com/Keinta15/Magisk-iOS-Emoji) ⭐ 389 | 🐛 14 | 🌐 Shell | 📅 2026-06-25** - Systemlessly replaces the emoji font with iOS Emoji. `FOSS` `[M]`
...
* **[HyperIsland](https://github.com/1812z/HyperIsland/blob/main/README_EN.md) ⭐ 448 | 🐛 7 | 🌐 Dart | 📅 2026-08-19** - Dynamic Island-style notifications for HyperOS 3, powered by LSPosed. `FOSS` `[LSP]`
...
* **[ColorOS Live Lyrics Bridge](https://github.com/Andrea-lyz/ColorOS-Live-Lyrics-Bridge) ⭐ 148 | 🐛 6 | 🌐 Java | 📅 2026-08-23** - Bridges timed lyrics from supported players into the ColorOS/OPlus lock-screen lyric pipeline. `FOSS` `[LSP]`
...
* **[Adaptive Theme: Auto Dark Mode by Ambient Light](https://github.com/xLexip/Adaptive-Theme) ⭐ 195 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-23** - Automatically switches between Light and Dark mode using the ambient light sensor. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=dev.lexip.hecate)
...
* **[DPIS](https://github.com/Kwensiu/DPIS) ⭐ 92 | 🐛 15 | 🌐 Java | 📅 2026-08-23** - LSPosed module for per-app interface scale, smallest width, and font size tuning. `FOSS` `[LSP]`
* **[DarQ Fork](https://github.com/Arora-Sir/DarQ) ⭐ 77 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-12** - Provides a per-app selectable force dark option for Android 10 and above. `FOSS`
* **[Pointer Replacer](https://github.com/thesandipv/pointer_replacer) ⭐ 27 | 🐛 9 | 🌐 Kotlin | 📅 2026-08-23** - Replaces a dot appears when user touch the screen \[Require Show Touches to be enabled in Developer Options]. `FOSS` `[LSP]`
...
* **[⭐ ViPERFX\_RE](https://github.com/likelikeslike/ViPERFX_RE) ⭐ 282 | 🐛 2 | 🌐 C | 📅 2026-08-11** - A fork of ViPER4Android FX with a redesigned UI and additional features. `FOSS` `[M]` `[K]`
...
* **[LibrePods](https://github.com/kavishdevar/librepods) ⭐ 29,551 | 🐛 275 | 🌐 Kotlin | 📅 2026-07-13** - Unlocks Apple's exclusive premium AirPods features on non-Apple devices. `FOSS` `[LSP]` `[M]` `[K]`
...
* **[HuaweiPods](https://github.com/Nshpiter/HuaweiPods) ⭐ 14 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-21** - Huawei audio device integration for Xiaomi HyperOS. `FOSS` `[LSP]`
...
* **[AdGuardHome for Root](https://github.com/twoone-3/AdGuardHomeForRoot/blob/main/README_en.md#adguardhome-for-root) ⭐ 1,364 | 🐛 11 | 🌐 Shell | 📅 2026-07-28** - A module to easily execute AdGuardHome on Android. `FOSS` `[M]`
...
* **[DNS Toggle](https://github.com/ELowry/DNSToggle) ⭐ 98 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-23** - A tiny Android app that allows you to easily toggle your phone's Private DNS through the Quick Settings panel. `FOSS`
...
* **[VPN Hotspot](https://github.com/Mygod/VPNHotspot) ⭐ 6,336 | 🐛 23 | 🌐 Kotlin | 📅 2026-08-23** - Share your VPN connection over hotspot or repeater. `FOSS`
...
* **[Surfing](https://github.com/GitMetaio/Surfing) ⭐ 2,345 | 🐛 79 | 🌐 Shell | 📅 2026-08-23** - Magisk and KernelSU modules for Clash/mihomo, sing-box, v2ray, xray, hysteria services. `FOSS` `[M]` `[K]`
* **[Box4Magisk / KernelSU / APatch](https://github.com/CHIZI-0618/box4magisk) ⭐ 1,893 | 🐛 3 | 🌐 Shell | 📅 2026-04-10** - Deploy multiple proxy cores on Android devices, including clash, mihomo, sing-box, v2ray, xray, and hysteria. `FOSS` `[M]` `[K]`
* **[NetProxy-Magisk](https://github.com/Fanju6/NetProxy-Magisk) ⭐ 1,114 | 🐛 24 | 🌐 Kotlin | 📅 2026-08-23** - Magisk proxy module based on Xray kernel, supports one-click start/stop transparent proxy. `FOSS` `[M]`
* **[VPN Hide](https://github.com/okhsunrog/vpnhide) ⭐ 523 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-22** - Hide active VPN from selected Android apps (kernel module + LSPosed + Zygisk) `FOSS` `[M]` `[K]`
* **[ZDT-D Root Module](https://github.com/GAME-OVER-op/ZDT-D) ⭐ 270 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-22** - Module for traffic routing, DPI bypass, proxy chaining, DNS control, and per-app network management. `FOSS` `[M]` `[K]`
* **[zapret for Magisk](https://github.com/sevcator/zapret-magisk) ⭐ 153 | 🐛 0 | 🌐 Shell | 📅 2026-08-23** - DPI bypass on Android with additional features. `FOSS` `[M]`
...
* **[MagicNet](https://github.com/LIghtJUNction/MagicNet#english-summary) ⭐ 155 | 🐛 0 | 🌐 Shell | 📅 2026-08-23** - Module for device-side traffic governance that enforce network rules below the app layer instead of relying on every app to respect a proxy setting. `FOSS` `[M]` `[K]`
...
* **[Network Switch](https://github.com/aunchagaonkar/NetworkSwitch#installation) ⭐ 435 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-20** - Modern Android app for 4G/5G network mode switching. `FOSS` | [🌱](https://apt.izzysoft.de/packages/com.supernova.networkswitch)
* **[WiFi Password Manager](https://github.com/Khh-vu/wifi-password-manager) ⭐ 282 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-21** - Simple app to manage WiFi passwords. `FOSS` | [🌱](https://apt.izzysoft.de/packages/io.github.wifi_password_manager)
...
* **[NFCGate](https://github.com/nfcgate/nfcgate) ⭐ 2,320 | 🐛 13 | 🌐 Java | 📅 2026-07-20** - Android application meant to capture, analyze, or modify NFC traffic. `FOSS` `[LSP]` | [🌱](https://f-droid.org/packages/de.tu_darmstadt.seemoo.nfcgate/)
...
* **[XposedFakeLocation](https://github.com/noobexon1/XposedFakeLocation) ⭐ 657 | 🐛 8 | 🌐 Kotlin | 📅 2026-08-02** - Allows you to spoof your device's location globally or for specific apps without using "mock location" from the developer options. `FOSS` `[LSP]`
...
* **[HLocation](https://github.com/sparr-sherrya/hlocation-release) ⭐ 45 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-21** - Location spoofing framework that synchronizes fake GPS and related environment signals across system and app processes for more consistent location virtualization. `FOSS` `[LSP]`
...
* **[AnyWhere](https://github.com/cxOrz/AnyWhere) ⭐ 1 | 🐛 0 | 🌐 Java | 📅 2026-08-23** - Location simulation tool for debugging LBS applications and for users to test geolocation functionality. `FOSS` `[LSP]`
...
* **[AsoulOpt](https://github.com/nakixii/Magisk_AsoulOpt) ⭐ 2,657 | 🐛 5 | 🌐 Shell | 📅 2026-08-09** - Game threads tweaker for Android, suitable for mainstream games and some niche games. `FOSS` `[M]`
...
* **[⭐ Termux](https://github.com/termux/termux-app) ⭐ 59,641 | 🐛 592 | 🌐 Java | 📅 2026-07-14** - A terminal emulator application for Android OS extendible by variety of packages. `FOSS` | [🌱](https://f-droid.org/en/packages/com.termux)
* **[aShell You](https://github.com/DP-Hridayan/aShellYou) ⭐ 2,216 | 🐛 37 | 🌐 Kotlin | 📅 2026-08-23** - Android shell utility app with Material Design 3 UI, letting you run ADB, root and shell commands. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/in.hridayan.ashell)
...
* **[Hotspot Wireless Debugging](https://github.com/droserasprout/io.drsr.hotspotadb) ⭐ 13 | 🐛 4 | 🌐 Kotlin | 📅 2026-07-18** - Xposed module to allow Wireless Debugging over Wi-Fi Hotspot. `FOSS` `[LSP]`
...
* **[Shizuku](https://github.com/RikkaApps/Shizuku) ⭐ 29,249 | 🐛 542 | 🌐 Kotlin | 📅 2025-06-18** - Use system APIs directly with ADB/root privileges. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/moe.shizuku.privileged.api) | [▶️](https://play.google.com/store/search?q=shizuku\&c=apps)
* **[⭐ Shizuku Fork](https://github.com/thedjchi/Shizuku) ⭐ 5,236 | 🐛 64 | 🌐 Kotlin | 📅 2026-07-15** - Shizuku for with automatic Shizuku startup, automation, and recovery features. `FOSS`
* **[Shevery](https://github.com/HmnDev-Tech/shevery) ⭐ 829 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-23** - Based on shizuku with Jetpack Compose, Material 3, and compatibility enhancements. `FOSS`
...
* **[⭐ Droidspaces](https://github.com/ravindu644/Droidspaces-OSS) ⭐ 1,747 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-23** - Run full Linux environments on top of Android, with complete init system support. `FOSS`
...
* **[Trixie.apk](https://github.com/DesktopECHO/trixie.apk) ⭐ 52 | 🐛 4 | 🌐 Java | 📅 2025-11-21** - Debian 13 (Trixie) Server/Desktop container for rooted Android 5.0+ devices. `FOSS`
...
* **[USB HID Client](https://github.com/Arian04/android-hid-client) ⭐ 425 | 🐛 18 | 🌐 Kotlin | 📅 2026-08-23** - Use your phone as a keyboard and mouse without any software on the other end. `FOSS` | [🌱](https://apt.izzysoft.de/packages/me.arianb.usb_hid_client)
...
* **[⭐ CleanShare](https://github.com/hxreborn/cleanshare) ⭐ 105 | 🐛 9 | 🌐 Kotlin | 📅 2026-08-01** - Removes Direct Share's suggested contact/conversation shortcuts from Android's Share Sheet. `FOSS` `[LSP]`
...
* **[UotanToolbox NT](https://github.com/Uotan-Dev/UotanToolboxNT) ⭐ 2,671 | 🐛 7 | 🌐 C# | 📅 2026-08-02** - A modern toolbox for Android power users and geeks. `FOSS`
* **[⭐ Essentials](https://github.com/sameerasw/essentials) ⭐ 2,668 | 🐛 90 | 🌐 Kotlin | 📅 2026-08-23** - Multi-purpose tweaks for display, notifications and alerts, security and privacy, sound and haptics, and app freezing. `FOSS`
...
* **[Zygisk Sui](https://github.com/XiaoTong6666/Sui) ⭐ 634 | 🐛 2 | 🌐 Java | 📅 2026-08-22** - Modern superuser interface (SUI) implementation for Android. `FOSS` `[M]` `[K]`
...
| 📂 **GitHub**    | Source, discussions & issues  | [GitHub Repo](https://github.com/awesome-android-root/awesome-android-root) ⭐ 4,379 \| 🐛 1 \| 🌐 Python \| 📅 2026-08-23 |
...
* 🐛 Report [issues](https://github.com/awesome-android-root/awesome-android-root/issues) ⭐ 4,379 | 🐛 1 | 🌐 Python | 📅 2026-08-23
...
**⚡ Built with ❤️ by [Awesome Android Root](https://github.com/awesome-android-root/awesome-android-root) ⭐ 4,379 | 🐛 1 | 🌐 Python | 📅 2026-08-23**
