...
> For privacy-friendly installs, use the F-Droid ecosystem: install [Droid-ify](https://github.com/Droid-ify/client/releases) ⭐ 7,373 | 🐛 191 | 🌐 Kotlin | 📅 2026-09-05 (modern F-Droid client) and enable the [IzzyOnDroid](https://apt.izzysoft.de/fdroid/) repo for many additional packages.
...
| :----------------------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------- |
|       **[Magisk](https://github.com/topjohnwu/Magisk) ⭐ 62,610 \| 🐛 36 \| 🌐 Kotlin \| 📅 2026-09-05** <br><small> `Root & Module Management` </small>      | If you chose Magisk, this is your manager.               |
| **[App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 8,897 \| 🐛 203 \| 🌐 Java \| 📅 2026-09-05** <br><small> `App & Package Management` </small> | Inspect and manage apps with root privileges.            |
...
* **[⭐ Magisk](https://github.com/topjohnwu/Magisk) ⭐ 62,610 | 🐛 36 | 🌐 Kotlin | 📅 2026-09-05** - Manage Magisk modules and root permissions. `FOSS`
* **[⭐ KernelSU](https://github.com/tiann/KernelSU) ⭐ 18,241 | 🐛 71 | 🌐 Kotlin | 📅 2026-09-05** - A Kernel based root solution for Android. `FOSS`
* **[APatch](https://github.com/bmax121/APatch) ⭐ 7,902 | 🐛 47 | 🌐 Kotlin | 📅 2026-09-04** - The patching of Android kernel and Android system. `FOSS` | [🌱](https://f-droid.org/packages/me.bmax.apatch/)
* **[SukiSU-Ultra](https://github.com/SukiSU-Ultra/SukiSU-Ultra) ⭐ 6,214 | 🐛 27 | 🌐 Kotlin | 📅 2026-09-01** - A kernel-based root solution for Android devices, forked from `KernelSU` with some useful changes. `FOSS`
* **[KernelSU-next](https://github.com/KernelSU-Next/KernelSU-Next) ⭐ 4,197 | 🐛 23 | 🌐 Kotlin | 📅 2026-09-05** - An advanced Kernel based root solution for Android. `FOSS`
* **[ReSukiSU](https://github.com/ReSukiSU/ReSukiSU) ⭐ 1,405 | 🐛 9 | 🌐 Kotlin | 📅 2026-09-05** - Fork of SukiSU-Ultra with additional features. `FOSS`
...
* **[⭐ Root My Galaxy](https://github.com/BuSung-dev/Root-My-Galaxy) ⭐ 1,110 | 🐛 461 | 🌐 Kotlin | 📅 2026-09-03** - One-tap temporary root for Snapdragon Galaxy flagships (S24/S25 series, S24 FE, A56...) via GhostLock; bootloader stays locked, Knox isn't tripped. `FOSS`
* **[GhostLock App](https://github.com/YuKongA/ghostlock-app) ⭐ 732 | 🐛 45 | 🌐 C | 📅 2026-09-05** - One-tap execution app for the GhostLock (CVE-2026-43499) exploit. `FOSS`
* **[Root-My-Galaxy-Payloads](https://github.com/BuSung-dev/Root-My-Galaxy-Payloads) ⭐ 379 | 🐛 193 | 🌐 C | 📅 2026-09-03** - Signed device profiles, exploit payloads, and KernelSU artifacts that Root My Galaxy fetches at runtime. `FOSS`
* **[ghostlock-oneplus](https://github.com/JoinChang/ghostlock-oneplus) ⭐ 326 | 🐛 21 | 🌐 C | 📅 2026-09-05** - GhostLock kernel exploit for OnePlus/OPPO/realme (and some Xiaomi) devices with locked bootloader; installs KernelSU with runtime kernel auto-detection. `FOSS`
* **[Root My Pixel](https://github.com/alex193a/Root-My-Pixel) ⭐ 317 | 🐛 18 | 🌐 Kotlin | 📅 2026-09-05** - Jailbreak supported Google Pixel phones with GhostLock; stages the payload via Shizuku, no PC needed. `FOSS`
* **[QuestStack](https://github.com/starseed12345/QuestStack) ⭐ 175 | 🐛 0 | 🌐 C# | 📅 2026-08-28** - Unlocks the Meta Quest 1 bootloader and gains root using GhostLock + CVE-2021-1931. `FOSS`
* **[IonStack-S22U](https://github.com/sarabpal-dev/IonStack-S22U) ⭐ 65 | 🐛 9 | 🌐 C | 📅 2026-09-03** - Full CVE-2026-43499 exploit chain for the Samsung Galaxy S22 Ultra (5.10 kernel). `FOSS`
...
* **[Meta-hybrid\_mount](https://github.com/YuzakiKokuban/meta-hybrid_mount) ⭐ 1,535 | 🐛 2 | 🌐 Rust | 📅 2026-09-04** - Three-engine mount orchestration (OverlayFS + Magic Mount + Kasumi LKM) with conflict monitor, SolidJS WebUI, auto-fallback, and EROFS storage backend support. `FOSS` `[K]` `[A]`
* **[⭐ Mountify](https://github.com/backslashxx/mountify) ⭐ 1,359 | 🐛 23 | 🌐 Shell | 📅 2026-08-25** - OverlayFS with tmpfs/ext4 sparse support for reduced detection, works on APatch/Magisk too. `FOSS` `[M]` `[K]` `[A]`
...
* **[⭐ Meta-overlayfs](https://github.com/KernelSU-Modules-Repo/meta-overlayfs) ⭐ 468 | 🐛 8 | 🌐 Rust | 📅 2025-12-02** - Official reference implementation using OverlayFS for most users and standard setup. `FOSS` `[K]`
* **[ZeroMount](https://github.com/Enginex0/zeromount) ⭐ 125 | 🐛 3 | 🌐 Rust | 📅 2026-04-15** - Mountless module loading with Kernel-level VFS path redirection & SUSFS integration, WebUI, bootloop guard, and strategy fallback. `FOSS` `[M]` `[K]` `[A]`
...
* **[⭐ Vector](https://github.com/JingMatrix/Vector) ⭐ 12,326 | 🐛 20 | 🌐 Kotlin | 📅 2026-09-04** - Open Source *Fork* of original LSPosed with dynamic module loading, and other improvements. `FOSS` `[M]`
...
* **[⭐ Zygisk Next](https://github.com/Dr-TSNG/ZygiskNext) ⭐ 10,547 | 🐛 9 | 🌐 C | 📅 2026-08-27** The "Gold Standard" for detection evasion. It is a standalone Zygisk implementation that offers the most advanced stealth features, including a dedicated **Zygote Monitor** and dashboard. `Proprietary` `[M]` `[K]` `[A]`
* **[ReZygisk](https://github.com/PerformanC/ReZygisk) ⭐ 3,889 | 🐛 9 | 🌐 C | 📅 2026-08-31** A high-performance implementation **entirely rewritten in C**. It introduces **custom linkers** to bypass modern linker-based detections, offering a WebUI for status monitoring and compatibility with Android 15 and 16. `FOSS` `[M]` `[K]` `[A]`
* **[NeoZygisk](https://github.com/JingMatrix/NeoZygisk) ⭐ 2,254 | 🐛 8 | 🌐 C++ | 📅 2026-09-03** A minimalist, high-stealth implementation using **ptrace injection**. It focuses on "trace cleaning," aiming to remove all injection artifacts from memory once modules are loaded. `FOSS` `[M]` `[K]` `[A]`
...
* **[RENE](https://github.com/rrr333nnn333/BRENE) ⭐ 343 | 🐛 6 | 🌐 Shell | 📅 2026-09-05** - SUSFS/KernelSU module for patched kernels with enhanced root hiding & spoofing. `FOSS` `[M]` `[K]`
* **[ReSuSFS](https://github.com/ahmed-alnassif/ReSuSFS) ⭐ 15 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-05** - SUSFS/KernelSU module for patched kernels with modern ui and configuration options. `FOSS` `[M]` `[K]`
...
* **[TrickyStore](https://github.com/5ec1cff/TrickyStore) ⭐ 6,325 | 🐛 4 | 📅 2025-11-30** - Modifies the certificate chain for Android key attestation (keybox-based). The original/reference module. `Proprietary` `[M]` `[K]`
* **[Hide My Applist](https://github.com/Dr-TSNG/Hide-My-Applist) ⭐ 5,579 | 🐛 13 | 🌐 Kotlin | 📅 2026-08-01** - Intercepts app-list detection. `Proprietary` `[LSP]`
* **[Play Integrity Fork (PIF)](https://github.com/osm0sis/PlayIntegrityFork) ⭐ 4,453 | 🐛 0 | 🌐 C++ | 📅 2026-08-29** - The most actively maintained PIF. Fixes `DEVICE_INTEGRITY` verdicts with custom fields/props. Recommended starting point after chiteroman's original was discontinued. `FOSS` `[M]`
* **[Play Integrity Fix (inject)](https://github.com/KOWX712/PlayIntegrityFix) ⭐ 3,828 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-01** - Actively maintained fork using injected GMS/Play Store spoofing with a WebUI. `FOSS` `[M]`
* **[Tricky Addon – Update Target List](https://github.com/KOWX712/Tricky-Addon-Update-Target-List) ⭐ 3,424 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-30** - KSU WebUI to configure TrickyStore's `target.txt`. `FOSS` `[K]`
* **[⭐ HMA-OSS](https://github.com/frknkrc44/HMA-OSS) ⭐ 3,061 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-05** - FOSS rewrite of Hide My Applist; hides your app list, settings, and package installers. `FOSS` `[LSP]`
...
* **[⭐ TEESimulator](https://github.com/JingMatrix/TEESimulator) ⭐ 2,366 | 🐛 12 | 🌐 C++ | 📅 2026-09-05** - Create a complete, software-based simulation of a hardware-backed Trusted Execution Environment (TEE) for Key Attestation. `FOSS` `[M]` `[K]`
* **[YuriKey](https://github.com/dpejoh/yurikey) ⭐ 1,884 | 🐛 9 | 🌐 Shell | 📅 2026-08-01** - Systemless module to obtain strong integrity easily. `FOSS` `[M]` `[K]`
* **[TEESimulator-RS](https://github.com/Enginex0/TEESimulator-RS) ⭐ 1,722 | 🐛 24 | 🌐 Kotlin | 📅 2026-07-11** - Fork of TEESimulator with native Rust certificate generation, key persistence, and AOSP-compliant attestation behavior. `FOSS` `[M]` `[K]`
* **[TrickyStore OSS](https://github.com/beakthoven/TrickyStoreOSS) ⭐ 1,356 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-02** - Open-source alternative to TrickyStore. `FOSS` `[M]` `[K]`
...
* **[Specter](https://github.com/dpejoh/specter) ⭐ 590 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-04** - Unified Play Integrity and root hiding stack for Android. Successor of Yurikey. `FOSS` `[M]` `[K]`
* **[Always Strong](https://github.com/evoker0/AlwaysStrong) ⭐ 466 | 🐛 1 | 🌐 Shell | 📅 2026-08-25** - Bundles TEESimulator-RS and PlayIntegrityFork into a single module for strong integrity on rooted devices. `FOSS` `[M]` `[K]`
...
* **[OhMyKeymint](https://github.com/qwq233/OhMyKeymint) ⭐ 327 | 🐛 3 | 🌐 Rust | 📅 2026-08-27** - Custom keystore implementation for Android Keystore Spoofer. `FOSS` `[M]` `[K]`
* **[ReZygisk's Treat Wheel](https://github.com/PerformanC/Treat-Wheel-Zygisk) ⭐ 262 | 🐛 8 | 🌐 C | 📅 2026-07-22** - Hides Magisk/root traces exclusively for ReZygisk, acting as the best userspace root hiding tool. `FOSS` `[M]` `[K]`
...
* **[Duck Detector](https://github.com/eltavine/Duck-Detector-Refactoring) ⭐ 962 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-28** - Android environment integrity inspection tool for root, hook, bootloader, SELinux, virtualization, and attestation signals. `FOSS`
* **[Play Integrity API Checker](https://github.com/1nikolas/play-integrity-checker-app) ⭐ 814 | 🐛 8 | 🌐 Java | 📅 2025-08-19** - This app shows info about your device integrity as reported by Google Play Services. If any of this fails could mean your device is rooted or tampered in a way. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=gr.nikolasspyr.integritycheck)
* **[Chunqiu Detector](https://github.com/mingzun09/Chunqiu-Detector-Problem-solution) ⭐ 382 | 🐛 1 | 🌐 HTML | 📅 2026-09-05** - Solutions, scripts, and modules for bypassing and troubleshooting Chunqiu Detector checks on rooted Android devices. `FOSS`
...
* **[SystemUI Tuner](https://github.com/zacharee/Tweaker?tab=readme-ov-file) ⭐ 1,724 | 🐛 67 | 🌐 Kotlin | 📅 2026-08-27** - View and modify hidden settings on Android devices. `FOSS` `[M]`
* **[PIXELIFY NEXT](https://github.com/BasGame1/Pixelify-Next) ⭐ 310 | 🐛 3 | 🌐 Shell | 📅 2026-08-26** - A Magisk Module which enables Pixel UI and some exclusive features. `FOSS` `[M]`
...
* **[LuckyTool](https://github.com/Xposed-Modules-Repo/com.luckyzyx.luckytool/blob/main/README_EN.md) ⭐ 1,896 | 🐛 8 | 📅 2026-04-26** - Extended functionality and optimization module for ColorOS. `Proprietary` `[LSP]`
* **[OShin](https://github.com/suqi8/OShin/blob/master/README_EN.md) ⭐ 1,191 | 🐛 112 | 🌐 Kotlin | 📅 2026-07-28** - Auxiliary module deeply integrated with ColorOS, designed to enhance and optimize your operating system experience. `FOSS` `[LSP]`
...
* **[⭐ HyperCeiler](https://github.com/ReChronoRain/HyperCeiler/blob/main/README_en-US.md) ⭐ 5,338 | 🐛 239 | 🌐 Java | 📅 2026-09-01** - Extensive customizations for HyperOS. `FOSS` `[LSP]`
...
* **[⭐ KnoxPatch](https://github.com/salvogiangri/KnoxPatch) ⭐ 1,502 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-25** - Get Samsung apps/features working again in your rooted Galaxy device. For better experience, please also [read this ↗](https://github.com/salvogiangri/KnoxPatch?tab=readme-ov-file#knoxpatch-enhancer) ⭐ 1,502 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-25 . `FOSS` `[LSP]`
...
* **[Samsung Dex Standalone Mode](https://github.com/supermarsx/magisk-samsung-dex-standalone-mode) ⭐ 70 | 🐛 0 | 🌐 Shell | 📅 2026-06-30** - Systemlessly enable Samsung DeX standalone mode. `FOSS` `[M]`
...
* **[Oxygen-Customizer](https://github.com/DHD2280/Oxygen-Customizer/) ⭐ 456 | 🐛 34 | 🌐 Java | 📅 2026-08-30** - Open-source Oxygen OS customizer application. `FOSS` `[LSP]`
...
* **[Live Boot Module](https://github.com/symbuzzer/livebootmodule) ⭐ 442 | 🐛 8 | 🌐 Shell | 📅 2026-09-03** - Enables unix-style (verbose) boot animation for Android devices. `FOSS` `[M]` `[K]`
...
* **[⭐ Canta](https://github.com/samolego/Canta) ⭐ 5,778 | 🐛 30 | 🌐 Kotlin | 📅 2026-09-04** - Uninstall any app without root using [Shizuku](#developer-tools). `FOSS` | [🌱](https://f-droid.org/en/packages/io.github.samolego.canta/) | [▶️](https://play.google.com/store/apps/details?id=io.github.samolego.canta)
...
* **[⭐ App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 8,897 | 🐛 203 | 🌐 Java | 📅 2026-09-05** - A full-featured package manager and viewer for Android. `FOSS` | [🌱](https://f-droid.org/packages/io.github.muntashirakon.AppManager/)
* **[⭐ Droid-ify](https://github.com/Droid-ify/client) ⭐ 7,373 | 🐛 191 | 🌐 Kotlin | 📅 2026-09-05** - F-Droid client with Material UI and auto updating apps using root. `FOSS` | [🌱](https://f-droid.org/packages/com.looker.droidify)
* **[⭐ Hail](https://github.com/aistra0528/Hail) ⭐ 6,604 | 🐛 168 | 🌐 Kotlin | 📅 2026-08-29** - Disable / Hide / Suspend / Uninstall Android apps. `FOSS` | [🌱](https://f-droid.org/packages/com.aistra.hail/)
* **[InstallerX-Revived](https://github.com/wxxsfxyzm/InstallerX-Revived) ⭐ 6,490 | 🐛 20 | 🌐 Kotlin | 📅 2026-09-05** - A modern and functional Android app installer. `FOSS` `[LSP]`
* **[Neo Store](https://github.com/NeoApplications/Neo-Store) ⭐ 4,971 | 🐛 121 | 🌐 Kotlin | 📅 2026-09-04** - An F-Droid client with modern UI and an arsenal of extra features. `FOSS` | [🌱](https://f-droid.org/packages/com.machiav3lli.fdroid)
* **[Aurora Store](https://github.com/whyorean/AuroraStore) ⭐ 2,946 | 🐛 26 | 🌐 Kotlin | 📅 2026-08-24** - A Google Play Store client to search, view app details, and download APKs directly to your device. `FOSS` | [🌱](https://f-droid.org/packages/com.aurora.store/)
...
* **[Universal Installer](https://github.com/pass-with-high-score/universal-installer) ⭐ 1,372 | 🐛 8 | 🌐 Kotlin | 📅 2026-09-05** - Install and manage APK packages with split APK support. `FOSS` `[LSP]`
* **[InxLocker](https://github.com/Chimioo/InxLocker) ⭐ 900 | 🐛 2 | 🌐 Kotlin | 📅 2026-06-11** - Intercepts/forwards Android system application installation and uninstallation requests, redirecting them to your specified installer app. `FOSS` `[LSP]`
...
* **[Thor](https://github.com/trinadhthatakula/Thor) ⭐ 537 | 🐛 13 | 🌐 Kotlin | 📅 2026-09-05** - Android App Manager and App Installer utility. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/com.valhalla.thor) | [▶️](https://play.google.com/store/apps/details?id=com.valhalla.thor)
...
* **[PermissionManagerX](https://github.com/mirfatif/PermissionManagerX) ⭐ 767 | 🐛 7 | 🌐 HTML | 📅 2026-09-03** - eXtended Permission Manager for Android to view and set Manifest Permissions and AppOps. `FOSS` | [🌱](https://f-droid.org/packages/com.mirfatif.permissionmanagerx) | [▶️](https://play.google.com/store/apps/details?id=com.mirfatif.permissionmanagerx)
...
* **[COPG](https://github.com/AlirezaParsi/COPG) ⭐ 380 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-03** - Spoof your device to enjoy premium features, max performance, and exclusive benefits. `FOSS` `[M]`
...
* **[KonaBess Next](https://github.com/KonaBess-Next/KonaBess-Next) ⭐ 223 | 🐛 23 | 🌐 Kotlin | 📅 2026-08-06** - Fork of KonaBess, Custom GPU overclocking and undervolting tool with granulated voltage for rooted Snapdragon Android devices. `FOSS`
...
* **[Kernel Enhancer](https://github.com/RAAJK20Pro/KernelEnhancer) ⭐ 39 | 🐛 1 | 📅 2026-06-18** - A Simple Kernel Parameters Optimization for all devices. `Proprietary` `[M]`
...
* **[Plus Plus Battery](https://github.com/dijia1124/plusplusbattery) ⭐ 470 | 🐛 16 | 🌐 Kotlin | 📅 2026-02-22** - Real-time battery stats & health estimator for OnePlus/Oppo/Realme phones. `FOSS` | [🌱](https://f-droid.org/en/packages/com.dijia1124.plusplusbattery/)
...
* **[⭐ FROSTY](https://github.com/Drsexo/Frosty) ⭐ 220 | 🐛 3 | 🌐 Shell | 📅 2026-09-03** - Optimizes battery life by selectively freezing Google Mobile Services (GMS) components and applying system-wide doze enhancements. `FOSS` `[M]` `[K]`
...
* **[BatStats](https://github.com/mlm-games/BatStats) ⭐ 179 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-01** - Battery monitor with stats via Shizuku/root. `FOSS`
...
* **[Shappky](https://github.com/YasserNull/shappky) ⭐ 553 | 🐛 22 | 🌐 Kotlin | 📅 2026-08-25** - A simple app to boost performance by stopping background apps, relying on Root/Shizuku permissions. `FOSS` `[M]`
...
* **[BlockAds](https://github.com/pass-with-high-score/blockads-android) ⭐ 1,950 | 🐛 64 | 🌐 Kotlin | 📅 2026-09-05** - System‑wide ad, tracker, & malware filtering, custom blocklists, per‑app controls etc. `FOSS` | [🌱](https://f-droid.org/packages/app.pwhs.blockads)
...
* **[Magisk Ad Blocking Module](https://github.com/pantsufan/Magisk-Ad-Blocking-Module) ⭐ 570 | 🐛 19 | 📅 2026-09-05** - Block ads on android. `FOSS` `[M]`
...
* **[Re-Malwack](https://github.com/ZG089/Re-Malwack) ⭐ 447 | 🐛 3 | 🌐 C | 📅 2026-08-16** - A fully-fledged ad-block module. Contains all your needs. `FOSS` `[M]`
...
* **[PCAPdroid](https://github.com/emanuele-f/PCAPdroid#pcapdroid) ⭐ 4,662 | 🐛 46 | 🌐 Java | 📅 2026-08-30** - Lets you track, analyze and block the connections made by the other apps in your device. `FOSS` | [🌱](https://f-droid.org/packages/com.emanuelef.remote_capture) | [▶️](https://play.google.com/store/apps/details?id=com.emanuelef.remote_capture)
* **[NetGuard](https://github.com/M66B/NetGuard) ⭐ 3,864 | 🐛 1 | 🌐 Java | 📅 2026-08-01** - Block access to the internet. Apps and addresses can individually be allowed or denied access to your Wi-Fi and/or mobile connection. `FOSS`
* **[AFWall+](https://github.com/ukanth/afwall) ⭐ 3,464 | 🐛 220 | 🌐 Java | 📅 2026-08-06** - Iptables-based firewall. `FOSS` | [🌱](https://f-droid.org/packages/dev.ukanth.ufirewall/) | [▶️](https://play.google.com/store/apps/details?id=dev.ukanth.ufirewall)
* **[ShizuWall](https://github.com/AhmetCanArslan/ShizuWall) ⭐ 2,217 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-05** - Android firewall without VPN powered by Shizuku / local ADB daemon / Root. `FOSS` | [🌱](https://f-droid.org/packages/com.arslan.shizuwall/) | [▶️](https://play.google.com/store/apps/details?id=com.arslan.shizuwall)
...
* **[De1984 Firewall](https://github.com/dorumrr/de1984) ⭐ 408 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-04** - A privacy-focused Firewall and Package Manager for Android devices. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/io.github.dorumrr.de1984)
...
* **[⭐ Amarok](https://github.com/deltazefiro/Amarok-Hider) ⭐ 3,231 | 🐛 62 | 🌐 Java | 📅 2026-08-11** - Android application which enables you to hide your private files and apps with a single click. `FOSS` | [🌱](https://f-droid.org/zh_Hans/packages/deltazero.amarok.foss/)
...
* **[FuseFixer](https://github.com/5ec1cff/FuseFixer) ⭐ 404 | 🐛 1 | 🌐 C | 📅 2026-04-14** - Hooks the MediaProvider Fuse Daemon to stop apps probing package existence through `Android/data` directory quirks (Unicode casefold tricks). `FOSS` `[LSP]`
* **[PrivacyFlip](https://github.com/dorumrr/privacyflip) ⭐ 280 | 🐛 13 | 🌐 Kotlin | 📅 2026-01-22** - Automatically disables/enables Wi-Fi, Bluetooth, mobile data, location services, NFC, and even camera/microphone sensors based on lock/unlock state. `FOSS` | [🌱](https://f-droid.org/packages/io.github.dorumrr.privacyflip/)
* **[FuseHide](https://github.com/XiaoTong6666/FuseHide) ⭐ 266 | 🐛 6 | 🌐 C++ | 📅 2026-09-04** - Hides chosen storage paths from MediaProvider on Android 12+ at runtime, and debugs/fixes `Android/data` Unicode casefold scenarios. `FOSS` `[LSP]`
...
* **[StrykerOSS](https://github.com/zalexdev/strykerapp) ⭐ 1,502 | 🐛 24 | 🌐 Java | 📅 2026-09-05** - Bundles a curated set of network, wireless and web security tools into a single rooted-Android application for penetration testing. `FOSS`
* **[⭐ Enable Screenshot](https://github.com/LSPosed/DisableFlagSecure) ⭐ 1,311 | 🐛 7 | 🌐 Java | 📅 2026-09-01** - Enabling screenshots in apps that normally wouldn't allow it, and disabling screenshot(Android 14+) and screen record(Android 15+) detection. `FOSS` `[LSP]`
...
* **[TapDucky](https://github.com/iodn/tap-ducky) ⭐ 164 | 🐛 8 | 🌐 Dart | 📅 2026-05-17** - Open-source DuckyScript runner for rooted Android with USB Gadget (ConfigFS) support. `FOSS`  | [🌱](https://f-droid.org/en/packages/org.kaijinlab.tap_ducky/)
...
* **[Device Faker](https://github.com/Seyud/device_faker/) ⭐ 743 | 🐛 1 | 🌐 Vue | 📅 2026-09-04** - A device model spoofing module based on Zygisk that can configure different device models for different applications. `FOSS` `[M]` `[K]`
* **[DeviceID/SSAID Changer](https://github.com/sidex15/deviceidchanger) ⭐ 271 | 🐛 4 | 🌐 HTML | 📅 2025-12-19** - A simple WebUI Module to change SSAID/DeviceID on Rooted Android Devices with Apatch, KSU (And its forks), or Magisk. `FOSS` `[M]` `[K]`
...
* **[SpoofMyDevice](https://github.com/BuSung-dev/SpoofMyDevice) ⭐ 136 | 🐛 10 | 🌐 Java | 📅 2026-07-19** - Xposed module and companion app for building, saving, and applying spoofed Android device profiles to selected apps. `FOSS` `[LSP]`
* **[HideMyAndroid](https://github.com/Xposed-Modules-Repo/com.wowsoftware.hidemyandroid/) ⭐ 95 | 🐛 0 | 📅 2026-09-04** - Android anti-detect module with profile isolation and spoofing. `Proprietary` `[LSP]`
...
* **[Privacy Kit](https://github.com/Xposed-Modules-Repo/com.sal.privacykit) ⭐ 29 | 🐛 0 | 📅 2026-09-05** - Per-app Android identifier spoofing for LSPosed. `Proprietary` `[LSP]`
...
* **[Deekseep](https://github.com/lllucccian/Deekseep) ⭐ 281 | 🐛 3 | 🌐 Java | 📅 2026-08-28** - Adds account, chat, image, interface, and local API tools to the official DeepSeek Android app. `FOSS` `[LSP]`
* **[Spotify Plus](https://github.com/LeNerd46/SpotifyPlus) ⭐ 223 | 🐛 11 | 🌐 Java | 📅 2026-08-31** - Adds beautiful lyrics to Spotify. `FOSS` `[LSP]`
...
* **[Nexus](https://github.com/niki914/agentic-nexus) ⭐ 139 | 🐛 28 | 🌐 Kotlin | 📅 2026-09-05** - Plug your own model into your phone's voice assistant. `Proprietary` `[LSP]`
...
* **[Spicy EX](https://github.com/amarinne/spicy-ex) ⭐ 24 | 🐛 1 | 🌐 Java | 📅 2026-09-04** - Adds Spicy lyrics in Spotify along with translation and much more UI features. `FOSS` `[LSP]`
...
* **[BBZQ](https://github.com/HSSkyBoy/BBZQ) ⭐ 435 | 🐛 16 | 🌐 Kotlin | 📅 2026-09-02** - Removes unnecessary content, optimizes the core experience, and provide various practical functions. `FOSS` `[LSP]`
...
* **[InstaEclipse](https://github.com/ReSo7200/InstaEclipse/) ⭐ 1,424 | 🐛 21 | 🌐 Java | 📅 2026-07-24** - Adds Features like Developer Options, Ghost Mode, Ad-Free browsing, and Distraction-Free Mode to Instagram. `FOSS` `[LSP]`
...
* **[QAuxiliary](https://github.com/cinit/QAuxiliary) ⭐ 5,731 | 🐛 270 | 🌐 Java | 📅 2026-09-04** - Xposed module based on QNotified. `FOSS` `[LSP]`
...
* **[TCQT Module](https://github.com/callng/TCQT) ⭐ 232 | 🐛 4 | 🌐 Kotlin | 📅 2026-09-04** - An Xposed module designed for Android QQ/TIM clients, which is used to intercept and retain messages that would otherwise be "retracted". `FOSS` `[LSP]`
...
* **[Morphe Reddit Patches](https://github.com/MorpheApp/morphe-patches#-patches-list) ⭐ 3,524 | 🐛 475 | 🌐 Java | 📅 2026-09-05** - Various patches for reddit. `FOSS`
* **[Patcheddit](https://github.com/wchill/patcheddit) ⭐ 784 | 🐛 49 | 🌐 Kotlin | 📅 2026-05-03** - Custom patches with features like view: deleted Reddit posts & comments,Banned subreddits etc. `FOSS`
...
* **[Telegami](https://github.com/aoya111/Telegami) ⭐ 230 | 🐛 36 | 🌐 Kotlin | 📅 2026-09-04** - Various tweaks for Telegram. `FOSS` `[LSP]`
...
* **[GramSieve](https://github.com/Xposed-Modules-Repo/com.tianqianguai.gramsieve) ⭐ 28 | 🐛 0 | 🌐 Java | 📅 2026-09-03** - Message filtering, host-settings integration, anti-recall, anti-edit/edit interception etc. `Proprietary` `[LSP]`

#### TikTok

* **[Douyin Enhancer](https://github.com/twyora/DouyinEnhancer) ⭐ 108 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-05** - Adds minor quality-of-life features to Douyin (Chinese TikTok). `FOSS` `[LSP]`
...
* **[MaskWechat](https://github.com/Mingyueyixi/MaskWechat) ⭐ 513 | 🐛 34 | 🌐 Kotlin | 📅 2025-06-21** - Hide the chat records of specific users to prevent private chats from being peeked by third parties. `FOSS` `[LSP]`
...
* **[⭐ WA Enhancer](https://github.com/Dev4Mod/WaEnhancer) ⭐ 1,684 | 🐛 248 | 🌐 Kotlin | 📅 2026-09-01** - Enhances your WhatsApp experience. `FOSS` `[LSP]`
* **[WA Enhancer X](https://github.com/Xposed-Modules-Repo/com.waenhancer) ⭐ 36 | 🐛 0 | 📅 2026-09-05** - Fork of WA Enhancer with additional features. `Proprietary` `[LSP]`
...
* **[⭐ Piko Patches](https://github.com/crimera/piko) ⭐ 5,115 | 🐛 237 | 🌐 Java | 📅 2026-09-05** - Morphe patches for twitter with features like hide promoted tweets, hide promoted accounts, hide promoted trends, hide "who to follow" etc. `FOSS`
* **[Re:X](https://github.com/Xposed-Modules-Repo/one.dot.rex) ⭐ 185 | 🐛 0 | 📅 2026-08-30** -  Tweaks for the new X / Twitter app. `Proprietary` `[LSP]`
...
* **[BetterVia](https://github.com/JiGuroLGC/BetterVia) ⭐ 1,287 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-25** - Bypass whitelist restrictions, Screenshot protection, Block components, One-tap theme switching etc. `FOSS` `[LSP]`
...
* **[EdgeX](https://github.com/SoClear/EdgeX) ⭐ 145 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-01** - An Xposed module for Microsoft Edge on Android, designed to enhance your browsing experience with UI tweaks and functional improvements. `FOSS` `[LSP]`
...
* **[Fxxk-MiBrowser](https://github.com/DuhMatt/Fxxk-MiBrowser) ⭐ 31 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-05** - Redirects forced Xiaomi Browser links to the system default browser. `FOSS` `[LSP]`

### YouTube & Media Mods

* **[NexAlloy](https://github.com/NexAlloy/NexAlloy) ⭐ 2,936 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-04** - YouTube, YT Music block ads, background playback, sponsorblock and much more. Also unlocks premium features of Strava and Photomath. Unlimited Google Photos backup. `FOSS` `[LSP]`
...
* **[⭐ Core Patch N](https://github.com/LSPosed/CorePatch) ⭐ 3,325 | 🐛 10 | 🌐 Kotlin | 📅 2026-07-26** - Disable signature verification For Android. `FOSS` `[LSP]`
...
* **[Material Files](https://github.com/zhanghai/MaterialFiles) ⭐ 8,872 | 🐛 628 | 🌐 Kotlin | 📅 2026-04-06** - Modern file manager with root capabilities. `FOSS` | [🌱](https://f-droid.org/packages/me.zhanghai.android.files)| [▶️](https://play.google.com/store/apps/details?id=me.zhanghai.android.files)
...
* **[Fossify File Manager](https://github.com/FossifyOrg/File-Manager) ⭐ 1,740 | 🐛 96 | 🌐 Kotlin | 📅 2026-09-01** - Easy app for managing your files without ads, respecting your privacy and security. `FOSS` | [🌱](https://f-droid.org/packages/org.fossify.filemanager/) | [▶️](https://play.google.com/store/apps/details?id=org.fossify.filemanager)
...
* **[DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,312 | 🐛 190 | 🌐 Kotlin | 📅 2026-09-05** - DataBackup for Android 7.0+. `FOSS` | [🌱](https://f-droid.org/zh_Hans/packages/com.xayah.databackup.foss/)
...
* **[⭐ SD Maid 2/SE](https://github.com/d4rken-org/sdmaid-se) ⭐ 7,461 | 🐛 15 | 🌐 Kotlin | 📅 2026-09-05** - A file management tool for Android that specializes in maintenance. Its core purpose is freeing up space and removing unwanted data. `FOSS` | [🌱](https://f-droid.org/en/packages/eu.darken.sdmse/) | [▶️](https://play.google.com/store/apps/details?id=eu.darken.sdmse)
...
* **[CZero](https://github.com/Xocio/CZero) ⭐ 51 | 🐛 1 | 📅 2026-09-05** - Cleans the cache of frequently used apps, and adds background suppression, empty-folder cleanup, and F2FS garbage collection. `FOSS` `[M]` `[K]`
...
* **[Iconify](https://github.com/Mahmud0808/Iconify) ⭐ 3,157 | 🐛 99 | 🌐 Kotlin | 📅 2026-08-30** - Customize your Android 12+ device easily. `FOSS` `[M]`
...
* **[HyperLight](https://github.com/KiminonawaResa/HyperLight#english) ⭐ 723 | 🐛 45 | 📅 2026-08-25** - Completes the highlight blur effects for HyperOS 3, bringing a unified visual experience to the desktop, notification shade, and control center. `FOSS` `[LSP]`
* **[Global Icon Pack](https://github.com/RichardLuo0/global-icon-pack-android) ⭐ 410 | 🐛 6 | 🌐 Kotlin | 📅 2026-09-05** - Apply icon packs globally. `FOSS` `[LSP]`
...
* **[Pixel Launcher Enhanced](https://github.com/Mahmud0808/PixelLauncherEnhanced) ⭐ 524 | 🐛 22 | 🌐 Kotlin | 📅 2026-08-02** - Unlock a variety of exciting features including customizing the look to adding more functionality and many more. `FOSS` `[LSP]`
...
* **[Lyricon](https://github.com/tomakino/lyricon) ⭐ 744 | 🐛 38 | 🌐 Kotlin | 📅 2026-08-30** - An Android status bar lyric enhancement tool based on the Xposed framework. `FOSS` `[LSP]`
* **[LyricProvider](https://github.com/tomakino/LyricProvider/tree/master) ⭐ 376 | 🐛 45 | 🌐 Kotlin | 📅 2026-08-26** - A lyric provider for Lyricon. `FOSS` `[LSP]`
...
* **[MakeFontsGreatAgain](https://github.com/Numbersf/MakeFontsGreatAgain) ⭐ 306 | 🐛 10 | 🌐 C | 📅 2026-09-03** - System-wide Font Overrider with Unique GMS Masking & Multi-Range Unicode Filter. `FOSS` `[M]` `[K]`
...
* **[HyperIsland](https://github.com/1812z/HyperIsland/blob/main/README_EN.md) ⭐ 482 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-04** - Dynamic Island-style notifications for HyperOS 3, powered by LSPosed. `FOSS` `[LSP]`
...
* **[ColorOS Live Lyrics Bridge](https://github.com/Andrea-lyz/ColorOS-Live-Lyrics-Bridge) ⭐ 165 | 🐛 7 | 🌐 Java | 📅 2026-09-01** - Bridges timed lyrics from supported players into the ColorOS/OPlus lock-screen lyric pipeline. `FOSS` `[LSP]`
...
* **[DPIS](https://github.com/Kwensiu/DPIS) ⭐ 96 | 🐛 16 | 🌐 Java | 📅 2026-09-05** - LSPosed module for per-app interface scale, smallest width, and font size tuning. `FOSS` `[LSP]`
...
* **[⭐ ViPERFX\_RE](https://github.com/likelikeslike/ViPERFX_RE) ⭐ 305 | 🐛 3 | 🌐 C | 📅 2026-08-11** - A fork of ViPER4Android FX with a redesigned UI and additional features. `FOSS` `[M]` `[K]`
...
* **[LibrePods](https://github.com/kavishdevar/librepods) ⭐ 29,716 | 🐛 280 | 🌐 Kotlin | 📅 2026-09-01** - Unlocks Apple's exclusive premium AirPods features on non-Apple devices. `FOSS` `[LSP]` `[M]` `[K]`
...
* **[SonyPods](https://github.com/Mercury000/SonyPods) ⭐ 28 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-05** - System-level Sony headphone control for HyperOS devices. `FOSS` `[LSP]`
* **[HuaweiPods](https://github.com/Nshpiter/HuaweiPods) ⭐ 17 | 🐛 4 | 🌐 Kotlin | 📅 2026-09-02** - Huawei audio device integration for Xiaomi HyperOS. `FOSS` `[LSP]`
...
* **[AdGuardHome for Root](https://github.com/twoone-3/AdGuardHomeForRoot/blob/main/README_en.md#adguardhome-for-root) ⭐ 1,385 | 🐛 11 | 🌐 Shell | 📅 2026-08-25** - A module to easily execute AdGuardHome on Android. `FOSS` `[M]`
...
* **[DNS Toggle](https://github.com/ELowry/DNSToggle) ⭐ 108 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-04** - A tiny Android app that allows you to easily toggle your phone's Private DNS through the Quick Settings panel. `FOSS`
...
* **[FlClash](https://github.com/chen08209/FlClash) ⭐ 51,004 | 🐛 516 | 🌐 Dart | 📅 2026-09-05** - A multi-platform proxy client based on ClashMeta, simple and easy to use, open-source and ad-free. `FOSS`
* **[VPN Hotspot](https://github.com/Mygod/VPNHotspot) ⭐ 6,404 | 🐛 24 | 🌐 Kotlin | 📅 2026-09-04** - Share your VPN connection over hotspot or repeater. `FOSS`
* **[Box for Root](https://github.com/taamarin/box_for_magisk) ⭐ 2,511 | 🐛 85 | 🌐 Shell | 📅 2025-10-21** - Box for Root (BFR) is a Magisk, KernelSU, APatch, module that provides a suite of proxy tools, including clash, sing-box, v2ray, hysteria and xray. It allows you to configure a transparent proxy on Android devices with root access. `FOSS` `[M]` `[K]`
* **[Surfing](https://github.com/GitMetaio/Surfing) ⭐ 2,379 | 🐛 80 | 🌐 Shell | 📅 2026-09-05** - Magisk and KernelSU modules for Clash/mihomo, sing-box, v2ray, xray, hysteria services. `FOSS` `[M]` `[K]`
...
* **[NetProxy-Magisk](https://github.com/Fanju6/NetProxy-Magisk) ⭐ 1,166 | 🐛 25 | 🌐 Go | 📅 2026-09-05** - Magisk proxy module based on Xray kernel, supports one-click start/stop transparent proxy. `FOSS` `[M]`
* **[VPN Hide](https://github.com/okhsunrog/vpnhide) ⭐ 539 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-26** - Hide active VPN from selected Android apps (kernel module + LSPosed + Zygisk) `FOSS` `[M]` `[K]`
...
* **[MagicNet](https://github.com/LIghtJUNction/MagicNet#english-summary) ⭐ 162 | 🐛 1 | 🌐 Shell | 📅 2026-09-05** - Module for device-side traffic governance that enforce network rules below the app layer instead of relying on every app to respect a proxy setting. `FOSS` `[M]` `[K]`
...
* **[NFCGate](https://github.com/nfcgate/nfcgate) ⭐ 2,354 | 🐛 12 | 🌐 Java | 📅 2026-07-20** - Android application meant to capture, analyze, or modify NFC traffic. `FOSS` `[LSP]` | [🌱](https://f-droid.org/packages/de.tu_darmstadt.seemoo.nfcgate/)
* **[onHit](https://github.com/0penPublic/onHit) ⭐ 83 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-04** - Trigger Android NFC events without a physical tag by Xposed. `FOSS` `[LSP]`
...
* **[HLocation](https://github.com/sparr-sherrya/hlocation-release) ⭐ 60 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-05** - Location spoofing framework that synchronizes fake GPS and related environment signals across system and app processes for more consistent location virtualization. `FOSS` `[LSP]`
...
* **[AnyWhere](https://github.com/cxOrz/AnyWhere) ⭐ 23 | 🐛 0 | 🌐 Java | 📅 2026-09-02** - Location simulation tool for debugging LBS applications and for users to test geolocation functionality. `FOSS` `[LSP]`
...
* **[Uperf-Game-Turbo](https://github.com/yinwanxi/Uperf-Game-Turbo) ⭐ 1,534 | 🐛 0 | 🌐 Shell | 📅 2026-07-31** - Userspace performance controller for Android. `FOSS` `[M]`
...
* **[⭐ Termux](https://github.com/termux/termux-app) ⭐ 60,377 | 🐛 606 | 🌐 Java | 📅 2026-08-24** - A terminal emulator application for Android OS extendible by variety of packages. `FOSS` | [🌱](https://f-droid.org/en/packages/com.termux)
* **[aShell You](https://github.com/DP-Hridayan/aShellYou) ⭐ 2,297 | 🐛 35 | 🌐 Kotlin | 📅 2026-09-05** - Android shell utility app with Material Design 3 UI, letting you run ADB, root and shell commands. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/in.hridayan.ashell)
...
* **[Shizuku](https://github.com/RikkaApps/Shizuku) ⭐ 29,782 | 🐛 566 | 🌐 Kotlin | 📅 2025-06-18** - Use system APIs directly with ADB/root privileges. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/moe.shizuku.privileged.api) | [▶️](https://play.google.com/store/search?q=shizuku\&c=apps)
* **[⭐ Shizuku Fork](https://github.com/thedjchi/Shizuku) ⭐ 5,546 | 🐛 70 | 🌐 Kotlin | 📅 2026-07-15** - Shizuku fork with automatic Shizuku startup, automation, and recovery features. `FOSS`
* **[Shevery](https://github.com/HmnDev-Tech/shevery) ⭐ 971 | 🐛 13 | 🌐 Kotlin | 📅 2026-09-05** - Based on shizuku with Jetpack Compose, Material 3, and compatibility enhancements. `FOSS`
...
* **[SideWire](https://github.com/mzggr0914/SideWire-KernelSU) ⭐ 18 | 🐛 0 | 🌐 Rust | 📅 2026-09-02** - Native bridge for controlling rooted Android devices from Windows, macOS, or Linux. `FOSS` `[K]`

### Linux Environments

* **[⭐ Droidspaces](https://github.com/ravindu644/Droidspaces-OSS) ⭐ 1,856 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-05** - Run full Linux environments on top of Android, with complete init system support. `FOSS`
...
* **[Basic Call Recorder](https://github.com/chenxiaolong/BCR) ⭐ 2,896 | 🐛 13 | 🌐 Kotlin | 📅 2026-09-05** - A Basic Call Recorder for rooted Android devices. Also check out [GUI for BCR ↗](https://github.com/nicorac/bcr-gui) ⭐ 353 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-31. `FOSS` `[M]` `[K]`
...
* **[⭐ Essentials](https://github.com/sameerasw/essentials) ⭐ 2,843 | 🐛 87 | 🌐 Kotlin | 📅 2026-09-05** - Multi-purpose tweaks for display, notifications and alerts, security and privacy, sound and haptics, and app freezing. `FOSS`
* **[UotanToolbox NT](https://github.com/Uotan-Dev/UotanToolboxNT) ⭐ 2,687 | 🐛 4 | 🌐 C# | 📅 2026-08-30** - A modern toolbox for Android power users and geeks. `FOSS`
...
* **[Zygisk Sui](https://github.com/XiaoTong6666/Sui) ⭐ 665 | 🐛 3 | 🌐 Java | 📅 2026-09-04** - Modern superuser interface (SUI) implementation for Android. `FOSS` `[M]` `[K]`
...
| 📂 **GitHub**    | Source, discussions & issues  | [GitHub Repo](https://github.com/awesome-android-root/awesome-android-root) ⭐ 4,491 \| 🐛 2 \| 🌐 Python \| 📅 2026-09-04 |
...
* 🐛 Report [issues](https://github.com/awesome-android-root/awesome-android-root/issues) ⭐ 4,491 | 🐛 2 | 🌐 Python | 📅 2026-09-04
...
**⚡ Built with ❤️ by [Awesome Android Root](https://github.com/awesome-android-root/awesome-android-root) ⭐ 4,491 | 🐛 2 | 🌐 Python | 📅 2026-09-04**
