...
> For privacy-friendly installs, use the F-Droid ecosystem: install [Droid-ify](https://github.com/Droid-ify/client/releases) ⭐ 7,378 | 🐛 192 | 🌐 Kotlin | 📅 2026-09-06 (modern F-Droid client) and enable the [IzzyOnDroid](https://apt.izzysoft.de/fdroid/) repo for many additional packages.
...
| :----------------------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------- |
|       **[Magisk](https://github.com/topjohnwu/Magisk) ⭐ 62,628 \| 🐛 37 \| 🌐 Kotlin \| 📅 2026-09-05** <br><small> `Root & Module Management` </small>      | If you chose Magisk, this is your manager.               |
| **[App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 8,908 \| 🐛 204 \| 🌐 Java \| 📅 2026-09-05** <br><small> `App & Package Management` </small> | Inspect and manage apps with root privileges.            |
...
* **[⭐ Magisk](https://github.com/topjohnwu/Magisk) ⭐ 62,628 | 🐛 37 | 🌐 Kotlin | 📅 2026-09-05** - Manage Magisk modules and root permissions. `FOSS`
* **[⭐ KernelSU](https://github.com/tiann/KernelSU) ⭐ 18,260 | 🐛 63 | 🌐 Kotlin | 📅 2026-09-06** - A Kernel based root solution for Android. `FOSS`
* **[APatch](https://github.com/bmax121/APatch) ⭐ 7,906 | 🐛 47 | 🌐 Kotlin | 📅 2026-09-04** - The patching of Android kernel and Android system. `FOSS` | [🌱](https://f-droid.org/packages/me.bmax.apatch/)
* **[SukiSU-Ultra](https://github.com/SukiSU-Ultra/SukiSU-Ultra) ⭐ 6,221 | 🐛 28 | 🌐 Kotlin | 📅 2026-09-01** - A kernel-based root solution for Android devices, forked from `KernelSU` with some useful changes. `FOSS`
* **[KernelSU-next](https://github.com/KernelSU-Next/KernelSU-Next) ⭐ 4,204 | 🐛 24 | 🌐 Kotlin | 📅 2026-09-06** - An advanced Kernel based root solution for Android. `FOSS`
* **[ReSukiSU](https://github.com/ReSukiSU/ReSukiSU) ⭐ 1,414 | 🐛 12 | 🌐 Kotlin | 📅 2026-09-06** - Fork of SukiSU-Ultra with additional features. `FOSS`
* **[FolkPatch](https://github.com/LyraVoid/FolkPatch) ⭐ 1,098 | 🐛 31 | 🌐 Kotlin | 📅 2026-09-04** - A Root management tool focused on interface optimization and feature extension, based on APatch. `FOSS`
...
* **[⭐ Root My Galaxy](https://github.com/BuSung-dev/Root-My-Galaxy) ⭐ 1,123 | 🐛 467 | 🌐 Kotlin | 📅 2026-09-03** - One-tap temporary root for Snapdragon Galaxy flagships (S24/S25 series, S24 FE, A56...) via GhostLock; bootloader stays locked, Knox isn't tripped. `FOSS`
* **[GhostLock App](https://github.com/YuKongA/ghostlock-app) ⭐ 763 | 🐛 46 | 🌐 C | 📅 2026-09-06** - One-tap execution app for the GhostLock (CVE-2026-43499) exploit. `FOSS`
* **[Root-My-Galaxy-Payloads](https://github.com/BuSung-dev/Root-My-Galaxy-Payloads) ⭐ 383 | 🐛 193 | 🌐 C | 📅 2026-09-03** - Signed device profiles, exploit payloads, and KernelSU artifacts that Root My Galaxy fetches at runtime. `FOSS`
* **[ghostlock-oneplus](https://github.com/JoinChang/ghostlock-oneplus) ⭐ 326 | 🐛 22 | 🌐 C | 📅 2026-09-05** - GhostLock kernel exploit for OnePlus/OPPO/realme (and some Xiaomi) devices with locked bootloader; installs KernelSU with runtime kernel auto-detection. `FOSS`
* **[Root My Pixel](https://github.com/alex193a/Root-My-Pixel) ⭐ 323 | 🐛 18 | 🌐 Kotlin | 📅 2026-09-05** - Jailbreak supported Google Pixel phones with GhostLock; stages the payload via Shizuku, no PC needed. `FOSS`
* **[QuestStack](https://github.com/starseed12345/QuestStack) ⭐ 176 | 🐛 0 | 🌐 C# | 📅 2026-08-28** - Unlocks the Meta Quest 1 bootloader and gains root using GhostLock + CVE-2021-1931. `FOSS`
* **[IonStack-S22U](https://github.com/sarabpal-dev/IonStack-S22U) ⭐ 66 | 🐛 2 | 🌐 C | 📅 2026-09-05** - Full CVE-2026-43499 exploit chain for the Samsung Galaxy S22 Ultra (5.10 kernel). `FOSS`
* **[oppo-ghostlock](https://github.com/pubglite55/oppo-ghostlock) ⭐ 64 | 🐛 4 | 🌐 C | 📅 2026-08-08** - GhostLock exploit adaptation for the OPPO Find N2. `FOSS`
* **[GhostLock-Galaxy](https://github.com/wxxsfxyzm/GhostLock-Galaxy) ⭐ 20 | 🐛 1 | 🌐 C | 📅 2026-08-10** - GhostLock app for the Samsung Galaxy Z Fold6 (kernel 6.1); stages via Shizuku or `adb shell` with per-kernel offset matching. `FOSS`
* **[GhostLock-5.10](https://github.com/R0rt1z2/GhostLock-5.10) ⭐ 18 | 🐛 0 | 🌐 C | 📅 2026-08-21** - GhostLock kernel root exploit for some 5.X-kernel devices, mostly Amazon (from the Kaeru/Fenrir developer). `FOSS`
* **[Root My Device](https://github.com/Witaqua-tools/Root-My-Device) ⭐ 16 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-29** - Community fork of Root My Galaxy generalized beyond Samsung, with its own payload feed. `FOSS`
* **[pixel-ksu-root](https://github.com/JingMatrix/pixel-ksu-root) ⭐ 14 | 🐛 0 | 🌐 C | 📅 2026-09-01** - ADB-driven KernelSU loader for stock Pixels; temporary kernel R/W via GhostLock, then late-loads a signature-matched `kernelsu.ko`. Manager-agnostic. `FOSS`
...
* **[Meta-hybrid\_mount](https://github.com/YuzakiKokuban/meta-hybrid_mount) ⭐ 1,538 | 🐛 2 | 🌐 Rust | 📅 2026-09-04** - Three-engine mount orchestration (OverlayFS + Magic Mount + Kasumi LKM) with conflict monitor, SolidJS WebUI, auto-fallback, and EROFS storage backend support. `FOSS` `[K]` `[A]`
* **[⭐ Mountify](https://github.com/backslashxx/mountify) ⭐ 1,360 | 🐛 23 | 🌐 Shell | 📅 2026-08-25** - OverlayFS with tmpfs/ext4 sparse support for reduced detection, works on APatch/Magisk too. `FOSS` `[M]` `[K]` `[A]`
...
* **[⭐ Meta-overlayfs](https://github.com/KernelSU-Modules-Repo/meta-overlayfs) ⭐ 471 | 🐛 8 | 🌐 Rust | 📅 2025-12-02** - Official reference implementation using OverlayFS for most users and standard setup. `FOSS` `[K]`
* **[ZeroMount](https://github.com/Enginex0/zeromount) ⭐ 126 | 🐛 3 | 🌐 Rust | 📅 2026-04-15** - Mountless module loading with Kernel-level VFS path redirection & SUSFS integration, WebUI, bootloop guard, and strategy fallback. `FOSS` `[M]` `[K]` `[A]`
...
* **[⭐ Vector](https://github.com/JingMatrix/Vector) ⭐ 12,340 | 🐛 20 | 🌐 Kotlin | 📅 2026-09-04** - Open Source *Fork* of original LSPosed with dynamic module loading, and other improvements. `FOSS` `[M]`
...
* **[⭐ Zygisk Next](https://github.com/Dr-TSNG/ZygiskNext) ⭐ 10,555 | 🐛 10 | 🌐 C | 📅 2026-08-27** The "Gold Standard" for detection evasion. It is a standalone Zygisk implementation that offers the most advanced stealth features, including a dedicated **Zygote Monitor** and dashboard. `Proprietary` `[M]` `[K]` `[A]`
* **[ReZygisk](https://github.com/PerformanC/ReZygisk) ⭐ 3,891 | 🐛 9 | 🌐 C | 📅 2026-08-31** A high-performance implementation **entirely rewritten in C**. It introduces **custom linkers** to bypass modern linker-based detections, offering a WebUI for status monitoring and compatibility with Android 15 and 16. `FOSS` `[M]` `[K]` `[A]`
* **[NeoZygisk](https://github.com/JingMatrix/NeoZygisk) ⭐ 2,256 | 🐛 9 | 🌐 C++ | 📅 2026-09-03** A minimalist, high-stealth implementation using **ptrace injection**. It focuses on "trace cleaning," aiming to remove all injection artifacts from memory once modules are loaded. `FOSS` `[M]` `[K]` `[A]`
...
* **[⭐ SUSFS for KernelSU](https://github.com/sidex15/susfs4ksu-module) ⭐ 2,552 | 🐛 4 | 🌐 HTML | 📅 2026-08-31** - Add-on root-hiding service for SUSFS-patched kernels (KernelSU/Next). The core of modern KSU hiding setups. `FOSS` `[M]` `[K]`
* **[RENE](https://github.com/rrr333nnn333/BRENE) ⭐ 344 | 🐛 7 | 🌐 Shell | 📅 2026-09-05** - SUSFS/KernelSU module for patched kernels with enhanced root hiding & spoofing. `FOSS` `[M]` `[K]`
* **[ReSuSFS](https://github.com/ahmed-alnassif/ReSuSFS) ⭐ 17 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-06** - SUSFS/KernelSU module for patched kernels with modern ui and configuration options. `FOSS` `[M]` `[K]`
...
* **[⭐ Shamiko](https://github.com/LSPosed/LSPosed.github.io/releases) ⭐ 6,327 | 🐛 0 | 🌐 HTML | 📅 2026-07-29** - Hides Magisk root from detection. `Proprietary` `[M]`
* **[TrickyStore](https://github.com/5ec1cff/TrickyStore) ⭐ 6,326 | 🐛 4 | 📅 2025-11-30** - Modifies the certificate chain for Android key attestation (keybox-based). The original/reference module. `Proprietary` `[M]` `[K]`
* **[Hide My Applist](https://github.com/Dr-TSNG/Hide-My-Applist) ⭐ 5,581 | 🐛 13 | 🌐 Kotlin | 📅 2026-08-01** - Intercepts app-list detection. `Proprietary` `[LSP]`
* **[Play Integrity Fork (PIF)](https://github.com/osm0sis/PlayIntegrityFork) ⭐ 4,457 | 🐛 0 | 🌐 C++ | 📅 2026-08-29** - The most actively maintained PIF. Fixes `DEVICE_INTEGRITY` verdicts with custom fields/props. Recommended starting point after chiteroman's original was discontinued. `FOSS` `[M]`
* **[Play Integrity Fix (inject)](https://github.com/KOWX712/PlayIntegrityFix) ⭐ 3,832 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-01** - Actively maintained fork using injected GMS/Play Store spoofing with a WebUI. `FOSS` `[M]`
* **[Tricky Addon – Update Target List](https://github.com/KOWX712/Tricky-Addon-Update-Target-List) ⭐ 3,424 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-06** - KSU WebUI to configure TrickyStore's `target.txt`. `FOSS` `[K]`
* **[⭐ HMA-OSS](https://github.com/frknkrc44/HMA-OSS) ⭐ 3,065 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-05** - FOSS rewrite of Hide My Applist; hides your app list, settings, and package installers. `FOSS` `[LSP]`
* **[Zygisk Assistant](https://github.com/snake-4/Zygisk-Assistant) ⭐ 2,591 | 🐛 17 | 🌐 C++ | 📅 2026-05-04** - Zygisk module to hide root on KernelSU, Magisk, and APatch. `FOSS` `[M]`
* **[⭐ TEESimulator](https://github.com/JingMatrix/TEESimulator) ⭐ 2,372 | 🐛 11 | 🌐 C++ | 📅 2026-09-05** - Create a complete, software-based simulation of a hardware-backed Trusted Execution Environment (TEE) for Key Attestation. `FOSS` `[M]` `[K]`
* **[YuriKey](https://github.com/dpejoh/yurikey) ⭐ 1,885 | 🐛 10 | 🌐 Shell | 📅 2026-09-06** - Systemless module to obtain strong integrity easily. `FOSS` `[M]` `[K]`
* **[TEESimulator-RS](https://github.com/Enginex0/TEESimulator-RS) ⭐ 1,726 | 🐛 24 | 🌐 Kotlin | 📅 2026-07-11** - Fork of TEESimulator with native Rust certificate generation, key persistence, and AOSP-compliant attestation behavior. `FOSS` `[M]` `[K]`
* **[TrickyStore OSS](https://github.com/beakthoven/TrickyStoreOSS) ⭐ 1,359 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-06** - Open-source alternative to TrickyStore. `FOSS` `[M]` `[K]`
...
* **[Specter](https://github.com/dpejoh/specter) ⭐ 592 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-06** - Unified Play Integrity and root hiding stack for Android. Successor of Yurikey. `FOSS` `[M]` `[K]`
* **[Always Strong](https://github.com/evoker0/AlwaysStrong) ⭐ 479 | 🐛 0 | 🌐 Shell | 📅 2026-09-06** - Bundles TEESimulator-RS and PlayIntegrityFork into a single module for strong integrity on rooted devices. `FOSS` `[M]` `[K]`
...
* **[OhMyKeymint](https://github.com/qwq233/OhMyKeymint) ⭐ 332 | 🐛 3 | 🌐 Rust | 📅 2026-08-27** - Custom keystore implementation for Android Keystore Spoofer. `FOSS` `[M]` `[K]`
* **[ReZygisk's Treat Wheel](https://github.com/PerformanC/Treat-Wheel-Zygisk) ⭐ 264 | 🐛 9 | 🌐 C | 📅 2026-07-22** - Hides Magisk/root traces exclusively for ReZygisk, acting as the best userspace root hiding tool. `FOSS` `[M]` `[K]`
...
* **[Komodo Build Props](https://github.com/Elcapitanoe/Komodo-Build-Prop#komodo-build-props) ⭐ 34 | 🐛 1 | 🌐 Python | 📅 2026-09-05** - Spoofs your device as a Pixel 9 Pro XL (komodo). `FOSS` `[M]`
...
* **[Anti bootloop](https://github.com/Magisk-Modules-Alt-Repo/abootloop) ⭐ 444 | 🐛 8 | 🌐 Shell | 📅 2025-03-11** - Protect from bootloops. `FOSS` `[M]`
...
* **[YetAnotherBootloopProtector](https://github.com/Magisk-Modules-Alt-Repo/YetAnotherBootloopProtector) ⭐ 179 | 🐛 5 | 🌐 Shell | 📅 2026-09-06** - Monitor and fix potential Bootloops and SystemUI failures. `FOSS` `[M]`
...
* **[MagiskDetection](https://github.com/apkunpacker/MagiskDetection) ⭐ 1,054 | 🐛 5 | 📅 2026-05-10** - Collection of Some publicly Available POC Apps to Detect Root/Magisk presence. `Proprietary`
* **[Duck Detector](https://github.com/eltavine/Duck-Detector-Refactoring) ⭐ 966 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-28** - Android environment integrity inspection tool for root, hook, bootloader, SELinux, virtualization, and attestation signals. `FOSS`
* **[Play Integrity API Checker](https://github.com/1nikolas/play-integrity-checker-app) ⭐ 815 | 🐛 8 | 🌐 Java | 📅 2025-08-19** - This app shows info about your device integrity as reported by Google Play Services. If any of this fails could mean your device is rooted or tampered in a way. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=gr.nikolasspyr.integritycheck)
* **[Chunqiu Detector](https://github.com/mingzun09/Chunqiu-Detector-Problem-solution) ⭐ 383 | 🐛 2 | 🌐 HTML | 📅 2026-09-05** - Solutions, scripts, and modules for bypassing and troubleshooting Chunqiu Detector checks on rooted Android devices. `FOSS`
...
* **[⭐ Duck Detector Fork](https://github.com/rrr333nnn333/Duck-Detector-Refactoring) ⭐ 49 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-28** - Duck Detector fork with additional features and improvements. `FOSS`
* **[Android-Device-Trust](https://github.com/reveny/Android-Device-Trust) ⭐ 42 | 🐛 0 | 🌐 Python | 📅 2026-08-20** - Android device attestation and fingerprinting tool. `FOSS`
...
* **[ZygoteNextProbe](https://github.com/XiaoTong6666/ZygoteNextProbe) ⭐ 19 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-15** - Research probe that checks whether Android 17's `zygote_next` native isolated services leak a global mount view - potentially exposing Magisk/Zygisk/LSPosed mounts to apps. `FOSS`
...
* **[Secure Element Access](https://github.com/jqssun/android-se-access) ⭐ 35 | 🐛 0 | 🌐 Kotlin | 📅 2026-04-25** - Enable access to secure element for trusted apps. `FOSS`
...
* **[Cromite SystemWebView](https://github.com/hddq/magisk-cromite-webview) ⭐ 11 | 🐛 0 | 🌐 Shell | 📅 2026-06-12** - Replaces the Android System WebView with Cromite WebView. `FOSS` `[M]`
...
* **[SystemUI Tuner](https://github.com/zacharee/Tweaker?tab=readme-ov-file) ⭐ 1,725 | 🐛 67 | 🌐 Kotlin | 📅 2026-08-27** - View and modify hidden settings on Android devices. `FOSS` `[M]`
* **[PIXELIFY NEXT](https://github.com/BasGame1/Pixelify-Next) ⭐ 311 | 🐛 3 | 🌐 Shell | 📅 2026-08-26** - A Magisk Module which enables Pixel UI and some exclusive features. `FOSS` `[M]`
...
* **[LuckyTool](https://github.com/Xposed-Modules-Repo/com.luckyzyx.luckytool/blob/main/README_EN.md) ⭐ 1,897 | 🐛 8 | 📅 2026-04-26** - Extended functionality and optimization module for ColorOS. `Proprietary` `[LSP]`
* **[OShin](https://github.com/suqi8/OShin/blob/master/README_EN.md) ⭐ 1,192 | 🐛 113 | 🌐 Kotlin | 📅 2026-07-28** - Auxiliary module deeply integrated with ColorOS, designed to enhance and optimize your operating system experience. `FOSS` `[LSP]`
...
* **[⭐ HyperCeiler](https://github.com/ReChronoRain/HyperCeiler/blob/main/README_en-US.md) ⭐ 5,348 | 🐛 239 | 🌐 Java | 📅 2026-09-06** - Extensive customizations for HyperOS. `FOSS` `[LSP]`
* **[Pengeek](https://github.com/monwf/customiuizer) ⭐ 1,470 | 🐛 48 | 🌐 Java | 📅 2026-05-19** - Customize your HyperOS to your liking. For HyperOS based on Android 14. `FOSS` `[LSP]`
* **[Hyper Helper](https://github.com/HowieHChen/XiaomiHelper/blob/master/README_EN-US.md) ⭐ 355 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-30** - Lightweight customization module for HyperOS only. `FOSS` `[LSP]`
...
> \[!TIP]
> Check this resource for more [HyperOS Mods ↗](https://github.com/ImKKingshuk/Awesome-HyperOS) ⭐ 158 | 🐛 0 | 📅 2026-01-12
...
* **[⭐ KnoxPatch](https://github.com/salvogiangri/KnoxPatch) ⭐ 1,503 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-25** - Get Samsung apps/features working again in your rooted Galaxy device. For better experience, please also [read this ↗](https://github.com/salvogiangri/KnoxPatch?tab=readme-ov-file#knoxpatch-enhancer) ⭐ 1,503 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-25 . `FOSS` `[LSP]`
...
* **[Samsung Dex Standalone Mode](https://github.com/supermarsx/magisk-samsung-dex-standalone-mode) ⭐ 71 | 🐛 0 | 🌐 Shell | 📅 2026-06-30** - Systemlessly enable Samsung DeX standalone mode. `FOSS` `[M]`
...
* **[OneLab](https://github.com/pigerzhu/OneLab) ⭐ 10 | 🐛 0 | 🌐 Java | 📅 2026-09-05** - One UI feature extensions and foldable app adaptations for Samsung devices. `FOSS` `[LSP]`
...
* **[Oxygen-Customizer](https://github.com/DHD2280/Oxygen-Customizer/) ⭐ 456 | 🐛 35 | 🌐 Java | 📅 2026-09-06** - Open-source Oxygen OS customizer application. `FOSS` `[LSP]`

#### ZUI

* **[ZTool](https://github.com/qwqawa64/ZUX-ZTool) ⭐ 65 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-06** - Provides optimization and customization features for the ZUXOS system. `FOSS` `[LSP]`
...
* **[Live Boot Module](https://github.com/symbuzzer/livebootmodule) ⭐ 443 | 🐛 8 | 🌐 Shell | 📅 2026-09-03** - Enables unix-style (verbose) boot animation for Android devices. `FOSS` `[M]` `[K]`
* **[video-to-bootanimation](https://github.com/Magisk-Modules-Alt-Repo/video-to-bootanimation) ⭐ 126 | 🐛 12 | 🌐 Shell | 📅 2026-09-06** - A Magisk Module Which Can Set Videos as Android Device BootAnimation. `FOSS` `[M]`
...
* **[⭐ Canta](https://github.com/samolego/Canta) ⭐ 5,792 | 🐛 30 | 🌐 Kotlin | 📅 2026-09-04** - Uninstall any app without root using [Shizuku](#developer-tools). `FOSS` | [🌱](https://f-droid.org/en/packages/io.github.samolego.canta/) | [▶️](https://play.google.com/store/apps/details?id=io.github.samolego.canta)
* **[De-Bloater](https://github.com/sunilpaulmathew/De-Bloater) ⭐ 781 | 🐛 49 | 🌐 Java | 📅 2026-05-25** - An application using the power of Magisk to debloat unwanted system apps!. `FOSS` | [🌱](https://f-droid.org/packages/com.sunilpaulmathew.debloater) | [▶️](https://play.google.com/store/apps/details?id=com.sunilpaulmathew.debloater)
* **[System App Nuker](https://github.com/ChiseWaguri/systemapp_nuker) ⭐ 253 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-30** - A module to debloat system apps with WebUI Interface. `FOSS` `[M]`
...
* **[⭐ App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 8,908 | 🐛 204 | 🌐 Java | 📅 2026-09-05** - A full-featured package manager and viewer for Android. `FOSS` | [🌱](https://f-droid.org/packages/io.github.muntashirakon.AppManager/)
* **[⭐ Droid-ify](https://github.com/Droid-ify/client) ⭐ 7,378 | 🐛 192 | 🌐 Kotlin | 📅 2026-09-06** - F-Droid client with Material UI and auto updating apps using root. `FOSS` | [🌱](https://f-droid.org/packages/com.looker.droidify)
* **[⭐ Hail](https://github.com/aistra0528/Hail) ⭐ 6,613 | 🐛 168 | 🌐 Kotlin | 📅 2026-08-29** - Disable / Hide / Suspend / Uninstall Android apps. `FOSS` | [🌱](https://f-droid.org/packages/com.aistra.hail/)
* **[InstallerX-Revived](https://github.com/wxxsfxyzm/InstallerX-Revived) ⭐ 6,505 | 🐛 21 | 🌐 Kotlin | 📅 2026-09-05** - A modern and functional Android app installer. `FOSS` `[LSP]`
* **[Neo Store](https://github.com/NeoApplications/Neo-Store) ⭐ 4,975 | 🐛 121 | 🌐 Kotlin | 📅 2026-09-06** - An F-Droid client with modern UI and an arsenal of extra features. `FOSS` | [🌱](https://f-droid.org/packages/com.machiav3lli.fdroid)
* **[Aurora Store](https://github.com/whyorean/AuroraStore) ⭐ 2,952 | 🐛 26 | 🌐 Kotlin | 📅 2026-08-24** - A Google Play Store client to search, view app details, and download APKs directly to your device. `FOSS` | [🌱](https://f-droid.org/packages/com.aurora.store/)
* **[⭐ Zygisk Detach](https://github.com/j-hc/zygisk-detach) ⭐ 2,126 | 🐛 0 | 🌐 Rust | 📅 2026-07-09** - Zygisk module to detach installed apps from Play Store, hooking binder. `FOSS` `[M]` `[K]`
* **[Inure](https://github.com/Hamza417/Inure) ⭐ 1,902 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-04** - An elegant and beautiful premium Android app manager for rooted and non-rooted devices. `FOSS` | [🌱](https://f-droid.org/en/packages/app.simple.inure/) | [▶️](https://play.google.com/store/apps/details?id=app.simple.inure.play)
* **[Universal Installer](https://github.com/pass-with-high-score/universal-installer) ⭐ 1,377 | 🐛 9 | 🌐 Kotlin | 📅 2026-09-06** - Install and manage APK packages with split APK support. `FOSS` `[LSP]`
* **[InxLocker](https://github.com/Chimioo/InxLocker) ⭐ 903 | 🐛 2 | 🌐 Kotlin | 📅 2026-06-11** - Intercepts/forwards Android system application installation and uninstallation requests, redirecting them to your specified installer app. `FOSS` `[LSP]`
* **[Package Manager](https://github.com/SmartPack/PackageManager) ⭐ 819 | 🐛 71 | 🌐 Java | 📅 2026-08-25** - A highly powerful app to manage both system and user apps installed on an Android device. `FOSS` | [🌱](https://f-droid.org/packages/com.smartpack.packagemanager) | [▶️](https://play.google.com/store/apps/details?id=com.smartpack.packagemanager)
* **[BetterKnownInstalled](https://github.com/Pixel-Props/BetterKnownInstalled) ⭐ 558 | 🐛 0 | 🌐 Shell | 📅 2026-09-03** - Patches packages to fix DroidGuard UNKNOWN\_INSTALLED issues. `FOSS` `[LSP]`
* **[Thor](https://github.com/trinadhthatakula/Thor) ⭐ 545 | 🐛 13 | 🌐 Kotlin | 📅 2026-09-05** - Android App Manager and App Installer utility. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/com.valhalla.thor) | [▶️](https://play.google.com/store/apps/details?id=com.valhalla.thor)
...
* **[Thanox](https://github.com/Tornaco/Thanox) ⭐ 3,253 | 🐛 469 | 🌐 Java | 📅 2026-08-14** - A system management tool that provide convenient functions like application startup management, background management, permission management etc. `FOSS` `[LSP]` | [▶️](https://play.google.com/store/apps/details?id=github.tornaco.android.thanos.pro\&hl=en\&gl=US)
* **[PermissionManagerX](https://github.com/mirfatif/PermissionManagerX) ⭐ 769 | 🐛 7 | 🌐 HTML | 📅 2026-09-03** - eXtended Permission Manager for Android to view and set Manifest Permissions and AppOps. `FOSS` | [🌱](https://f-droid.org/packages/com.mirfatif.permissionmanagerx) | [▶️](https://play.google.com/store/apps/details?id=com.mirfatif.permissionmanagerx)
...
* **[Infamick Script](https://github.com/Infamousmick/Infamick-script/) ⭐ 88 | 🐛 0 | 🌐 Shell | 📅 2026-04-15** - A powerful system utility script that provides easy access to various system information and settings. `FOSS` `[M]`
...
* **[FDE.AI](https://github.com/feravolt/FDE.AI-docs) ⭐ 672 | 🐛 0 | 🌐 HTML | 📅 2026-08-19** - All-in-One ultimate optimizer for all devices running Android OS. `Proprietary` `[LSP]`
...
* **[AZenith](https://github.com/Liliya2727/AZenith) ⭐ 121 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-03** - All-In-One (AIO) system optimization module designed to enhance Android performance. `FOSS` `[M]` `[K]`
...
* **[KonaBess Next](https://github.com/KonaBess-Next/KonaBess-Next) ⭐ 223 | 🐛 20 | 🌐 Kotlin | 📅 2026-09-06** - Fork of KonaBess, Custom GPU overclocking and undervolting tool with granulated voltage for rooted Snapdragon Android devices. `FOSS`
* **[Minimal Kernel Manager](https://github.com/abhay-byte/mkm) ⭐ 147 | 🐛 8 | 🌐 Kotlin | 📅 2026-09-04** - Android kernel management and system monitoring application. `FOSS` | [🌱](https://f-droid.org/packages/com.ivarna.fluxlinux/)
...
* **[PerfMTK](https://github.com/JUANIMAN/PerfMTK) ⭐ 90 | 🐛 21 | 🌐 Shell | 📅 2026-06-28** - Designed to optimize performance and power efficiency on MediaTek devices with Mali GPUs. `FOSS` `[M]`
* **[Kernel Enhancer](https://github.com/RAAJK20Pro/KernelEnhancer) ⭐ 44 | 🐛 1 | 📅 2026-06-18** - A Simple Kernel Parameters Optimization for all devices. `Proprietary` `[M]`
...
* **[Plus Plus Battery](https://github.com/dijia1124/plusplusbattery) ⭐ 473 | 🐛 16 | 🌐 Kotlin | 📅 2026-02-22** - Real-time battery stats & health estimator for OnePlus/Oppo/Realme phones. `FOSS` | [🌱](https://f-droid.org/en/packages/com.dijia1124.plusplusbattery/)
* **[EnforceDoze](https://github.com/farfromrefug/EnforceDoze) ⭐ 359 | 🐛 21 | 🌐 Java | 📅 2026-07-26** - Enable Doze mode immediately after screen off and turn off motion sensing to get best battery life. `FOSS` | [🌱](https://f-droid.org/packages/com.akylas.enforcedoze/)
...
* **[⭐ FROSTY](https://github.com/Drsexo/Frosty) ⭐ 221 | 🐛 3 | 🌐 Shell | 📅 2026-09-03** - Optimizes battery life by selectively freezing Google Mobile Services (GMS) components and applying system-wide doze enhancements. `FOSS` `[M]` `[K]`
* **[AntiWakeLock](https://github.com/binarynoise/XposedModulets/releases?q=AntiWakeLock) ⭐ 218 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-03** - Disable WAKE\_LOCK and FLAG\_KEEP\_SCREEN\_ON to save battery. `FOSS` `[LSP]`
* **[BatStats](https://github.com/mlm-games/BatStats) ⭐ 179 | 🐛 4 | 🌐 Kotlin | 📅 2026-09-01** - Battery monitor with stats via Shizuku/root. `FOSS`
...
* **[Universal GMS Doze Fork](https://github.com/MarsPatrick/universal-gms-doze) ⭐ 69 | 🐛 1 | 🌐 Shell | 📅 2026-08-17** - Patches Google Play services app and certain processes/services to be able to use battery optimization. `FOSS` `[M]`
...
* **[AccA](https://github.com/VR-25/acc) ⭐ 2,391 | 🐛 19 | 🌐 Shell | 📅 2025-06-06** - Advanced Charging Controller app. `FOSS`
...
* **[TaskManager](https://github.com/RohitKushvaha01/TaskManager) ⭐ 622 | 🐛 4 | 🌐 C++ | 📅 2026-08-18** - Task Manager inspired from gnome system monitor for android.Must read [F-Droid inclusion](https://github.com/RohitKushvaha01/TaskManager/issues/24) ⭐ 622 | 🐛 4 | 🌐 C++ | 📅 2026-08-18 `FOSS` | [▶️](https://play.google.com/store/apps/details?id=com.rk.taskmanager)
* **[Shappky](https://github.com/YasserNull/shappky) ⭐ 555 | 🐛 22 | 🌐 Kotlin | 📅 2026-08-25** - A simple app to boost performance by stopping background apps, relying on Root/Shizuku permissions. `FOSS` `[M]`
* **[No More Background](https://github.com/adil192/no_more_background) ⭐ 318 | 🐛 11 | 🌐 Dart | 📅 2026-09-01** - A fire-and-forget program to stop Android apps from running in the background. `FOSS` | [🌱](https://f-droid.org/en/packages/com.adilhanney.no_more_background/)
* **[Appzuku](https://github.com/northmendo/Appzuku) ⭐ 185 | 🐛 1 | 🌐 Java | 📅 2026-03-29** - Simple app to boost performance by stopping background apps, relying on Root/Shizuku permissions. `FOSS`
...
* **[BlockAds](https://github.com/pass-with-high-score/blockads-android) ⭐ 1,954 | 🐛 64 | 🌐 Kotlin | 📅 2026-09-05** - System‑wide ad, tracker, & malware filtering, custom blocklists, per‑app controls etc. `FOSS` | [🌱](https://f-droid.org/packages/app.pwhs.blockads)
* **[⭐ Bindhosts](https://github.com/bindhosts/bindhosts) ⭐ 1,413 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-06** - Systemless hosts for APatch, KernelSU and Magisk that is fully standalone and self-updating. `FOSS` `[M]` `[K]`
...
* **[Magisk Ad Blocking Module](https://github.com/pantsufan/Magisk-Ad-Blocking-Module) ⭐ 569 | 🐛 19 | 📅 2026-09-06** - Block ads on android. `FOSS` `[M]`
...
* **[Re-Malwack](https://github.com/ZG089/Re-Malwack) ⭐ 448 | 🐛 3 | 🌐 C | 📅 2026-08-16** - A fully-fledged ad-block module. Contains all your needs. `FOSS` `[M]`
* **[StevenBlock](https://github.com/mikropsoft/StevenBlock) ⭐ 298 | 🐛 2 | 🌐 Shell | 📅 2026-04-25** - Ad Blocking Module for Android supporting Magisk, KernelSU and APatch. `FOSS` `[M]`
...
* **[Marketing Notification Blocker](https://github.com/lm060719/io.mo.mnblocker) ⭐ 42 | 🐛 0 | 🌐 Java | 📅 2026-07-30** - Intercepts and blocks annoying marketing ads and spam push notifications. `FOSS` `[LSP]`
...
* **[PCAPdroid](https://github.com/emanuele-f/PCAPdroid#pcapdroid) ⭐ 4,668 | 🐛 46 | 🌐 Java | 📅 2026-09-06** - Lets you track, analyze and block the connections made by the other apps in your device. `FOSS` | [🌱](https://f-droid.org/packages/com.emanuelef.remote_capture) | [▶️](https://play.google.com/store/apps/details?id=com.emanuelef.remote_capture)
* **[NetGuard](https://github.com/M66B/NetGuard) ⭐ 3,866 | 🐛 1 | 🌐 Java | 📅 2026-08-01** - Block access to the internet. Apps and addresses can individually be allowed or denied access to your Wi-Fi and/or mobile connection. `FOSS`
* **[AFWall+](https://github.com/ukanth/afwall) ⭐ 3,468 | 🐛 220 | 🌐 Java | 📅 2026-08-06** - Iptables-based firewall. `FOSS` | [🌱](https://f-droid.org/packages/dev.ukanth.ufirewall/) | [▶️](https://play.google.com/store/apps/details?id=dev.ukanth.ufirewall)
* **[ShizuWall](https://github.com/AhmetCanArslan/ShizuWall) ⭐ 2,220 | 🐛 8 | 🌐 Kotlin | 📅 2026-09-06** - Android firewall without VPN powered by Shizuku / local ADB daemon / Root. `FOSS` | [🌱](https://f-droid.org/packages/com.arslan.shizuwall/) | [▶️](https://play.google.com/store/apps/details?id=com.arslan.shizuwall)
...
* **[De1984 Firewall](https://github.com/dorumrr/de1984) ⭐ 411 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-04** - A privacy-focused Firewall and Package Manager for Android devices. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/io.github.dorumrr.de1984)
* **[Net Switch](https://github.com/Rem01Gaming/net-switch) ⭐ 324 | 🐛 3 | 🌐 JavaScript | 📅 2025-11-08** - Isolate any app from Internet access. `FOSS` `[M]`
...
* **[⭐ Amarok](https://github.com/deltazefiro/Amarok-Hider) ⭐ 3,234 | 🐛 62 | 🌐 Java | 📅 2026-08-11** - Android application which enables you to hide your private files and apps with a single click. `FOSS` | [🌱](https://f-droid.org/zh_Hans/packages/deltazero.amarok.foss/)
* **[Tarnhelm](https://github.com/lz233/Tarnhelm) ⭐ 790 | 🐛 9 | 🌐 Kotlin | 📅 2026-08-13** - The magic to clean sharing links up. `FOSS` `[LSP]`
...
* **[FuseFixer](https://github.com/5ec1cff/FuseFixer) ⭐ 405 | 🐛 1 | 🌐 C | 📅 2026-04-14** - Hooks the MediaProvider Fuse Daemon to stop apps probing package existence through `Android/data` directory quirks (Unicode casefold tricks). `FOSS` `[LSP]`
...
* **[FuseHide](https://github.com/XiaoTong6666/FuseHide) ⭐ 269 | 🐛 6 | 🌐 C++ | 📅 2026-09-04** - Hides chosen storage paths from MediaProvider on Android 12+ at runtime, and debugs/fixes `Android/data` Unicode casefold scenarios. `FOSS` `[LSP]`
* **[Do Not Try Accessibility](https://github.com/Nitsuya/DoNotTryAccessibility) ⭐ 206 | 🐛 7 | 🌐 Kotlin | 📅 2025-01-23** - Hook System Framework makes the app think that accessibility services are not enabled. `FOSS` `[LSP]`
...
* **[⭐ Move Certificate](https://github.com/ys1231/MoveCertificate) ⭐ 1,963 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-02** - Move user certificates to system certificates. Supports Android 7-16. `FOSS` `[M]` `[K]`
* **[StrykerOSS](https://github.com/zalexdev/strykerapp) ⭐ 1,512 | 🐛 24 | 🌐 Java | 📅 2026-09-05** - Bundles a curated set of network, wireless and web security tools into a single rooted-Android application for penetration testing. `FOSS`
* **[⭐ Enable Screenshot](https://github.com/LSPosed/DisableFlagSecure) ⭐ 1,313 | 🐛 7 | 🌐 Java | 📅 2026-09-01** - Enabling screenshots in apps that normally wouldn't allow it, and disabling screenshot(Android 14+) and screen record(Android 15+) detection. `FOSS` `[LSP]`
...
* **[ih8SecureLock](https://github.com/j-hc/ih8SecureLock) ⭐ 179 | 🐛 2 | 🌐 C++ | 📅 2026-08-15** - Prevent apps from blocking and listening to your screenshots with Zygisk. `FOSS` `[M]` `[K]`
* **[⭐ SSL Killer](https://github.com/Xposed-Modules-Repo/com.simo.ssl.killer) ⭐ 169 | 🐛 0 | 📅 2026-08-04** - Bypass multiple ssl pinning implementations. `Proprietary` `[LSP]`
* **[TapDucky](https://github.com/iodn/tap-ducky) ⭐ 165 | 🐛 8 | 🌐 Dart | 📅 2026-05-17** - Open-source DuckyScript runner for rooted Android with USB Gadget (ConfigFS) support. `FOSS`  | [🌱](https://f-droid.org/en/packages/org.kaijinlab.tap_ducky/)
...
* **[Simple Flag Secure](https://github.com/ShivamXD6/Simple-Flag-Secure) ⭐ 106 | 🐛 4 | 🌐 Shell | 📅 2026-09-03** - Disable Secure Flag and allow taking screenshots/screen recording in apps supports KSU/APatch . `FOSS` `[M]` `[K]`
...
* **[Biometric App Lock](https://github.com/hxreborn/biometric-app-lock) ⭐ 51 | 🐛 6 | 🌐 Kotlin | 📅 2026-09-06** - Locks apps you choose behind fingerprint or face unlock. `FOSS` `[LSP]`
...
* **[Device Faker](https://github.com/Seyud/device_faker/) ⭐ 744 | 🐛 0 | 🌐 Vue | 📅 2026-09-06** - A device model spoofing module based on Zygisk that can configure different device models for different applications. `FOSS` `[M]` `[K]`
* **[DeviceID/SSAID Changer](https://github.com/sidex15/deviceidchanger) ⭐ 272 | 🐛 4 | 🌐 HTML | 📅 2025-12-19** - A simple WebUI Module to change SSAID/DeviceID on Rooted Android Devices with Apatch, KSU (And its forks), or Magisk. `FOSS` `[M]` `[K]`
...
* **[SpoofMyDevice](https://github.com/BuSung-dev/SpoofMyDevice) ⭐ 137 | 🐛 10 | 🌐 Java | 📅 2026-07-19** - Xposed module and companion app for building, saving, and applying spoofed Android device profiles to selected apps. `FOSS` `[LSP]`
* **[HideMyAndroid](https://github.com/Xposed-Modules-Repo/com.wowsoftware.hidemyandroid/) ⭐ 96 | 🐛 0 | 📅 2026-09-04** - Android anti-detect module with profile isolation and spoofing. `Proprietary` `[LSP]`
...
* **[Privacy Kit](https://github.com/Xposed-Modules-Repo/com.sal.privacykit) ⭐ 29 | 🐛 0 | 📅 2026-09-06** - Per-app Android identifier spoofing for LSPosed. `Proprietary` `[LSP]`

### App Isolation

* **[Island](https://github.com/oasisfeng/island/tree/dev) ⭐ 3,905 | 🐛 670 | 🌐 Java | 📅 2025-04-24** - App isolation and cloning. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=com.oasisfeng.island)
...
* **[FingerprintPay](https://github.com/eritpchy/FingerprintPay) ⭐ 4,499 | 🐛 35 | 🌐 Java | 📅 2026-03-06** - Enables fingerprint payment via WeChat, Alipay, Taobao, Tencent QQ, and UnionPay on phones that support fingerprint recognition. `FOSS` `[M]` `[LSP]`
...
* **[⭐ GPhotosUnlimited](https://github.com/Rev4N1/GPhotosUnlimited) ⭐ 356 | 🐛 1 | 🌐 C++ | 📅 2026-09-04** - A Zygisk module which gives unlimited Google Photos storage. `FOSS` `[M]` `[K]`
* **[Deekseep](https://github.com/lllucccian/Deekseep) ⭐ 283 | 🐛 3 | 🌐 Java | 📅 2026-08-28** - Adds account, chat, image, interface, and local API tools to the official DeepSeek Android app. `FOSS` `[LSP]`
* **[Spotify Plus](https://github.com/LeNerd46/SpotifyPlus) ⭐ 224 | 🐛 11 | 🌐 Java | 📅 2026-09-05** - Adds beautiful lyrics to Spotify. `FOSS` `[LSP]`
...
* **[Nexus](https://github.com/niki914/agentic-nexus) ⭐ 141 | 🐛 25 | 🌐 Kotlin | 📅 2026-09-06** - Plug your own model into your phone's voice assistant. `Proprietary` `[LSP]`
* **[GboardHook](https://github.com/chenyue404/GboardHook) ⭐ 136 | 🐛 2 | 🌐 Kotlin | 📅 2026-06-14** - Modifies the number of clipboard items displayed and their expiration time. `FOSS` `[LSP]`
...
* **[Spicy EX](https://github.com/amarinne/spicy-ex) ⭐ 25 | 🐛 1 | 🌐 Java | 📅 2026-09-04** - Adds Spicy lyrics in Spotify along with translation and much more UI features. `FOSS` `[LSP]`
...
* **[Timeline Unlocker](https://github.com/SherlockChiang/ReLocationReportEnabler) ⭐ 9 | 🐛 9 | 🌐 Java | 📅 2026-09-05** - Lets GMS Location History / Timeline be enabled on devices whose SIM is registered in a region where Google has restricted the feature. `FOSS` `[LSP]`
...
* **[BBZQ](https://github.com/HSSkyBoy/BBZQ) ⭐ 437 | 🐛 16 | 🌐 Kotlin | 📅 2026-09-02** - Removes unnecessary content, optimizes the core experience, and provide various practical functions. `FOSS` `[LSP]`

#### Discord

* **[Revenge](https://github.com/revenge-mod/revenge-bundle-next) ⭐ 172 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-05** - Revenge is a client modification for Discord Android. `FOSS`
* **[Kettu](https://github.com/C0C0B01/KettuXposed) ⭐ 49 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-02** - A Discord mobile app client modification continuing Bunny's mission. `FOSS` `[LSP]`
...
* **[InstaEclipse](https://github.com/ReSo7200/InstaEclipse/) ⭐ 1,425 | 🐛 21 | 🌐 Java | 📅 2026-07-24** - Adds Features like Developer Options, Ghost Mode, Ad-Free browsing, and Distraction-Free Mode to Instagram. `FOSS` `[LSP]`

#### Line

* **[Knot](https://github.com/2b-zipper/Knot) ⭐ 120 | 🐛 2 | 🌐 Java | 📅 2026-09-05** - Message privacy, notification tweaks & Screen display & UI mods for Line. `FOSS` `[LSP]`

#### QQ

* **[QAuxiliary](https://github.com/cinit/QAuxiliary) ⭐ 5,734 | 🐛 270 | 🌐 Java | 📅 2026-09-04** - Xposed module based on QNotified. `FOSS` `[LSP]`
* **[XAutoDaily](https://github.com/LuckyPray/XAutoDaily) ⭐ 1,584 | 🐛 37 | 🌐 Kotlin | 📅 2026-08-25** - Various tweaks for QQ. `FOSS` `[LSP]`
* **[QFun](https://github.com/oneQAQone/QFun) ⭐ 255 | 🐛 1 | 🌐 Java | 📅 2026-09-02** - Functionality enhancement module developed based on the Xposed framework. `FOSS` `[LSP]`
* **[TCQT Module](https://github.com/callng/TCQT) ⭐ 235 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-06** - An Xposed module designed for Android QQ/TIM clients, which is used to intercept and retain messages that would otherwise be "retracted". `FOSS` `[LSP]`
...
* **[Morphe Reddit Patches](https://github.com/MorpheApp/morphe-patches#-patches-list) ⭐ 3,535 | 🐛 483 | 🌐 Java | 📅 2026-09-06** - Various patches for reddit. `FOSS`
* **[Patcheddit](https://github.com/wchill/patcheddit) ⭐ 785 | 🐛 49 | 🌐 Kotlin | 📅 2026-05-03** - Custom patches with features like view: deleted Reddit posts & comments,Banned subreddits etc. `FOSS`
* **[Adobo Patches](https://github.com/jkennethcarino/adobo/) ⭐ 246 | 🐛 10 | 🌐 Kotlin | 📅 2026-09-06** - Various patches for reddit app. `FOSS`
...
* **[Telegami](https://github.com/aoya111/Telegami) ⭐ 231 | 🐛 36 | 🌐 Kotlin | 📅 2026-09-04** - Various tweaks for Telegram. `FOSS` `[LSP]`
...
* **[GramSieve](https://github.com/Xposed-Modules-Repo/com.tianqianguai.gramsieve) ⭐ 29 | 🐛 0 | 🌐 Java | 📅 2026-09-06** - Message filtering, host-settings integration, anti-recall, anti-edit/edit interception etc. `Proprietary` `[LSP]`

#### TikTok

* **[Douyin Enhancer](https://github.com/twyora/DouyinEnhancer) ⭐ 110 | 🐛 6 | 🌐 Kotlin | 📅 2026-09-05** - Adds minor quality-of-life features to Douyin (Chinese TikTok). `FOSS` `[LSP]`
* **[Toki](https://github.com/MeiYongAI/Toki) ⭐ 70 | 🐛 4 | 🌐 Java | 📅 2026-08-19** - Adds various tweaks to TikTok app. `FOSS` `[LSP]`
...
* **[WeChat Auxiliary](https://github.com/HdShare/WAuxiliary_Public) ⭐ 3,991 | 🐛 12 | 🌐 Kotlin | 📅 2026-05-31** - Various tweaks for WeChat. `Proprietary` `[LSP]`
...
* **[⭐ WA Enhancer](https://github.com/Dev4Mod/WaEnhancer) ⭐ 1,685 | 🐛 245 | 🌐 Kotlin | 📅 2026-09-06** - Enhances your WhatsApp experience. `FOSS` `[LSP]`
* **[WA Enhancer X](https://github.com/Xposed-Modules-Repo/com.waenhancer) ⭐ 37 | 🐛 0 | 📅 2026-09-05** - Fork of WA Enhancer with additional features. `Proprietary` `[LSP]`
* **[WAPlus](https://github.com/RevealedSoulEven/WAPlusXposed) ⭐ 36 | 🐛 0 | 🌐 Kotlin | 📅 2026-06-29** - Unlock WhatsApp Plus Features. `FOSS` `[LSP]`
* **[WaThemer](https://github.com/ayane-04/wathemer) ⭐ 10 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-03** - Themes WhatsApp with custom colors, chat bubble shapes, wallpapers, fonts, icons, system bars and a Liquid Glass mode. Requires Android 12+. `FOSS` `[LSP]`

#### X/Twitter

* **[⭐ Piko Patches](https://github.com/crimera/piko) ⭐ 5,131 | 🐛 234 | 🌐 Java | 📅 2026-09-06** - Morphe patches for twitter with features like hide promoted tweets, hide promoted accounts, hide promoted trends, hide "who to follow" etc. `FOSS`
* **[Re:X](https://github.com/Xposed-Modules-Repo/one.dot.rex) ⭐ 186 | 🐛 0 | 📅 2026-08-30** -  Tweaks for the new X / Twitter app. `Proprietary` `[LSP]`
...
* **[BetterVia](https://github.com/JiGuroLGC/BetterVia) ⭐ 1,288 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-25** - Bypass whitelist restrictions, Screenshot protection, Block components, One-tap theme switching etc. `FOSS` `[LSP]`
...
* **[EdgeX](https://github.com/SoClear/EdgeX) ⭐ 145 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-06** - An Xposed module for Microsoft Edge on Android, designed to enhance your browsing experience with UI tweaks and functional improvements. `FOSS` `[LSP]`
...
* **[Fxxk-MiBrowser](https://github.com/DuhMatt/Fxxk-MiBrowser) ⭐ 31 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-06** - Redirects forced Xiaomi Browser links to the system default browser. `FOSS` `[LSP]`

### YouTube & Media Mods

* **[NexAlloy](https://github.com/NexAlloy/NexAlloy) ⭐ 2,942 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-04** - YouTube, YT Music block ads, background playback, sponsorblock and much more. Also unlocks premium features of Strava and Photomath. Unlimited Google Photos backup. `FOSS` `[LSP]`
* **[PolyglotYT](https://github.com/Dr-TSNG/PolyglotYT) ⭐ 183 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-15** - Immersive translation Xposed module for YouTube app. `FOSS` `[LSP]`
...
* **[⭐ Core Patch N](https://github.com/LSPosed/CorePatch) ⭐ 3,328 | 🐛 10 | 🌐 Kotlin | 📅 2026-07-26** - Disable signature verification For Android. `FOSS` `[LSP]`
* **[⭐ Pairipfix](https://github.com/ahmedmani/pairipfix) ⭐ 660 | 🐛 20 | 🌐 Java | 📅 2026-04-20** - Bypasses the "Get this app from Play" screen that appears when installing Android apps as an APK instead of from the Google Play Store. `FOSS` `[LSP]`
* **[F\*\*k Google License](https://github.com/JiGuroLGC/FuckGoogleLicense) ⭐ 213 | 🐛 0 | 🌐 Java | 📅 2026-08-16** - Bypass Google Service License Verification. `FOSS` `[LSP]`
...
* **[Material Files](https://github.com/zhanghai/MaterialFiles) ⭐ 8,878 | 🐛 628 | 🌐 Kotlin | 📅 2026-04-06** - Modern file manager with root capabilities. `FOSS` | [🌱](https://f-droid.org/packages/me.zhanghai.android.files)| [▶️](https://play.google.com/store/apps/details?id=me.zhanghai.android.files)
* **[AnExplorer](https://github.com/1hakr/AnExplorer) ⭐ 2,023 | 🐛 36 | 🌐 Java | 📅 2026-06-02** - A simple, Small, Fast and Efficient File Explorer. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=dev.dworks.apps.anexplorer)
* **[Fossify File Manager](https://github.com/FossifyOrg/File-Manager) ⭐ 1,740 | 🐛 96 | 🌐 Kotlin | 📅 2026-09-06** - Easy app for managing your files without ads, respecting your privacy and security. `FOSS` | [🌱](https://f-droid.org/packages/org.fossify.filemanager/) | [▶️](https://play.google.com/store/apps/details?id=org.fossify.filemanager)
* **[NoStorageRestrict](https://github.com/Xposed-Modules-Repo/com.github.dan.nostoragerestrict) ⭐ 515 | 🐛 3 | 🌐 Java | 📅 2026-07-29** - Removes the restriction when selecting folders (Sdcard, Download, data and obb) through the file manager on Android 11 and higher. `FOSS`
...
* **[Sortify](https://github.com/xCaptaiN09/Sortify) ⭐ 38 | 🐛 0 | 🌐 Shell | 📅 2026-01-19** - Automatically organizes files in your Download folder. `FOSS` `[M]` `[K]`
...
* **[DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,315 | 🐛 190 | 🌐 Kotlin | 📅 2026-09-06** - DataBackup for Android 7.0+. `FOSS` | [🌱](https://f-droid.org/zh_Hans/packages/com.xayah.databackup.foss/)
* **[Neo Backup](https://github.com/NeoApplications/Neo-Backup) ⭐ 3,796 | 🐛 242 | 🌐 Kotlin | 📅 2026-05-03** - Powerful open-source backup solution. `FOSS` | [🌱](https://f-droid.org/packages/com.machiav3lli.backup/)
* **[Restoid](https://github.com/hddq/restoid) ⭐ 169 | 🐛 22 | 🌐 Kotlin | 📅 2026-09-03** - modern, root-based Android app backup tool powered by restic. `FOSS`
...
* **[⭐ SD Maid 2/SE](https://github.com/d4rken-org/sdmaid-se) ⭐ 7,472 | 🐛 13 | 🌐 Kotlin | 📅 2026-09-06** - A file management tool for Android that specializes in maintenance. Its core purpose is freeing up space and removing unwanted data. `FOSS` | [🌱](https://f-droid.org/en/packages/eu.darken.sdmse/) | [▶️](https://play.google.com/store/apps/details?id=eu.darken.sdmse)
* **[Cleaner Royall](https://github.com/araafroyall/Cleaner-Royall) ⭐ 241 | 🐛 0 | 🌐 Shell | 📅 2026-09-05** - A lightweight but ultra-fast and powerful cleaner for Android. `Proprietary` `[LSP]`
...
* **[CZero](https://github.com/Xocio/CZero) ⭐ 57 | 🐛 1 | 📅 2026-09-05** - Cleans the cache of frequently used apps, and adds background suppression, empty-folder cleanup, and F2FS garbage collection. `FOSS` `[M]` `[K]`
* **[ClearBox](https://github.com/FLYCOM-E/ClearBox) ⭐ 38 | 🐛 1 | 🌐 C | 📅 2026-09-06** - Can delete all software caches, installation packages, compressed packages, garbage, empty folders etc. `Proprietary` `[M]` `[K]`
...
* **[Iconify](https://github.com/Mahmud0808/Iconify) ⭐ 3,159 | 🐛 99 | 🌐 Kotlin | 📅 2026-08-30** - Customize your Android 12+ device easily. `FOSS` `[M]`
* **[ColorBlendr](https://github.com/Mahmud0808/ColorBlendr) ⭐ 2,433 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-03** - Customize Material You colors of your device. `FOSS` | [🌱](https://f-droid.org/en/packages/com.drdisagree.colorblendr/)
* **[HyperLight](https://github.com/KiminonawaResa/HyperLight#english) ⭐ 725 | 🐛 50 | 📅 2026-09-06** - Completes the highlight blur effects for HyperOS 3, bringing a unified visual experience to the desktop, notification shade, and control center. `FOSS` `[LSP]`
* **[Global Icon Pack](https://github.com/RichardLuo0/global-icon-pack-android) ⭐ 410 | 🐛 6 | 🌐 Kotlin | 📅 2026-09-06** - Apply icon packs globally. `FOSS` `[LSP]`
...
* **[Activity Manager](https://github.com/sdex/ActivityManager) ⭐ 1,309 | 🐛 16 | 🌐 Kotlin | 📅 2026-07-25** - Discover the activities of installed applications, run them, and create shortcuts. `FOSS` | [🌱](https://f-droid.org/packages/com.activitymanager/)
...
* **[Pixel Launcher Enhanced](https://github.com/Mahmud0808/PixelLauncherEnhanced) ⭐ 525 | 🐛 22 | 🌐 Kotlin | 📅 2026-08-02** - Unlock a variety of exciting features including customizing the look to adding more functionality and many more. `FOSS` `[LSP]`
* **[HyperOS Launcher](https://github.com/Mods-Center/HyperOS-Launcher#hyperos-launcher-v5) ⭐ 395 | 🐛 64 | 📅 2026-09-01** - Enhanced HyperOS Launcher with features from high-end devices, including customizable app drawer, icon packs, and more. `Proprietary` `[M]` `[K]`
...
* **[NavTweaks](https://github.com/Magisk-Modules-Alt-Repo/HideNavBar) ⭐ 804 | 🐛 28 | 🌐 JavaScript | 📅 2026-06-23** - Fullscreen/Immersive Gesture Tweaks for Android 10-14. `FOSS` `[M]`
* **[Lyricon](https://github.com/tomakino/lyricon) ⭐ 746 | 🐛 38 | 🌐 Kotlin | 📅 2026-08-30** - An Android status bar lyric enhancement tool based on the Xposed framework. `FOSS` `[LSP]`
* **[LyricProvider](https://github.com/tomakino/LyricProvider/tree/master) ⭐ 378 | 🐛 45 | 🌐 Kotlin | 📅 2026-08-26** - A lyric provider for Lyricon. `FOSS` `[LSP]`
...
* **[QS Boundless Tiles](https://github.com/hxreborn/qs-boundless-tiles) ⭐ 33 | 🐛 5 | 🌐 YAML | 📅 2026-09-05** - Keeps third-party Quick Settings tiles responsive on Android 13+. `FOSS` `[LSP]`
...
* **[Three-Finger-Screenshot](https://github.com/hxreborn/three-finger-swipe) ⭐ 41 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-28**- Standalone LSPosed implementation of three-finger swipe. `FOSS` `[LSP]`
...
* **[MakeFontsGreatAgain](https://github.com/Numbersf/MakeFontsGreatAgain) ⭐ 308 | 🐛 10 | 🌐 C | 📅 2026-09-03** - System-wide Font Overrider with Unique GMS Masking & Multi-Range Unicode Filter. `FOSS` `[M]` `[K]`
...
* **[HyperIsland](https://github.com/1812z/HyperIsland/blob/main/README_EN.md) ⭐ 486 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-06** - Dynamic Island-style notifications for HyperOS 3, powered by LSPosed. `FOSS` `[LSP]`
* **[Punch-hole Download Progress](https://github.com/hxreborn/punch-hole-download-progress) ⭐ 235 | 🐛 8 | 🌐 Kotlin | 📅 2026-09-05** - Displays download progress as an animated ring around the camera cutout. `FOSS` `[LSP]` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/eu.hxreborn.phdp)
* **[Notification Icon Fix](https://github.com/Xposed-Modules-Repo/io.github.howard20181.notificationiconfix/) ⭐ 81 | 🐛 10 | 📅 2026-03-22** - A module for AOSP, MIUI and HyperOS. Using an algorithm to convert white notification icons into recognizable icons. `FOSS` `[LSP]`
...
* **[ColorOS Live Lyrics Bridge](https://github.com/Andrea-lyz/ColorOS-Live-Lyrics-Bridge) ⭐ 166 | 🐛 7 | 🌐 Java | 📅 2026-09-06** - Bridges timed lyrics from supported players into the ColorOS/OPlus lock-screen lyric pipeline. `FOSS` `[LSP]`
...
* **[Adaptive Theme: Auto Dark Mode by Ambient Light](https://github.com/xLexip/Adaptive-Theme) ⭐ 222 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-04** - Automatically switches between Light and Dark mode using the ambient light sensor. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=dev.lexip.hecate)
* **[Anti Brightness Change](https://github.com/binarynoise/XposedModulets) ⭐ 218 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-03** - Prevents every app from changing the screen brightness. `FOSS` `[LSP]` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/com.programminghoch10.AntiBrightnessChange)
...
* **[DPIS](https://github.com/Kwensiu/DPIS) ⭐ 96 | 🐛 16 | 🌐 Java | 📅 2026-09-06** - LSPosed module for per-app interface scale, smallest width, and font size tuning. `FOSS` `[LSP]`
* **[DarQ Fork](https://github.com/Arora-Sir/DarQ) ⭐ 90 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-06** - Provides a per-app selectable force dark option for Android 10 and above. `FOSS`
...
* **[⭐ ViPERFX\_RE](https://github.com/likelikeslike/ViPERFX_RE) ⭐ 307 | 🐛 3 | 🌐 C | 📅 2026-08-11** - A fork of ViPER4Android FX with a redesigned UI and additional features. `FOSS` `[M]` `[K]`
* **[NLSound](https://github.com/Briclyaz/NLSound_module_QCom) ⭐ 294 | 🐛 2 | 🌐 Shell | 📅 2025-05-05** - Magisk module for improving audio and microphone quality in your Snapdragon SoC device. `FOSS` `[M]`
* **[Audio Modification Library Ryuki Mod](https://github.com/reiryuki/Audio-Modification-Library-Ryuki-Mod-Magisk-Module) ⭐ 285 | 🐛 0 | 🌐 Shell | 📅 2026-08-01** - Enables supported audio mods to share the same needed files, such as audio\_effects. `FOSS` `[M]`

### Audio Control

* **[LibrePods](https://github.com/kavishdevar/librepods) ⭐ 29,756 | 🐛 281 | 🌐 Kotlin | 📅 2026-09-01** - Unlocks Apple's exclusive premium AirPods features on non-Apple devices. `FOSS` `[LSP]` `[M]` `[K]`
...
* **[SonyPods](https://github.com/Mercury000/SonyPods) ⭐ 28 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-06** - System-level Sony headphone control for HyperOS devices. `FOSS` `[LSP]`
* **[HuaweiPods](https://github.com/Nshpiter/HuaweiPods) ⭐ 18 | 🐛 4 | 🌐 Kotlin | 📅 2026-09-02** - Huawei audio device integration for Xiaomi HyperOS. `FOSS` `[LSP]`
...
* **[AdGuardHome for Root](https://github.com/twoone-3/AdGuardHomeForRoot/blob/main/README_en.md#adguardhome-for-root) ⭐ 1,386 | 🐛 12 | 🌐 Shell | 📅 2026-08-25** - A module to easily execute AdGuardHome on Android. `FOSS` `[M]`
* **[personalDNSfilter](https://github.com/IngoZenz/personaldnsfilter) ⭐ 931 | 🐛 66 | 🌐 Java | 📅 2026-08-05** - A DNS filter proxy that provides local filtering of ads, malware, and tracking servers, supporting secure DNS protocols like DOH and DOT for enhanced privacy. `FOSS` | [🌱](https://f-droid.org/packages/dnsfilter.android/)
* **[Pi-hole-for-Android](https://github.com/DesktopECHO/Pi-hole-for-Android) ⭐ 653 | 🐛 1 | 🌐 Shell | 📅 2025-12-26** - Pi-hole/Unbound Raspbian APK installer for Android 5.0+ devices. `FOSS`
* **[DNS Toggle](https://github.com/ELowry/DNSToggle) ⭐ 109 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-06** - A tiny Android app that allows you to easily toggle your phone's Private DNS through the Quick Settings panel. `FOSS`
...
* **[FlClash](https://github.com/chen08209/FlClash) ⭐ 51,105 | 🐛 517 | 🌐 Dart | 📅 2026-09-05** - A multi-platform proxy client based on ClashMeta, simple and easy to use, open-source and ad-free. `FOSS`
* **[VPN Hotspot](https://github.com/Mygod/VPNHotspot) ⭐ 6,409 | 🐛 24 | 🌐 Kotlin | 📅 2026-09-04** - Share your VPN connection over hotspot or repeater. `FOSS`
* **[Box for Root](https://github.com/taamarin/box_for_magisk) ⭐ 2,512 | 🐛 85 | 🌐 Shell | 📅 2025-10-21** - Box for Root (BFR) is a Magisk, KernelSU, APatch, module that provides a suite of proxy tools, including clash, sing-box, v2ray, hysteria and xray. It allows you to configure a transparent proxy on Android devices with root access. `FOSS` `[M]` `[K]`
* **[Surfing](https://github.com/GitMetaio/Surfing) ⭐ 2,383 | 🐛 80 | 🌐 Shell | 📅 2026-09-06** - Magisk and KernelSU modules for Clash/mihomo, sing-box, v2ray, xray, hysteria services. `FOSS` `[M]` `[K]`
* **[Box4Magisk / KernelSU / APatch](https://github.com/CHIZI-0618/box4magisk) ⭐ 1,896 | 🐛 3 | 🌐 Shell | 📅 2026-09-06** - Deploy multiple proxy cores on Android devices, including clash, mihomo, sing-box, v2ray, xray, and hysteria. `FOSS` `[M]` `[K]`
* **[NetProxy-Magisk](https://github.com/Fanju6/NetProxy-Magisk) ⭐ 1,168 | 🐛 26 | 🌐 Go | 📅 2026-09-06** - Magisk proxy module based on Xray kernel, supports one-click start/stop transparent proxy. `FOSS` `[M]`
* **[VPN Hide](https://github.com/okhsunrog/vpnhide) ⭐ 540 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-06** - Hide active VPN from selected Android apps (kernel module + LSPosed + Zygisk) `FOSS` `[M]` `[K]`
* **[ZDT-D Root Module](https://github.com/GAME-OVER-op/ZDT-D) ⭐ 274 | 🐛 6 | 🌐 Kotlin | 📅 2026-09-02** - Module for traffic routing, DPI bypass, proxy chaining, DNS control, and per-app network management. `FOSS` `[M]` `[K]`
...
* **[Happwner](https://github.com/Omegaplexx/Happwner) ⭐ 111 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-21** - Exporte Happ subscriptions to other VPN clients. `FOSS` `[LSP]`
* **[NoVPNDetect Enhanced](https://github.com/BlueCat300/NoVPNDetectEnhanced/) ⭐ 90 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-06** - An enhanced version of NoVPNDetect that prevents apps from detecting VPN usage by modifying system properties and network configurations. `FOSS` `[LSP]`
...
* **[MagicNet](https://github.com/LIghtJUNction/MagicNet#english-summary) ⭐ 162 | 🐛 0 | 🌐 Shell | 📅 2026-09-06** - Module for device-side traffic governance that enforce network rules below the app layer instead of relying on every app to respect a proxy setting. `FOSS` `[M]` `[K]`
* **[TCP Optimiser Module](https://github.com/fatalcoder524/TCP_Optimiser_Module) ⭐ 150 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-01** - Change tcp congestion algorithm based on current active internet type and some network enhancements. `FOSS` `[M]` `[K]`
...
* **[Network Switch](https://github.com/aunchagaonkar/NetworkSwitch#installation) ⭐ 461 | 🐛 23 | 🌐 Kotlin | 📅 2026-08-20** - Modern Android app for 4G/5G network mode switching. `FOSS` | [🌱](https://apt.izzysoft.de/packages/com.supernova.networkswitch)
* **[WiFi Password Manager](https://github.com/Khh-vu/wifi-password-manager) ⭐ 295 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-29** - Simple app to manage WiFi passwords. `FOSS` | [🌱](https://apt.izzysoft.de/packages/io.github.wifi_password_manager)
* **[VirtualAP](https://github.com/ravindu644/VirtualAP) ⭐ 77 | 🐛 2 | 🌐 Kotlin | 📅 2026-07-16** - Turn a rooted Android phone into Wi-Fi access point with static gateway, selectable upstream (mobile data, Wi-Fi, Ethernet, or a VPN tunnel) etc. `FOSS` `[LSP]`
...
* **[Wi‑Fi Passwords Exporter](https://github.com/mlm-games/wifi-exporter) ⭐ 33 | 🐛 2 | 🌐 Rust | 📅 2026-09-05** - Android app that exports wifi passwords. `FOSS`
...
* **[NFCGate](https://github.com/nfcgate/nfcgate) ⭐ 2,355 | 🐛 12 | 🌐 Java | 📅 2026-07-20** - Android application meant to capture, analyze, or modify NFC traffic. `FOSS` `[LSP]` | [🌱](https://f-droid.org/packages/de.tu_darmstadt.seemoo.nfcgate/)
* **[onHit](https://github.com/0penPublic/onHit) ⭐ 84 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-04** - Trigger Android NFC events without a physical tag by Xposed. `FOSS` `[LSP]`
...
* **[Hide Mock Location](https://github.com/auag0/HideMockLocation) ⭐ 365 | 🐛 13 | 🌐 Kotlin | 📅 2026-05-12** - Hide Mock Location Settings. `FOSS` `[LSP]`
...
* **[HLocation](https://github.com/sparr-sherrya/hlocation-release) ⭐ 61 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-05** - Location spoofing framework that synchronizes fake GPS and related environment signals across system and app processes for more consistent location virtualization. `FOSS` `[LSP]`
...
* **[AnyWhere](https://github.com/cxOrz/AnyWhere) ⭐ 25 | 🐛 0 | 🌐 Java | 📅 2026-09-02** - Location simulation tool for debugging LBS applications and for users to test geolocation functionality. `FOSS` `[LSP]`
...
* **[AsoulOpt](https://github.com/nakixii/Magisk_AsoulOpt) ⭐ 2,692 | 🐛 0 | 🌐 Shell | 📅 2026-08-09** - Game threads tweaker for Android, suitable for mainstream games and some niche games. `FOSS` `[M]`
* **[Uperf-Game-Turbo](https://github.com/yinwanxi/Uperf-Game-Turbo) ⭐ 1,536 | 🐛 0 | 🌐 Shell | 📅 2026-07-31** - Userspace performance controller for Android. `FOSS` `[M]`
...
* **[⭐ Termux](https://github.com/termux/termux-app) ⭐ 60,424 | 🐛 608 | 🌐 Java | 📅 2026-09-06** - A terminal emulator application for Android OS extendible by variety of packages. `FOSS` | [🌱](https://f-droid.org/en/packages/com.termux)
* **[aShell You](https://github.com/DP-Hridayan/aShellYou) ⭐ 2,306 | 🐛 37 | 🌐 Kotlin | 📅 2026-09-06** - Android shell utility app with Material Design 3 UI, letting you run ADB, root and shell commands. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/in.hridayan.ashell)
* **[Termux-Root-Recovery-Tool](https://github.com/Ishu43642/Termux-Root-Recovery-Tool) ⭐ 265 | 🐛 5 | 🌐 Shell | 📅 2026-03-17** - Install GSi Rom , Flashing Fastboot Rom, install Twrp Recovery, Boot.img & vbmeta.img files. `FOSS`
...
* **[Magisk-WiFiADB](https://github.com/mrh929/magisk-wifiadb) ⭐ 268 | 🐛 4 | 🌐 Shell | 📅 2025-05-05** - Enable WiFi ADB automatically. `FOSS` `[M]`
...
* **[Hotspot Wireless Debugging](https://github.com/droserasprout/io.drsr.hotspotadb) ⭐ 17 | 🐛 4 | 🌐 Kotlin | 📅 2026-07-18** - Xposed module to allow Wireless Debugging over Wi-Fi Hotspot. `FOSS` `[LSP]`
...
* **[Shizuku](https://github.com/RikkaApps/Shizuku) ⭐ 29,824 | 🐛 567 | 🌐 Kotlin | 📅 2025-06-18** - Use system APIs directly with ADB/root privileges. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/moe.shizuku.privileged.api) | [▶️](https://play.google.com/store/search?q=shizuku\&c=apps)
* **[⭐ Shizuku Fork](https://github.com/thedjchi/Shizuku) ⭐ 5,563 | 🐛 70 | 🌐 Kotlin | 📅 2026-07-15** - Shizuku fork with automatic Shizuku startup, automation, and recovery features. `FOSS`
* **[Shevery](https://github.com/HmnDev-Tech/shevery) ⭐ 982 | 🐛 13 | 🌐 Kotlin | 📅 2026-09-06** - Based on shizuku with Jetpack Compose, Material 3, and compatibility enhancements. `FOSS`
...
* **[KSU Toolkit](https://github.com/backslashxx/ksu_toolkit) ⭐ 106 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-30** - Small extensions on top of KernelSU for testing and debugging purposes. `FOSS` `[K]`
...
* **[DuckPolicy](https://github.com/Xposed-Modules-Repo/com.strawing.duckdevicepolicy) ⭐ 26 | 🐛 0 | 📅 2026-09-06** - Makes apps see no device-policy restrictions on your own device. `Proprietary` `[LSP]`
* **[SideWire](https://github.com/mzggr0914/SideWire-KernelSU) ⭐ 21 | 🐛 0 | 🌐 Rust | 📅 2026-09-06** - Native bridge for controlling rooted Android devices from Windows, macOS, or Linux. `FOSS` `[K]`

### Linux Environments

* **[⭐ Droidspaces](https://github.com/ravindu644/Droidspaces-OSS) ⭐ 1,863 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-05** - Run full Linux environments on top of Android, with complete init system support. `FOSS`
...
* **[DebDroid](https://github.com/NICUP14/DebDroid) ⭐ 268 | 🐛 2 | 🌐 Shell | 📅 2026-06-06** - Debian Container Runtime for Android. `FOSS`
* **[Ubuntu Chroot](https://github.com/ravindu644/Ubuntu-Chroot) ⭐ 155 | 🐛 0 | 🌐 Python | 📅 2026-03-23** - Run Ubuntu 24.04 on Android With full Hardware Access and pure namespace isolation. `FOSS` `[M]` `[K]`
...
* **[crond4Android](https://github.com/powerAn2020/crond4android) ⭐ 35 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-07** - Cron daemon for scheduled jobs on KernelSU, APatch, and Magisk. `FOSS` `[M]` `[K]`
...
* **[USB HID Client](https://github.com/Arian04/android-hid-client) ⭐ 433 | 🐛 18 | 🌐 Kotlin | 📅 2026-09-05** - Use your phone as a keyboard and mouse without any software on the other end. `FOSS` | [🌱](https://apt.izzysoft.de/packages/me.arianb.usb_hid_client)
...
* **[Rclone Magisk Module](https://github.com/NewFuture/rclone-fuse3-magisk) ⭐ 69 | 🐛 7 | 🌐 Shell | 📅 2026-09-05** - Integrates Rclone with FUSE support into Android, allowing you to manage remote storage mounts seamlessly. `FOSS` `[M]`
...
* **[⭐ CleanShare](https://github.com/hxreborn/cleanshare) ⭐ 112 | 🐛 11 | 🌐 Kotlin | 📅 2026-09-01** - Removes Direct Share's suggested contact/conversation shortcuts from Android's Share Sheet. `FOSS` `[LSP]`
...
* **[ClipVault](https://github.com/kaduvert/AClipBoardManager) ⭐ 13 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-28** - Android ClipBoard Manager using LSPosed / Magisk. `FOSS` `[M]` `[K]` `[LSP]`

### Communication & Messaging

* **[Basic Call Recorder](https://github.com/chenxiaolong/BCR) ⭐ 2,900 | 🐛 13 | 🌐 Kotlin | 📅 2026-09-05** - A Basic Call Recorder for rooted Android devices. Also check out [GUI for BCR ↗](https://github.com/nicorac/bcr-gui) ⭐ 355 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-31. `FOSS` `[M]` `[K]`
...
* **[⭐ Essentials](https://github.com/sameerasw/essentials) ⭐ 2,852 | 🐛 89 | 🌐 Kotlin | 📅 2026-09-06** - Multi-purpose tweaks for display, notifications and alerts, security and privacy, sound and haptics, and app freezing. `FOSS`
* **[UotanToolbox NT](https://github.com/Uotan-Dev/UotanToolboxNT) ⭐ 2,690 | 🐛 4 | 🌐 C# | 📅 2026-08-30** - A modern toolbox for Android power users and geeks. `FOSS`
* **[SwitchAI - Switch AI Digital Assistant](https://github.com/WSTxda/SwitchAI) ⭐ 1,426 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-30** - Easily select, start, and manage your preferred AI digital assistants. `FOSS`
* **[Zygisk Sui](https://github.com/XiaoTong6666/Sui) ⭐ 666 | 🐛 3 | 🌐 Java | 📅 2026-09-04** - Modern superuser interface (SUI) implementation for Android. `FOSS` `[M]` `[K]`
* **[APatch Utilities](https://github.com/lzghzr/APatch_kpm) ⭐ 428 | 🐛 1 | 🌐 C | 📅 2026-06-06** - Collection of utility modules for APatch. `FOSS`
* **[XposedModulets](https://github.com/binarynoise/XposedModulets) ⭐ 218 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-03** - A collection of many small useful Xposed Modules. `FOSS` `[LSP]`
...
| 📂 **GitHub**    | Source, discussions & issues  | [GitHub Repo](https://github.com/awesome-android-root/awesome-android-root) ⭐ 4,536 \| 🐛 3 \| 🌐 Python \| 📅 2026-09-06 |
...
* 🐛 Report [issues](https://github.com/awesome-android-root/awesome-android-root/issues) ⭐ 4,536 | 🐛 3 | 🌐 Python | 📅 2026-09-06
...
**⚡ Built with ❤️ by [Awesome Android Root](https://github.com/awesome-android-root/awesome-android-root) ⭐ 4,536 | 🐛 3 | 🌐 Python | 📅 2026-09-06**
