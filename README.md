...
> For privacy-friendly installs, use the F-Droid ecosystem: install [Droid-ify](https://github.com/Droid-ify/client/releases) ⭐ 7,284 | 🐛 201 | 🌐 Kotlin | 📅 2026-08-20 (modern F-Droid client) and enable the [IzzyOnDroid](https://apt.izzysoft.de/fdroid/) repo for many additional packages.
...
| :----------------------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------- |
|       **[Magisk](https://github.com/topjohnwu/Magisk) ⭐ 62,316 \| 🐛 59 \| 🌐 Kotlin \| 📅 2026-08-18** <br><small> `Root & Module Management` </small>      | If you chose Magisk, this is your manager.               |
| **[App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 8,773 \| 🐛 218 \| 🌐 Java \| 📅 2026-06-29** <br><small> `App & Package Management` </small> | Inspect and manage apps with root privileges.            |
...
* **[⭐ Magisk](https://github.com/topjohnwu/Magisk) ⭐ 62,316 | 🐛 59 | 🌐 Kotlin | 📅 2026-08-18** - Manage Magisk modules and root permissions. `FOSS`
* **[⭐ KernelSU](https://github.com/tiann/KernelSU) ⭐ 17,927 | 🐛 61 | 🌐 Kotlin | 📅 2026-08-20** - A Kernel based root solution for Android. `FOSS`
* **[APatch](https://github.com/bmax121/APatch) ⭐ 7,821 | 🐛 84 | 🌐 Kotlin | 📅 2026-08-20** - The patching of Android kernel and Android system. `FOSS` | [🌱](https://f-droid.org/packages/me.bmax.apatch/)
* **[SukiSU-Ultra](https://github.com/SukiSU-Ultra/SukiSU-Ultra) ⭐ 6,131 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-15** - A kernel-based root solution for Android devices, forked from `KernelSU` with some useful changes. `FOSS`
* **[KernelSU-next](https://github.com/KernelSU-Next/KernelSU-Next) ⭐ 4,130 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-20** - An advanced Kernel based root solution for Android. `FOSS`
* **[ReSukiSU](https://github.com/ReSukiSU/ReSukiSU) ⭐ 1,247 | 🐛 15 | 🌐 Kotlin | 📅 2026-08-20** - Fork of SukiSU-Ultra with additional features. `FOSS`
* **[FolkPatch](https://github.com/LyraVoid/FolkPatch) ⭐ 1,056 | 🐛 28 | 🌐 Kotlin | 📅 2026-08-20** - A Root management tool focused on interface optimization and feature extension, based on APatch. `FOSS`

### Module Managers

* **[⭐ MMRL](https://github.com/DerGoogler/MMRL) ⭐ 2,130 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-18** - An Android app that helps manage your own modules repository. `FOSS` `[M]` `[K]` `[A]` | [🌱](https://f-droid.org/en/packages/com.dergoogler.mmrl/) | [▶️](https://play.google.com/store/apps/details?id=com.dergoogler.mmrl)
...
* **[Meta-hybrid\_mount](https://github.com/YuzakiKokuban/meta-hybrid_mount) ⭐ 1,451 | 🐛 3 | 🌐 Rust | 📅 2026-08-17** - Three-engine mount orchestration (OverlayFS + Magic Mount + Kasumi LKM) with conflict monitor, SolidJS WebUI, auto-fallback, and EROFS storage backend support. `FOSS` `[K]` `[A]`
* **[⭐ Mountify](https://github.com/backslashxx/mountify) ⭐ 1,305 | 🐛 23 | 🌐 Shell | 📅 2026-08-16** - OverlayFS with tmpfs/ext4 sparse support for reduced detection, works on APatch/Magisk too. `FOSS` `[M]` `[K]` `[A]`
* **[⭐ Meta-overlayfs](https://github.com/KernelSU-Modules-Repo/meta-overlayfs) ⭐ 458 | 🐛 8 | 🌐 Rust | 📅 2025-12-02** - Official reference implementation using OverlayFS for most users and standard setup. `FOSS` `[K]`
...
* **[⭐ Vector](https://github.com/JingMatrix/Vector) ⭐ 12,173 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-20** - Open Source *Fork* of original LSPosed with dynamic module loading, and other improvements. `FOSS` `[M]`
...
* **[⭐ Zygisk Next](https://github.com/Dr-TSNG/ZygiskNext) ⭐ 10,364 | 🐛 1 | 📅 2026-08-05** The "Gold Standard" for detection evasion. It is a standalone Zygisk implementation that offers the most advanced stealth features, including a dedicated **Zygote Monitor** and dashboard. `Proprietary` `[M]` `[K]` `[A]`
...
* **[NeoZygisk](https://github.com/JingMatrix/NeoZygisk) ⭐ 2,199 | 🐛 6 | 🌐 C++ | 📅 2026-08-09** A minimalist, high-stealth implementation using **ptrace injection**. It focuses on "trace cleaning," aiming to remove all injection artifacts from memory once modules are loaded. `FOSS` `[M]` `[K]` `[A]`
...
* **[Hide My Applist](https://github.com/Dr-TSNG/Hide-My-Applist) ⭐ 5,522 | 🐛 9 | 🌐 Kotlin | 📅 2026-08-01** - Intercepts app-list detection. `Proprietary` `[LSP]`
* **[Play Integrity Fork (PIF)](https://github.com/osm0sis/PlayIntegrityFork) ⭐ 4,402 | 🐛 0 | 🌐 C++ | 📅 2026-08-08** - The most actively maintained PIF. Fixes `DEVICE_INTEGRITY` verdicts with custom fields/props. Recommended starting point after chiteroman's original was discontinued. `FOSS` `[M]`
* **[Play Integrity Fix (inject)](https://github.com/KOWX712/PlayIntegrityFix) ⭐ 3,756 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-18** - Actively maintained fork using injected GMS/Play Store spoofing with a WebUI. `FOSS` `[M]`
* **[Tricky Addon – Update Target List](https://github.com/KOWX712/Tricky-Addon-Update-Target-List) ⭐ 3,392 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-18** - KSU WebUI to configure TrickyStore's `target.txt`. `FOSS` `[K]`
* **[⭐ HMA-OSS](https://github.com/frknkrc44/HMA-OSS) ⭐ 2,910 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-20** - FOSS rewrite of Hide My Applist; hides your app list, settings, and package installers. `FOSS` `[LSP]`
* **[Zygisk Assistant](https://github.com/snake-4/Zygisk-Assistant) ⭐ 2,572 | 🐛 17 | 🌐 C++ | 📅 2026-05-04** - Zygisk module to hide root on KernelSU, Magisk, and APatch. `FOSS` `[M]`
* **[⭐ SUSFS for KernelSU](https://github.com/sidex15/susfs4ksu-module) ⭐ 2,512 | 🐛 2 | 🌐 HTML | 📅 2026-08-08** - Add-on root-hiding service for SUSFS-patched kernels (KernelSU/Next). The core of modern KSU hiding setups. `FOSS` `[M]` `[K]`
* **[⭐ TEESimulator](https://github.com/JingMatrix/TEESimulator) ⭐ 2,240 | 🐛 4 | 🌐 C++ | 📅 2026-08-20** - Create a complete, software-based simulation of a hardware-backed Trusted Execution Environment (TEE) for Key Attestation. `FOSS` `[M]` `[K]`
* **[YuriKey](https://github.com/dpejoh/yurikey) ⭐ 1,855 | 🐛 9 | 🌐 Shell | 📅 2026-08-01** - Systemless module to obtain strong integrity easily. `FOSS` `[M]` `[K]`
* **[TEESimulator-RS](https://github.com/Enginex0/TEESimulator-RS) ⭐ 1,620 | 🐛 22 | 🌐 Kotlin | 📅 2026-07-11** - Fork of TEESimulator with native Rust certificate generation, key persistence, and AOSP-compliant attestation behavior. `FOSS` `[M]` `[K]`
* **[NoHello](https://github.com/MhmRdd/NoHello) ⭐ 1,345 | 🐛 21 | 🌐 C++ | 📅 2025-06-28** - Lightweight Zygisk module to hide root. `FOSS` `[M]`
* **[TrickyStore OSS](https://github.com/beakthoven/TrickyStoreOSS) ⭐ 1,295 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-20** - Open-source alternative to TrickyStore. `FOSS` `[M]` `[K]`
...
* **[Specter](https://github.com/dpejoh/specter) ⭐ 531 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-19** - Unified Play Integrity and root hiding stack for Android. Successor of Yurikey. `FOSS` `[M]` `[K]`
...
* **[⭐ BRENE](https://github.com/rrr333nnn333/BRENE) ⭐ 324 | 🐛 11 | 🌐 Shell | 📅 2026-08-20** - SUSFS/KernelSU module for patched kernels with enhanced root hiding & spoofing. `FOSS` `[M]` `[K]`
* **[Always Strong](https://github.com/evoker0/AlwaysStrong) ⭐ 313 | 🐛 5 | 🌐 Shell | 📅 2026-08-16** - Bundles TEESimulator-RS and PlayIntegrityFork into a single module for strong integrity on rooted devices. `FOSS` `[M]` `[K]`
* **[OhMyKeymint](https://github.com/qwq233/OhMyKeymint) ⭐ 264 | 🐛 2 | 🌐 Rust | 📅 2026-08-12** - Custom keystore implementation for Android Keystore Spoofer. `FOSS` `[M]` `[K]`
* **[ReZygisk's Treat Wheel](https://github.com/PerformanC/Treat-Wheel-Zygisk) ⭐ 245 | 🐛 7 | 🌐 C | 📅 2026-07-22** - Hides Magisk/root traces exclusively for ReZygisk, acting as the best userspace root hiding tool. `FOSS` `[M]` `[K]`
* **[DirtySepolicy Bypass](https://github.com/flipphoneguy/DirtySepolicy_Bypass) ⭐ 73 | 🐛 9 | 🌐 C++ | 📅 2026-06-19** - Bypasses new DirtySepolicy on rooted Android devices to keep apps working. `FOSS` `[M]` `[K]` `[A]`
...
* **[⭐ Android-Native-Root-Detector](https://github.com/reveny/Android-Native-Root-Detector) ⭐ 1,373 | 🐛 16 | 🌐 Kotlin | 📅 2026-04-11** - A tool for detecting root on android. `FOSS`
...
* **[Duck Detector](https://github.com/eltavine/Duck-Detector-Refactoring) ⭐ 876 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-20** - Android environment integrity inspection tool for root, hook, bootloader, SELinux, virtualization, and attestation signals. `FOSS`
...
* **[⭐ Duck Detector Fork](https://github.com/rrr333nnn333/Duck-Detector-Refactoring) ⭐ 41 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-20** - Duck Detector fork with additional features and improvements. `FOSS`
...
* **[PIXELIFY NEXT](https://github.com/BasGame1/Pixelify-Next) ⭐ 304 | 🐛 13 | 🌐 Shell | 📅 2026-08-20** - A Magisk Module which enables Pixel UI and some exclusive features. `FOSS` `[M]`
...
* **[LuckyTool](https://github.com/Xposed-Modules-Repo/com.luckyzyx.luckytool/blob/main/README_EN.md) ⭐ 1,874 | 🐛 8 | 📅 2026-04-26** - Extended functionality and optimization module for ColorOS. `Proprietary` `[LSP]`
* **[OShin](https://github.com/suqi8/OShin/blob/master/README_EN.md) ⭐ 1,162 | 🐛 99 | 🌐 Kotlin | 📅 2026-07-28** - Auxiliary module deeply integrated with ColorOS, designed to enhance and optimize your operating system experience. `FOSS` `[LSP]`
...
* **[⭐ HyperCeiler](https://github.com/ReChronoRain/HyperCeiler/blob/main/README_en-US.md) ⭐ 5,233 | 🐛 228 | 🌐 Java | 📅 2026-08-20** - Extensive customizations for HyperOS. `FOSS` `[LSP]`
* **[Pengeek](https://github.com/monwf/customiuizer) ⭐ 1,463 | 🐛 48 | 🌐 Java | 📅 2026-05-19** - Customize your HyperOS to your liking. For HyperOS based on Android 14. `FOSS` `[LSP]`
* **[Hyper Helper](https://github.com/HowieHChen/XiaomiHelper/blob/master/README_EN-US.md) ⭐ 342 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-16** - Lightweight customization module for HyperOS only. `FOSS` `[LSP]`
...
* **[⭐ KnoxPatch](https://github.com/salvogiangri/KnoxPatch) ⭐ 1,484 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-11** - Get Samsung apps/features working again in your rooted Galaxy device. For better experience, please also [read this ↗](https://github.com/salvogiangri/KnoxPatch?tab=readme-ov-file#knoxpatch-enhancer) ⭐ 1,484 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-11 . `FOSS` `[LSP]`
* **[One UI X](https://github.com/SoClear/OneUIX) ⭐ 172 | 🐛 17 | 🌐 Kotlin | 📅 2026-08-19** - Remove annoying restrictions, and inject powerful enhancements into the Status Bar, Quick Settings, and native apps etc on Samsung's One UI. `FOSS` `[LSP]`
...
* **[⭐ Canta](https://github.com/samolego/Canta) ⭐ 5,581 | 🐛 29 | 🌐 Kotlin | 📅 2026-08-16** - Uninstall any app without root using [Shizuku](#developer-tools). `FOSS` | [🌱](https://f-droid.org/en/packages/io.github.samolego.canta/) | [▶️](https://play.google.com/store/apps/details?id=io.github.samolego.canta)
...
* **[⭐ App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 8,773 | 🐛 218 | 🌐 Java | 📅 2026-06-29** - A full-featured package manager and viewer for Android. `FOSS` | [🌱](https://f-droid.org/packages/io.github.muntashirakon.AppManager/)
* **[⭐ Droid-ify](https://github.com/Droid-ify/client) ⭐ 7,284 | 🐛 201 | 🌐 Kotlin | 📅 2026-08-20** - F-Droid client with Material UI and auto updating apps using root. `FOSS` | [🌱](https://f-droid.org/packages/com.looker.droidify)
* **[⭐ Hail](https://github.com/aistra0528/Hail) ⭐ 6,490 | 🐛 168 | 🌐 Kotlin | 📅 2026-08-12** - Disable / Hide / Suspend / Uninstall Android apps. `FOSS` | [🌱](https://f-droid.org/packages/com.aistra.hail/)
* **[InstallerX-Revived](https://github.com/wxxsfxyzm/InstallerX-Revived) ⭐ 6,221 | 🐛 14 | 🌐 Kotlin | 📅 2026-08-20** - A modern and functional Android app installer. `FOSS` `[LSP]`
* **[Neo Store](https://github.com/NeoApplications/Neo-Store) ⭐ 4,919 | 🐛 129 | 🌐 Kotlin | 📅 2026-04-25** - An F-Droid client with modern UI and an arsenal of extra features. `FOSS` | [🌱](https://f-droid.org/packages/com.machiav3lli.fdroid)
* **[Aurora Store](https://github.com/whyorean/AuroraStore) ⭐ 2,849 | 🐛 26 | 🌐 Kotlin | 📅 2026-08-19** - A Google Play Store client to search, view app details, and download APKs directly to your device. `FOSS` | [🌱](https://f-droid.org/packages/com.aurora.store/)
* **[⭐ Zygisk Detach](https://github.com/j-hc/zygisk-detach) ⭐ 2,111 | 🐛 0 | 🌐 Rust | 📅 2026-07-09** - Zygisk module to detach installed apps from Play Store, hooking binder. `FOSS` `[M]` `[K]`
...
* **[Universal Installer](https://github.com/pass-with-high-score/universal-installer) ⭐ 1,280 | 🐛 23 | 🌐 Kotlin | 📅 2026-08-09** - Install and manage APK packages with split APK support. `FOSS` `[LSP]`
* **[InxLocker](https://github.com/Chimioo/InxLocker) ⭐ 859 | 🐛 2 | 🌐 Kotlin | 📅 2026-06-11** - Intercepts/forwards Android system application installation and uninstallation requests, redirecting them to your specified installer app. `FOSS` `[LSP]`
* **[Package Manager](https://github.com/SmartPack/PackageManager) ⭐ 811 | 🐛 90 | 🌐 Java | 📅 2026-06-17** - A highly powerful app to manage both system and user apps installed on an Android device. `FOSS` | [🌱](https://f-droid.org/packages/com.smartpack.packagemanager) | [▶️](https://play.google.com/store/apps/details?id=com.smartpack.packagemanager)
* **[BetterKnownInstalled](https://github.com/Pixel-Props/BetterKnownInstalled) ⭐ 538 | 🐛 3 | 🌐 Shell | 📅 2026-08-13** - Patches packages to fix DroidGuard UNKNOWN\_INSTALLED issues. `FOSS` `[LSP]`
* **[Thor](https://github.com/trinadhthatakula/Thor) ⭐ 517 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-20** - Android App Manager and App Installer utility. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/com.valhalla.thor) | [▶️](https://play.google.com/store/apps/details?id=com.valhalla.thor)
...
* **[COPG](https://github.com/AlirezaParsi/COPG) ⭐ 374 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-18** - Spoof your device to enjoy premium features, max performance, and exclusive benefits. `FOSS` `[M]`
...
* **[AZenith](https://github.com/Liliya2727/AZenith) ⭐ 112 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-19** - All-In-One (AIO) system optimization module designed to enhance Android performance. `FOSS` `[M]` `[K]`
...
* **[Plus Plus Battery](https://github.com/dijia1124/plusplusbattery) ⭐ 462 | 🐛 16 | 🌐 Kotlin | 📅 2026-02-22** - Real-time battery stats & health estimator for OnePlus/Oppo/Realme phones. `FOSS` | [🌱](https://f-droid.org/en/packages/com.dijia1124.plusplusbattery/)
...
* **[AccA](https://github.com/VR-25/acc) ⭐ 2,376 | 🐛 19 | 🌐 Shell | 📅 2025-06-06** - Advanced Charging Controller app. `FOSS`
...
* **[⭐ AdAway](https://github.com/AdAway/AdAway) ⭐ 9,349 | 🐛 667 | 🌐 C | 📅 2026-02-10** - Open-source ad blocker using the hosts file. Blocks ads without permissions. `FOSS` | [🌱](https://f-droid.org/packages/org.adaway)
* **[BlockAds](https://github.com/pass-with-high-score/blockads-android) ⭐ 1,750 | 🐛 66 | 🌐 Kotlin | 📅 2026-07-30** - System‑wide ad, tracker, & malware filtering, custom blocklists, per‑app controls etc. `FOSS` | [🌱](https://f-droid.org/packages/app.pwhs.blockads)
* **[⭐ Bindhosts](https://github.com/bindhosts/bindhosts) ⭐ 1,373 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-16** - Systemless hosts for APatch, KernelSU and Magisk that is fully standalone and self-updating. `FOSS` `[M]` `[K]`
...
* **[Magisk Ad Blocking Module](https://github.com/pantsufan/Magisk-Ad-Blocking-Module) ⭐ 567 | 🐛 19 | 📅 2026-08-20** - Block ads on android. `FOSS` `[M]`
...
* **[PCAPdroid](https://github.com/emanuele-f/PCAPdroid#pcapdroid) ⭐ 4,486 | 🐛 44 | 🌐 Java | 📅 2026-08-20** - Lets you track, analyze and block the connections made by the other apps in your device. `FOSS` | [🌱](https://f-droid.org/packages/com.emanuelef.remote_capture) | [▶️](https://play.google.com/store/apps/details?id=com.emanuelef.remote_capture)
* **[NetGuard](https://github.com/M66B/NetGuard) ⭐ 3,831 | 🐛 1 | 🌐 Java | 📅 2026-08-01** - Block access to the internet. Apps and addresses can individually be allowed or denied access to your Wi-Fi and/or mobile connection. `FOSS`
* **[AFWall+](https://github.com/ukanth/afwall) ⭐ 3,446 | 🐛 217 | 🌐 Java | 📅 2026-08-06** - Iptables-based firewall. `FOSS` | [🌱](https://f-droid.org/packages/dev.ukanth.ufirewall/) | [▶️](https://play.google.com/store/apps/details?id=dev.ukanth.ufirewall)
* **[ShizuWall](https://github.com/AhmetCanArslan/ShizuWall) ⭐ 2,153 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-13** - Android firewall without VPN powered by Shizuku / local ADB daemon / Root. `FOSS` | [🌱](https://f-droid.org/packages/com.arslan.shizuwall/) | [▶️](https://play.google.com/store/apps/details?id=com.arslan.shizuwall)
...
* **[⭐ Enable Screenshot](https://github.com/LSPosed/DisableFlagSecure) ⭐ 1,290 | 🐛 3 | 🌐 Java | 📅 2026-08-13** - Enabling screenshots in apps that normally wouldn't allow it, and disabling screenshot(Android 14+) and screen record(Android 15+) detection. `FOSS` `[LSP]`
...
* **[TapDucky](https://github.com/iodn/tap-ducky) ⭐ 154 | 🐛 8 | 🌐 Dart | 📅 2026-05-17** - Open-source DuckyScript runner for rooted Android with USB Gadget (ConfigFS) support. `FOSS`  | [🌱](https://f-droid.org/en/packages/org.kaijinlab.tap_ducky/)
* **[Just Trust Me Pro](https://github.com/hang666/JustTrustMePro) ⭐ 145 | 🐛 5 | 🌐 Kotlin | 📅 2026-03-31** - Disables SSL certificate checking for the purposes of auditing an app with cert pinning. `FOSS` `[M]`
...
* **[Biometric App Lock](https://github.com/hxreborn/biometric-app-lock) ⭐ 44 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-20** - Locks apps you choose behind fingerprint or face unlock. `FOSS` `[LSP]`
...
* **[Device Faker](https://github.com/Seyud/device_faker/) ⭐ 699 | 🐛 1 | 🌐 Vue | 📅 2026-08-12** - A device model spoofing module based on Zygisk that can configure different device models for different applications. `FOSS` `[M]` `[K]`
...
* **[SpoofMyDevice](https://github.com/BuSung-dev/SpoofMyDevice) ⭐ 113 | 🐛 9 | 🌐 Java | 📅 2026-07-19** - Xposed module and companion app for building, saving, and applying spoofed Android device profiles to selected apps. `FOSS` `[LSP]`
* **[HideMyAndroid](https://github.com/Xposed-Modules-Repo/com.wowsoftware.hidemyandroid/) ⭐ 80 | 🐛 0 | 📅 2026-08-17** - Android anti-detect module with profile isolation and spoofing. `Proprietary` `[LSP]`
...
* **[Island](https://github.com/oasisfeng/island/tree/dev) ⭐ 3,876 | 🐛 664 | 🌐 Java | 📅 2025-04-24** - App isolation and cloning. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=com.oasisfeng.island)
...
* **[⭐ GPhotosUnlimited](https://github.com/Rev4N1/GPhotosUnlimited) ⭐ 331 | 🐛 1 | 🌐 C++ | 📅 2026-08-19** - A Zygisk module which gives unlimited Google Photos storage. `FOSS` `[M]` `[K]`
* **[Spotify Plus](https://github.com/LeNerd46/SpotifyPlus) ⭐ 215 | 🐛 10 | 🌐 Java | 📅 2026-07-25** - Adds beautiful lyrics to Spotify. `FOSS` `[LSP]`
...
* **[Deekseep](https://github.com/lllucccian/Deekseep) ⭐ 173 | 🐛 3 | 🌐 Java | 📅 2026-08-17** - Adds account, chat, image, interface, and local API tools to the official DeepSeek Android app. `FOSS` `[LSP]`
...
* **[Nexus](https://github.com/niki914/agentic-nexus) ⭐ 121 | 🐛 41 | 🌐 Kotlin | 📅 2026-08-19** - Plug your own model into your phone's voice assistant. `Proprietary` `[LSP]`
...
* **[Play Store Adblock](https://github.com/hxreborn/playstore-adblock) ⭐ 74 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-19** - Xposed module to remove sponsored listings and ads from the Google Play Store. `FOSS` `[LSP]`
...
* **[BBZQ](https://github.com/HSSkyBoy/BBZQ) ⭐ 384 | 🐛 9 | 🌐 Kotlin | 📅 2026-08-18** - Removes unnecessary content, optimizes the core experience, and provide various practical functions. `FOSS` `[LSP]`
...
* **[Facebook App Ads Remover](https://github.com/Xposed-Modules-Repo/tn.loukious.facebookappadsremover) ⭐ 49 | 🐛 5 | 🌐 Kotlin | 📅 2026-07-23** - Removes ads from Facebook app. `FOSS` `[LSP]`

#### Instagram

* **[InstaEclipse](https://github.com/ReSo7200/InstaEclipse/) ⭐ 1,409 | 🐛 16 | 🌐 Java | 📅 2026-07-24** - Adds Features like Developer Options, Ghost Mode, Ad-Free browsing, and Distraction-Free Mode to Instagram. `FOSS` `[LSP]`

#### Line

* **[Knot](https://github.com/2b-zipper/Knot) ⭐ 110 | 🐛 3 | 🌐 Java | 📅 2026-08-20** - Message privacy, notification tweaks & Screen display & UI mods for Line. `FOSS` `[LSP]`

#### QQ

* **[QAuxiliary](https://github.com/cinit/QAuxiliary) ⭐ 5,709 | 🐛 264 | 🌐 Java | 📅 2026-08-20** - Xposed module based on QNotified. `FOSS` `[LSP]`
* **[XAutoDaily](https://github.com/LuckyPray/XAutoDaily) ⭐ 1,577 | 🐛 37 | 🌐 Kotlin | 📅 2026-07-22** - Various tweaks for QQ. `FOSS` `[LSP]`
...
* **[Morphe Reddit Patches](https://github.com/MorpheApp/morphe-patches#-patches-list) ⭐ 3,299 | 🐛 428 | 🌐 Java | 📅 2026-08-20** - Various patches for reddit. `FOSS`
* **[Patcheddit](https://github.com/wchill/patcheddit) ⭐ 764 | 🐛 48 | 🌐 Kotlin | 📅 2026-05-03** - Custom patches with features like view: deleted Reddit posts & comments,Banned subreddits etc. `FOSS`
* **[Adobo Patches](https://github.com/jkennethcarino/adobo/) ⭐ 230 | 🐛 11 | 🌐 Kotlin | 📅 2026-08-09** - Various patches for reddit app. `FOSS`
...
* **[Telegami](https://github.com/aoya111/Telegami) ⭐ 224 | 🐛 26 | 🌐 Kotlin | 📅 2026-08-20** - Various tweaks for Telegram. `FOSS` `[LSP]`
...
* **[WeChat Auxiliary](https://github.com/HdShare/WAuxiliary_Public) ⭐ 3,969 | 🐛 12 | 🌐 Kotlin | 📅 2026-05-31** - Various tweaks for WeChat. `Proprietary` `[LSP]`
...
* **[⭐ WA Enhancer](https://github.com/Dev4Mod/WaEnhancer) ⭐ 1,654 | 🐛 284 | 🌐 Kotlin | 📅 2026-08-20** - Enhances your WhatsApp experience. `FOSS` `[LSP]`
...
* **[⭐ Piko Patches](https://github.com/crimera/piko) ⭐ 4,785 | 🐛 495 | 🌐 Java | 📅 2026-08-20** - Morphe patches for twitter with features like hide promoted tweets, hide promoted accounts, hide promoted trends, hide "who to follow" etc. `FOSS`
* **[Re:X](https://github.com/Xposed-Modules-Repo/one.dot.rex) ⭐ 125 | 🐛 0 | 📅 2026-08-15** -  Tweaks for the new X / Twitter app. `Proprietary` `[LSP]`
...
* **[BetterVia](https://github.com/JiGuroLGC/BetterVia) ⭐ 1,216 | 🐛 3 | 🌐 JavaScript | 📅 2026-07-11** - Bypass whitelist restrictions, Screenshot protection, Block components, One-tap theme switching etc. `FOSS` `[LSP]`
* **[⭐ ChromeXt](https://github.com/JingMatrix/ChromeXt) ⭐ 1,130 | 🐛 27 | 🌐 Kotlin | 📅 2026-08-20** - UserScript and DevTools support for Chromium-based and WebView-based browsers. `FOSS` `[LSP]`
...
* **[Fxxk-MiBrowser](https://github.com/DuhMatt/Fxxk-MiBrowser) ⭐ 27 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-20** - Redirects forced Xiaomi Browser links to the system default browser. `FOSS` `[LSP]`

### YouTube & Media Mods

* **[NexAlloy](https://github.com/NexAlloy/NexAlloy) ⭐ 2,882 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-03** - YouTube, YT Music block ads, background playback, sponsorblock and much more. Also unlocks premium features of Strava and Photomath. Unlimited Google Photos backup. `FOSS` `[LSP]`
* **[GlassMic](https://github.com/lm060719/io.mo.glassmic) ⭐ 53 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-19** - Lets you route an imported audio file into target recording apps through AudioRecord/AAudio hooks. `FOSS` `[LSP]`
...
* **[xCam](https://github.com/hazbu/xCam) ⭐ 18 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-14** - Replace live camera feeds and actual photo captures with virtual media sources. `FOSS` `[LSP]`
...
* **[⭐ Pairipfix](https://github.com/ahmedmani/pairipfix) ⭐ 650 | 🐛 20 | 🌐 Java | 📅 2026-04-20** - Bypasses the "Get this app from Play" screen that appears when installing Android apps as an APK instead of from the Google Play Store. `FOSS` `[LSP]`
...
* **[F\*\*k Google License](https://github.com/JiGuroLGC/FuckGoogleLicense) ⭐ 193 | 🐛 0 | 🌐 Java | 📅 2026-08-16** - Bypass Google Service License Verification. `FOSS` `[LSP]`
...
* **[Material Files](https://github.com/zhanghai/MaterialFiles) ⭐ 8,774 | 🐛 625 | 🌐 Kotlin | 📅 2026-04-06** - Modern file manager with root capabilities. `FOSS` | [🌱](https://f-droid.org/packages/me.zhanghai.android.files)| [▶️](https://play.google.com/store/apps/details?id=me.zhanghai.android.files)
...
* **[Fossify File Manager](https://github.com/FossifyOrg/File-Manager) ⭐ 1,717 | 🐛 95 | 🌐 Kotlin | 📅 2026-08-17** - Easy app for managing your files without ads, respecting your privacy and security. `FOSS` | [🌱](https://f-droid.org/packages/org.fossify.filemanager/) | [▶️](https://play.google.com/store/apps/details?id=org.fossify.filemanager)
...
* **[DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,232 | 🐛 186 | 🌐 Kotlin | 📅 2026-08-19** - DataBackup for Android 7.0+. `FOSS` | [🌱](https://f-droid.org/zh_Hans/packages/com.xayah.databackup.foss/)
* **[Neo Backup](https://github.com/NeoApplications/Neo-Backup) ⭐ 3,767 | 🐛 240 | 🌐 Kotlin | 📅 2026-05-03** - Powerful open-source backup solution. `FOSS` | [🌱](https://f-droid.org/packages/com.machiav3lli.backup/)
...
* **[⭐ SD Maid 2/SE](https://github.com/d4rken-org/sdmaid-se) ⭐ 7,332 | 🐛 13 | 🌐 Kotlin | 📅 2026-08-20** - A file management tool for Android that specializes in maintenance. Its core purpose is freeing up space and removing unwanted data. `FOSS` | [🌱](https://f-droid.org/en/packages/eu.darken.sdmse/) | [▶️](https://play.google.com/store/apps/details?id=eu.darken.sdmse)
* **[Cleaner Royall](https://github.com/araafroyall/Cleaner-Royall) ⭐ 240 | 🐛 0 | 🌐 Shell | 📅 2026-08-20** - A lightweight but ultra-fast and powerful cleaner for Android. `Proprietary` `[LSP]`
...
* **[Iconify](https://github.com/Mahmud0808/Iconify) ⭐ 3,136 | 🐛 100 | 🌐 Kotlin | 📅 2026-08-16** - Customize your Android 12+ device easily. `FOSS` `[M]`
* **[ColorBlendr](https://github.com/Mahmud0808/ColorBlendr) ⭐ 2,393 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-17** - Customize Material You colors of your device. `FOSS` | [🌱](https://f-droid.org/en/packages/com.drdisagree.colorblendr/)
* **[HyperLight](https://github.com/KiminonawaResa/HyperLight#english) ⭐ 674 | 🐛 33 | 📅 2026-08-20** - Completes the highlight blur effects for HyperOS 3, bringing a unified visual experience to the desktop, notification shade, and control center. `FOSS` `[LSP]`
...
* **[Pixel Launcher Enhanced](https://github.com/Mahmud0808/PixelLauncherEnhanced) ⭐ 512 | 🐛 23 | 🌐 Kotlin | 📅 2026-08-02** - Unlock a variety of exciting features including customizing the look to adding more functionality and many more. `FOSS` `[LSP]`
* **[HyperOS Launcher](https://github.com/Mods-Center/HyperOS-Launcher#hyperos-launcher-v5) ⭐ 379 | 🐛 60 | 📅 2026-08-12** - Enhanced HyperOS Launcher with features from high-end devices, including customizable app drawer, icon packs, and more. `Proprietary` `[M]` `[K]`
...
* **[Lyricon](https://github.com/tomakino/lyricon) ⭐ 718 | 🐛 35 | 🌐 Kotlin | 📅 2026-05-30** - An Android status bar lyric enhancement tool based on the Xposed framework. `FOSS` `[LSP]`
...
* **[Recents](https://github.com/tymwitko/Recents) ⭐ 66 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-19** - Launcher-agnostic "Recents" menu for Android. `FOSS` `[LSP]`
...
* **[Ogesture](https://github.com/tanujnotes/ogesture) ⭐ 19 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-20** - Use gesture navigation with third-party launchers on any Android phone. `FOSS` `[LSP]`
...
* **[HyperIsland](https://github.com/1812z/HyperIsland/blob/main/README_EN.md) ⭐ 445 | 🐛 7 | 🌐 Dart | 📅 2026-08-19** - Dynamic Island-style notifications for HyperOS 3, powered by LSPosed. `FOSS` `[LSP]`
...
* **[Auto Expand Notifications](https://github.com/kvmy666/-AutoExpandNotifications) ⭐ 32 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-18** - Notification Tweaks for OxygenOS. `FOSS` `[LSP]`
...
* **[Adaptive Theme: Auto Dark Mode by Ambient Light](https://github.com/xLexip/Adaptive-Theme) ⭐ 192 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-20** - Automatically switches between Light and Dark mode using the ambient light sensor. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=dev.lexip.hecate)
...
* **[⭐ ViPERFX\_RE](https://github.com/likelikeslike/ViPERFX_RE) ⭐ 278 | 🐛 2 | 🌐 C | 📅 2026-08-11** - A fork of ViPER4Android FX with a redesigned UI and additional features. `FOSS` `[M]` `[K]`

### Audio Control

* **[LibrePods](https://github.com/kavishdevar/librepods) ⭐ 29,537 | 🐛 268 | 🌐 Kotlin | 📅 2026-07-13** - Unlocks Apple's exclusive premium AirPods features on non-Apple devices. `FOSS` `[LSP]` `[M]` `[K]`
...
* **[Hi-Res Audio Enabler](https://github.com/reiryuki/Hi-Res-Audio-Enabler-Magisk-Module) ⭐ 206 | 🐛 0 | 🌐 Shell | 📅 2026-08-01** - Enables high resolution 24 or 32-bit width audio output if device is supported. `FOSS` `[M]`
...
* **[DNS Toggle](https://github.com/ELowry/DNSToggle) ⭐ 94 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-17** - A tiny Android app that allows you to easily toggle your phone's Private DNS through the Quick Settings panel. `FOSS`
...
* **[VPN Hotspot](https://github.com/Mygod/VPNHotspot) ⭐ 6,329 | 🐛 23 | 🌐 Kotlin | 📅 2026-08-16** - Share your VPN connection over hotspot or repeater. `FOSS`
...
* **[Surfing](https://github.com/GitMetaio/Surfing) ⭐ 2,343 | 🐛 78 | 🌐 Shell | 📅 2026-08-20** - Magisk and KernelSU modules for Clash/mihomo, sing-box, v2ray, xray, hysteria services. `FOSS` `[M]` `[K]`
...
* **[NetProxy-Magisk](https://github.com/Fanju6/NetProxy-Magisk) ⭐ 1,105 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-20** - Magisk proxy module based on Xray kernel, supports one-click start/stop transparent proxy. `FOSS` `[M]`
* **[VPN Hide](https://github.com/okhsunrog/vpnhide) ⭐ 515 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-20** - Hide active VPN from selected Android apps (kernel module + LSPosed + Zygisk) `FOSS` `[M]` `[K]`
* **[ZDT-D Root Module](https://github.com/GAME-OVER-op/ZDT-D) ⭐ 267 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-19** - Module for traffic routing, DPI bypass, proxy chaining, DNS control, and per-app network management. `FOSS` `[M]` `[K]`
...
* **[MagicNet](https://github.com/LIghtJUNction/MagicNet#english-summary) ⭐ 154 | 🐛 1 | 🌐 Shell | 📅 2026-08-20** - Module for device-side traffic governance that enforce network rules below the app layer instead of relying on every app to respect a proxy setting. `FOSS` `[M]` `[K]`
...
* **[Network Switch](https://github.com/aunchagaonkar/NetworkSwitch#installation) ⭐ 427 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-20** - Modern Android app for 4G/5G network mode switching. `FOSS` | [🌱](https://apt.izzysoft.de/packages/com.supernova.networkswitch)
* **[WiFi Password Manager](https://github.com/Khh-vu/wifi-password-manager) ⭐ 280 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-08** - Simple app to manage WiFi passwords. `FOSS` | [🌱](https://apt.izzysoft.de/packages/io.github.wifi_password_manager)
...
* **[onHit](https://github.com/0penPublic/onHit) ⭐ 78 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-17** - Trigger Android NFC events without a physical tag by Xposed. `FOSS` `[LSP]`
* **[KonamikU](https://github.com/C-F0x/KonamikU) ⭐ 35 | 🐛 0 | 🌐 Kotlin | 📅 2026-07-24** - Extend NFC Capabilities of your device. `FOSS` `[LSP]`
...
* **[XposedFakeLocation](https://github.com/noobexon1/XposedFakeLocation) ⭐ 650 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-02** - Allows you to spoof your device's location globally or for specific apps without using "mock location" from the developer options. `FOSS` `[LSP]`
* **[AnyWhere](https://github.com/cxOrz/AnyWhere) ⭐ 552 | 🐛 9 | 🌐 Java | 📅 2026-08-04** - Location simulation tool for debugging LBS applications and for users to test geolocation functionality. `FOSS` `[LSP]`
...
* **[HLocation](https://github.com/sparr-sherrya/hlocation-release) ⭐ 41 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-19** - Location spoofing framework that synchronizes fake GPS and related environment signals across system and app processes for more consistent location virtualization. `FOSS` `[LSP]`
...
* **[AsoulOpt](https://github.com/nakixii/Magisk_AsoulOpt) ⭐ 2,647 | 🐛 5 | 🌐 Shell | 📅 2026-08-09** - Game threads tweaker for Android, suitable for mainstream games and some niche games. `FOSS` `[M]`
* **[Uperf-Game-Turbo](https://github.com/yinwanxi/Uperf-Game-Turbo) ⭐ 1,516 | 🐛 0 | 🌐 Shell | 📅 2026-07-31** - Userspace performance controller for Android. `FOSS` `[M]`
* **[Encore Tweaks](https://github.com/Rem01Gaming/encore) ⭐ 503 | 🐛 3 | 🌐 C++ | 📅 2026-08-16** - Enhance device performance during gaming sessions, while keeping battery life optimized for normal use. `Proprietary` `[M]`
...
* **[⭐ Termux](https://github.com/termux/termux-app) ⭐ 59,498 | 🐛 592 | 🌐 Java | 📅 2026-07-14** - A terminal emulator application for Android OS extendible by variety of packages. `FOSS` | [🌱](https://f-droid.org/en/packages/com.termux)
* **[aShell You](https://github.com/DP-Hridayan/aShellYou) ⭐ 2,207 | 🐛 35 | 🌐 Kotlin | 📅 2026-08-20** - Android shell utility app with Material Design 3 UI, letting you run ADB, root and shell commands. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/in.hridayan.ashell)
...
* **[LADB](https://github.com/tytydraco/LADB) ⭐ 2,389 | 🐛 53 | 🌐 Kotlin | 📅 2026-07-26** - Local ADB shell. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=com.draco.ladb)
...
* **[Shizuku](https://github.com/RikkaApps/Shizuku) ⭐ 29,123 | 🐛 535 | 🌐 Kotlin | 📅 2025-06-18** - Use system APIs directly with ADB/root privileges. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/moe.shizuku.privileged.api) | [▶️](https://play.google.com/store/search?q=shizuku\&c=apps)
* **[⭐ Shizuku Fork](https://github.com/thedjchi/Shizuku) ⭐ 5,176 | 🐛 64 | 🌐 Kotlin | 📅 2026-07-15** - Shizuku for with automatic Shizuku startup, automation, and recovery features. `FOSS`
* **[Shevery](https://github.com/HmnDev-Tech/shevery) ⭐ 800 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-20** - Based on shizuku with Jetpack Compose, Material 3, and compatibility enhancements. `FOSS`
...
* **[⭐ Droidspaces](https://github.com/ravindu644/Droidspaces-OSS) ⭐ 1,724 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-20** - Run full Linux environments on top of Android, with complete init system support. `FOSS`
...
* **[USB HID Client](https://github.com/Arian04/android-hid-client) ⭐ 424 | 🐛 19 | 🌐 Kotlin | 📅 2026-08-19** - Use your phone as a keyboard and mouse without any software on the other end. `FOSS` | [🌱](https://apt.izzysoft.de/packages/me.arianb.usb_hid_client)
...
* **[RebootNya](https://github.com/daisukiKaffuChino/RebootNya) ⭐ 241 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-20** - A simple yet advanced reboot utility for Android devices. `FOSS`
...
* **[Basic Call Recorder](https://github.com/chenxiaolong/BCR) ⭐ 2,876 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-20** - A Basic Call Recorder for rooted Android devices. Also check out [GUI for BCR ↗](https://github.com/nicorac/bcr-gui) ⭐ 350 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-10. `FOSS` `[M]` `[K]`
...
* **[⭐ Essentials](https://github.com/sameerasw/essentials) ⭐ 2,650 | 🐛 96 | 🌐 Kotlin | 📅 2026-08-20** - Multi-purpose tweaks for display, notifications and alerts, security and privacy, sound and haptics, and app freezing. `FOSS`
...
* **[Zygisk Sui](https://github.com/XiaoTong6666/Sui) ⭐ 629 | 🐛 3 | 🌐 Java | 📅 2026-08-20** - Modern superuser interface (SUI) implementation for Android. `FOSS` `[M]` `[K]`
...
| 📂 **GitHub**    | Source, discussions & issues  | [GitHub Repo](https://github.com/awesome-android-root/awesome-android-root) ⭐ 4,362 \| 🐛 1 \| 🌐 Python \| 📅 2026-08-20 |
...
* 🐛 Report [issues](https://github.com/awesome-android-root/awesome-android-root/issues) ⭐ 4,362 | 🐛 1 | 🌐 Python | 📅 2026-08-20
...
**⚡ Built with ❤️ by [Awesome Android Root](https://github.com/awesome-android-root/awesome-android-root) ⭐ 4,362 | 🐛 1 | 🌐 Python | 📅 2026-08-20**
