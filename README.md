...
> For privacy-friendly installs, use the F-Droid ecosystem: install [Droid-ify](https://github.com/Droid-ify/client/releases) ⭐ 7,325 | 🐛 197 | 🌐 Kotlin | 📅 2026-08-26 (modern F-Droid client) and enable the [IzzyOnDroid](https://apt.izzysoft.de/fdroid/) repo for many additional packages.
...
| :----------------------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------- |
|       **[Magisk](https://github.com/topjohnwu/Magisk) ⭐ 62,467 \| 🐛 38 \| 🌐 Kotlin \| 📅 2026-08-27** <br><small> `Root & Module Management` </small>      | If you chose Magisk, this is your manager.               |
| **[App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 8,835 \| 🐛 207 \| 🌐 Java \| 📅 2026-08-26** <br><small> `App & Package Management` </small> | Inspect and manage apps with root privileges.            |
...
* **[⭐ Magisk](https://github.com/topjohnwu/Magisk) ⭐ 62,467 | 🐛 38 | 🌐 Kotlin | 📅 2026-08-27** - Manage Magisk modules and root permissions. `FOSS`
* **[⭐ KernelSU](https://github.com/tiann/KernelSU) ⭐ 18,031 | 🐛 61 | 🌐 Kotlin | 📅 2026-08-27** - A Kernel based root solution for Android. `FOSS`
* **[APatch](https://github.com/bmax121/APatch) ⭐ 7,865 | 🐛 43 | 🌐 Kotlin | 📅 2026-08-27** - The patching of Android kernel and Android system. `FOSS` | [🌱](https://f-droid.org/packages/me.bmax.apatch/)
* **[SukiSU-Ultra](https://github.com/SukiSU-Ultra/SukiSU-Ultra) ⭐ 6,172 | 🐛 24 | 🌐 Kotlin | 📅 2026-08-27** - A kernel-based root solution for Android devices, forked from `KernelSU` with some useful changes. `FOSS`
* **[KernelSU-next](https://github.com/KernelSU-Next/KernelSU-Next) ⭐ 4,164 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-27** - An advanced Kernel based root solution for Android. `FOSS`
* **[ReSukiSU](https://github.com/ReSukiSU/ReSukiSU) ⭐ 1,313 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-27** - Fork of SukiSU-Ultra with additional features. `FOSS`
* **[FolkPatch](https://github.com/LyraVoid/FolkPatch) ⭐ 1,075 | 🐛 27 | 🌐 Kotlin | 📅 2026-08-21** - A Root management tool focused on interface optimization and feature extension, based on APatch. `FOSS`
...
* **[⭐ Root My Galaxy](https://github.com/BuSung-dev/Root-My-Galaxy) ⭐ 939 | 🐛 399 | 🌐 Kotlin | 📅 2026-08-24** - One-tap temporary root for Snapdragon Galaxy flagships (S24/S25 series, S24 FE, A56...) via GhostLock; bootloader stays locked, Knox isn't tripped. `FOSS`
* **[GhostLock App](https://github.com/YuKongA/ghostlock-app) ⭐ 511 | 🐛 29 | 🌐 C | 📅 2026-08-27** - One-tap execution app for the GhostLock (CVE-2026-43499) exploit. `FOSS`
* **[Root-My-Galaxy-Payloads](https://github.com/BuSung-dev/Root-My-Galaxy-Payloads) ⭐ 335 | 🐛 177 | 🌐 C | 📅 2026-08-25** - Signed device profiles, exploit payloads, and KernelSU artifacts that Root My Galaxy fetches at runtime. `FOSS`
* **[ghostlock-oneplus](https://github.com/JoinChang/ghostlock-oneplus) ⭐ 289 | 🐛 17 | 🌐 C | 📅 2026-08-21** - GhostLock kernel exploit for OnePlus/OPPO/realme (and some Xiaomi) devices with locked bootloader; installs KernelSU with runtime kernel auto-detection. `FOSS`
* **[Root My Pixel](https://github.com/alex193a/Root-My-Pixel) ⭐ 225 | 🐛 22 | 🌐 Kotlin | 📅 2026-08-24** - Jailbreak supported Google Pixel phones with GhostLock; stages the payload via Shizuku, no PC needed. `FOSS`
* **[QuestStack](https://github.com/starseed12345/QuestStack) ⭐ 141 | 🐛 0 | 🌐 C# | 📅 2026-08-26** - Unlocks the Meta Quest 1 bootloader and gains root using GhostLock + CVE-2021-1931. `FOSS`
...
* **[IonStack-S22U](https://github.com/sarabpal-dev/IonStack-S22U) ⭐ 55 | 🐛 8 | 🌐 C | 📅 2026-08-25** - Full CVE-2026-43499 exploit chain for the Samsung Galaxy S22 Ultra (5.10 kernel). `FOSS`
...
* **[Root My Device](https://github.com/Witaqua-tools/Root-My-Device) ⭐ 11 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-03** - Community fork of Root My Galaxy generalized beyond Samsung, with its own payload feed. `FOSS`
* **[pixel-ksu-root](https://github.com/JingMatrix/pixel-ksu-root) ⭐ 8 | 🐛 0 | 🌐 C | 📅 2026-08-25** - ADB-driven KernelSU loader for stock Pixels; temporary kernel R/W via GhostLock, then late-loads a signature-matched `kernelsu.ko`. Manager-agnostic. `FOSS`
* **[iQOO Z9 5G / vivo T3 5G Root](https://github.com/ankitrawatgit/iQOO-Z9_5G-vivo-T3_5G-Root-GhostLock) ⭐ 6 | 🐛 0 | 🌐 C | 📅 2026-08-23** - One-tap root app and payloads for the iQOO Z9 5G and vivo T3 5G (Dimensity 7200, kernel 5.15). `FOSS`
...
* **[⭐ MMRL](https://github.com/DerGoogler/MMRL) ⭐ 2,144 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-18** - An Android app that helps manage your own modules repository. `FOSS` `[M]` `[K]` `[A]` | [🌱](https://f-droid.org/en/packages/com.dergoogler.mmrl/) | [▶️](https://play.google.com/store/apps/details?id=com.dergoogler.mmrl)
* **[KPatch Next Module](https://github.com/KernelSU-Next/KPatch-Next-Module) ⭐ 473 | 🐛 7 | 🌐 JavaScript | 📅 2026-03-05** - Standalone implementation of KPM (KernelSU Patch Module) support for Magisk/KernelSU with WebUI. `FOSS` `[M]` `[K]`
...
* **[Meta-hybrid\_mount](https://github.com/YuzakiKokuban/meta-hybrid_mount) ⭐ 1,491 | 🐛 1 | 🌐 Rust | 📅 2026-08-27** - Three-engine mount orchestration (OverlayFS + Magic Mount + Kasumi LKM) with conflict monitor, SolidJS WebUI, auto-fallback, and EROFS storage backend support. `FOSS` `[K]` `[A]`
* **[⭐ Mountify](https://github.com/backslashxx/mountify) ⭐ 1,331 | 🐛 24 | 🌐 Shell | 📅 2026-08-25** - OverlayFS with tmpfs/ext4 sparse support for reduced detection, works on APatch/Magisk too. `FOSS` `[M]` `[K]` `[A]`
* **[Magic Mount Metamodule](https://github.com/Tools-cx-app/meta-magic_mount-rs) ⭐ 486 | 🐛 5 | 🌐 Vue | 📅 2026-08-25** - An implementation of a metamodule using Magic Mount, based on MKSU. `FOSS` `[M]` `[K]` `[A]`
...
* **[⭐ Vector](https://github.com/JingMatrix/Vector) ⭐ 12,244 | 🐛 16 | 🌐 Kotlin | 📅 2026-08-26** - Open Source *Fork* of original LSPosed with dynamic module loading, and other improvements. `FOSS` `[M]`
...
* **[⭐ Zygisk Next](https://github.com/Dr-TSNG/ZygiskNext) ⭐ 10,445 | 🐛 1 | 🌐 C | 📅 2026-08-27** The "Gold Standard" for detection evasion. It is a standalone Zygisk implementation that offers the most advanced stealth features, including a dedicated **Zygote Monitor** and dashboard. `Proprietary` `[M]` `[K]` `[A]`
* **[ReZygisk](https://github.com/PerformanC/ReZygisk) ⭐ 3,860 | 🐛 11 | 🌐 C | 📅 2026-08-22** A high-performance implementation **entirely rewritten in C**. It introduces **custom linkers** to bypass modern linker-based detections, offering a WebUI for status monitoring and compatibility with Android 15 and 16. `FOSS` `[M]` `[K]` `[A]`
* **[NeoZygisk](https://github.com/JingMatrix/NeoZygisk) ⭐ 2,228 | 🐛 7 | 🌐 C++ | 📅 2026-08-26** A minimalist, high-stealth implementation using **ptrace injection**. It focuses on "trace cleaning," aiming to remove all injection artifacts from memory once modules are loaded. `FOSS` `[M]` `[K]` `[A]`
...
* **[TrickyStore](https://github.com/5ec1cff/TrickyStore) ⭐ 6,316 | 🐛 4 | 📅 2025-11-30** - Modifies the certificate chain for Android key attestation (keybox-based). The original/reference module. `Proprietary` `[M]` `[K]`
* **[Hide My Applist](https://github.com/Dr-TSNG/Hide-My-Applist) ⭐ 5,542 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-01** - Intercepts app-list detection. `Proprietary` `[LSP]`
* **[Play Integrity Fork (PIF)](https://github.com/osm0sis/PlayIntegrityFork) ⭐ 4,433 | 🐛 0 | 🌐 C++ | 📅 2026-08-24** - The most actively maintained PIF. Fixes `DEVICE_INTEGRITY` verdicts with custom fields/props. Recommended starting point after chiteroman's original was discontinued. `FOSS` `[M]`
* **[Play Integrity Fix (inject)](https://github.com/KOWX712/PlayIntegrityFix) ⭐ 3,791 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-18** - Actively maintained fork using injected GMS/Play Store spoofing with a WebUI. `FOSS` `[M]`
* **[Tricky Addon – Update Target List](https://github.com/KOWX712/Tricky-Addon-Update-Target-List) ⭐ 3,407 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-24** - KSU WebUI to configure TrickyStore's `target.txt`. `FOSS` `[K]`
* **[⭐ HMA-OSS](https://github.com/frknkrc44/HMA-OSS) ⭐ 2,983 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-28** - FOSS rewrite of Hide My Applist; hides your app list, settings, and package installers. `FOSS` `[LSP]`
* **[Zygisk Assistant](https://github.com/snake-4/Zygisk-Assistant) ⭐ 2,584 | 🐛 17 | 🌐 C++ | 📅 2026-05-04** - Zygisk module to hide root on KernelSU, Magisk, and APatch. `FOSS` `[M]`
* **[⭐ SUSFS for KernelSU](https://github.com/sidex15/susfs4ksu-module) ⭐ 2,533 | 🐛 2 | 🌐 HTML | 📅 2026-08-08** - Add-on root-hiding service for SUSFS-patched kernels (KernelSU/Next). The core of modern KSU hiding setups. `FOSS` `[M]` `[K]`
* **[⭐ TEESimulator](https://github.com/JingMatrix/TEESimulator) ⭐ 2,315 | 🐛 11 | 🌐 C++ | 📅 2026-08-21** - Create a complete, software-based simulation of a hardware-backed Trusted Execution Environment (TEE) for Key Attestation. `FOSS` `[M]` `[K]`
* **[YuriKey](https://github.com/dpejoh/yurikey) ⭐ 1,868 | 🐛 9 | 🌐 Shell | 📅 2026-08-01** - Systemless module to obtain strong integrity easily. `FOSS` `[M]` `[K]`
...
* **[TrickyStore OSS](https://github.com/beakthoven/TrickyStoreOSS) ⭐ 1,328 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-27** - Open-source alternative to TrickyStore. `FOSS` `[M]` `[K]`
...
* **[Specter](https://github.com/dpejoh/specter) ⭐ 557 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-24** - Unified Play Integrity and root hiding stack for Android. Successor of Yurikey. `FOSS` `[M]` `[K]`
...
* **[Always Strong](https://github.com/evoker0/AlwaysStrong) ⭐ 365 | 🐛 0 | 🌐 Shell | 📅 2026-08-25** - Bundles TEESimulator-RS and PlayIntegrityFork into a single module for strong integrity on rooted devices. `FOSS` `[M]` `[K]`
* **[⭐ BRENE](https://github.com/rrr333nnn333/BRENE) ⭐ 329 | 🐛 6 | 🌐 Shell | 📅 2026-08-26** - SUSFS/KernelSU module for patched kernels with enhanced root hiding & spoofing. `FOSS` `[M]` `[K]`
* **[OhMyKeymint](https://github.com/qwq233/OhMyKeymint) ⭐ 294 | 🐛 2 | 🌐 Rust | 📅 2026-08-27** - Custom keystore implementation for Android Keystore Spoofer. `FOSS` `[M]` `[K]`
...
* **[Komodo Build Props](https://github.com/Elcapitanoe/Komodo-Build-Prop#komodo-build-props) ⭐ 34 | 🐛 1 | 🌐 Python | 📅 2026-08-26** - Spoofs your device as a Pixel 9 Pro XL (komodo). `FOSS` `[M]`
...
* **[YetAnotherBootloopProtector](https://github.com/Magisk-Modules-Alt-Repo/YetAnotherBootloopProtector) ⭐ 177 | 🐛 5 | 🌐 Shell | 📅 2026-08-27** - Monitor and fix potential Bootloops and SystemUI failures. `FOSS` `[M]`

### Root Detection & Testing

* **[⭐ Android-Native-Root-Detector](https://github.com/reveny/Android-Native-Root-Detector) ⭐ 1,378 | 🐛 16 | 🌐 Kotlin | 📅 2026-04-11** - A tool for detecting root on android. `FOSS`
* **[MagiskDetection](https://github.com/apkunpacker/MagiskDetection) ⭐ 1,050 | 🐛 4 | 📅 2026-05-10** - Collection of Some publicly Available POC Apps to Detect Root/Magisk presence. `Proprietary`
* **[Duck Detector](https://github.com/eltavine/Duck-Detector-Refactoring) ⭐ 898 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-27** - Android environment integrity inspection tool for root, hook, bootloader, SELinux, virtualization, and attestation signals. `FOSS`
...
* **[Chunqiu Detector](https://github.com/mingzun09/Chunqiu-Detector-Problem-solution) ⭐ 357 | 🐛 0 | 🌐 Shell | 📅 2026-08-26** - Solutions, scripts, and modules for bypassing and troubleshooting Chunqiu Detector checks on rooted Android devices. `FOSS`
...
* **[⭐ Duck Detector Fork](https://github.com/rrr333nnn333/Duck-Detector-Refactoring) ⭐ 44 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-21** - Duck Detector fork with additional features and improvements. `FOSS`
...
* **[Play Integrity Alert](https://github.com/Xiddoc/PlayIntegrityAlert) ⭐ 26 | 🐛 2 | 🌐 Kotlin | 📅 2026-07-02** - Get notified when an app calls the Play Integrity API. `FOSS` `[LSP]`
...
* **[HyperOS Security Center](https://github.com/Mods-Center/HyperOS-Security-Center) ⭐ 125 | 🐛 5 | 📅 2026-08-14** - Advanced app info tools, system app Wi-Fi management, removal of root/account restrictions etc. `Proprietary` `[M]` `[K]`
...
* **[OShin](https://github.com/suqi8/OShin/blob/master/README_EN.md) ⭐ 1,178 | 🐛 105 | 🌐 Kotlin | 📅 2026-07-28** - Auxiliary module deeply integrated with ColorOS, designed to enhance and optimize your operating system experience. `FOSS` `[LSP]`
...
* **[⭐ HyperCeiler](https://github.com/ReChronoRain/HyperCeiler/blob/main/README_en-US.md) ⭐ 5,288 | 🐛 231 | 🌐 Java | 📅 2026-08-25** - Extensive customizations for HyperOS. `FOSS` `[LSP]`
...
* **[Hyper Helper](https://github.com/HowieHChen/XiaomiHelper/blob/master/README_EN-US.md) ⭐ 350 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-24** - Lightweight customization module for HyperOS only. `FOSS` `[LSP]`
...
* **[NothingTweaks](https://github.com/RevealedSoulEven/NothingTweaks) ⭐ 8 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-26** - A customization module for Nothing OS based on Xposed framework. `FOSS` `[LSP]`

#### One UI (Samsung)

* **[⭐ KnoxPatch](https://github.com/salvogiangri/KnoxPatch) ⭐ 1,496 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-25** - Get Samsung apps/features working again in your rooted Galaxy device. For better experience, please also [read this ↗](https://github.com/salvogiangri/KnoxPatch?tab=readme-ov-file#knoxpatch-enhancer) ⭐ 1,496 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-25 . `FOSS` `[LSP]`
* **[One UI X](https://github.com/SoClear/OneUIX) ⭐ 185 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-21** - Remove annoying restrictions, and inject powerful enhancements into the Status Bar, Quick Settings, and native apps etc on Samsung's One UI. `FOSS` `[LSP]`
...
* **[OneLab](https://github.com/pigerzhu/OneLab) ⭐ 7 | 🐛 0 | 🌐 Java | 📅 2026-08-27** - One UI feature extensions and foldable app adaptations for Samsung devices. `FOSS` `[LSP]`
...
* **[Oxygen-Customizer](https://github.com/DHD2280/Oxygen-Customizer/) ⭐ 454 | 🐛 32 | 🌐 Java | 📅 2026-08-27** - Open-source Oxygen OS customizer application. `FOSS` `[LSP]`
...
* **[⭐ Canta](https://github.com/samolego/Canta) ⭐ 5,652 | 🐛 30 | 🌐 Kotlin | 📅 2026-08-24** - Uninstall any app without root using [Shizuku](#developer-tools). `FOSS` | [🌱](https://f-droid.org/en/packages/io.github.samolego.canta/) | [▶️](https://play.google.com/store/apps/details?id=io.github.samolego.canta)
* **[De-Bloater](https://github.com/sunilpaulmathew/De-Bloater) ⭐ 768 | 🐛 48 | 🌐 Java | 📅 2026-05-25** - An application using the power of Magisk to debloat unwanted system apps!. `FOSS` | [🌱](https://f-droid.org/packages/com.sunilpaulmathew.debloater) | [▶️](https://play.google.com/store/apps/details?id=com.sunilpaulmathew.debloater)
* **[System App Nuker](https://github.com/ChiseWaguri/systemapp_nuker) ⭐ 245 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-27** - A module to debloat system apps with WebUI Interface. `FOSS` `[M]`
...
* **[⭐ App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 8,835 | 🐛 207 | 🌐 Java | 📅 2026-08-26** - A full-featured package manager and viewer for Android. `FOSS` | [🌱](https://f-droid.org/packages/io.github.muntashirakon.AppManager/)
* **[⭐ Droid-ify](https://github.com/Droid-ify/client) ⭐ 7,325 | 🐛 197 | 🌐 Kotlin | 📅 2026-08-26** - F-Droid client with Material UI and auto updating apps using root. `FOSS` | [🌱](https://f-droid.org/packages/com.looker.droidify)
* **[⭐ Hail](https://github.com/aistra0528/Hail) ⭐ 6,546 | 🐛 166 | 🌐 Kotlin | 📅 2026-08-27** - Disable / Hide / Suspend / Uninstall Android apps. `FOSS` | [🌱](https://f-droid.org/packages/com.aistra.hail/)
* **[InstallerX-Revived](https://github.com/wxxsfxyzm/InstallerX-Revived) ⭐ 6,350 | 🐛 17 | 🌐 Kotlin | 📅 2026-08-27** - A modern and functional Android app installer. `FOSS` `[LSP]`
* **[Neo Store](https://github.com/NeoApplications/Neo-Store) ⭐ 4,941 | 🐛 127 | 🌐 Kotlin | 📅 2026-08-26** - An F-Droid client with modern UI and an arsenal of extra features. `FOSS` | [🌱](https://f-droid.org/packages/com.machiav3lli.fdroid)
* **[Aurora Store](https://github.com/whyorean/AuroraStore) ⭐ 2,898 | 🐛 26 | 🌐 Kotlin | 📅 2026-08-24** - A Google Play Store client to search, view app details, and download APKs directly to your device. `FOSS` | [🌱](https://f-droid.org/packages/com.aurora.store/)
...
* **[Inure](https://github.com/Hamza417/Inure) ⭐ 1,895 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-26** - An elegant and beautiful premium Android app manager for rooted and non-rooted devices. `FOSS` | [🌱](https://f-droid.org/en/packages/app.simple.inure/) | [▶️](https://play.google.com/store/apps/details?id=app.simple.inure.play)
* **[Universal Installer](https://github.com/pass-with-high-score/universal-installer) ⭐ 1,314 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-23** - Install and manage APK packages with split APK support. `FOSS` `[LSP]`
* **[InxLocker](https://github.com/Chimioo/InxLocker) ⭐ 883 | 🐛 2 | 🌐 Kotlin | 📅 2026-06-11** - Intercepts/forwards Android system application installation and uninstallation requests, redirecting them to your specified installer app. `FOSS` `[LSP]`
...
* **[BetterKnownInstalled](https://github.com/Pixel-Props/BetterKnownInstalled) ⭐ 553 | 🐛 0 | 🌐 Shell | 📅 2026-08-23** - Patches packages to fix DroidGuard UNKNOWN\_INSTALLED issues. `FOSS` `[LSP]`
* **[Thor](https://github.com/trinadhthatakula/Thor) ⭐ 532 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-27** - Android App Manager and App Installer utility. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/com.valhalla.thor) | [▶️](https://play.google.com/store/apps/details?id=com.valhalla.thor)
...
* **[Updates Manager Extended](https://github.com/Senliast/xposed-modules/tree/main/Updates_Manager_Extended) ⭐ 21 | 🐛 2 | 🌐 Java | 📅 2026-05-26** - Allows to block app updates (including automatic updates) for specific apps, no matter from which app store they were installed. `FOSS` `[LSP]`
...
* **[Thanox](https://github.com/Tornaco/Thanox) ⭐ 3,246 | 🐛 468 | 🌐 Java | 📅 2026-08-14** - A system management tool that provide convenient functions like application startup management, background management, permission management etc. `FOSS` `[LSP]` | [▶️](https://play.google.com/store/apps/details?id=github.tornaco.android.thanos.pro\&hl=en\&gl=US)
* **[PermissionManagerX](https://github.com/mirfatif/PermissionManagerX) ⭐ 760 | 🐛 10 | 🌐 HTML | 📅 2026-07-11** - eXtended Permission Manager for Android to view and set Manifest Permissions and AppOps. `FOSS` | [🌱](https://f-droid.org/packages/com.mirfatif.permissionmanagerx) | [▶️](https://play.google.com/store/apps/details?id=com.mirfatif.permissionmanagerx)
...
* **[FDE.AI](https://github.com/feravolt/FDE.AI-docs) ⭐ 668 | 🐛 0 | 🌐 HTML | 📅 2026-08-19** - All-in-One ultimate optimizer for all devices running Android OS. `Proprietary` `[LSP]`
* **[COPG](https://github.com/AlirezaParsi/COPG) ⭐ 377 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-25** - Spoof your device to enjoy premium features, max performance, and exclusive benefits. `FOSS` `[M]`
...
* **[Stellar Tweaks](https://github.com/kanaodnd/Stellar-Tweaks) ⭐ 88 | 🐛 0 | 📅 2026-04-26** - Sophisticated scheduler designed to harmonize device performance and efficiency. `Proprietary` `[M]` `[K]` `[A]`
...
* **[Rv Kernel Manager](https://github.com/Rve27/RvKernel-Manager) ⭐ 256 | 🐛 11 | 🌐 Kotlin | 📅 2026-05-11** - A modern Kernel Manager with Material 3 Expressive Design. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/com.rve.rvkernelmanager)
* **[KonaBess Next](https://github.com/KonaBess-Next/KonaBess-Next) ⭐ 212 | 🐛 22 | 🌐 Kotlin | 📅 2026-08-06** - Fork of KonaBess, Custom GPU overclocking and undervolting tool with granulated voltage for rooted Snapdragon Android devices. `FOSS`
...
* **[⭐ FROSTY](https://github.com/Drsexo/Frosty) ⭐ 208 | 🐛 4 | 🌐 Shell | 📅 2026-07-04** - Optimizes battery life by selectively freezing Google Mobile Services (GMS) components and applying system-wide doze enhancements. `FOSS` `[M]` `[K]`
...
* **[Shappky](https://github.com/YasserNull/shappky) ⭐ 543 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-25** - A simple app to boost performance by stopping background apps, relying on Root/Shizuku permissions. `FOSS` `[M]`
* **[No More Background](https://github.com/adil192/no_more_background) ⭐ 308 | 🐛 9 | 🌐 Dart | 📅 2026-08-06** - A fire-and-forget program to stop Android apps from running in the background. `FOSS` | [🌱](https://f-droid.org/en/packages/com.adilhanney.no_more_background/)
* **[Appzuku](https://github.com/northmendo/Appzuku) ⭐ 181 | 🐛 1 | 🌐 Java | 📅 2026-03-29** - Simple app to boost performance by stopping background apps, relying on Root/Shizuku permissions. `FOSS`
...
* **[⭐ AdAway](https://github.com/AdAway/AdAway) ⭐ 9,371 | 🐛 670 | 🌐 C | 📅 2026-02-10** - Open-source ad blocker using the hosts file. Blocks ads without permissions. `FOSS` | [🌱](https://f-droid.org/packages/org.adaway)
* **[BlockAds](https://github.com/pass-with-high-score/blockads-android) ⭐ 1,779 | 🐛 61 | 🌐 Kotlin | 📅 2026-08-23** - System‑wide ad, tracker, & malware filtering, custom blocklists, per‑app controls etc. `FOSS` | [🌱](https://f-droid.org/packages/app.pwhs.blockads)
...
* **[Magisk Ad Blocking Module](https://github.com/pantsufan/Magisk-Ad-Blocking-Module) ⭐ 569 | 🐛 19 | 📅 2026-08-27** - Block ads on android. `FOSS` `[M]`
...
* **[Discover Ads Filter](https://github.com/hxreborn/discover-ads-filter) ⭐ 43 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-24** - Hides sponsored cards and ads from the Google Discover feed in the Pixel Launcher -1 screen and inside the Google app itself. `FOSS` `[LSP]`
...
* **[PCAPdroid](https://github.com/emanuele-f/PCAPdroid#pcapdroid) ⭐ 4,609 | 🐛 44 | 🌐 Java | 📅 2026-08-26** - Lets you track, analyze and block the connections made by the other apps in your device. `FOSS` | [🌱](https://f-droid.org/packages/com.emanuelef.remote_capture) | [▶️](https://play.google.com/store/apps/details?id=com.emanuelef.remote_capture)
* **[NetGuard](https://github.com/M66B/NetGuard) ⭐ 3,849 | 🐛 1 | 🌐 Java | 📅 2026-08-01** - Block access to the internet. Apps and addresses can individually be allowed or denied access to your Wi-Fi and/or mobile connection. `FOSS`
* **[AFWall+](https://github.com/ukanth/afwall) ⭐ 3,457 | 🐛 218 | 🌐 Java | 📅 2026-08-06** - Iptables-based firewall. `FOSS` | [🌱](https://f-droid.org/packages/dev.ukanth.ufirewall/) | [▶️](https://play.google.com/store/apps/details?id=dev.ukanth.ufirewall)
* **[ShizuWall](https://github.com/AhmetCanArslan/ShizuWall) ⭐ 2,175 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-27** - Android firewall without VPN powered by Shizuku / local ADB daemon / Root. `FOSS` | [🌱](https://f-droid.org/packages/com.arslan.shizuwall/) | [▶️](https://play.google.com/store/apps/details?id=com.arslan.shizuwall)
...
* **[De1984 Firewall](https://github.com/dorumrr/de1984) ⭐ 386 | 🐛 9 | 🌐 Kotlin | 📅 2026-08-27** - A privacy-focused Firewall and Package Manager for Android devices. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/io.github.dorumrr.de1984)
...
* **[⭐ Amarok](https://github.com/deltazefiro/Amarok-Hider) ⭐ 3,217 | 🐛 61 | 🌐 Java | 📅 2026-08-11** - Android application which enables you to hide your private files and apps with a single click. `FOSS` | [🌱](https://f-droid.org/zh_Hans/packages/deltazero.amarok.foss/)
* **[Tarnhelm](https://github.com/lz233/Tarnhelm) ⭐ 785 | 🐛 9 | 🌐 Kotlin | 📅 2026-08-13** - The magic to clean sharing links up. `FOSS` `[LSP]`
...
* **[FuseFixer](https://github.com/5ec1cff/FuseFixer) ⭐ 385 | 🐛 1 | 🌐 C | 📅 2026-04-14** - Hooks the MediaProvider Fuse Daemon to stop apps probing package existence through `Android/data` directory quirks (Unicode casefold tricks). `FOSS` `[LSP]`
...
* **[FuseHide](https://github.com/XiaoTong6666/FuseHide) ⭐ 249 | 🐛 6 | 🌐 C++ | 📅 2026-08-25** - Hides chosen storage paths from MediaProvider on Android 12+ at runtime, and debugs/fixes `Android/data` Unicode casefold scenarios. `FOSS` `[LSP]`
...
* **[⭐ Move Certificate](https://github.com/ys1231/MoveCertificate) ⭐ 1,949 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-18** - Move user certificates to system certificates. Supports Android 7-16. `FOSS` `[M]` `[K]`
* **[StrykerOSS](https://github.com/zalexdev/strykerapp) ⭐ 1,373 | 🐛 14 | 🌐 Java | 📅 2026-08-13** - Bundles a curated set of network, wireless and web security tools into a single rooted-Android application for penetration testing. `FOSS`
* **[⭐ Enable Screenshot](https://github.com/LSPosed/DisableFlagSecure) ⭐ 1,297 | 🐛 6 | 🌐 Java | 📅 2026-08-24** - Enabling screenshots in apps that normally wouldn't allow it, and disabling screenshot(Android 14+) and screen record(Android 15+) detection. `FOSS` `[LSP]`
...
* **[ih8SecureLock](https://github.com/j-hc/ih8SecureLock) ⭐ 171 | 🐛 2 | 🌐 C++ | 📅 2026-08-15** - Prevent apps from blocking and listening to your screenshots with Zygisk. `FOSS` `[M]` `[K]`
...
* **[Biometric App Lock](https://github.com/hxreborn/biometric-app-lock) ⭐ 47 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-26** - Locks apps you choose behind fingerprint or face unlock. `FOSS` `[LSP]`
...
* **[Device Faker](https://github.com/Seyud/device_faker/) ⭐ 723 | 🐛 1 | 🌐 Vue | 📅 2026-08-28** - A device model spoofing module based on Zygisk that can configure different device models for different applications. `FOSS` `[M]` `[K]`
...
* **[SpoofMyDevice](https://github.com/BuSung-dev/SpoofMyDevice) ⭐ 121 | 🐛 9 | 🌐 Java | 📅 2026-07-19** - Xposed module and companion app for building, saving, and applying spoofed Android device profiles to selected apps. `FOSS` `[LSP]`
* **[HideMyAndroid](https://github.com/Xposed-Modules-Repo/com.wowsoftware.hidemyandroid/) ⭐ 86 | 🐛 0 | 📅 2026-08-27** - Android anti-detect module with profile isolation and spoofing. `Proprietary` `[LSP]`
...
* **[MAC Editor for Android](https://github.com/jqssun/android-mac-editor) ⭐ 61 | 🐛 2 | 🌐 Kotlin | 📅 2026-06-02** - Securely edit Wi-Fi MAC address on Android. `FOSS` `[LSP]`
...
* **[SSAID (Android ID Modifier)](https://github.com/HSSkyBoy/AndroidIDChange) ⭐ 30 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-17** - A modern Android SSAID (Android ID) inspector, modifier, backup, and management utility. `FOSS` `[LSP]`
...
* **[Island](https://github.com/oasisfeng/island/tree/dev) ⭐ 3,887 | 🐛 668 | 🌐 Java | 📅 2025-04-24** - App isolation and cloning. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=com.oasisfeng.island)
...
* **[FingerprintPay](https://github.com/eritpchy/FingerprintPay) ⭐ 4,493 | 🐛 35 | 🌐 Java | 📅 2026-03-06** - Enables fingerprint payment via WeChat, Alipay, Taobao, Tencent QQ, and UnionPay on phones that support fingerprint recognition. `FOSS` `[M]` `[LSP]`
...
* **[Deekseep](https://github.com/lllucccian/Deekseep) ⭐ 247 | 🐛 3 | 🌐 Java | 📅 2026-08-17** - Adds account, chat, image, interface, and local API tools to the official DeepSeek Android app. `FOSS` `[LSP]`
...
* **[Nexus](https://github.com/niki914/agentic-nexus) ⭐ 127 | 🐛 40 | 🌐 Kotlin | 📅 2026-08-27** - Plug your own model into your phone's voice assistant. `Proprietary` `[LSP]`
...
* **[KGPT](https://github.com/eluea/KGPT) ⭐ 83 | 🐛 6 | 🌐 Java | 📅 2026-08-25** - LSPosed Module to integrate Generative AI like ChatGPT in keyboard. `FOSS` `[LSP]`
...
* **[Spicy EX](https://github.com/amarinne/spicy-ex) ⭐ 22 | 🐛 1 | 🌐 Java | 📅 2026-08-25** - Adds Spicy lyrics in Spotify along with translation and much more UI features. `FOSS` `[LSP]`
...
* **[BBZQ](https://github.com/HSSkyBoy/BBZQ) ⭐ 408 | 🐛 16 | 🌐 Kotlin | 📅 2026-08-27** - Removes unnecessary content, optimizes the core experience, and provide various practical functions. `FOSS` `[LSP]`

#### Discord

* **[Revenge](https://github.com/revenge-mod/revenge-bundle-next) ⭐ 168 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-26** - Revenge is a client modification for Discord Android. `FOSS`
...
* **[Knot](https://github.com/2b-zipper/Knot) ⭐ 114 | 🐛 2 | 🌐 Java | 📅 2026-08-26** - Message privacy, notification tweaks & Screen display & UI mods for Line. `FOSS` `[LSP]`

#### QQ

* **[QAuxiliary](https://github.com/cinit/QAuxiliary) ⭐ 5,723 | 🐛 267 | 🌐 Java | 📅 2026-08-26** - Xposed module based on QNotified. `FOSS` `[LSP]`
* **[XAutoDaily](https://github.com/LuckyPray/XAutoDaily) ⭐ 1,581 | 🐛 37 | 🌐 Kotlin | 📅 2026-08-25** - Various tweaks for QQ. `FOSS` `[LSP]`
* **[QFun](https://github.com/oneQAQone/QFun) ⭐ 238 | 🐛 2 | 🌐 Java | 📅 2026-08-25** - Functionality enhancement module developed based on the Xposed framework. `FOSS` `[LSP]`
* **[TCQT Module](https://github.com/callng/TCQT) ⭐ 222 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-26** - An Xposed module designed for Android QQ/TIM clients, which is used to intercept and retain messages that would otherwise be "retracted". `FOSS` `[LSP]`
...
* **[Morphe Reddit Patches](https://github.com/MorpheApp/morphe-patches#-patches-list) ⭐ 3,421 | 🐛 444 | 🌐 Java | 📅 2026-08-27** - Various patches for reddit. `FOSS`
...
* **[Telegami](https://github.com/aoya111/Telegami) ⭐ 226 | 🐛 30 | 🌐 Kotlin | 📅 2026-08-26** - Various tweaks for Telegram. `FOSS` `[LSP]`
...
* **[Toki](https://github.com/MeiYongAI/Toki) ⭐ 59 | 🐛 3 | 🌐 Java | 📅 2026-08-19** - Adds various tweaks to TikTok app. `FOSS` `[LSP]`
...
* **[WeChat Auxiliary](https://github.com/HdShare/WAuxiliary_Public) ⭐ 3,979 | 🐛 12 | 🌐 Kotlin | 📅 2026-05-31** - Various tweaks for WeChat. `Proprietary` `[LSP]`
...
* **[⭐ WA Enhancer](https://github.com/Dev4Mod/WaEnhancer) ⭐ 1,665 | 🐛 242 | 🌐 Kotlin | 📅 2026-08-27** - Enhances your WhatsApp experience. `FOSS` `[LSP]`
...
* **[⭐ Piko Patches](https://github.com/crimera/piko) ⭐ 4,926 | 🐛 496 | 🌐 Java | 📅 2026-08-27** - Morphe patches for twitter with features like hide promoted tweets, hide promoted accounts, hide promoted trends, hide "who to follow" etc. `FOSS`
* **[Re:X](https://github.com/Xposed-Modules-Repo/one.dot.rex) ⭐ 151 | 🐛 0 | 📅 2026-08-27** -  Tweaks for the new X / Twitter app. `Proprietary` `[LSP]`
...
* **[BetterVia](https://github.com/JiGuroLGC/BetterVia) ⭐ 1,253 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-25** - Bypass whitelist restrictions, Screenshot protection, Block components, One-tap theme switching etc. `FOSS` `[LSP]`
...
* **[Fxxk-MiBrowser](https://github.com/DuhMatt/Fxxk-MiBrowser) ⭐ 28 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-27** - Redirects forced Xiaomi Browser links to the system default browser. `FOSS` `[LSP]`

### YouTube & Media Mods

* **[NexAlloy](https://github.com/NexAlloy/NexAlloy) ⭐ 2,903 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-03** - YouTube, YT Music block ads, background playback, sponsorblock and much more. Also unlocks premium features of Strava and Photomath. Unlimited Google Photos backup. `FOSS` `[LSP]`
* **[PolyglotYT](https://github.com/Dr-TSNG/PolyglotYT) ⭐ 176 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-15** - Immersive translation Xposed module for YouTube app. `FOSS` `[LSP]`
* **[GlassMic](https://github.com/lm060719/io.mo.glassmic) ⭐ 55 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-27** - Lets you route an imported audio file into target recording apps through AudioRecord/AAudio hooks. `FOSS` `[LSP]`
...
* **[Material Files](https://github.com/zhanghai/MaterialFiles) ⭐ 8,816 | 🐛 627 | 🌐 Kotlin | 📅 2026-04-06** - Modern file manager with root capabilities. `FOSS` | [🌱](https://f-droid.org/packages/me.zhanghai.android.files)| [▶️](https://play.google.com/store/apps/details?id=me.zhanghai.android.files)
* **[AnExplorer](https://github.com/1hakr/AnExplorer) ⭐ 2,017 | 🐛 36 | 🌐 Java | 📅 2026-06-02** - A simple, Small, Fast and Efficient File Explorer. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=dev.dworks.apps.anexplorer)
* **[Fossify File Manager](https://github.com/FossifyOrg/File-Manager) ⭐ 1,728 | 🐛 98 | 🌐 Kotlin | 📅 2026-08-24** - Easy app for managing your files without ads, respecting your privacy and security. `FOSS` | [🌱](https://f-droid.org/packages/org.fossify.filemanager/) | [▶️](https://play.google.com/store/apps/details?id=org.fossify.filemanager)
...
* **[DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,275 | 🐛 187 | 🌐 Kotlin | 📅 2026-08-27** - DataBackup for Android 7.0+. `FOSS` | [🌱](https://f-droid.org/zh_Hans/packages/com.xayah.databackup.foss/)
* **[Neo Backup](https://github.com/NeoApplications/Neo-Backup) ⭐ 3,782 | 🐛 241 | 🌐 Kotlin | 📅 2026-05-03** - Powerful open-source backup solution. `FOSS` | [🌱](https://f-droid.org/packages/com.machiav3lli.backup/)
* **[Restoid](https://github.com/hddq/restoid) ⭐ 164 | 🐛 18 | 🌐 Kotlin | 📅 2026-08-26** - modern, root-based Android app backup tool powered by restic. `FOSS`
...
* **[⭐ SD Maid 2/SE](https://github.com/d4rken-org/sdmaid-se) ⭐ 7,379 | 🐛 14 | 🌐 Kotlin | 📅 2026-08-27** - A file management tool for Android that specializes in maintenance. Its core purpose is freeing up space and removing unwanted data. `FOSS` | [🌱](https://f-droid.org/en/packages/eu.darken.sdmse/) | [▶️](https://play.google.com/store/apps/details?id=eu.darken.sdmse)
...
* **[CZero](https://github.com/Xocio/CZero) ⭐ 37 | 🐛 0 | 📅 2026-08-18** - Cleans the cache of frequently used apps, and adds background suppression, empty-folder cleanup, and F2FS garbage collection. `FOSS` `[M]` `[K]`
* **[ClearBox](https://github.com/FLYCOM-E/ClearBox) ⭐ 36 | 🐛 1 | 🌐 C | 📅 2026-08-27** - Can delete all software caches, installation packages, compressed packages, garbage, empty folders etc. `Proprietary` `[M]` `[K]`
...
* **[ColorBlendr](https://github.com/Mahmud0808/ColorBlendr) ⭐ 2,413 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-23** - Customize Material You colors of your device. `FOSS` | [🌱](https://f-droid.org/en/packages/com.drdisagree.colorblendr/)
* **[HyperLight](https://github.com/KiminonawaResa/HyperLight#english) ⭐ 711 | 🐛 40 | 📅 2026-08-25** - Completes the highlight blur effects for HyperOS 3, bringing a unified visual experience to the desktop, notification shade, and control center. `FOSS` `[LSP]`
* **[Global Icon Pack](https://github.com/RichardLuo0/global-icon-pack-android) ⭐ 409 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-25** - Apply icon packs globally. `FOSS` `[LSP]`
...
* **[Pixel Launcher Mods](https://github.com/KieronQuinn/PixelLauncherMods/) ⭐ 1,304 | 🐛 7 | 🌐 Kotlin | 📅 2025-10-30** - Mods for enhancing the Pixel Launcher experience. `FOSS`
* **[Activity Manager](https://github.com/sdex/ActivityManager) ⭐ 1,292 | 🐛 14 | 🌐 Kotlin | 📅 2026-07-25** - Discover the activities of installed applications, run them, and create shortcuts. `FOSS` | [🌱](https://f-droid.org/packages/com.activitymanager/)
* **[Google Shortcuts Launcher](https://github.com/WSTxda/Google-Shortcuts-Launcher) ⭐ 699 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-27** - Easily access essential Google apps features directly from your launcher app drawer. `FOSS`
...
* **[Pixel Launcher Enhanced](https://github.com/Mahmud0808/PixelLauncherEnhanced) ⭐ 515 | 🐛 22 | 🌐 Kotlin | 📅 2026-08-02** - Unlock a variety of exciting features including customizing the look to adding more functionality and many more. `FOSS` `[LSP]`
* **[HyperOS Launcher](https://github.com/Mods-Center/HyperOS-Launcher#hyperos-launcher-v5) ⭐ 388 | 🐛 61 | 📅 2026-08-12** - Enhanced HyperOS Launcher with features from high-end devices, including customizable app drawer, icon packs, and more. `Proprietary` `[M]` `[K]`
...
* **[Lyricon](https://github.com/tomakino/lyricon) ⭐ 730 | 🐛 36 | 🌐 Kotlin | 📅 2026-08-23** - An Android status bar lyric enhancement tool based on the Xposed framework. `FOSS` `[LSP]`
* **[LyricProvider](https://github.com/tomakino/LyricProvider/tree/master) ⭐ 367 | 🐛 43 | 🌐 Kotlin | 📅 2026-08-26** - A lyric provider for Lyricon. `FOSS` `[LSP]`
...
* **[Volume Key Track Control Module](https://github.com/Hepolise/VolumeKeyTrackControlModule) ⭐ 83 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-27** - Allows to skip and play/pause track with volume keys. `FOSS` `[LSP]`
...
* **[Recents](https://github.com/tymwitko/Recents) ⭐ 68 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-27** - Launcher-agnostic "Recents" menu for Android. `FOSS` `[LSP]`
...
* **[Ogesture](https://github.com/tanujnotes/ogesture) ⭐ 22 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-20** - Use gesture navigation with third-party launchers on any Android phone. `FOSS` `[LSP]`
...
* **[MakeFontsGreatAgain](https://github.com/Numbersf/MakeFontsGreatAgain) ⭐ 298 | 🐛 10 | 🌐 C | 📅 2026-08-01** - System-wide Font Overrider with Unique GMS Masking & Multi-Range Unicode Filter. `FOSS` `[M]` `[K]`
...
* **[HyperIsland](https://github.com/1812z/HyperIsland/blob/main/README_EN.md) ⭐ 452 | 🐛 8 | 🌐 Dart | 📅 2026-08-27** - Dynamic Island-style notifications for HyperOS 3, powered by LSPosed. `FOSS` `[LSP]`
...
* **[ColorOS Live Lyrics Bridge](https://github.com/Andrea-lyz/ColorOS-Live-Lyrics-Bridge) ⭐ 154 | 🐛 8 | 🌐 Java | 📅 2026-08-23** - Bridges timed lyrics from supported players into the ColorOS/OPlus lock-screen lyric pipeline. `FOSS` `[LSP]`
...
* **[DPIS](https://github.com/Kwensiu/DPIS) ⭐ 92 | 🐛 15 | 🌐 Java | 📅 2026-08-28** - LSPosed module for per-app interface scale, smallest width, and font size tuning. `FOSS` `[LSP]`
* **[DarQ Fork](https://github.com/Arora-Sir/DarQ) ⭐ 81 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-12** - Provides a per-app selectable force dark option for Android 10 and above. `FOSS`
...
* **[⭐ ViPERFX\_RE](https://github.com/likelikeslike/ViPERFX_RE) ⭐ 290 | 🐛 3 | 🌐 C | 📅 2026-08-11** - A fork of ViPER4Android FX with a redesigned UI and additional features. `FOSS` `[M]` `[K]`
* **[NLSound](https://github.com/Briclyaz/NLSound_module_QCom) ⭐ 290 | 🐛 2 | 🌐 Shell | 📅 2025-05-05** - Magisk module for improving audio and microphone quality in your Snapdragon SoC device. `FOSS` `[M]`
* **[Audio Modification Library Ryuki Mod](https://github.com/reiryuki/Audio-Modification-Library-Ryuki-Mod-Magisk-Module) ⭐ 281 | 🐛 0 | 🌐 Shell | 📅 2026-08-01** - Enables supported audio mods to share the same needed files, such as audio\_effects. `FOSS` `[M]`

### Audio Control

* **[LibrePods](https://github.com/kavishdevar/librepods) ⭐ 29,596 | 🐛 282 | 🌐 Kotlin | 📅 2026-08-25** - Unlocks Apple's exclusive premium AirPods features on non-Apple devices. `FOSS` `[LSP]` `[M]` `[K]`
...
* **[SonyPods](https://github.com/Mercury000/SonyPods) ⭐ 24 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-27** - System-level Sony headphone control for HyperOS devices. `FOSS` `[LSP]`
* **[HuaweiPods](https://github.com/Nshpiter/HuaweiPods) ⭐ 14 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-26** - Huawei audio device integration for Xiaomi HyperOS. `FOSS` `[LSP]`
...
* **[personalDNSfilter](https://github.com/IngoZenz/personaldnsfilter) ⭐ 930 | 🐛 65 | 🌐 Java | 📅 2026-08-05** - A DNS filter proxy that provides local filtering of ads, malware, and tracking servers, supporting secure DNS protocols like DOH and DOT for enhanced privacy. `FOSS` | [🌱](https://f-droid.org/packages/dnsfilter.android/)
...
* **[FlClash](https://github.com/chen08209/FlClash) ⭐ 50,130 | 🐛 626 | 🌐 Dart | 📅 2026-08-28** - A multi-platform proxy client based on ClashMeta, simple and easy to use, open-source and ad-free. `FOSS`
* **[VPN Hotspot](https://github.com/Mygod/VPNHotspot) ⭐ 6,361 | 🐛 24 | 🌐 Kotlin | 📅 2026-08-26** - Share your VPN connection over hotspot or repeater. `FOSS`
...
* **[Surfing](https://github.com/GitMetaio/Surfing) ⭐ 2,357 | 🐛 79 | 🌐 Shell | 📅 2026-08-27** - Magisk and KernelSU modules for Clash/mihomo, sing-box, v2ray, xray, hysteria services. `FOSS` `[M]` `[K]`
...
* **[NetProxy-Magisk](https://github.com/Fanju6/NetProxy-Magisk) ⭐ 1,135 | 🐛 25 | 🌐 Kotlin | 📅 2026-08-26** - Magisk proxy module based on Xray kernel, supports one-click start/stop transparent proxy. `FOSS` `[M]`
...
* **[ZDT-D Root Module](https://github.com/GAME-OVER-op/ZDT-D) ⭐ 272 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-27** - Module for traffic routing, DPI bypass, proxy chaining, DNS control, and per-app network management. `FOSS` `[M]` `[K]`
...
* **[ZeroTier for Magisk](https://github.com/eventlOwOp/zerotier-magisk) ⭐ 145 | 🐛 7 | 🌐 HTML | 📅 2025-08-13** - Run zerotier in the background after booting with no conflicts with other Android VPN services. Use Android App to control ZeroTier. `FOSS` `[M]`
...
* **[Happwner](https://github.com/Omegaplexx/Happwner) ⭐ 109 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-21** - Exporte Happ subscriptions to other VPN clients. `FOSS` `[LSP]`
...
* **[MagicNet](https://github.com/LIghtJUNction/MagicNet#english-summary) ⭐ 157 | 🐛 2 | 🌐 Shell | 📅 2026-08-28** - Module for device-side traffic governance that enforce network rules below the app layer instead of relying on every app to respect a proxy setting. `FOSS` `[M]` `[K]`
...
* **[Network Switch](https://github.com/aunchagaonkar/NetworkSwitch#installation) ⭐ 449 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-20** - Modern Android app for 4G/5G network mode switching. `FOSS` | [🌱](https://apt.izzysoft.de/packages/com.supernova.networkswitch)
* **[WiFi Password Manager](https://github.com/Khh-vu/wifi-password-manager) ⭐ 288 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-25** - Simple app to manage WiFi passwords. `FOSS` | [🌱](https://apt.izzysoft.de/packages/io.github.wifi_password_manager)
...
* **[Nothing EUICC Force Enabler](https://github.com/reindex-ot/nothing-euicc#note-english) ⭐ 23 | 🐛 0 | 🌐 Shell | 📅 2026-02-14** - Forcibly enables eSIM on Nothing devices that do not officially support it. `FOSS` `[M]`
...
* **[XposedFakeLocation](https://github.com/noobexon1/XposedFakeLocation) ⭐ 663 | 🐛 8 | 🌐 Kotlin | 📅 2026-08-02** - Allows you to spoof your device's location globally or for specific apps without using "mock location" from the developer options. `FOSS` `[LSP]`
...
* **[HLocation](https://github.com/sparr-sherrya/hlocation-release) ⭐ 50 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-27** - Location spoofing framework that synchronizes fake GPS and related environment signals across system and app processes for more consistent location virtualization. `FOSS` `[LSP]`
...
* **[AnyWhere](https://github.com/cxOrz/AnyWhere) ⭐ 10 | 🐛 0 | 🌐 Java | 📅 2026-08-26** - Location simulation tool for debugging LBS applications and for users to test geolocation functionality. `FOSS` `[LSP]`
...
* **[AsoulOpt](https://github.com/nakixii/Magisk_AsoulOpt) ⭐ 2,669 | 🐛 0 | 🌐 Shell | 📅 2026-08-09** - Game threads tweaker for Android, suitable for mainstream games and some niche games. `FOSS` `[M]`
...
* **[⭐ Termux](https://github.com/termux/termux-app) ⭐ 59,883 | 🐛 598 | 🌐 Java | 📅 2026-08-24** - A terminal emulator application for Android OS extendible by variety of packages. `FOSS` | [🌱](https://f-droid.org/en/packages/com.termux)
* **[aShell You](https://github.com/DP-Hridayan/aShellYou) ⭐ 2,235 | 🐛 36 | 🌐 Kotlin | 📅 2026-08-27** - Android shell utility app with Material Design 3 UI, letting you run ADB, root and shell commands. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/in.hridayan.ashell)
...
* **[Hotspot Wireless Debugging](https://github.com/droserasprout/io.drsr.hotspotadb) ⭐ 15 | 🐛 4 | 🌐 Kotlin | 📅 2026-07-18** - Xposed module to allow Wireless Debugging over Wi-Fi Hotspot. `FOSS` `[LSP]`
...
* **[Shizuku](https://github.com/RikkaApps/Shizuku) ⭐ 29,419 | 🐛 547 | 🌐 Kotlin | 📅 2025-06-18** - Use system APIs directly with ADB/root privileges. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/moe.shizuku.privileged.api) | [▶️](https://play.google.com/store/search?q=shizuku\&c=apps)
* **[⭐ Shizuku Fork](https://github.com/thedjchi/Shizuku) ⭐ 5,363 | 🐛 66 | 🌐 Kotlin | 📅 2026-07-15** - Shizuku for with automatic Shizuku startup, automation, and recovery features. `FOSS`
* **[Shevery](https://github.com/HmnDev-Tech/shevery) ⭐ 881 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-27** - Based on shizuku with Jetpack Compose, Material 3, and compatibility enhancements. `FOSS`
...
* **[Dhizuku API for Xposed](https://github.com/iamr0s/Dhizuku-API-Xposed) ⭐ 136 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-25** - Force applications to support Dhizuku. `FOSS` `[LSP]`
...
* **[KSU Toolkit](https://github.com/backslashxx/ksu_toolkit) ⭐ 103 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-23** - Small extensions on top of KernelSU for testing and debugging purposes. `FOSS` `[K]`
...
* **[⭐ Droidspaces](https://github.com/ravindu644/Droidspaces-OSS) ⭐ 1,777 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-25** - Run full Linux environments on top of Android, with complete init system support. `FOSS`
...
* **[Trixie.apk](https://github.com/DesktopECHO/trixie.apk) ⭐ 52 | 🐛 5 | 🌐 Java | 📅 2025-11-21** - Debian 13 (Trixie) Server/Desktop container for rooted Android 5.0+ devices. `FOSS`
...
* **[RebootNya](https://github.com/daisukiKaffuChino/RebootNya) ⭐ 251 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-20** - A simple yet advanced reboot utility for Android devices. `FOSS`
...
* **[ClipVault](https://github.com/kaduvert/AClipBoardManager) ⭐ 12 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-27** - Android ClipBoard Manager using LSPosed / Magisk. `FOSS` `[M]` `[K]` `[LSP]`

### Communication & Messaging

* **[Basic Call Recorder](https://github.com/chenxiaolong/BCR) ⭐ 2,881 | 🐛 13 | 🌐 Kotlin | 📅 2026-08-20** - A Basic Call Recorder for rooted Android devices. Also check out [GUI for BCR ↗](https://github.com/nicorac/bcr-gui) ⭐ 351 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-10. `FOSS` `[M]` `[K]`
...
* **[⭐ Essentials](https://github.com/sameerasw/essentials) ⭐ 2,748 | 🐛 92 | 🌐 Kotlin | 📅 2026-08-27** - Multi-purpose tweaks for display, notifications and alerts, security and privacy, sound and haptics, and app freezing. `FOSS`
...
| 📂 **GitHub**    | Source, discussions & issues  | [GitHub Repo](https://github.com/awesome-android-root/awesome-android-root) ⭐ 4,410 \| 🐛 1 \| 🌐 Python \| 📅 2026-08-26 |
...
* 🐛 Report [issues](https://github.com/awesome-android-root/awesome-android-root/issues) ⭐ 4,410 | 🐛 1 | 🌐 Python | 📅 2026-08-26
...
**⚡ Built with ❤️ by [Awesome Android Root](https://github.com/awesome-android-root/awesome-android-root) ⭐ 4,410 | 🐛 1 | 🌐 Python | 📅 2026-08-26**
