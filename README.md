...
> For privacy-friendly installs, use the F-Droid ecosystem: install [Droid-ify](https://github.com/Droid-ify/client/releases) ⭐ 7,332 | 🐛 195 | 🌐 Kotlin | 📅 2026-08-28 (modern F-Droid client) and enable the [IzzyOnDroid](https://apt.izzysoft.de/fdroid/) repo for many additional packages.
...
| :----------------------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------- |
|       **[Magisk](https://github.com/topjohnwu/Magisk) ⭐ 62,482 \| 🐛 38 \| 🌐 Kotlin \| 📅 2026-08-27** <br><small> `Root & Module Management` </small>      | If you chose Magisk, this is your manager.               |
| **[App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 8,843 \| 🐛 207 \| 🌐 Java \| 📅 2026-08-26** <br><small> `App & Package Management` </small> | Inspect and manage apps with root privileges.            |
...
* **[⭐ Magisk](https://github.com/topjohnwu/Magisk) ⭐ 62,482 | 🐛 38 | 🌐 Kotlin | 📅 2026-08-27** - Manage Magisk modules and root permissions. `FOSS`
* **[⭐ KernelSU](https://github.com/tiann/KernelSU) ⭐ 18,057 | 🐛 62 | 🌐 Kotlin | 📅 2026-08-28** - A Kernel based root solution for Android. `FOSS`
* **[APatch](https://github.com/bmax121/APatch) ⭐ 7,868 | 🐛 44 | 🌐 Kotlin | 📅 2026-08-28** - The patching of Android kernel and Android system. `FOSS` | [🌱](https://f-droid.org/packages/me.bmax.apatch/)
...
* **[KernelSU-next](https://github.com/KernelSU-Next/KernelSU-Next) ⭐ 4,172 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-28** - An advanced Kernel based root solution for Android. `FOSS`
* **[ReSukiSU](https://github.com/ReSukiSU/ReSukiSU) ⭐ 1,319 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-29** - Fork of SukiSU-Ultra with additional features. `FOSS`
* **[FolkPatch](https://github.com/LyraVoid/FolkPatch) ⭐ 1,078 | 🐛 27 | 🌐 Kotlin | 📅 2026-08-28** - A Root management tool focused on interface optimization and feature extension, based on APatch. `FOSS`
...
* **[⭐ Root My Galaxy](https://github.com/BuSung-dev/Root-My-Galaxy) ⭐ 945 | 🐛 404 | 🌐 Kotlin | 📅 2026-08-24** - One-tap temporary root for Snapdragon Galaxy flagships (S24/S25 series, S24 FE, A56...) via GhostLock; bootloader stays locked, Knox isn't tripped. `FOSS`
* **[GhostLock App](https://github.com/YuKongA/ghostlock-app) ⭐ 533 | 🐛 30 | 🌐 C | 📅 2026-08-29** - One-tap execution app for the GhostLock (CVE-2026-43499) exploit. `FOSS`
* **[Root-My-Galaxy-Payloads](https://github.com/BuSung-dev/Root-My-Galaxy-Payloads) ⭐ 337 | 🐛 180 | 🌐 C | 📅 2026-08-25** - Signed device profiles, exploit payloads, and KernelSU artifacts that Root My Galaxy fetches at runtime. `FOSS`
* **[ghostlock-oneplus](https://github.com/JoinChang/ghostlock-oneplus) ⭐ 290 | 🐛 18 | 🌐 C | 📅 2026-08-21** - GhostLock kernel exploit for OnePlus/OPPO/realme (and some Xiaomi) devices with locked bootloader; installs KernelSU with runtime kernel auto-detection. `FOSS`
* **[Root My Pixel](https://github.com/alex193a/Root-My-Pixel) ⭐ 229 | 🐛 22 | 🌐 Kotlin | 📅 2026-08-24** - Jailbreak supported Google Pixel phones with GhostLock; stages the payload via Shizuku, no PC needed. `FOSS`
* **[QuestStack](https://github.com/starseed12345/QuestStack) ⭐ 149 | 🐛 0 | 🌐 C# | 📅 2026-08-28** - Unlocks the Meta Quest 1 bootloader and gains root using GhostLock + CVE-2021-1931. `FOSS`
...
* **[⭐ MMRL](https://github.com/DerGoogler/MMRL) ⭐ 2,143 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-18** - An Android app that helps manage your own modules repository. `FOSS` `[M]` `[K]` `[A]` | [🌱](https://f-droid.org/en/packages/com.dergoogler.mmrl/) | [▶️](https://play.google.com/store/apps/details?id=com.dergoogler.mmrl)
* **[KPatch Next Module](https://github.com/KernelSU-Next/KPatch-Next-Module) ⭐ 476 | 🐛 7 | 🌐 JavaScript | 📅 2026-03-05** - Standalone implementation of KPM (KernelSU Patch Module) support for Magisk/KernelSU with WebUI. `FOSS` `[M]` `[K]`
...
* **[Meta-hybrid\_mount](https://github.com/YuzakiKokuban/meta-hybrid_mount) ⭐ 1,498 | 🐛 1 | 🌐 Rust | 📅 2026-08-29** - Three-engine mount orchestration (OverlayFS + Magic Mount + Kasumi LKM) with conflict monitor, SolidJS WebUI, auto-fallback, and EROFS storage backend support. `FOSS` `[K]` `[A]`
* **[⭐ Mountify](https://github.com/backslashxx/mountify) ⭐ 1,337 | 🐛 24 | 🌐 Shell | 📅 2026-08-25** - OverlayFS with tmpfs/ext4 sparse support for reduced detection, works on APatch/Magisk too. `FOSS` `[M]` `[K]` `[A]`
...
* **[ZeroMount](https://github.com/Enginex0/zeromount) ⭐ 122 | 🐛 2 | 🌐 Rust | 📅 2026-04-15** - Mountless module loading with Kernel-level VFS path redirection & SUSFS integration, WebUI, bootloop guard, and strategy fallback. `FOSS` `[M]` `[K]` `[A]`
...
* **[⭐ Vector](https://github.com/JingMatrix/Vector) ⭐ 12,259 | 🐛 18 | 🌐 Kotlin | 📅 2026-08-26** - Open Source *Fork* of original LSPosed with dynamic module loading, and other improvements. `FOSS` `[M]`
...
* **[⭐ Zygisk Next](https://github.com/Dr-TSNG/ZygiskNext) ⭐ 10,461 | 🐛 1 | 🌐 C | 📅 2026-08-27** The "Gold Standard" for detection evasion. It is a standalone Zygisk implementation that offers the most advanced stealth features, including a dedicated **Zygote Monitor** and dashboard. `Proprietary` `[M]` `[K]` `[A]`
* **[ReZygisk](https://github.com/PerformanC/ReZygisk) ⭐ 3,860 | 🐛 9 | 🌐 C | 📅 2026-08-28** A high-performance implementation **entirely rewritten in C**. It introduces **custom linkers** to bypass modern linker-based detections, offering a WebUI for status monitoring and compatibility with Android 15 and 16. `FOSS` `[M]` `[K]` `[A]`
...
* **[TrickyStore](https://github.com/5ec1cff/TrickyStore) ⭐ 6,318 | 🐛 4 | 📅 2025-11-30** - Modifies the certificate chain for Android key attestation (keybox-based). The original/reference module. `Proprietary` `[M]` `[K]`
* **[⭐ Shamiko](https://github.com/LSPosed/LSPosed.github.io/releases) ⭐ 6,315 | 🐛 0 | 🌐 HTML | 📅 2026-07-29** - Hides Magisk root from detection. `Proprietary` `[M]`
* **[Hide My Applist](https://github.com/Dr-TSNG/Hide-My-Applist) ⭐ 5,548 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-01** - Intercepts app-list detection. `Proprietary` `[LSP]`
* **[Play Integrity Fork (PIF)](https://github.com/osm0sis/PlayIntegrityFork) ⭐ 4,435 | 🐛 0 | 🌐 C++ | 📅 2026-08-28** - The most actively maintained PIF. Fixes `DEVICE_INTEGRITY` verdicts with custom fields/props. Recommended starting point after chiteroman's original was discontinued. `FOSS` `[M]`
* **[Play Integrity Fix (inject)](https://github.com/KOWX712/PlayIntegrityFix) ⭐ 3,795 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-18** - Actively maintained fork using injected GMS/Play Store spoofing with a WebUI. `FOSS` `[M]`
* **[Tricky Addon – Update Target List](https://github.com/KOWX712/Tricky-Addon-Update-Target-List) ⭐ 3,410 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-24** - KSU WebUI to configure TrickyStore's `target.txt`. `FOSS` `[K]`
* **[⭐ HMA-OSS](https://github.com/frknkrc44/HMA-OSS) ⭐ 2,995 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-28** - FOSS rewrite of Hide My Applist; hides your app list, settings, and package installers. `FOSS` `[LSP]`
...
* **[⭐ SUSFS for KernelSU](https://github.com/sidex15/susfs4ksu-module) ⭐ 2,534 | 🐛 2 | 🌐 HTML | 📅 2026-08-08** - Add-on root-hiding service for SUSFS-patched kernels (KernelSU/Next). The core of modern KSU hiding setups. `FOSS` `[M]` `[K]`
* **[⭐ TEESimulator](https://github.com/JingMatrix/TEESimulator) ⭐ 2,320 | 🐛 10 | 🌐 C++ | 📅 2026-08-21** - Create a complete, software-based simulation of a hardware-backed Trusted Execution Environment (TEE) for Key Attestation. `FOSS` `[M]` `[K]`
* **[YuriKey](https://github.com/dpejoh/yurikey) ⭐ 1,870 | 🐛 9 | 🌐 Shell | 📅 2026-08-01** - Systemless module to obtain strong integrity easily. `FOSS` `[M]` `[K]`
* **[TEESimulator-RS](https://github.com/Enginex0/TEESimulator-RS) ⭐ 1,675 | 🐛 22 | 🌐 Kotlin | 📅 2026-07-11** - Fork of TEESimulator with native Rust certificate generation, key persistence, and AOSP-compliant attestation behavior. `FOSS` `[M]` `[K]`
* **[NoHello](https://github.com/MhmRdd/NoHello) ⭐ 1,350 | 🐛 21 | 🌐 C++ | 📅 2025-06-28** - Lightweight Zygisk module to hide root. `FOSS` `[M]`
* **[TrickyStore OSS](https://github.com/beakthoven/TrickyStoreOSS) ⭐ 1,337 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-27** - Open-source alternative to TrickyStore. `FOSS` `[M]` `[K]`
...
* **[Specter](https://github.com/dpejoh/specter) ⭐ 562 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-24** - Unified Play Integrity and root hiding stack for Android. Successor of Yurikey. `FOSS` `[M]` `[K]`
...
* **[Always Strong](https://github.com/evoker0/AlwaysStrong) ⭐ 378 | 🐛 1 | 🌐 Shell | 📅 2026-08-25** - Bundles TEESimulator-RS and PlayIntegrityFork into a single module for strong integrity on rooted devices. `FOSS` `[M]` `[K]`
* **[⭐ BRENE](https://github.com/rrr333nnn333/BRENE) ⭐ 329 | 🐛 6 | 🌐 Shell | 📅 2026-08-28** - SUSFS/KernelSU module for patched kernels with enhanced root hiding & spoofing. `FOSS` `[M]` `[K]`
* **[OhMyKeymint](https://github.com/qwq233/OhMyKeymint) ⭐ 296 | 🐛 2 | 🌐 Rust | 📅 2026-08-27** - Custom keystore implementation for Android Keystore Spoofer. `FOSS` `[M]` `[K]`
* **[ReZygisk's Treat Wheel](https://github.com/PerformanC/Treat-Wheel-Zygisk) ⭐ 247 | 🐛 7 | 🌐 C | 📅 2026-07-22** - Hides Magisk/root traces exclusively for ReZygisk, acting as the best userspace root hiding tool. `FOSS` `[M]` `[K]`
...
* **[⭐ Android-Native-Root-Detector](https://github.com/reveny/Android-Native-Root-Detector) ⭐ 1,379 | 🐛 16 | 🌐 Kotlin | 📅 2026-04-11** - A tool for detecting root on android. `FOSS`
...
* **[Duck Detector](https://github.com/eltavine/Duck-Detector-Refactoring) ⭐ 905 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-28** - Android environment integrity inspection tool for root, hook, bootloader, SELinux, virtualization, and attestation signals. `FOSS`
...
* **[Chunqiu Detector](https://github.com/mingzun09/Chunqiu-Detector-Problem-solution) ⭐ 362 | 🐛 0 | 🌐 HTML | 📅 2026-08-28** - Solutions, scripts, and modules for bypassing and troubleshooting Chunqiu Detector checks on rooted Android devices. `FOSS`
...
* **[⭐ Duck Detector Fork](https://github.com/rrr333nnn333/Duck-Detector-Refactoring) ⭐ 44 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-28** - Duck Detector fork with additional features and improvements. `FOSS`
* **[Android-Device-Trust](https://github.com/reveny/Android-Device-Trust) ⭐ 36 | 🐛 0 | 🌐 Python | 📅 2026-08-20** - Android device attestation and fingerprinting tool. `FOSS`
* **[Play Integrity Alert](https://github.com/Xiddoc/PlayIntegrityAlert) ⭐ 27 | 🐛 2 | 🌐 Kotlin | 📅 2026-07-02** - Get notified when an app calls the Play Integrity API. `FOSS` `[LSP]`
...
* **[Noogle Magisk](https://github.com/SelfRef/noogle-magisk) ⭐ 129 | 🐛 17 | 🌐 Shell | 📅 2025-04-23** - Magisk modules for removing/replacing Google applications on stock Android 11-15. `FOSS` `[M]`
...
* **[Cromite SystemWebView](https://github.com/hddq/magisk-cromite-webview) ⭐ 7 | 🐛 0 | 🌐 Shell | 📅 2026-06-12** - Replaces the Android System WebView with Cromite WebView. `FOSS` `[M]`
...
* **[VBMeta Disguiser](https://github.com/Astoritin/VBMetaDisguiser) ⭐ 84 | 🐛 0 | 🌐 Shell | 📅 2025-11-22** - Disguises the properties of vbmeta. `FOSS` `[M]` `[K]`
...
* **[SystemUI Tuner](https://github.com/zacharee/Tweaker?tab=readme-ov-file) ⭐ 1,720 | 🐛 67 | 🌐 Kotlin | 📅 2026-08-27** - View and modify hidden settings on Android devices. `FOSS` `[M]`
* **[PIXELIFY NEXT](https://github.com/BasGame1/Pixelify-Next) ⭐ 310 | 🐛 1 | 🌐 Shell | 📅 2026-08-26** - A Magisk Module which enables Pixel UI and some exclusive features. `FOSS` `[M]`
...
* **[OShin](https://github.com/suqi8/OShin/blob/master/README_EN.md) ⭐ 1,178 | 🐛 106 | 🌐 Kotlin | 📅 2026-07-28** - Auxiliary module deeply integrated with ColorOS, designed to enhance and optimize your operating system experience. `FOSS` `[LSP]`
...
* **[⭐ HyperCeiler](https://github.com/ReChronoRain/HyperCeiler/blob/main/README_en-US.md) ⭐ 5,292 | 🐛 231 | 🌐 Java | 📅 2026-08-25** - Extensive customizations for HyperOS. `FOSS` `[LSP]`
...
* **[Hyper Unlocked](https://github.com/ukriu/HyperUnlocked) ⭐ 224 | 🐛 16 | 🌐 Shell | 📅 2026-08-24** - Unlock all high-end features possible to be unlocked on low-end xiaomi devices. `FOSS` `[M]`
...
* **[NothingTweaks](https://github.com/RevealedSoulEven/NothingTweaks) ⭐ 8 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-28** - A customization module for Nothing OS based on Xposed framework. `FOSS` `[LSP]`

#### One UI (Samsung)

* **[⭐ KnoxPatch](https://github.com/salvogiangri/KnoxPatch) ⭐ 1,497 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-25** - Get Samsung apps/features working again in your rooted Galaxy device. For better experience, please also [read this ↗](https://github.com/salvogiangri/KnoxPatch?tab=readme-ov-file#knoxpatch-enhancer) ⭐ 1,497 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-25 . `FOSS` `[LSP]`
...
* **[One Design](https://github.com/Xposed-Modules-Repo/qyz.onedesign) ⭐ 33 | 🐛 0 | 📅 2026-08-28** - Customize multiple applications at the system level, providing feature enhancements, and system optimizations. `Proprietary` `[LSP]`
...
* **[Oxygen-Customizer](https://github.com/DHD2280/Oxygen-Customizer/) ⭐ 454 | 🐛 33 | 🌐 Java | 📅 2026-08-27** - Open-source Oxygen OS customizer application. `FOSS` `[LSP]`
...
* **[⭐ Canta](https://github.com/samolego/Canta) ⭐ 5,663 | 🐛 30 | 🌐 Kotlin | 📅 2026-08-24** - Uninstall any app without root using [Shizuku](#developer-tools). `FOSS` | [🌱](https://f-droid.org/en/packages/io.github.samolego.canta/) | [▶️](https://play.google.com/store/apps/details?id=io.github.samolego.canta)
...
* **[System App Nuker](https://github.com/ChiseWaguri/systemapp_nuker) ⭐ 247 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-28** - A module to debloat system apps with WebUI Interface. `FOSS` `[M]`
* **[Scalpel](https://github.com/Enginex0/Scalpel) ⭐ 40 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-23** - Precision Debloat & Systemize for Rooted Android. `FOSS` `[M]` `[K]`
...
* **[⭐ App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 8,843 | 🐛 207 | 🌐 Java | 📅 2026-08-26** - A full-featured package manager and viewer for Android. `FOSS` | [🌱](https://f-droid.org/packages/io.github.muntashirakon.AppManager/)
* **[⭐ Droid-ify](https://github.com/Droid-ify/client) ⭐ 7,332 | 🐛 195 | 🌐 Kotlin | 📅 2026-08-28** - F-Droid client with Material UI and auto updating apps using root. `FOSS` | [🌱](https://f-droid.org/packages/com.looker.droidify)
* **[⭐ Hail](https://github.com/aistra0528/Hail) ⭐ 6,560 | 🐛 167 | 🌐 Kotlin | 📅 2026-08-28** - Disable / Hide / Suspend / Uninstall Android apps. `FOSS` | [🌱](https://f-droid.org/packages/com.aistra.hail/)
* **[InstallerX-Revived](https://github.com/wxxsfxyzm/InstallerX-Revived) ⭐ 6,363 | 🐛 17 | 🌐 Kotlin | 📅 2026-08-28** - A modern and functional Android app installer. `FOSS` `[LSP]`
* **[Neo Store](https://github.com/NeoApplications/Neo-Store) ⭐ 4,945 | 🐛 126 | 🌐 Kotlin | 📅 2026-08-26** - An F-Droid client with modern UI and an arsenal of extra features. `FOSS` | [🌱](https://f-droid.org/packages/com.machiav3lli.fdroid)
* **[Aurora Store](https://github.com/whyorean/AuroraStore) ⭐ 2,905 | 🐛 26 | 🌐 Kotlin | 📅 2026-08-24** - A Google Play Store client to search, view app details, and download APKs directly to your device. `FOSS` | [🌱](https://f-droid.org/packages/com.aurora.store/)
...
* **[Inure](https://github.com/Hamza417/Inure) ⭐ 1,898 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-28** - An elegant and beautiful premium Android app manager for rooted and non-rooted devices. `FOSS` | [🌱](https://f-droid.org/en/packages/app.simple.inure/) | [▶️](https://play.google.com/store/apps/details?id=app.simple.inure.play)
* **[Universal Installer](https://github.com/pass-with-high-score/universal-installer) ⭐ 1,326 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-29** - Install and manage APK packages with split APK support. `FOSS` `[LSP]`
* **[InxLocker](https://github.com/Chimioo/InxLocker) ⭐ 884 | 🐛 2 | 🌐 Kotlin | 📅 2026-06-11** - Intercepts/forwards Android system application installation and uninstallation requests, redirecting them to your specified installer app. `FOSS` `[LSP]`
* **[Package Manager](https://github.com/SmartPack/PackageManager) ⭐ 814 | 🐛 71 | 🌐 Java | 📅 2026-08-25** - A highly powerful app to manage both system and user apps installed on an Android device. `FOSS` | [🌱](https://f-droid.org/packages/com.smartpack.packagemanager) | [▶️](https://play.google.com/store/apps/details?id=com.smartpack.packagemanager)
...
* **[Thor](https://github.com/trinadhthatakula/Thor) ⭐ 534 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-28** - Android App Manager and App Installer utility. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/com.valhalla.thor) | [▶️](https://play.google.com/store/apps/details?id=com.valhalla.thor)
...
* **[Thanox](https://github.com/Tornaco/Thanox) ⭐ 3,245 | 🐛 468 | 🌐 Java | 📅 2026-08-14** - A system management tool that provide convenient functions like application startup management, background management, permission management etc. `FOSS` `[LSP]` | [▶️](https://play.google.com/store/apps/details?id=github.tornaco.android.thanos.pro\&hl=en\&gl=US)
* **[PermissionManagerX](https://github.com/mirfatif/PermissionManagerX) ⭐ 761 | 🐛 10 | 🌐 HTML | 📅 2026-07-11** - eXtended Permission Manager for Android to view and set Manifest Permissions and AppOps. `FOSS` | [🌱](https://f-droid.org/packages/com.mirfatif.permissionmanagerx) | [▶️](https://play.google.com/store/apps/details?id=com.mirfatif.permissionmanagerx)
...
* **[COPG](https://github.com/AlirezaParsi/COPG) ⭐ 379 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-25** - Spoof your device to enjoy premium features, max performance, and exclusive benefits. `FOSS` `[M]`
...
* **[AZenith](https://github.com/Liliya2727/AZenith) ⭐ 116 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-21** - All-In-One (AIO) system optimization module designed to enhance Android performance. `FOSS` `[M]` `[K]`
...
* **[KonaBess](https://github.com/libxzr/KonaBess) ⭐ 1,778 | 🐛 12 | 🌐 Java | 📅 2025-10-03** - A straightforward application designed to customize GPU frequency and voltage tables without the need for kernel recompilation. `FOSS`
* **[Kernel Flasher](https://github.com/fatalcoder524/KernelFlasher) ⭐ 491 | 🐛 7 | 🌐 Kotlin | 📅 2026-07-01** - An Android app to flash (AK3 files), backup, and restore kernels. `FOSS`
...
* **[KonaBess Next](https://github.com/KonaBess-Next/KonaBess-Next) ⭐ 212 | 🐛 23 | 🌐 Kotlin | 📅 2026-08-06** - Fork of KonaBess, Custom GPU overclocking and undervolting tool with granulated voltage for rooted Snapdragon Android devices. `FOSS`
* **[Minimal Kernel Manager](https://github.com/abhay-byte/mkm) ⭐ 141 | 🐛 8 | 🌐 Kotlin | 📅 2026-07-07** - Android kernel management and system monitoring application. `FOSS` | [🌱](https://f-droid.org/packages/com.ivarna.fluxlinux/)
...
* **[Zuan Kernel Manager](https://github.com/ZUANVFX01/ZKM/) ⭐ 99 | 🐛 2 | 🌐 Kotlin | 📅 2026-02-22** - Advanced Android kernel management tool, rebuilt from the Rve Kernel Manager project base with Material 3 Expressive Modern Style. `FOSS`
...
* **[Swap Disabler](https://github.com/rompelhd/Swap-Disabler) ⭐ 23 | 🐛 0 | 🌐 Shell | 📅 2026-04-05** - Disable swap at system startup. `FOSS` `[M]`
...
* **[Plus Plus Battery](https://github.com/dijia1124/plusplusbattery) ⭐ 466 | 🐛 16 | 🌐 Kotlin | 📅 2026-02-22** - Real-time battery stats & health estimator for OnePlus/Oppo/Realme phones. `FOSS` | [🌱](https://f-droid.org/en/packages/com.dijia1124.plusplusbattery/)
* **[EnforceDoze](https://github.com/farfromrefug/EnforceDoze) ⭐ 357 | 🐛 21 | 🌐 Java | 📅 2026-07-26** - Enable Doze mode immediately after screen off and turn off motion sensing to get best battery life. `FOSS` | [🌱](https://f-droid.org/packages/com.akylas.enforcedoze/)
* **[NoWakeLock](https://github.com/NoWakeLock/NoWakeLock) ⭐ 310 | 🐛 3 | 🌐 Kotlin | 📅 2026-05-16** - An application that controls Android wakelocks can run on Android N and later. `FOSS` `[LSP]`
...
* **[⭐ FROSTY](https://github.com/Drsexo/Frosty) ⭐ 209 | 🐛 4 | 🌐 Shell | 📅 2026-07-04** - Optimizes battery life by selectively freezing Google Mobile Services (GMS) components and applying system-wide doze enhancements. `FOSS` `[M]` `[K]`
* **[BatStats](https://github.com/mlm-games/BatStats) ⭐ 175 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-24** - Battery monitor with stats via Shizuku/root. `FOSS`
...
* **[Xtreme-Battery-Saver](https://github.com/Magisk-Modules-Alt-Repo/Xtreme-Battery-Saver) ⭐ 126 | 🐛 1 | 🌐 Shell | 📅 2025-08-13** - An extreme battery saver Magisk Module for users who want to really stretch their battery life. `FOSS` `[M]`
...
* **[Universal GMS Doze Fork](https://github.com/MarsPatrick/universal-gms-doze) ⭐ 65 | 🐛 1 | 🌐 Shell | 📅 2026-08-17** - Patches Google Play services app and certain processes/services to be able to use battery optimization. `FOSS` `[M]`
...
* **[AccA](https://github.com/VR-25/acc) ⭐ 2,382 | 🐛 19 | 🌐 Shell | 📅 2025-06-06** - Advanced Charging Controller app. `FOSS`
...
* **[Shappky](https://github.com/YasserNull/shappky) ⭐ 546 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-25** - A simple app to boost performance by stopping background apps, relying on Root/Shizuku permissions. `FOSS` `[M]`
...
* **[BlockAds](https://github.com/pass-with-high-score/blockads-android) ⭐ 1,780 | 🐛 61 | 🌐 Kotlin | 📅 2026-08-23** - System‑wide ad, tracker, & malware filtering, custom blocklists, per‑app controls etc. `FOSS` | [🌱](https://f-droid.org/packages/app.pwhs.blockads)
...
* **[Magisk Ad Blocking Module](https://github.com/pantsufan/Magisk-Ad-Blocking-Module) ⭐ 569 | 🐛 19 | 📅 2026-08-28** - Block ads on android. `FOSS` `[M]`
...
* **[Re-Malwack](https://github.com/ZG089/Re-Malwack) ⭐ 446 | 🐛 4 | 🌐 C | 📅 2026-08-16** - A fully-fledged ad-block module. Contains all your needs. `FOSS` `[M]`
...
* **[AFWall+](https://github.com/ukanth/afwall) ⭐ 3,459 | 🐛 218 | 🌐 Java | 📅 2026-08-06** - Iptables-based firewall. `FOSS` | [🌱](https://f-droid.org/packages/dev.ukanth.ufirewall/) | [▶️](https://play.google.com/store/apps/details?id=dev.ukanth.ufirewall)
* **[ShizuWall](https://github.com/AhmetCanArslan/ShizuWall) ⭐ 2,181 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-28** - Android firewall without VPN powered by Shizuku / local ADB daemon / Root. `FOSS` | [🌱](https://f-droid.org/packages/com.arslan.shizuwall/) | [▶️](https://play.google.com/store/apps/details?id=com.arslan.shizuwall)
* **[Athena](https://github.com/Kin69/Athena) ⭐ 697 | 🐛 43 | 🌐 Kotlin | 📅 2026-01-26** - Material You (Material 3) firewall and ad blocker that works seamlessly on both rooted and non-rooted devices. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=com.kin.athena)
* **[De1984 Firewall](https://github.com/dorumrr/de1984) ⭐ 388 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-28** - A privacy-focused Firewall and Package Manager for Android devices. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/io.github.dorumrr.de1984)
* **[Net Switch](https://github.com/Rem01Gaming/net-switch) ⭐ 323 | 🐛 3 | 🌐 JavaScript | 📅 2025-11-08** - Isolate any app from Internet access. `FOSS` `[M]`
...
* **[⭐ Amarok](https://github.com/deltazefiro/Amarok-Hider) ⭐ 3,219 | 🐛 61 | 🌐 Java | 📅 2026-08-11** - Android application which enables you to hide your private files and apps with a single click. `FOSS` | [🌱](https://f-droid.org/zh_Hans/packages/deltazero.amarok.foss/)
...
* **[FuseFixer](https://github.com/5ec1cff/FuseFixer) ⭐ 389 | 🐛 1 | 🌐 C | 📅 2026-04-14** - Hooks the MediaProvider Fuse Daemon to stop apps probing package existence through `Android/data` directory quirks (Unicode casefold tricks). `FOSS` `[LSP]`
...
* **[FuseHide](https://github.com/XiaoTong6666/FuseHide) ⭐ 250 | 🐛 6 | 🌐 C++ | 📅 2026-08-25** - Hides chosen storage paths from MediaProvider on Android 12+ at runtime, and debugs/fixes `Android/data` Unicode casefold scenarios. `FOSS` `[LSP]`
...
* **[Always Trust User Certs](https://github.com/NVISOsecurity/AlwaysTrustUserCerts) ⭐ 2,550 | 🐛 10 | 🌐 Shell | 📅 2025-06-24** - A Magisk/KernelSU module that automatically adds user certificates to the system root CA store. `FOSS` `[M]` `[K]`
* **[⭐ Move Certificate](https://github.com/ys1231/MoveCertificate) ⭐ 1,954 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-18** - Move user certificates to system certificates. Supports Android 7-16. `FOSS` `[M]` `[K]`
* **[StrykerOSS](https://github.com/zalexdev/strykerapp) ⭐ 1,378 | 🐛 15 | 🌐 Java | 📅 2026-08-13** - Bundles a curated set of network, wireless and web security tools into a single rooted-Android application for penetration testing. `FOSS`
* **[⭐ Enable Screenshot](https://github.com/LSPosed/DisableFlagSecure) ⭐ 1,299 | 🐛 6 | 🌐 Java | 📅 2026-08-24** - Enabling screenshots in apps that normally wouldn't allow it, and disabling screenshot(Android 14+) and screen record(Android 15+) detection. `FOSS` `[LSP]`
...
* **[ih8SecureLock](https://github.com/j-hc/ih8SecureLock) ⭐ 172 | 🐛 2 | 🌐 C++ | 📅 2026-08-15** - Prevent apps from blocking and listening to your screenshots with Zygisk. `FOSS` `[M]` `[K]`
...
* **[TapDucky](https://github.com/iodn/tap-ducky) ⭐ 158 | 🐛 8 | 🌐 Dart | 📅 2026-05-17** - Open-source DuckyScript runner for rooted Android with USB Gadget (ConfigFS) support. `FOSS`  | [🌱](https://f-droid.org/en/packages/org.kaijinlab.tap_ducky/)
...
* **[HideMyAndroid](https://github.com/Xposed-Modules-Repo/com.wowsoftware.hidemyandroid/) ⭐ 88 | 🐛 0 | 📅 2026-08-27** - Android anti-detect module with profile isolation and spoofing. `Proprietary` `[LSP]`
...
* **[SSAID (Android ID Modifier)](https://github.com/HSSkyBoy/AndroidIDChange) ⭐ 31 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-17** - A modern Android SSAID (Android ID) inspector, modifier, backup, and management utility. `FOSS` `[LSP]`
...
* **[Island](https://github.com/oasisfeng/island/tree/dev) ⭐ 3,887 | 🐛 670 | 🌐 Java | 📅 2025-04-24** - App isolation and cloning. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=com.oasisfeng.island)
...
* **[FingerprintPay](https://github.com/eritpchy/FingerprintPay) ⭐ 4,492 | 🐛 35 | 🌐 Java | 📅 2026-03-06** - Enables fingerprint payment via WeChat, Alipay, Taobao, Tencent QQ, and UnionPay on phones that support fingerprint recognition. `FOSS` `[M]` `[LSP]`
...
* **[⭐ GPhotosUnlimited](https://github.com/Rev4N1/GPhotosUnlimited) ⭐ 345 | 🐛 1 | 🌐 C++ | 📅 2026-08-19** - A Zygisk module which gives unlimited Google Photos storage. `FOSS` `[M]` `[K]`
* **[Deekseep](https://github.com/lllucccian/Deekseep) ⭐ 250 | 🐛 3 | 🌐 Java | 📅 2026-08-28** - Adds account, chat, image, interface, and local API tools to the official DeepSeek Android app. `FOSS` `[LSP]`
...
* **[Nexus](https://github.com/niki914/agentic-nexus) ⭐ 127 | 🐛 29 | 🌐 Kotlin | 📅 2026-08-28** - Plug your own model into your phone's voice assistant. `Proprietary` `[LSP]`
...
* **[AmznKiller](https://github.com/hxreborn/amznkiller) ⭐ 83 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-24** - Hides sponsored content and ads in the Amazon Shopping app. `FOSS` `[LSP]`
* **[Play Store Adblock](https://github.com/hxreborn/playstore-adblock) ⭐ 78 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-24** - Xposed module to remove sponsored listings and ads from the Google Play Store. `FOSS` `[LSP]`
...
* **[Spicy EX](https://github.com/amarinne/spicy-ex) ⭐ 22 | 🐛 1 | 🌐 Java | 📅 2026-08-28** - Adds Spicy lyrics in Spotify along with translation and much more UI features. `FOSS` `[LSP]`
...
* **[NSG Tweaks](https://github.com/h3nnes/nsg-tweaks) ⭐ 15 | 🐛 0 | 🌐 Java | 📅 2026-08-27** - Extends [NSG (QuickTest) ↗](https://play.google.com/store/apps/details?id=com.qtrun.QuickTest) with additional columns, rows, signaling tools, and log-replay improvements. `Proprietary` `[LSP]`
...
* **[Timeline Unlocker](https://github.com/SherlockChiang/ReLocationReportEnabler) ⭐ 9 | 🐛 2 | 🌐 Java | 📅 2026-07-12** - Lets GMS Location History / Timeline be enabled on devices whose SIM is registered in a region where Google has restricted the feature. `FOSS` `[LSP]`
...
* **[BBZQ](https://github.com/HSSkyBoy/BBZQ) ⭐ 414 | 🐛 16 | 🌐 Kotlin | 📅 2026-08-28** - Removes unnecessary content, optimizes the core experience, and provide various practical functions. `FOSS` `[LSP]`

#### Discord

* **[Revenge](https://github.com/revenge-mod/revenge-bundle-next) ⭐ 168 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-28** - Revenge is a client modification for Discord Android. `FOSS`
...
* **[Facebook App Ads Remover](https://github.com/Xposed-Modules-Repo/tn.loukious.facebookappadsremover) ⭐ 52 | 🐛 5 | 🌐 Kotlin | 📅 2026-07-23** - Removes ads from Facebook app. `FOSS` `[LSP]`

#### Instagram

* **[InstaEclipse](https://github.com/ReSo7200/InstaEclipse/) ⭐ 1,413 | 🐛 17 | 🌐 Java | 📅 2026-07-24** - Adds Features like Developer Options, Ghost Mode, Ad-Free browsing, and Distraction-Free Mode to Instagram. `FOSS` `[LSP]`
...
* **[QAuxiliary](https://github.com/cinit/QAuxiliary) ⭐ 5,723 | 🐛 267 | 🌐 Java | 📅 2026-08-28** - Xposed module based on QNotified. `FOSS` `[LSP]`
...
* **[TCQT Module](https://github.com/callng/TCQT) ⭐ 223 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-26** - An Xposed module designed for Android QQ/TIM clients, which is used to intercept and retain messages that would otherwise be "retracted". `FOSS` `[LSP]`
...
* **[Morphe Reddit Patches](https://github.com/MorpheApp/morphe-patches#-patches-list) ⭐ 3,430 | 🐛 450 | 🌐 Java | 📅 2026-08-29** - Various patches for reddit. `FOSS`
* **[Patcheddit](https://github.com/wchill/patcheddit) ⭐ 777 | 🐛 48 | 🌐 Kotlin | 📅 2026-05-03** - Custom patches with features like view: deleted Reddit posts & comments,Banned subreddits etc. `FOSS`
* **[Adobo Patches](https://github.com/jkennethcarino/adobo/) ⭐ 240 | 🐛 13 | 🌐 Kotlin | 📅 2026-08-21** - Various patches for reddit app. `FOSS`

#### Telegram

* **[TMoe](https://github.com/cinit/TMoe) ⭐ 1,427 | 🐛 20 | 🌐 Java | 📅 2026-07-19** - Adds various tweaks to various Telegram clients. `FOSS` `[LSP]`
...
* **[Telegami](https://github.com/aoya111/Telegami) ⭐ 226 | 🐛 31 | 🌐 Kotlin | 📅 2026-08-28** - Various tweaks for Telegram. `FOSS` `[LSP]`
...
* **[GramSieve](https://github.com/Xposed-Modules-Repo/com.tianqianguai.gramsieve) ⭐ 22 | 🐛 0 | 🌐 Java | 📅 2026-08-29** - Message filtering, host-settings integration, anti-recall, anti-edit/edit interception etc. `Proprietary` `[LSP]`

#### TikTok

* **[Douyin Enhancer](https://github.com/twyora/DouyinEnhancer) ⭐ 88 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-27** - Adds minor quality-of-life features to Douyin (Chinese TikTok). `FOSS` `[LSP]`
* **[Toki](https://github.com/MeiYongAI/Toki) ⭐ 62 | 🐛 3 | 🌐 Java | 📅 2026-08-19** - Adds various tweaks to TikTok app. `FOSS` `[LSP]`
...
* **[WeChat Auxiliary](https://github.com/HdShare/WAuxiliary_Public) ⭐ 3,980 | 🐛 12 | 🌐 Kotlin | 📅 2026-05-31** - Various tweaks for WeChat. `Proprietary` `[LSP]`
...
* **[⭐ WA Enhancer](https://github.com/Dev4Mod/WaEnhancer) ⭐ 1,669 | 🐛 242 | 🌐 Kotlin | 📅 2026-08-27** - Enhances your WhatsApp experience. `FOSS` `[LSP]`
* **[WAPlus](https://github.com/RevealedSoulEven/WAPlusXposed) ⭐ 34 | 🐛 0 | 🌐 Kotlin | 📅 2026-06-29** - Unlock WhatsApp Plus Features. `FOSS` `[LSP]`
* **[WaThemer](https://github.com/ayane-04/wathemer) ⭐ 3 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-26** - Themes WhatsApp with custom colors, chat bubble shapes, wallpapers, fonts, icons, system bars and a Liquid Glass mode. Requires Android 12+. `FOSS` `[LSP]`
* **[WA Enhancer X](https://github.com/mubashardev/WaEnhancerX)** - Fork of WA Enhancer with additional features. `FOSS` `[LSP]`

#### X/Twitter

* **[⭐ Piko Patches](https://github.com/crimera/piko) ⭐ 4,950 | 🐛 497 | 🌐 Java | 📅 2026-08-29** - Morphe patches for twitter with features like hide promoted tweets, hide promoted accounts, hide promoted trends, hide "who to follow" etc. `FOSS`
* **[Re:X](https://github.com/Xposed-Modules-Repo/one.dot.rex) ⭐ 155 | 🐛 0 | 📅 2026-08-28** -  Tweaks for the new X / Twitter app. `Proprietary` `[LSP]`
...
* **[BetterVia](https://github.com/JiGuroLGC/BetterVia) ⭐ 1,258 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-25** - Bypass whitelist restrictions, Screenshot protection, Block components, One-tap theme switching etc. `FOSS` `[LSP]`
* **[⭐ ChromeXt](https://github.com/JingMatrix/ChromeXt) ⭐ 1,136 | 🐛 28 | 🌐 Kotlin | 📅 2026-08-20** - UserScript and DevTools support for Chromium-based and WebView-based browsers. `FOSS` `[LSP]`
...
* **[NexAlloy](https://github.com/NexAlloy/NexAlloy) ⭐ 2,907 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-03** - YouTube, YT Music block ads, background playback, sponsorblock and much more. Also unlocks premium features of Strava and Photomath. Unlimited Google Photos backup. `FOSS` `[LSP]`
...
* **[GlassMic](https://github.com/lm060719/io.mo.glassmic) ⭐ 57 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-27** - Lets you route an imported audio file into target recording apps through AudioRecord/AAudio hooks. `FOSS` `[LSP]`
...
* **[⭐ Core Patch N](https://github.com/LSPosed/CorePatch) ⭐ 3,284 | 🐛 9 | 🌐 Kotlin | 📅 2026-07-26** - Disable signature verification For Android. `FOSS` `[LSP]`
...
* **[Apk Protection Patch](https://github.com/Mods-Center/Apk-Protection-Patch) ⭐ 206 | 🐛 10 | 📅 2025-08-12** - Removes signature verification restrictions on AOSP and OEM ROMs (HyperOS, ColorOS, etc.), allowing installation of modified APKs. `Proprietary` `[M]` `[K]`
* **[F\*\*k Google License](https://github.com/JiGuroLGC/FuckGoogleLicense) ⭐ 203 | 🐛 0 | 🌐 Java | 📅 2026-08-16** - Bypass Google Service License Verification. `FOSS` `[LSP]`
...
* **[Material Files](https://github.com/zhanghai/MaterialFiles) ⭐ 8,822 | 🐛 627 | 🌐 Kotlin | 📅 2026-04-06** - Modern file manager with root capabilities. `FOSS` | [🌱](https://f-droid.org/packages/me.zhanghai.android.files)| [▶️](https://play.google.com/store/apps/details?id=me.zhanghai.android.files)
* **[AnExplorer](https://github.com/1hakr/AnExplorer) ⭐ 2,018 | 🐛 36 | 🌐 Java | 📅 2026-06-02** - A simple, Small, Fast and Efficient File Explorer. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=dev.dworks.apps.anexplorer)
* **[Fossify File Manager](https://github.com/FossifyOrg/File-Manager) ⭐ 1,730 | 🐛 98 | 🌐 Kotlin | 📅 2026-08-24** - Easy app for managing your files without ads, respecting your privacy and security. `FOSS` | [🌱](https://f-droid.org/packages/org.fossify.filemanager/) | [▶️](https://play.google.com/store/apps/details?id=org.fossify.filemanager)
...
* **[DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,279 | 🐛 187 | 🌐 Kotlin | 📅 2026-08-27** - DataBackup for Android 7.0+. `FOSS` | [🌱](https://f-droid.org/zh_Hans/packages/com.xayah.databackup.foss/)
...
* **[Restoid](https://github.com/hddq/restoid) ⭐ 164 | 🐛 18 | 🌐 Kotlin | 📅 2026-08-28** - modern, root-based Android app backup tool powered by restic. `FOSS`
...
* **[⭐ SD Maid 2/SE](https://github.com/d4rken-org/sdmaid-se) ⭐ 7,392 | 🐛 15 | 🌐 Kotlin | 📅 2026-08-27** - A file management tool for Android that specializes in maintenance. Its core purpose is freeing up space and removing unwanted data. `FOSS` | [🌱](https://f-droid.org/en/packages/eu.darken.sdmse/) | [▶️](https://play.google.com/store/apps/details?id=eu.darken.sdmse)
* **[Cleaner Royall](https://github.com/araafroyall/Cleaner-Royall) ⭐ 240 | 🐛 0 | 🌐 Shell | 📅 2026-08-27** - A lightweight but ultra-fast and powerful cleaner for Android. `Proprietary` `[LSP]`
...
* **[Iconify](https://github.com/Mahmud0808/Iconify) ⭐ 3,153 | 🐛 99 | 🌐 Kotlin | 📅 2026-08-22** - Customize your Android 12+ device easily. `FOSS` `[M]`
* **[ColorBlendr](https://github.com/Mahmud0808/ColorBlendr) ⭐ 2,419 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-23** - Customize Material You colors of your device. `FOSS` | [🌱](https://f-droid.org/en/packages/com.drdisagree.colorblendr/)
* **[HyperLight](https://github.com/KiminonawaResa/HyperLight#english) ⭐ 714 | 🐛 41 | 📅 2026-08-25** - Completes the highlight blur effects for HyperOS 3, bringing a unified visual experience to the desktop, notification shade, and control center. `FOSS` `[LSP]`
* **[Global Icon Pack](https://github.com/RichardLuo0/global-icon-pack-android) ⭐ 408 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-25** - Apply icon packs globally. `FOSS` `[LSP]`
...
* **[Activity Manager](https://github.com/sdex/ActivityManager) ⭐ 1,293 | 🐛 14 | 🌐 Kotlin | 📅 2026-07-25** - Discover the activities of installed applications, run them, and create shortcuts. `FOSS` | [🌱](https://f-droid.org/packages/com.activitymanager/)
* **[Google Shortcuts Launcher](https://github.com/WSTxda/Google-Shortcuts-Launcher) ⭐ 699 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-29** - Easily access essential Google apps features directly from your launcher app drawer. `FOSS`
...
* **[Lyricon](https://github.com/tomakino/lyricon) ⭐ 733 | 🐛 36 | 🌐 Kotlin | 📅 2026-08-23** - An Android status bar lyric enhancement tool based on the Xposed framework. `FOSS` `[LSP]`
* **[LyricProvider](https://github.com/tomakino/LyricProvider/tree/master) ⭐ 370 | 🐛 43 | 🌐 Kotlin | 📅 2026-08-26** - A lyric provider for Lyricon. `FOSS` `[LSP]`
...
* **[Volume Key Track Control Module](https://github.com/Hepolise/VolumeKeyTrackControlModule) ⭐ 83 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-28** - Allows to skip and play/pause track with volume keys. `FOSS` `[LSP]`
...
* **[MakeFontsGreatAgain](https://github.com/Numbersf/MakeFontsGreatAgain) ⭐ 298 | 🐛 9 | 🌐 C | 📅 2026-08-01** - System-wide Font Overrider with Unique GMS Masking & Multi-Range Unicode Filter. `FOSS` `[M]` `[K]`
...
* **[HyperIsland](https://github.com/1812z/HyperIsland/blob/main/README_EN.md) ⭐ 456 | 🐛 7 | 🌐 Dart | 📅 2026-08-28** - Dynamic Island-style notifications for HyperOS 3, powered by LSPosed. `FOSS` `[LSP]`
...
* **[Adaptive Theme: Auto Dark Mode by Ambient Light](https://github.com/xLexip/Adaptive-Theme) ⭐ 210 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-27** - Automatically switches between Light and Dark mode using the ambient light sensor. `FOSS` | [▶️](https://play.google.com/store/apps/details?id=dev.lexip.hecate)
...
* **[DarQ Fork](https://github.com/Arora-Sir/DarQ) ⭐ 82 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-12** - Provides a per-app selectable force dark option for Android 10 and above. `FOSS`
...
* **[JamesDSP](https://github.com/james34602/JamesDSPManager) ⭐ 931 | 🐛 35 | 🌐 C | 📅 2025-06-18** - Audio DSP effects built on the Android system framework layer. This repository contains a pack of high-quality DSP algorithms specialized for audio processing. `FOSS` `[M]`
* **[⭐ ViPERFX\_RE](https://github.com/likelikeslike/ViPERFX_RE) ⭐ 295 | 🐛 3 | 🌐 C | 📅 2026-08-11** - A fork of ViPER4Android FX with a redesigned UI and additional features. `FOSS` `[M]` `[K]`
...
* **[LibrePods](https://github.com/kavishdevar/librepods) ⭐ 29,610 | 🐛 276 | 🌐 Kotlin | 📅 2026-08-25** - Unlocks Apple's exclusive premium AirPods features on non-Apple devices. `FOSS` `[LSP]` `[M]` `[K]`
...
* **[SonyPods](https://github.com/Mercury000/SonyPods) ⭐ 24 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-28** - System-level Sony headphone control for HyperOS devices. `FOSS` `[LSP]`
* **[HuaweiPods](https://github.com/Nshpiter/HuaweiPods) ⭐ 14 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-28** - Huawei audio device integration for Xiaomi HyperOS. `FOSS` `[LSP]`

### Audio Effects

* **[Audio Misc Settings](https://github.com/Magisk-Modules-Alt-Repo/audio-misc-settings) ⭐ 341 | 🐛 0 | 🌐 Shell | 📅 2026-01-18** - For setting miscellaneous audio configuration values (media audio volume steps (100 steps), raising the resampling quality, disabling the effects framework, etc.) `FOSS` `[M]`
...
* **[Hifi-maximizer-mod](https://github.com/yzyhk904/hifi-maximizer-mod) ⭐ 191 | 🐛 1 | 🌐 Shell | 📅 2026-08-06** - Maximize the digital audio fidelity by reducing jitters on audio outputs (USB DACs, Bluetooth a2dp, DLNA, etc.) `FOSS` `[M]`
...
* **[personalDNSfilter](https://github.com/IngoZenz/personaldnsfilter) ⭐ 931 | 🐛 65 | 🌐 Java | 📅 2026-08-05** - A DNS filter proxy that provides local filtering of ads, malware, and tracking servers, supporting secure DNS protocols like DOH and DOT for enhanced privacy. `FOSS` | [🌱](https://f-droid.org/packages/dnsfilter.android/)
...
* **[FlClash](https://github.com/chen08209/FlClash) ⭐ 50,253 | 🐛 604 | 🌐 Dart | 📅 2026-08-28** - A multi-platform proxy client based on ClashMeta, simple and easy to use, open-source and ad-free. `FOSS`
* **[VPN Hotspot](https://github.com/Mygod/VPNHotspot) ⭐ 6,368 | 🐛 24 | 🌐 Kotlin | 📅 2026-08-28** - Share your VPN connection over hotspot or repeater. `FOSS`
...
* **[Surfing](https://github.com/GitMetaio/Surfing) ⭐ 2,360 | 🐛 79 | 🌐 Shell | 📅 2026-08-28** - Magisk and KernelSU modules for Clash/mihomo, sing-box, v2ray, xray, hysteria services. `FOSS` `[M]` `[K]`
...
* **[NetProxy-Magisk](https://github.com/Fanju6/NetProxy-Magisk) ⭐ 1,143 | 🐛 25 | 🌐 Kotlin | 📅 2026-08-26** - Magisk proxy module based on Xray kernel, supports one-click start/stop transparent proxy. `FOSS` `[M]`
* **[VPN Hide](https://github.com/okhsunrog/vpnhide) ⭐ 528 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-26** - Hide active VPN from selected Android apps (kernel module + LSPosed + Zygisk) `FOSS` `[M]` `[K]`
* **[ZDT-D Root Module](https://github.com/GAME-OVER-op/ZDT-D) ⭐ 272 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-28** - Module for traffic routing, DPI bypass, proxy chaining, DNS control, and per-app network management. `FOSS` `[M]` `[K]`
...
* **[Network Switch](https://github.com/aunchagaonkar/NetworkSwitch#installation) ⭐ 451 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-20** - Modern Android app for 4G/5G network mode switching. `FOSS` | [🌱](https://apt.izzysoft.de/packages/com.supernova.networkswitch)
* **[WiFi Password Manager](https://github.com/Khh-vu/wifi-password-manager) ⭐ 289 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-25** - Simple app to manage WiFi passwords. `FOSS` | [🌱](https://apt.izzysoft.de/packages/io.github.wifi_password_manager)
...
* **[NFCGate](https://github.com/nfcgate/nfcgate) ⭐ 2,338 | 🐛 12 | 🌐 Java | 📅 2026-07-20** - Android application meant to capture, analyze, or modify NFC traffic. `FOSS` `[LSP]` | [🌱](https://f-droid.org/packages/de.tu_darmstadt.seemoo.nfcgate/)
* **[onHit](https://github.com/0penPublic/onHit) ⭐ 81 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-28** - Trigger Android NFC events without a physical tag by Xposed. `FOSS` `[LSP]`
...
* **[XposedFakeLocation](https://github.com/noobexon1/XposedFakeLocation) ⭐ 666 | 🐛 9 | 🌐 Kotlin | 📅 2026-08-02** - Allows you to spoof your device's location globally or for specific apps without using "mock location" from the developer options. `FOSS` `[LSP]`
* **[Hide Mock Location](https://github.com/auag0/HideMockLocation) ⭐ 362 | 🐛 13 | 🌐 Kotlin | 📅 2026-05-12** - Hide Mock Location Settings. `FOSS` `[LSP]`
...
* **[HLocation](https://github.com/sparr-sherrya/hlocation-release) ⭐ 53 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-29** - Location spoofing framework that synchronizes fake GPS and related environment signals across system and app processes for more consistent location virtualization. `FOSS` `[LSP]`
...
* **[AnyWhere](https://github.com/cxOrz/AnyWhere) ⭐ 10 | 🐛 0 | 🌐 Java | 📅 2026-08-28** - Location simulation tool for debugging LBS applications and for users to test geolocation functionality. `FOSS` `[LSP]`
...
* **[AsoulOpt](https://github.com/nakixii/Magisk_AsoulOpt) ⭐ 2,670 | 🐛 0 | 🌐 Shell | 📅 2026-08-09** - Game threads tweaker for Android, suitable for mainstream games and some niche games. `FOSS` `[M]`
...
* **[Encore Tweaks](https://github.com/Rem01Gaming/encore) ⭐ 508 | 🐛 3 | 🌐 C++ | 📅 2026-08-16** - Enhance device performance during gaming sessions, while keeping battery life optimized for normal use. `Proprietary` `[M]`
...
* **[⭐ Termux](https://github.com/termux/termux-app) ⭐ 59,944 | 🐛 598 | 🌐 Java | 📅 2026-08-24** - A terminal emulator application for Android OS extendible by variety of packages. `FOSS` | [🌱](https://f-droid.org/en/packages/com.termux)
* **[aShell You](https://github.com/DP-Hridayan/aShellYou) ⭐ 2,243 | 🐛 35 | 🌐 Kotlin | 📅 2026-08-29** - Android shell utility app with Material Design 3 UI, letting you run ADB, root and shell commands. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/in.hridayan.ashell)
...
* **[Shizuku](https://github.com/RikkaApps/Shizuku) ⭐ 29,474 | 🐛 548 | 🌐 Kotlin | 📅 2025-06-18** - Use system APIs directly with ADB/root privileges. `FOSS` | [🌱](https://apt.izzysoft.de/fdroid/index/apk/moe.shizuku.privileged.api) | [▶️](https://play.google.com/store/search?q=shizuku\&c=apps)
* **[⭐ Shizuku Fork](https://github.com/thedjchi/Shizuku) ⭐ 5,385 | 🐛 66 | 🌐 Kotlin | 📅 2026-07-15** - Shizuku for with automatic Shizuku startup, automation, and recovery features. `FOSS`
* **[Shevery](https://github.com/HmnDev-Tech/shevery) ⭐ 891 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-28** - Based on shizuku with Jetpack Compose, Material 3, and compatibility enhancements. `FOSS`
...
* **[Zygisk-Loader](https://github.com/HanSoBored/Zygisk-Loader) ⭐ 105 | 🐛 0 | 🌐 C | 📅 2026-08-16** - Module for hot-swapping native libraries into Android applications without rebooting. `FOSS` `[K]`
...
* **[Py2Droid](https://github.com/Mrakorez/py2droid) ⭐ 73 | 🐛 0 | 🌐 Python | 📅 2026-08-06** - Install Python 3 on Android, including the standard library (STDLIB). `FOSS` `[M]`
...
* **[⭐ Droidspaces](https://github.com/ravindu644/Droidspaces-OSS) ⭐ 1,782 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-28** - Run full Linux environments on top of Android, with complete init system support. `FOSS`
...
* **[USB HID Client](https://github.com/Arian04/android-hid-client) ⭐ 430 | 🐛 19 | 🌐 Kotlin | 📅 2026-08-25** - Use your phone as a keyboard and mouse without any software on the other end. `FOSS` | [🌱](https://apt.izzysoft.de/packages/me.arianb.usb_hid_client)
...
* **[RebootNya](https://github.com/daisukiKaffuChino/RebootNya) ⭐ 253 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-20** - A simple yet advanced reboot utility for Android devices. `FOSS`
...
* **[⭐ CleanShare](https://github.com/hxreborn/cleanshare) ⭐ 109 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-26** - Removes Direct Share's suggested contact/conversation shortcuts from Android's Share Sheet. `FOSS` `[LSP]`
...
* **[Basic Call Recorder](https://github.com/chenxiaolong/BCR) ⭐ 2,882 | 🐛 13 | 🌐 Kotlin | 📅 2026-08-20** - A Basic Call Recorder for rooted Android devices. Also check out [GUI for BCR ↗](https://github.com/nicorac/bcr-gui) ⭐ 351 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-10. `FOSS` `[M]` `[K]`
...
* **[⭐ Essentials](https://github.com/sameerasw/essentials) ⭐ 2,789 | 🐛 96 | 🌐 Kotlin | 📅 2026-08-28** - Multi-purpose tweaks for display, notifications and alerts, security and privacy, sound and haptics, and app freezing. `FOSS`
* **[UotanToolbox NT](https://github.com/Uotan-Dev/UotanToolboxNT) ⭐ 2,675 | 🐛 7 | 🌐 C# | 📅 2026-08-02** - A modern toolbox for Android power users and geeks. `FOSS`
* **[SwitchAI - Switch AI Digital Assistant](https://github.com/WSTxda/SwitchAI) ⭐ 1,422 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-27** - Easily select, start, and manage your preferred AI digital assistants. `FOSS`
* **[Zygisk Sui](https://github.com/XiaoTong6666/Sui) ⭐ 642 | 🐛 2 | 🌐 Java | 📅 2026-08-25** - Modern superuser interface (SUI) implementation for Android. `FOSS` `[M]` `[K]`
